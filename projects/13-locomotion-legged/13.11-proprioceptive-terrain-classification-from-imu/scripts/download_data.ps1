# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.11 (Proprioceptive terrain classification from IMU/joint history)
#
...
Write-Host "[download_data] Project 13.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
