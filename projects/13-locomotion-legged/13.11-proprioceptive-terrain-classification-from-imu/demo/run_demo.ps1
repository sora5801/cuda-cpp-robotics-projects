# ===========================================================================
# run_demo.ps1 — one-command demo for 13.11 (Proprioceptive terrain classification from IMU/joint history)
#
...
$Slug       = 'proprioceptive-terrain-classification-from-imu'                     # substituted by scaffold.py
