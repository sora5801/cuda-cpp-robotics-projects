#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 13.11 (Proprioceptive terrain classification from IMU/joint history)
...
SLUG='proprioceptive-terrain-classification-from-imu'
