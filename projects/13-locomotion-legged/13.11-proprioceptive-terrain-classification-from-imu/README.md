# 13.11 — Proprioceptive terrain classification from IMU/joint history

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Proprioceptive terrain classification from IMU/joint history`
>
...
1. Open [`build/proprioceptive-terrain-classification-from-imu.sln`](build/proprioceptive-terrain-classification-from-imu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/proprioceptive-terrain-classification-from-imu.exe`.
