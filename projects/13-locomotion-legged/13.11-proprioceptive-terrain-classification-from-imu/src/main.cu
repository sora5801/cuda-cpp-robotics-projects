// ===========================================================================
// main.cu — entry point for project 13.11 (Proprioceptive terrain classification from IMU/joint history)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.11 (proprioceptive-terrain-classification-from-imu)\n");
