# 13.04 — Terrain traversability + steppability analysis on GPU

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Terrain traversability + steppability analysis on GPU`
>
...
1. Open [`build/terrain-traversability-steppability-analysis.sln`](build/terrain-traversability-steppability-analysis.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/terrain-traversability-steppability-analysis.exe`.
