# ===========================================================================
# run_demo.ps1 — one-command demo for 13.04 (Terrain traversability + steppability analysis on GPU)
#
...
$Slug       = 'terrain-traversability-steppability-analysis'                     # substituted by scaffold.py
