// ===========================================================================
// main.cu — entry point for project 13.04 (Terrain traversability + steppability analysis on GPU)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.04 (terrain-traversability-steppability-analysis)\n");
