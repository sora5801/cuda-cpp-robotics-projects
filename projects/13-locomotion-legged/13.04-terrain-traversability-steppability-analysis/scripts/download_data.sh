#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.04 (Terrain traversability + steppability analysis on GPU)
...
echo "[download_data] Project 13.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
