# 13.07 — CPG (central pattern generator) parameter evolution with parallel sim

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `CPG (central pattern generator) parameter evolution with parallel sim`
>
...
1. Open [`build/cpg-parameter-evolution-with-parallel-sim.sln`](build/cpg-parameter-evolution-with-parallel-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/cpg-parameter-evolution-with-parallel-sim.exe`.
