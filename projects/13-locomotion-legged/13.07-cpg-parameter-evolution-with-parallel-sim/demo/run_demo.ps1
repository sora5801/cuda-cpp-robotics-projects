# ===========================================================================
# run_demo.ps1 — one-command demo for 13.07 (CPG (central pattern generator) parameter evolution with parallel sim)
#
...
$Slug       = 'cpg-parameter-evolution-with-parallel-sim'                     # substituted by scaffold.py
