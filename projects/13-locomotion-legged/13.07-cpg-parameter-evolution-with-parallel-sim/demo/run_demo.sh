#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 13.07 (CPG (central pattern generator) parameter evolution with parallel sim)
...
SLUG='cpg-parameter-evolution-with-parallel-sim'
