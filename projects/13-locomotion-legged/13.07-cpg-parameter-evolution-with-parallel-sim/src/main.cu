// ===========================================================================
// main.cu — entry point for project 13.07 (CPG (central pattern generator) parameter evolution with parallel sim)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.07 (cpg-parameter-evolution-with-parallel-sim)\n");
