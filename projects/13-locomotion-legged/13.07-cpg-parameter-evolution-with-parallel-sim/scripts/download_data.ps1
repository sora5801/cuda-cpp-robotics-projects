# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.07 (CPG (central pattern generator) parameter evolution with parallel sim)
#
...
Write-Host "[download_data] Project 13.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
