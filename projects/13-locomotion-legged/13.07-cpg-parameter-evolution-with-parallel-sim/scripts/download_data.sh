#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.07 (CPG (central pattern generator) parameter evolution with parallel sim)
...
echo "[download_data] Project 13.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
