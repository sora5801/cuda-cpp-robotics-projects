# ===========================================================================
# run_demo.ps1 — one-command demo for 13.08 (Humanoid footstep planning: GPU-expanded A* with capture-point feasibility)
#
...
$Slug       = 'humanoid-footstep-planning'                     # substituted by scaffold.py
