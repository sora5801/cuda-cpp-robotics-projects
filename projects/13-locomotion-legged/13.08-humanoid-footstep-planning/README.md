# 13.08 — Humanoid footstep planning: GPU-expanded A* with capture-point feasibility

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Humanoid footstep planning: GPU-expanded A* with capture-point feasibility`
>
...
1. Open [`build/humanoid-footstep-planning.sln`](build/humanoid-footstep-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/humanoid-footstep-planning.exe`.
