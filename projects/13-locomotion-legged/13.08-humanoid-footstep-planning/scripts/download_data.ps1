# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.08 (Humanoid footstep planning: GPU-expanded A* with capture-point feasibility)
#
...
Write-Host "[download_data] Project 13.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
