#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.08 (Humanoid footstep planning: GPU-expanded A* with capture-point feasibility)
...
echo "[download_data] Project 13.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
