// ===========================================================================
// main.cu — entry point for project 13.08 (Humanoid footstep planning: GPU-expanded A* with capture-point feasibility)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.08 (humanoid-footstep-planning)\n");
