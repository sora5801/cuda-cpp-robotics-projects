#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 13.01 (Parallel-sim RL quadruped gait training (the flagship GPU robotics project))
...
SLUG='parallel-sim-rl-quadruped-gait-training'
