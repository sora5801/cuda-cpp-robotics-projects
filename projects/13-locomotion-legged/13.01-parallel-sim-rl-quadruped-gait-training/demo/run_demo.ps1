# ===========================================================================
# run_demo.ps1 — one-command demo for 13.01 (Parallel-sim RL quadruped gait training (the flagship GPU robotics project))
#
...
$Slug       = 'parallel-sim-rl-quadruped-gait-training'                     # substituted by scaffold.py
