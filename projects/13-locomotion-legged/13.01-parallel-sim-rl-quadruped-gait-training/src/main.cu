// ===========================================================================
// main.cu — entry point for project 13.01 (Parallel-sim RL quadruped gait training (the flagship GPU robotics project))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.01 (parallel-sim-rl-quadruped-gait-training)\n");
