# 13.01 — Parallel-sim RL quadruped gait training (the flagship GPU robotics project)

**Difficulty:** ★ beginner · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `★ Parallel-sim RL quadruped gait training (the flagship GPU robotics project)`
>
...
1. Open [`build/parallel-sim-rl-quadruped-gait-training.sln`](build/parallel-sim-rl-quadruped-gait-training.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/parallel-sim-rl-quadruped-gait-training.exe`.
