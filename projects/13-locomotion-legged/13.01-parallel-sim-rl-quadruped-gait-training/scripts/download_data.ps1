# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.01 (Parallel-sim RL quadruped gait training (the flagship GPU robotics project))
#
...
Write-Host "[download_data] Project 13.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
