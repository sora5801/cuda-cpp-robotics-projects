#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.01 (Parallel-sim RL quadruped gait training (the flagship GPU robotics project))
...
echo "[download_data] Project 13.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
