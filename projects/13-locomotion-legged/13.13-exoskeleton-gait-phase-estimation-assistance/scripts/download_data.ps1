# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.13 (Exoskeleton gait-phase estimation + assistance-torque optimization)
#
...
Write-Host "[download_data] Project 13.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
