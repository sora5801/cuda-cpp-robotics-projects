#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.13 (Exoskeleton gait-phase estimation + assistance-torque optimization)
...
echo "[download_data] Project 13.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
