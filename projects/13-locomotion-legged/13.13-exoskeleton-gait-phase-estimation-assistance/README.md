# 13.13 — Exoskeleton gait-phase estimation + assistance-torque optimization

**Difficulty:** [R&D] research · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Exoskeleton gait-phase estimation + assistance-torque optimization [R&D]`
>
...
Exoskeleton gait-phase estimation + assistance-torque optimization
...
1. Open [`build/exoskeleton-gait-phase-estimation-assistance.sln`](build/exoskeleton-gait-phase-estimation-assistance.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/exoskeleton-gait-phase-estimation-assistance.exe`.
