#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 13.13 (Exoskeleton gait-phase estimation + assistance-torque optimization)
...
SLUG='exoskeleton-gait-phase-estimation-assistance'
