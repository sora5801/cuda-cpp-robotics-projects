# ===========================================================================
# run_demo.ps1 — one-command demo for 13.13 (Exoskeleton gait-phase estimation + assistance-torque optimization)
#
...
$Slug       = 'exoskeleton-gait-phase-estimation-assistance'                     # substituted by scaffold.py
