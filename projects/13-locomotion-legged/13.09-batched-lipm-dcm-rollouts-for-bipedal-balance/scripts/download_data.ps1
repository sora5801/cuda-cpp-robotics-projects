# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.09 (Batched LIPM/DCM rollouts for bipedal balance + push recovery)
#
...
Write-Host "[download_data] Project 13.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
