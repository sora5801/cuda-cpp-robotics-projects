#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.09 (Batched LIPM/DCM rollouts for bipedal balance + push recovery)
...
echo "[download_data] Project 13.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
