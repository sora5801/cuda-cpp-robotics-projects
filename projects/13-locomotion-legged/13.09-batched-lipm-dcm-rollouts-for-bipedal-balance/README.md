# 13.09 — Batched LIPM/DCM rollouts for bipedal balance + push recovery

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Batched LIPM/DCM rollouts for bipedal balance + push recovery`
>
...
1. Open [`build/batched-lipm-dcm-rollouts-for-bipedal-balance.sln`](build/batched-lipm-dcm-rollouts-for-bipedal-balance.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-lipm-dcm-rollouts-for-bipedal-balance.exe`.
