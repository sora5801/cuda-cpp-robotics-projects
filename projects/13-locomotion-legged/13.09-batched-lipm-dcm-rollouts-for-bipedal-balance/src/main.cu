// ===========================================================================
// main.cu — entry point for project 13.09 (Batched LIPM/DCM rollouts for bipedal balance + push recovery)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.09 (batched-lipm-dcm-rollouts-for-bipedal-balance)\n");
