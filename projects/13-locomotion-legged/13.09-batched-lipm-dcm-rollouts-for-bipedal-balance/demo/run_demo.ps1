# ===========================================================================
# run_demo.ps1 — one-command demo for 13.09 (Batched LIPM/DCM rollouts for bipedal balance + push recovery)
#
...
$Slug       = 'batched-lipm-dcm-rollouts-for-bipedal-balance'                     # substituted by scaffold.py
