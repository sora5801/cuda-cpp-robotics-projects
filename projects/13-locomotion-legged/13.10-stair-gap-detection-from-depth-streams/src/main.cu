// ===========================================================================
// main.cu — entry point for project 13.10 (Stair/gap detection from depth streams)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.10 (stair-gap-detection-from-depth-streams)\n");
