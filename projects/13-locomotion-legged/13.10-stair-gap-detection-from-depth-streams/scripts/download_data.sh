#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.10 (Stair/gap detection from depth streams)
...
echo "[download_data] Project 13.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
