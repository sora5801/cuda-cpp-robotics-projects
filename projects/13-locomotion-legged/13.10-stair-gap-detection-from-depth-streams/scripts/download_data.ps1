# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.10 (Stair/gap detection from depth streams)
#
...
Write-Host "[download_data] Project 13.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
