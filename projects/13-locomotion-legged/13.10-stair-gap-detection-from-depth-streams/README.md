# 13.10 — Stair/gap detection from depth streams

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Stair/gap detection from depth streams`
>
...
1. Open [`build/stair-gap-detection-from-depth-streams.sln`](build/stair-gap-detection-from-depth-streams.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/stair-gap-detection-from-depth-streams.exe`.
