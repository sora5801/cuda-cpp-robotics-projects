# 13.05 — Contact-schedule optimization via sampling

**Difficulty:** [R&D] research · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Contact-schedule optimization via sampling [R&D]`
>
...
Contact-schedule optimization via sampling
...
1. Open [`build/contact-schedule-optimization-via-sampling.sln`](build/contact-schedule-optimization-via-sampling.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/contact-schedule-optimization-via-sampling.exe`.
