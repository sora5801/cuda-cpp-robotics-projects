# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.05 (Contact-schedule optimization via sampling)
#
...
Write-Host "[download_data] Project 13.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
