#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.05 (Contact-schedule optimization via sampling)
...
echo "[download_data] Project 13.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
