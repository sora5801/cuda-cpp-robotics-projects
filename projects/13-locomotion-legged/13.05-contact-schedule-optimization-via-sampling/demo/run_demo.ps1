# ===========================================================================
# run_demo.ps1 — one-command demo for 13.05 (Contact-schedule optimization via sampling)
#
...
$Slug       = 'contact-schedule-optimization-via-sampling'                     # substituted by scaffold.py
