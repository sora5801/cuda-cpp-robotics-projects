// ===========================================================================
// main.cu — entry point for project 13.05 (Contact-schedule optimization via sampling)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.05 (contact-schedule-optimization-via-sampling)\n");
