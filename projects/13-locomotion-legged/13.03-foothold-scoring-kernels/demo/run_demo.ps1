# ===========================================================================
# run_demo.ps1 — one-command demo for 13.03 (Foothold scoring kernels: slope, roughness, edge distance from elevation maps)
#
...
#
# 13.03: the real foothold-scoring pipeline is in; this script is unchanged
# from the template (the scaffold's promise held — no changes were needed).
# expected_output.txt carries the real stable lines — the output contract
# lives at the top of ../src/main.cu; change the two together. The demo
# writes demo/out/foothold_score.pgm and demo/out/selected_footholds.csv
# (both git-ignored) — view the PGM in any image tool and plot the CSV.
#
...
$Slug       = 'foothold-scoring-kernels'                     # substituted by scaffold.py
...
# (expected_output.txt's header block is such a comment).
