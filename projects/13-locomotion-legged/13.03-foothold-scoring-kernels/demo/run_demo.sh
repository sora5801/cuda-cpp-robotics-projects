#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 13.03 (Foothold scoring kernels: slope, roughness, edge distance from elevation maps)
...
# expected_output.txt is kept in sync with the stable output lines documented
# at the top of ../src/main.cu.
# ===========================================================================
set -euo pipefail
