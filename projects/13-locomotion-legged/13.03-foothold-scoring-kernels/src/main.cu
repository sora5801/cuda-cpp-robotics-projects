// ===========================================================================
// main.cu — entry point for project 13.03 (Foothold scoring kernels: slope, roughness, edge distance from elevation maps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.03 (foothold-scoring-kernels)\n");
