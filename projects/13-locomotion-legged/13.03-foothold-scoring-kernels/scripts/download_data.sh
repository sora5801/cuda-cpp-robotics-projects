#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.03 (Foothold scoring kernels: slope, roughness, edge distance from elevation maps)
...
echo "[download_data] Project 13.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
