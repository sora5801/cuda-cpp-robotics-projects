# 13.02 — Centroidal MPC via batched QP + gait-timing search in parallel

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Centroidal MPC via batched QP + gait-timing search in parallel`
>
...
1. Open [`build/centroidal-mpc-via-batched-qp-gait-timing-search.sln`](build/centroidal-mpc-via-batched-qp-gait-timing-search.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/centroidal-mpc-via-batched-qp-gait-timing-search.exe`.
