// ===========================================================================
// main.cu — entry point for project 13.02 (Centroidal MPC via batched QP + gait-timing search in parallel)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.02 (centroidal-mpc-via-batched-qp-gait-timing-search)\n");
