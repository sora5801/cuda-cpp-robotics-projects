# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.02 (Centroidal MPC via batched QP + gait-timing search in parallel)
#
...
Write-Host "[download_data] Project 13.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
