# ===========================================================================
# run_demo.ps1 — one-command demo for 13.02 (Centroidal MPC via batched QP + gait-timing search in parallel)
#
...
$Slug       = 'centroidal-mpc-via-batched-qp-gait-timing-search'                     # substituted by scaffold.py
