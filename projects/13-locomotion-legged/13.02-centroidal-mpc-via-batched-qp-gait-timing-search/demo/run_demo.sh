#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 13.02 (Centroidal MPC via batched QP + gait-timing search in parallel)
...
SLUG='centroidal-mpc-via-batched-qp-gait-timing-search'
