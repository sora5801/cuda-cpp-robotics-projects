# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.06 (SLIP/hopper model parameter sweeps (Raibert tuning at scale))
#
...
Write-Host "[download_data] Project 13.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
