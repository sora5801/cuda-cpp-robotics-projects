# ===========================================================================
# run_demo.ps1 — one-command demo for 13.06 (SLIP/hopper model parameter sweeps (Raibert tuning at scale))
#
...
$Slug       = 'slip-hopper-model-parameter-sweeps'                     # substituted by scaffold.py
