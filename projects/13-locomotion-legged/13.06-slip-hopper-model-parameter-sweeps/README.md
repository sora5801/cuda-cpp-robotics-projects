# 13.06 — SLIP/hopper model parameter sweeps (Raibert tuning at scale)

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `SLIP/hopper model parameter sweeps (Raibert tuning at scale)`
>
...
1. Open [`build/slip-hopper-model-parameter-sweeps.sln`](build/slip-hopper-model-parameter-sweeps.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/slip-hopper-model-parameter-sweeps.exe`.
