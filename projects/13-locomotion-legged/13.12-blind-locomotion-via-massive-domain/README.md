# 13.12 — Blind locomotion via massive domain randomization

**Difficulty:** intermediate · **Domain:** 13. Locomotion — Legged

> Catalog bullet (source of truth, verbatim): `Blind locomotion via massive domain randomization`
>
...
1. Open [`build/blind-locomotion-via-massive-domain.sln`](build/blind-locomotion-via-massive-domain.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/blind-locomotion-via-massive-domain.exe`.
