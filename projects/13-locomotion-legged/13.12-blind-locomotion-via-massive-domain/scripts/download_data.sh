#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 13.12 (Blind locomotion via massive domain randomization)
...
echo "[download_data] Project 13.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
