# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 13.12 (Blind locomotion via massive domain randomization)
#
...
Write-Host "[download_data] Project 13.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
