# ===========================================================================
# run_demo.ps1 — one-command demo for 13.12 (Blind locomotion via massive domain randomization)
#
...
$Slug       = 'blind-locomotion-via-massive-domain'                     # substituted by scaffold.py
