// ===========================================================================
// main.cu — entry point for project 13.12 (Blind locomotion via massive domain randomization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 13.12 (blind-locomotion-via-massive-domain)\n");
