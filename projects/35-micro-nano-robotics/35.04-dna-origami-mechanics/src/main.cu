// ===========================================================================
// main.cu — entry point for project 35.04 (DNA-origami mechanics (oxDNA-style GPU))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 35.04 (dna-origami-mechanics)\n");
