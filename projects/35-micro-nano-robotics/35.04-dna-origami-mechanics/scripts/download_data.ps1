# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.04 (DNA-origami mechanics (oxDNA-style GPU))
#
...
Write-Host "[download_data] Project 35.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
