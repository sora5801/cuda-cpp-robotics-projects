#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.04 (DNA-origami mechanics (oxDNA-style GPU))
...
echo "[download_data] Project 35.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
