# 35.04 — DNA-origami mechanics (oxDNA-style GPU)

**Difficulty:** [R&D] research · **Domain:** 35. Micro & Nano Robotics

> Catalog bullet (source of truth, verbatim): `DNA-origami mechanics (oxDNA-style GPU) [R&D]`
>
...
DNA-origami mechanics (oxDNA-style GPU)
...
1. Open [`build/dna-origami-mechanics.sln`](build/dna-origami-mechanics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/dna-origami-mechanics.exe`.
