# ===========================================================================
# run_demo.ps1 — one-command demo for 35.05 (Optical tweezer force-field computation)
#
...
$Slug       = 'optical-tweezer-force-field-computation'                     # substituted by scaffold.py
