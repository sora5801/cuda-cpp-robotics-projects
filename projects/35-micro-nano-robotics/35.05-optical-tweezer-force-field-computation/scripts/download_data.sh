#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.05 (Optical tweezer force-field computation)
...
echo "[download_data] Project 35.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
