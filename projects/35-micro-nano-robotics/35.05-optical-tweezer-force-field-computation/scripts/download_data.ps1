# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.05 (Optical tweezer force-field computation)
#
...
Write-Host "[download_data] Project 35.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
