// ===========================================================================
// main.cu — entry point for project 35.05 (Optical tweezer force-field computation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 35.05 (optical-tweezer-force-field-computation)\n");
