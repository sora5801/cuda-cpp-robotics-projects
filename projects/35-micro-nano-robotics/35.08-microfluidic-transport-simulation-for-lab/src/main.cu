// ===========================================================================
// main.cu — entry point for project 35.08 (Microfluidic transport simulation for lab-on-chip robots)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 35.08 (microfluidic-transport-simulation-for-lab)\n");
