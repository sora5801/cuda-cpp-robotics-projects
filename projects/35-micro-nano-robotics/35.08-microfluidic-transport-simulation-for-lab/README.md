# 35.08 — Microfluidic transport simulation for lab-on-chip robots

**Difficulty:** [R&D] research · **Domain:** 35. Micro & Nano Robotics

> Catalog bullet (source of truth, verbatim): `Microfluidic transport simulation for lab-on-chip robots [R&D]`
>
...
Microfluidic transport simulation for lab-on-chip robots
...
1. Open [`build/microfluidic-transport-simulation-for-lab.sln`](build/microfluidic-transport-simulation-for-lab.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/microfluidic-transport-simulation-for-lab.exe`.
