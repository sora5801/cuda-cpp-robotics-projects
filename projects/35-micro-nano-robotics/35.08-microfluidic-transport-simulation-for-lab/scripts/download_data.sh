#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.08 (Microfluidic transport simulation for lab-on-chip robots)
...
echo "[download_data] Project 35.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
