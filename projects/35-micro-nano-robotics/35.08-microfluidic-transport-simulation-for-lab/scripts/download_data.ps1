# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.08 (Microfluidic transport simulation for lab-on-chip robots)
#
...
Write-Host "[download_data] Project 35.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
