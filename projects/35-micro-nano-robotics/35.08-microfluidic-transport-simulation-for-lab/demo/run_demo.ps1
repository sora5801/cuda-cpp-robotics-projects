# ===========================================================================
# run_demo.ps1 — one-command demo for 35.08 (Microfluidic transport simulation for lab-on-chip robots)
#
...
$Slug       = 'microfluidic-transport-simulation-for-lab'                     # substituted by scaffold.py
