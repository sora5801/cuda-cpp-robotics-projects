# 35.03 — Brownian dynamics of nanorobots

**Difficulty:** [R&D] research · **Domain:** 35. Micro & Nano Robotics

> Catalog bullet (source of truth, verbatim): `Brownian dynamics of nanorobots [R&D]`
>
...
Brownian dynamics of nanorobots
...
1. Open [`build/brownian-dynamics-of-nanorobots.sln`](build/brownian-dynamics-of-nanorobots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/brownian-dynamics-of-nanorobots.exe`.
