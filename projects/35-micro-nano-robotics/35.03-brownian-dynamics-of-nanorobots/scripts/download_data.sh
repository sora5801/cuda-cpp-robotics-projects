#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.03 (Brownian dynamics of nanorobots)
...
echo "[download_data] Project 35.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
