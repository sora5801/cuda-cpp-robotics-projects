# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.03 (Brownian dynamics of nanorobots)
#
...
Write-Host "[download_data] Project 35.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
