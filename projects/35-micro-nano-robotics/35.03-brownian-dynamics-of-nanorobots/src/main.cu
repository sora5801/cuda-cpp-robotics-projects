// ===========================================================================
// main.cu — entry point for project 35.03 (Brownian dynamics of nanorobots)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 35.03 (brownian-dynamics-of-nanorobots)\n");
