// ===========================================================================
// main.cu — entry point for project 35.06 (Acoustic levitation/manipulation field solvers)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 35.06 (acoustic-levitation-manipulation-field-solvers)\n");
