# ===========================================================================
# run_demo.ps1 — one-command demo for 35.06 (Acoustic levitation/manipulation field solvers)
#
...
$Slug       = 'acoustic-levitation-manipulation-field-solvers'                     # substituted by scaffold.py
