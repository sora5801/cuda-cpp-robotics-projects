# 35.06 — Acoustic levitation/manipulation field solvers

**Difficulty:** [R&D] research · **Domain:** 35. Micro & Nano Robotics

> Catalog bullet (source of truth, verbatim): `Acoustic levitation/manipulation field solvers [R&D]`
>
...
Acoustic levitation/manipulation field solvers
...
1. Open [`build/acoustic-levitation-manipulation-field-solvers.sln`](build/acoustic-levitation-manipulation-field-solvers.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/acoustic-levitation-manipulation-field-solvers.exe`.
