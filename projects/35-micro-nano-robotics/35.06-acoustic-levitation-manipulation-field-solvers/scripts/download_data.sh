#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.06 (Acoustic levitation/manipulation field solvers)
...
echo "[download_data] Project 35.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
