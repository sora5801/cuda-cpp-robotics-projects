# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.06 (Acoustic levitation/manipulation field solvers)
#
...
Write-Host "[download_data] Project 35.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
