#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.09 (Electrostatic MEMS actuator FEM)
...
echo "[download_data] Project 35.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
