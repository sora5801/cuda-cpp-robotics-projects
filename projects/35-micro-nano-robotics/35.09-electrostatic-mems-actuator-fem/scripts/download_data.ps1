# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.09 (Electrostatic MEMS actuator FEM)
#
...
Write-Host "[download_data] Project 35.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
