# 35.09 — Electrostatic MEMS actuator FEM

**Difficulty:** [R&D] research · **Domain:** 35. Micro & Nano Robotics

> Catalog bullet (source of truth, verbatim): `Electrostatic MEMS actuator FEM [R&D]`
>
...
Electrostatic MEMS actuator FEM
...
1. Open [`build/electrostatic-mems-actuator-fem.sln`](build/electrostatic-mems-actuator-fem.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/electrostatic-mems-actuator-fem.exe`.
