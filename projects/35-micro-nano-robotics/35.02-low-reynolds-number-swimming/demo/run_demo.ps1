# ===========================================================================
# run_demo.ps1 — one-command demo for 35.02 (Low-Reynolds-number swimming: Stokes-flow boundary element solvers)
#
...
$Slug       = 'low-reynolds-number-swimming'                     # substituted by scaffold.py
