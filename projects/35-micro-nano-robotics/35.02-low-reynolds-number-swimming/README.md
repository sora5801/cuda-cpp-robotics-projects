# 35.02 — Low-Reynolds-number swimming: Stokes-flow boundary element solvers

**Difficulty:** [R&D] research · **Domain:** 35. Micro & Nano Robotics

> Catalog bullet (source of truth, verbatim): `Low-Reynolds-number swimming: Stokes-flow boundary element solvers [R&D]`
>
...
Low-Reynolds-number swimming: Stokes-flow boundary element solvers
...
1. Open [`build/low-reynolds-number-swimming.sln`](build/low-reynolds-number-swimming.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/low-reynolds-number-swimming.exe`.
