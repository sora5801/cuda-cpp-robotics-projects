# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.02 (Low-Reynolds-number swimming: Stokes-flow boundary element solvers)
#
...
Write-Host "[download_data] Project 35.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
