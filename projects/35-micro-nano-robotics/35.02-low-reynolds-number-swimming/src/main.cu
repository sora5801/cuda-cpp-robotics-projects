// ===========================================================================
// main.cu — entry point for project 35.02 (Low-Reynolds-number swimming: Stokes-flow boundary element solvers)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 35.02 (low-reynolds-number-swimming)\n");
