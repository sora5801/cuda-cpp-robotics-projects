#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.07 (Bacteria-inspired chemotaxis simulation)
...
echo "[download_data] Project 35.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
