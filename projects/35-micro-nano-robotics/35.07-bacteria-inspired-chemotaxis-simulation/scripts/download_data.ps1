# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 35.07 (Bacteria-inspired chemotaxis simulation)
#
...
Write-Host "[download_data] Project 35.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
