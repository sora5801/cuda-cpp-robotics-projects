# ===========================================================================
# run_demo.ps1 — one-command demo for 35.07 (Bacteria-inspired chemotaxis simulation)
#
...
$Slug       = 'bacteria-inspired-chemotaxis-simulation'                     # substituted by scaffold.py
