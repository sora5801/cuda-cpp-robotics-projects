// ===========================================================================
// main.cu — entry point for project 35.01 (Magnetic microrobot swarms: Biot-Savart field computation + swarm dynamics)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 35.01 (magnetic-microrobot-swarms)\n");
