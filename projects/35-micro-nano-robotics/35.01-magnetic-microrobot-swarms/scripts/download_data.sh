#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 35.01 (Magnetic microrobot swarms: Biot-Savart field computation + swarm dynamics)
...
echo "[download_data] Project 35.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
