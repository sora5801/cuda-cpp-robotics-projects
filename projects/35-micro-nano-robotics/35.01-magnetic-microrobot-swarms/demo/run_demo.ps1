# ===========================================================================
# run_demo.ps1 — one-command demo for 35.01 (Magnetic microrobot swarms: Biot-Savart field computation + swarm dynamics)
#
...
#
# 35.01: the real implementation is in; this script is unchanged from the
# template (as designed — a real project's run_demo.ps1 usually needs no
# changes at all, CLAUDE.md paragraph 6.3). expected_output.txt carries the
# real stable lines — the output contract lives at the top of ../src/main.cu;
# change the two together. The demo writes three artifacts under demo/out/
# (git-ignored): field_magnitude.pgm, swarm_trajectory.csv, swarm_final.pgm.
#
...
$Slug       = 'magnetic-microrobot-swarms'                     # substituted by scaffold.py
...
# (this file's header/provenance comments are such lines).
