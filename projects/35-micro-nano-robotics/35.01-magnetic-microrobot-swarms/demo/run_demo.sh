#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 35.01 (Magnetic microrobot swarms: Biot-Savart field computation + swarm dynamics)
...
# 35.01: expected_output.txt carries the real project's stable output lines
# (see the "output contract" comment in ../src/main.cu) — keep the two in sync.
# ===========================================================================
set -euo pipefail
...
SLUG='magnetic-microrobot-swarms'
