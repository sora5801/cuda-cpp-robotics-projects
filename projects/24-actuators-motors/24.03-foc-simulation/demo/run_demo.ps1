# ===========================================================================
# run_demo.ps1 — one-command demo for 24.03 (FOC simulation: current-loop tuning grids; sensorless observer (EKF/SMO) banks)
#
...
$Slug       = 'foc-simulation'                     # substituted by scaffold.py
