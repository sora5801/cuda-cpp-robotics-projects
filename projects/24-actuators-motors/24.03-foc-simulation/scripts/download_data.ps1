# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.03 (FOC simulation: current-loop tuning grids; sensorless observer (EKF/SMO) banks)
#
...
Write-Host "[download_data] Project 24.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
