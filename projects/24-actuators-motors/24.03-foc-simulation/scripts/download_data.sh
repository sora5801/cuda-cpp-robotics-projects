#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.03 (FOC simulation: current-loop tuning grids; sensorless observer (EKF/SMO) banks)
...
echo "[download_data] Project 24.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
