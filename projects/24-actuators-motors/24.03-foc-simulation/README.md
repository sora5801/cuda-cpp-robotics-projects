# 24.03 — FOC simulation: current-loop tuning grids; sensorless observer (EKF/SMO) banks

**Difficulty:** intermediate · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `FOC simulation: current-loop tuning grids; sensorless observer (EKF/SMO) banks`
>
...
1. Open [`build/foc-simulation.sln`](build/foc-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/foc-simulation.exe`.
