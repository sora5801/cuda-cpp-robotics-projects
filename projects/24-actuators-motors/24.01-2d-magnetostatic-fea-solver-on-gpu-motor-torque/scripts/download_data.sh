#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.01 (2D magnetostatic FEA solver on GPU → motor torque-ripple/cogging parameter sweeps)
...
echo "[download_data] Project 24.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
