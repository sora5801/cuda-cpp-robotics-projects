// ===========================================================================
// main.cu — entry point for project 24.01 (2D magnetostatic FEA solver on GPU → motor torque-ripple/cogging parameter sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 24.01 (2d-magnetostatic-fea-solver-on-gpu-motor-torque)\n");
