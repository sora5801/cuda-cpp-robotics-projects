#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 24.01 (2D magnetostatic FEA solver on GPU → motor torque-ripple/cogging parameter sweeps)
...
# expected_output.txt's ten checked lines mirror src/main.cu's "Output
# contract" comment exactly: "[demo]", "PROBLEM:", "SCENARIO:", "VERIFY:",
# "ANALYTIC_AMPERE:", "ANALYTIC_INTERFACE:", "SWEEP:", "PHYSICS:",
# "ARTIFACT:", "RESULT:" — keep the two in sync if either ever changes.
# ===========================================================================
set -euo pipefail
...
SLUG='2d-magnetostatic-fea-solver-on-gpu-motor-torque'
