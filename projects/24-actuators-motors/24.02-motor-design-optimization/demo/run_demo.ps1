# ===========================================================================
# run_demo.ps1 — one-command demo for 24.02 (Motor design optimization: evolutionary search over geometry, parallel evaluation)
#
...
$Slug       = 'motor-design-optimization'                     # substituted by scaffold.py
