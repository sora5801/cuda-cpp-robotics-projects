#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.02 (Motor design optimization: evolutionary search over geometry, parallel evaluation)
...
echo "[download_data] Project 24.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
