# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.02 (Motor design optimization: evolutionary search over geometry, parallel evaluation)
#
...
Write-Host "[download_data] Project 24.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
