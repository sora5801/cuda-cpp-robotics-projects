# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.12 (Magnetic gear simulation)
#
...
Write-Host "[download_data] Project 24.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
