#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.14 (Whole-robot actuator selection optimizer: search catalogs against torque/mass/thermal feasibility at scale)
...
echo "[download_data] Project 24.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
