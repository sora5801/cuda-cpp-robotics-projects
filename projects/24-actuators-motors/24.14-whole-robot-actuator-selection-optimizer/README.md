# 24.14 — Whole-robot actuator selection optimizer: search catalogs against torque/mass/thermal feasibility at scale

**Difficulty:** intermediate · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `Whole-robot actuator selection optimizer: search catalogs against torque/mass/thermal feasibility at scale`
>
...
1. Open [`build/whole-robot-actuator-selection-optimizer.sln`](build/whole-robot-actuator-selection-optimizer.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/whole-robot-actuator-selection-optimizer.exe`.
