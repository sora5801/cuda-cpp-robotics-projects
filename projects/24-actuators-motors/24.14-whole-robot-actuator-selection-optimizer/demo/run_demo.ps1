# ===========================================================================
# run_demo.ps1 — one-command demo for 24.14 (Whole-robot actuator selection optimizer: search catalogs against torque/mass/thermal feasibility at scale)
#
...
$Slug       = 'whole-robot-actuator-selection-optimizer'                     # substituted by scaffold.py
