#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.04 (PMSM thermal Monte Carlo + current-derating optimization)
...
echo "[download_data] Project 24.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
