// ===========================================================================
// main.cu — entry point for project 24.04 (PMSM thermal Monte Carlo + current-derating optimization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 24.04 (pmsm-thermal-monte-carlo-current-derating)\n");
