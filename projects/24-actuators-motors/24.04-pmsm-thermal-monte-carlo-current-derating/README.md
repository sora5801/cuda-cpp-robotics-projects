# 24.04 — PMSM thermal Monte Carlo + current-derating optimization

**Difficulty:** intermediate · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `PMSM thermal Monte Carlo + current-derating optimization`
>
...
1. Open [`build/pmsm-thermal-monte-carlo-current-derating.sln`](build/pmsm-thermal-monte-carlo-current-derating.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/pmsm-thermal-monte-carlo-current-derating.exe`.
