// ===========================================================================
// main.cu — entry point for project 24.06 (Harmonic-drive compliance identification)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 24.06 (harmonic-drive-compliance-identification)\n");
