# 24.06 — Harmonic-drive compliance identification

**Difficulty:** intermediate · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `Harmonic-drive compliance identification`
>
...
1. Open [`build/harmonic-drive-compliance-identification.sln`](build/harmonic-drive-compliance-identification.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/harmonic-drive-compliance-identification.exe`.
