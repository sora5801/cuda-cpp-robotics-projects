# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.06 (Harmonic-drive compliance identification)
#
...
Write-Host "[download_data] Project 24.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
