#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.06 (Harmonic-drive compliance identification)
...
echo "[download_data] Project 24.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
