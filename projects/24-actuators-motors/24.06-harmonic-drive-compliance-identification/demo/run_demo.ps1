# ===========================================================================
# run_demo.ps1 — one-command demo for 24.06 (Harmonic-drive compliance identification)
#
...
$Slug       = 'harmonic-drive-compliance-identification'                     # substituted by scaffold.py
