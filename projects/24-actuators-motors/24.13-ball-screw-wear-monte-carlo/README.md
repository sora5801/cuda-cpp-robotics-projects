# 24.13 — Ball-screw wear Monte Carlo

**Difficulty:** intermediate · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `Ball-screw wear Monte Carlo`
>
...
1. Open [`build/ball-screw-wear-monte-carlo.sln`](build/ball-screw-wear-monte-carlo.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/ball-screw-wear-monte-carlo.exe`.
