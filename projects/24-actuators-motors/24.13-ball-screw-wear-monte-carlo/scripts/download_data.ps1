# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.13 (Ball-screw wear Monte Carlo)
#
...
Write-Host "[download_data] Project 24.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
