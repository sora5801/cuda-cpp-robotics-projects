#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.13 (Ball-screw wear Monte Carlo)
...
echo "[download_data] Project 24.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
