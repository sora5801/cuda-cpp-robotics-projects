# ===========================================================================
# run_demo.ps1 — one-command demo for 24.07 (Series-elastic / quasi-direct-drive impedance-fidelity sweeps)
#
...
$Slug       = 'series-elastic-quasi-direct-drive-impedance'                     # substituted by scaffold.py
