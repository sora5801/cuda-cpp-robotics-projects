// ===========================================================================
// main.cu — entry point for project 24.07 (Series-elastic / quasi-direct-drive impedance-fidelity sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 24.07 (series-elastic-quasi-direct-drive-impedance)\n");
