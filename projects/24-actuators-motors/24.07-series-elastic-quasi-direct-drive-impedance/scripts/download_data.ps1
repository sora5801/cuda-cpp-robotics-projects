# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.07 (Series-elastic / quasi-direct-drive impedance-fidelity sweeps)
#
...
Write-Host "[download_data] Project 24.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
