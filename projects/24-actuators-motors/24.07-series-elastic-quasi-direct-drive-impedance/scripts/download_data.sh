#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.07 (Series-elastic / quasi-direct-drive impedance-fidelity sweeps)
...
echo "[download_data] Project 24.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
