# 24.07 — Series-elastic / quasi-direct-drive impedance-fidelity sweeps

**Difficulty:** intermediate · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `Series-elastic / quasi-direct-drive impedance-fidelity sweeps`
>
...
1. Open [`build/series-elastic-quasi-direct-drive-impedance.sln`](build/series-elastic-quasi-direct-drive-impedance.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/series-elastic-quasi-direct-drive-impedance.exe`.
