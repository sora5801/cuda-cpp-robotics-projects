# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.08 (Pneumatic (McKibben) muscle model batches + valve-timing optimization)
#
...
Write-Host "[download_data] Project 24.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
