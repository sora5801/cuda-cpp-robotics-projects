#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.08 (Pneumatic (McKibben) muscle model batches + valve-timing optimization)
...
echo "[download_data] Project 24.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
