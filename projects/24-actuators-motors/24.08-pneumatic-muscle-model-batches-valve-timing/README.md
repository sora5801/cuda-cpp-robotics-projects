# 24.08 — Pneumatic (McKibben) muscle model batches + valve-timing optimization

**Difficulty:** intermediate · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `Pneumatic (McKibben) muscle model batches + valve-timing optimization`
>
...
1. Open [`build/pneumatic-muscle-model-batches-valve-timing.sln`](build/pneumatic-muscle-model-batches-valve-timing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/pneumatic-muscle-model-batches-valve-timing.exe`.
