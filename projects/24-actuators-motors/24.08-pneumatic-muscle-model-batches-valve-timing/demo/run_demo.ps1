# ===========================================================================
# run_demo.ps1 — one-command demo for 24.08 (Pneumatic (McKibben) muscle model batches + valve-timing optimization)
#
...
$Slug       = 'pneumatic-muscle-model-batches-valve-timing'                     # substituted by scaffold.py
