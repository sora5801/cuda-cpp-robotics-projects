#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 24.08 (Pneumatic (McKibben) muscle model batches + valve-timing optimization)
...
SLUG='pneumatic-muscle-model-batches-valve-timing'
