# 24.11 — Piezo hysteresis (Preisach/Prandtl) fitting; ultrasonic motor FEM

**Difficulty:** [R&D] research · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `Piezo hysteresis (Preisach/Prandtl) fitting; ultrasonic motor FEM [R&D]`
>
...
Piezo hysteresis (Preisach/Prandtl) fitting; ultrasonic motor FEM
...
1. Open [`build/piezo-hysteresis-fitting-ultrasonic-motor-fem.sln`](build/piezo-hysteresis-fitting-ultrasonic-motor-fem.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/piezo-hysteresis-fitting-ultrasonic-motor-fem.exe`.
