# ===========================================================================
# run_demo.ps1 — one-command demo for 24.11 (Piezo hysteresis (Preisach/Prandtl) fitting; ultrasonic motor FEM)
#
...
$Slug       = 'piezo-hysteresis-fitting-ultrasonic-motor-fem'                     # substituted by scaffold.py
