#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 24.11 (Piezo hysteresis (Preisach/Prandtl) fitting; ultrasonic motor FEM)
...
SLUG='piezo-hysteresis-fitting-ultrasonic-motor-fem'
