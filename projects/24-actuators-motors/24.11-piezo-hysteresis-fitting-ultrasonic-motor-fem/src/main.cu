// ===========================================================================
// main.cu — entry point for project 24.11 (Piezo hysteresis (Preisach/Prandtl) fitting; ultrasonic motor FEM)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 24.11 (piezo-hysteresis-fitting-ultrasonic-motor-fem)\n");
