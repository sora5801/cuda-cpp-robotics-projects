# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.11 (Piezo hysteresis (Preisach/Prandtl) fitting; ultrasonic motor FEM)
#
...
Write-Host "[download_data] Project 24.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
