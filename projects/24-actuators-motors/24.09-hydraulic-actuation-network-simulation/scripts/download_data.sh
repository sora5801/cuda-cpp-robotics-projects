#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.09 (Hydraulic actuation network simulation)
...
echo "[download_data] Project 24.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
