# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.09 (Hydraulic actuation network simulation)
#
...
Write-Host "[download_data] Project 24.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
