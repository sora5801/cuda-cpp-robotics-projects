# 24.10 — Dielectric elastomer FEM · SMA thermomechanical sim · HASEL models · twisted-string actuators

**Difficulty:** [R&D] research · **Domain:** 24. Actuators & Motors

> Catalog bullet (source of truth, verbatim): `Dielectric elastomer FEM [R&D] · SMA thermomechanical sim [R&D] · HASEL models [R&D] · twisted-string actuators`
>
...
Dielectric elastomer FEM · SMA thermomechanical sim · HASEL models · twisted-string actuators
...
1. Open [`build/dielectric-elastomer-fem-sma-thermomechanical.sln`](build/dielectric-elastomer-fem-sma-thermomechanical.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/dielectric-elastomer-fem-sma-thermomechanical.exe`.
