# ===========================================================================
# run_demo.ps1 — one-command demo for 24.10 (Dielectric elastomer FEM · SMA thermomechanical sim · HASEL models · twisted-string actuators)
#
...
$Slug       = 'dielectric-elastomer-fem-sma-thermomechanical'                     # substituted by scaffold.py
