// ===========================================================================
// main.cu — entry point for project 24.10 (Dielectric elastomer FEM · SMA thermomechanical sim · HASEL models · twisted-string actuators)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 24.10 (dielectric-elastomer-fem-sma-thermomechanical)\n");
