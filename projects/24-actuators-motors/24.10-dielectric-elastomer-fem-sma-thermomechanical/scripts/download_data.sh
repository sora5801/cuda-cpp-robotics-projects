#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.10 (Dielectric elastomer FEM · SMA thermomechanical sim · HASEL models · twisted-string actuators)
...
echo "[download_data] Project 24.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
