# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.10 (Dielectric elastomer FEM · SMA thermomechanical sim · HASEL models · twisted-string actuators)
#
...
Write-Host "[download_data] Project 24.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
