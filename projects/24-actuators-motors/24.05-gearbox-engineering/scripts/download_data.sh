#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 24.05 (Gearbox engineering: mesh-stiffness FEA, backlash/efficiency Monte Carlo, cycloidal tolerance sweeps)
...
echo "[download_data] Project 24.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
