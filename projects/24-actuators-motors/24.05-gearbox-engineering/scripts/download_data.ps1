# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 24.05 (Gearbox engineering: mesh-stiffness FEA, backlash/efficiency Monte Carlo, cycloidal tolerance sweeps)
#
...
Write-Host "[download_data] Project 24.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
