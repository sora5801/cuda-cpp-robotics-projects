# ===========================================================================
# run_demo.ps1 — one-command demo for 24.05 (Gearbox engineering: mesh-stiffness FEA, backlash/efficiency Monte Carlo, cycloidal tolerance sweeps)
#
...
$Slug       = 'gearbox-engineering'                     # substituted by scaffold.py
