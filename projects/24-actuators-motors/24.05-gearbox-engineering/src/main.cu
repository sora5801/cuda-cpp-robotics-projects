// ===========================================================================
// main.cu — entry point for project 24.05 (Gearbox engineering: mesh-stiffness FEA, backlash/efficiency Monte Carlo, cycloidal tolerance sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 24.05 (gearbox-engineering)\n");
