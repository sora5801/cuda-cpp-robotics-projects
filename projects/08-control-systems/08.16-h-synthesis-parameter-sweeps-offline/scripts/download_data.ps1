# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.16 (H∞ synthesis parameter sweeps offline)
#
...
Write-Host "[download_data] Project 08.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
