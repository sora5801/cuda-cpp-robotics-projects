#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.16 (H∞ synthesis parameter sweeps offline)
...
echo "[download_data] Project 08.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
