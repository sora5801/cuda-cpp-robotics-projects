// ===========================================================================
// main.cu — entry point for project 08.16 (H∞ synthesis parameter sweeps offline)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.16 (h-synthesis-parameter-sweeps-offline)\n");
