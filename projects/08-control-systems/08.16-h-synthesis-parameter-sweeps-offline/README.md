# 08.16 — H∞ synthesis parameter sweeps offline

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `H∞ synthesis parameter sweeps offline`
>
...
1. Open [`build/h-synthesis-parameter-sweeps-offline.sln`](build/h-synthesis-parameter-sweeps-offline.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/h-synthesis-parameter-sweeps-offline.exe`.
