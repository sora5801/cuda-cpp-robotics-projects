# 08.05 — Stochastic/tube MPC: uncertainty propagation via parallel rollouts

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Stochastic/tube MPC: uncertainty propagation via parallel rollouts`
>
...
1. Open [`build/stochastic-tube-mpc.sln`](build/stochastic-tube-mpc.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/stochastic-tube-mpc.exe`.
