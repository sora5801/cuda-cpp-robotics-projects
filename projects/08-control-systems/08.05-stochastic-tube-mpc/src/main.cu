// ===========================================================================
// main.cu — entry point for project 08.05 (Stochastic/tube MPC: uncertainty propagation via parallel rollouts)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.05 (stochastic-tube-mpc)\n");
