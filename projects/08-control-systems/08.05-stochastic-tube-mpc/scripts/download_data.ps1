# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.05 (Stochastic/tube MPC: uncertainty propagation via parallel rollouts)
#
...
Write-Host "[download_data] Project 08.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
