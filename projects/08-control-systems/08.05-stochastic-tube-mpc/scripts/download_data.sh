#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.05 (Stochastic/tube MPC: uncertainty propagation via parallel rollouts)
...
echo "[download_data] Project 08.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
