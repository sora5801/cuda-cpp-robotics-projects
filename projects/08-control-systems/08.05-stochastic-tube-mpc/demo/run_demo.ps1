# ===========================================================================
# run_demo.ps1 — one-command demo for 08.05 (Stochastic/tube MPC: uncertainty propagation via parallel rollouts)
#
...
$Slug       = 'stochastic-tube-mpc'                     # substituted by scaffold.py
