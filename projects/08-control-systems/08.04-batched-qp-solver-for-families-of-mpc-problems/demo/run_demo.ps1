# ===========================================================================
# run_demo.ps1 — one-command demo for 08.04 (Batched QP solver (ADMM / interior-point) for families of MPC problems)
#
...
$Slug       = 'batched-qp-solver-for-families-of-mpc-problems'                     # substituted by scaffold.py
