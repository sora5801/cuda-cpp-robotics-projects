#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 08.04 (Batched QP solver (ADMM / interior-point) for families of MPC problems)
...
SLUG='batched-qp-solver-for-families-of-mpc-problems'
