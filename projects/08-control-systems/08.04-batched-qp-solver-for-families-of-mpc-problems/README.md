# 08.04 — Batched QP solver (ADMM / interior-point) for families of MPC problems

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Batched QP solver (ADMM / interior-point) for families of MPC problems`
>
...
1. Open [`build/batched-qp-solver-for-families-of-mpc-problems.sln`](build/batched-qp-solver-for-families-of-mpc-problems.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-qp-solver-for-families-of-mpc-problems.exe`.
