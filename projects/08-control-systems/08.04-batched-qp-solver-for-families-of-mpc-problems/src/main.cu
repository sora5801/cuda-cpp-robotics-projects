// ===========================================================================
// main.cu — entry point for project 08.04 (Batched QP solver (ADMM / interior-point) for families of MPC problems)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.04 (batched-qp-solver-for-families-of-mpc-problems)\n");
