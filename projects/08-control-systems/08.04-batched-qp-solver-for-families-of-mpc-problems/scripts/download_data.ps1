# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.04 (Batched QP solver (ADMM / interior-point) for families of MPC problems)
#
...
Write-Host "[download_data] Project 08.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
