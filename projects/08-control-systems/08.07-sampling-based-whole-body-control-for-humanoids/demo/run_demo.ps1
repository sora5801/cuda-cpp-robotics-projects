# ===========================================================================
# run_demo.ps1 — one-command demo for 08.07 (Sampling-based whole-body control for humanoids (MuJoCo-MPC-style, GPU port))
#
...
$Slug       = 'sampling-based-whole-body-control-for-humanoids'                     # substituted by scaffold.py
