#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 08.07 (Sampling-based whole-body control for humanoids (MuJoCo-MPC-style, GPU port))
...
SLUG='sampling-based-whole-body-control-for-humanoids'
