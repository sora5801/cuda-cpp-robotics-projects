# 08.07 — Sampling-based whole-body control for humanoids (MuJoCo-MPC-style, GPU port)

**Difficulty:** [R&D] research · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Sampling-based whole-body control for humanoids (MuJoCo-MPC-style, GPU port) [R&D]`
>
...
Sampling-based whole-body control for humanoids (MuJoCo-MPC-style, GPU port)
...
1. Open [`build/sampling-based-whole-body-control-for-humanoids.sln`](build/sampling-based-whole-body-control-for-humanoids.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/sampling-based-whole-body-control-for-humanoids.exe`.
