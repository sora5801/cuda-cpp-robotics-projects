# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.07 (Sampling-based whole-body control for humanoids (MuJoCo-MPC-style, GPU port))
#
...
Write-Host "[download_data] Project 08.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
