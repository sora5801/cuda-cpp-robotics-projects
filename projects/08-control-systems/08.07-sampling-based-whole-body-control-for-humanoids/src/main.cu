// ===========================================================================
// main.cu — entry point for project 08.07 (Sampling-based whole-body control for humanoids (MuJoCo-MPC-style, GPU port))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.07 (sampling-based-whole-body-control-for-humanoids)\n");
