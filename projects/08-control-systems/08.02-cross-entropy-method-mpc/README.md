# 08.02 — Cross-entropy-method MPC

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Cross-entropy-method MPC`
>
...
1. Open [`build/cross-entropy-method-mpc.sln`](build/cross-entropy-method-mpc.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/cross-entropy-method-mpc.exe`.
