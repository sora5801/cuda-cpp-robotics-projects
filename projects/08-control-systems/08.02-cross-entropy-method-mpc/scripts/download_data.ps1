# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.02 (Cross-entropy-method MPC)
#
...
Write-Host "[download_data] Project 08.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
