#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.02 (Cross-entropy-method MPC)
...
echo "[download_data] Project 08.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
