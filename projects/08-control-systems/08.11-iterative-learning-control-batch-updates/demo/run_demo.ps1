# ===========================================================================
# run_demo.ps1 — one-command demo for 08.11 (Iterative learning control batch updates)
#
...
$Slug       = 'iterative-learning-control-batch-updates'                     # substituted by scaffold.py
