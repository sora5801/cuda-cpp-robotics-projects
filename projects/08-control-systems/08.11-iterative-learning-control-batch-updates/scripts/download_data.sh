#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.11 (Iterative learning control batch updates)
...
echo "[download_data] Project 08.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
