# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.11 (Iterative learning control batch updates)
#
...
Write-Host "[download_data] Project 08.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
