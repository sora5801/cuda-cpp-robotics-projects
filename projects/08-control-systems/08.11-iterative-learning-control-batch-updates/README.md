# 08.11 — Iterative learning control batch updates

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Iterative learning control batch updates`
>
...
1. Open [`build/iterative-learning-control-batch-updates.sln`](build/iterative-learning-control-batch-updates.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/iterative-learning-control-batch-updates.exe`.
