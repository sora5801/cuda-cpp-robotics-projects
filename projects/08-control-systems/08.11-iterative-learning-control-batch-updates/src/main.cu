// ===========================================================================
// main.cu — entry point for project 08.11 (Iterative learning control batch updates)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.11 (iterative-learning-control-batch-updates)\n");
