# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.08 (Contact-implicit MPC via parallel complementarity solves)
#
...
Write-Host "[download_data] Project 08.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
