#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.08 (Contact-implicit MPC via parallel complementarity solves)
...
echo "[download_data] Project 08.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
