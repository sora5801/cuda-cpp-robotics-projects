// ===========================================================================
// main.cu — entry point for project 08.08 (Contact-implicit MPC via parallel complementarity solves)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.08 (contact-implicit-mpc-via-parallel)\n");
