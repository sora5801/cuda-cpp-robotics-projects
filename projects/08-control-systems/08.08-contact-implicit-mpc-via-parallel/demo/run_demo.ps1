# ===========================================================================
# run_demo.ps1 — one-command demo for 08.08 (Contact-implicit MPC via parallel complementarity solves)
#
...
$Slug       = 'contact-implicit-mpc-via-parallel'                     # substituted by scaffold.py
