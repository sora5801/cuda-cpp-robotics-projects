# 08.08 — Contact-implicit MPC via parallel complementarity solves

**Difficulty:** [R&D] research · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Contact-implicit MPC via parallel complementarity solves [R&D]`
>
...
Contact-implicit MPC via parallel complementarity solves
...
1. Open [`build/contact-implicit-mpc-via-parallel.sln`](build/contact-implicit-mpc-via-parallel.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/contact-implicit-mpc-via-parallel.exe`.
