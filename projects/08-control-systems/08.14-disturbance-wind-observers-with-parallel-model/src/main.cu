// ===========================================================================
// main.cu — entry point for project 08.14 (Disturbance/wind observers with parallel model banks)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.14 (disturbance-wind-observers-with-parallel-model)\n");
