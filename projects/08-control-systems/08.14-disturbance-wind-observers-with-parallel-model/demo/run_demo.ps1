# ===========================================================================
# run_demo.ps1 — one-command demo for 08.14 (Disturbance/wind observers with parallel model banks)
#
...
$Slug       = 'disturbance-wind-observers-with-parallel-model'                     # substituted by scaffold.py
