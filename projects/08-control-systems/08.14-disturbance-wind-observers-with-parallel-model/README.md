# 08.14 — Disturbance/wind observers with parallel model banks

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Disturbance/wind observers with parallel model banks`
>
...
1. Open [`build/disturbance-wind-observers-with-parallel-model.sln`](build/disturbance-wind-observers-with-parallel-model.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/disturbance-wind-observers-with-parallel-model.exe`.
