# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.14 (Disturbance/wind observers with parallel model banks)
#
...
Write-Host "[download_data] Project 08.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
