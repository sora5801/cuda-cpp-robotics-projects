#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.14 (Disturbance/wind observers with parallel model banks)
...
echo "[download_data] Project 08.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
