#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.13 (Control barrier function safety filter evaluated over sampled control sets)
...
echo "[download_data] Project 08.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
