# 08.13 — Control barrier function safety filter evaluated over sampled control sets

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Control barrier function safety filter evaluated over sampled control sets`
>
...
1. Open [`build/control-barrier-function-safety-filter-evaluated.sln`](build/control-barrier-function-safety-filter-evaluated.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/control-barrier-function-safety-filter-evaluated.exe`.
