#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 08.13 (Control barrier function safety filter evaluated over sampled control sets)
...
SLUG='control-barrier-function-safety-filter-evaluated'
