// ===========================================================================
// main.cu — entry point for project 08.13 (Control barrier function safety filter evaluated over sampled control sets)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.13 (control-barrier-function-safety-filter-evaluated)\n");
