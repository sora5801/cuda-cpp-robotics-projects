# 08.03 — iLQR/DDP with batched line search + parallel-shooting integrators

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `iLQR/DDP with batched line search + parallel-shooting integrators`
>
...
1. Open [`build/ilqr-ddp-with-batched-line-search-parallel.sln`](build/ilqr-ddp-with-batched-line-search-parallel.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/ilqr-ddp-with-batched-line-search-parallel.exe`.
