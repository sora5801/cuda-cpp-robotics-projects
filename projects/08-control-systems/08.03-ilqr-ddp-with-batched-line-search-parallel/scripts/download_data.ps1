# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.03 (iLQR/DDP with batched line search + parallel-shooting integrators)
#
...
Write-Host "[download_data] Project 08.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
