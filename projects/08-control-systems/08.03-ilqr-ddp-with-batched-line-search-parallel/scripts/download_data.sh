#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.03 (iLQR/DDP with batched line search + parallel-shooting integrators)
...
echo "[download_data] Project 08.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
