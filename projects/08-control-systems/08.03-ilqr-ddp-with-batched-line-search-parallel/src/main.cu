// ===========================================================================
// main.cu — entry point for project 08.03 (iLQR/DDP with batched line search + parallel-shooting integrators)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.03 (ilqr-ddp-with-batched-line-search-parallel)\n");
