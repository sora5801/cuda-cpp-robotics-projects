# ===========================================================================
# run_demo.ps1 — one-command demo for 08.03 (iLQR/DDP with batched line search + parallel-shooting integrators)
#
...
$Slug       = 'ilqr-ddp-with-batched-line-search-parallel'                     # substituted by scaffold.py
