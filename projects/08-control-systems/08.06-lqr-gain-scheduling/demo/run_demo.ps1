# ===========================================================================
# run_demo.ps1 — one-command demo for 08.06 (LQR gain scheduling: Riccati solves across an operating-point grid)
#
...
$Slug       = 'lqr-gain-scheduling'                     # substituted by scaffold.py
