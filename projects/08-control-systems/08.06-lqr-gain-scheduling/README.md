# 08.06 — LQR gain scheduling: Riccati solves across an operating-point grid

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `LQR gain scheduling: Riccati solves across an operating-point grid`
>
...
1. Open [`build/lqr-gain-scheduling.sln`](build/lqr-gain-scheduling.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/lqr-gain-scheduling.exe`.
