// ===========================================================================
// main.cu — entry point for project 08.06 (LQR gain scheduling: Riccati solves across an operating-point grid)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.06 (lqr-gain-scheduling)\n");
