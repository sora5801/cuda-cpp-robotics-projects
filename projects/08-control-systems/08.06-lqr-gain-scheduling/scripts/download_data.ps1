# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.06 (LQR gain scheduling: Riccati solves across an operating-point grid)
#
...
Write-Host "[download_data] Project 08.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
