# ===========================================================================
# run_demo.ps1 — one-command demo for 08.01 (MPPI controller — the canonical GPU controller: cart-pole → quadrotor → AGV → off-road racer)
#
...
#
# 08.01: the real implementation is in; this script is unchanged from the
...
# The demo writes demo/out/trajectory.csv (git-ignored) — plot it to watch
# the swing-up (columns: t_s, p_m, pdot_ms, theta_rad, thdot_rads, u_N).
#
...
$Slug       = 'mppi-controller-the-canonical-gpu-controller'                     # substituted by scaffold.py
