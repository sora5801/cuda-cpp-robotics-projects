#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 08.01 (MPPI controller — the canonical GPU controller: cart-pole → quadrotor → AGV → off-road racer)
...
# 08.01: expected_output.txt carries the real implementation's stable lines
# (the output contract lives at the top of ../src/main.cu; change together).
# ===========================================================================
set -euo pipefail
...
SLUG='mppi-controller-the-canonical-gpu-controller'
