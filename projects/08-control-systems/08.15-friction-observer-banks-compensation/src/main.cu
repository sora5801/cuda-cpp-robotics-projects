// ===========================================================================
// main.cu — entry point for project 08.15 (Friction observer banks + compensation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.15 (friction-observer-banks-compensation)\n");
