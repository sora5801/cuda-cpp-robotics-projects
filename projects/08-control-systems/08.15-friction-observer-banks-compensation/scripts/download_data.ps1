# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.15 (Friction observer banks + compensation)
#
...
Write-Host "[download_data] Project 08.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
