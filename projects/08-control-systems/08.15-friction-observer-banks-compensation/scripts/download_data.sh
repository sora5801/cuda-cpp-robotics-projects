#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.15 (Friction observer banks + compensation)
...
echo "[download_data] Project 08.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
