# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.12 (Control allocation for overactuated vehicles (thrusters/rotors) via batched QP)
#
...
Write-Host "[download_data] Project 08.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
