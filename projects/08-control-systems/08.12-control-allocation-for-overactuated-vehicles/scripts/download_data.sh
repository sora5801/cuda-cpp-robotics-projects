#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.12 (Control allocation for overactuated vehicles (thrusters/rotors) via batched QP)
...
echo "[download_data] Project 08.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
