# 08.12 — Control allocation for overactuated vehicles (thrusters/rotors) via batched QP

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Control allocation for overactuated vehicles (thrusters/rotors) via batched QP`
>
...
1. Open [`build/control-allocation-for-overactuated-vehicles.sln`](build/control-allocation-for-overactuated-vehicles.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/control-allocation-for-overactuated-vehicles.exe`.
