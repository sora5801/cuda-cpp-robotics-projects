// ===========================================================================
// main.cu — entry point for project 08.12 (Control allocation for overactuated vehicles (thrusters/rotors) via batched QP)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.12 (control-allocation-for-overactuated-vehicles)\n");
