#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 08.12 (Control allocation for overactuated vehicles (thrusters/rotors) via batched QP)
...
SLUG='control-allocation-for-overactuated-vehicles'
