# ===========================================================================
# run_demo.ps1 — one-command demo for 08.12 (Control allocation for overactuated vehicles (thrusters/rotors) via batched QP)
#
...
$Slug       = 'control-allocation-for-overactuated-vehicles'                     # substituted by scaffold.py
