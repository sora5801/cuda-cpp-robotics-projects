# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.09 (PID autotune farm: massive closed-loop simulation sweeps over gains)
#
...
Write-Host "[download_data] Project 08.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
