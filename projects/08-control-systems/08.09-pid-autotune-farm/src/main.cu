// ===========================================================================
// main.cu — entry point for project 08.09 (PID autotune farm: massive closed-loop simulation sweeps over gains)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 08.09 (pid-autotune-farm)\n");
