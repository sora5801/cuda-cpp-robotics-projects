# 08.09 — PID autotune farm: massive closed-loop simulation sweeps over gains

**Difficulty:** ★ beginner · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `★ PID autotune farm: massive closed-loop simulation sweeps over gains`
>
...
1. Open [`build/pid-autotune-farm.sln`](build/pid-autotune-farm.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/pid-autotune-farm.exe`.
