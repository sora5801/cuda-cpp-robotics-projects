# ===========================================================================
# run_demo.ps1 — one-command demo for 08.09 (PID autotune farm: massive closed-loop simulation sweeps over gains)
#
...
$Slug       = 'pid-autotune-farm'                     # substituted by scaffold.py
