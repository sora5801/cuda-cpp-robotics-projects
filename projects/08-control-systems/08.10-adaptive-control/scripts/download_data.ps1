# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 08.10 (Adaptive control: parallel recursive-least-squares model banks)
#
...
Write-Host "[download_data] Project 08.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
