#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 08.10 (Adaptive control: parallel recursive-least-squares model banks)
...
echo "[download_data] Project 08.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
