# 08.10 — Adaptive control: parallel recursive-least-squares model banks

**Difficulty:** intermediate · **Domain:** 8. Control Systems

> Catalog bullet (source of truth, verbatim): `Adaptive control: parallel recursive-least-squares model banks`
>
...
1. Open [`build/adaptive-control.sln`](build/adaptive-control.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/adaptive-control.exe`.
