# ===========================================================================
# run_demo.ps1 — one-command demo for 12.20 (Graph-neural-network physics simulators)
#
...
$Slug       = 'graph-neural-network-physics-simulators'                     # substituted by scaffold.py
