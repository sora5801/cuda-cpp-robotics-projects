# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.20 (Graph-neural-network physics simulators)
#
...
Write-Host "[download_data] Project 12.20 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
