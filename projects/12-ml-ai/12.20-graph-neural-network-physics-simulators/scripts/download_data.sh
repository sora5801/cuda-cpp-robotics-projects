#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.20 (Graph-neural-network physics simulators)
...
echo "[download_data] Project 12.20 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
