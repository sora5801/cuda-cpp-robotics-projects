# 12.20 — Graph-neural-network physics simulators

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Graph-neural-network physics simulators [R&D]`
>
...
Graph-neural-network physics simulators
...
1. Open [`build/graph-neural-network-physics-simulators.sln`](build/graph-neural-network-physics-simulators.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/graph-neural-network-physics-simulators.exe`.
