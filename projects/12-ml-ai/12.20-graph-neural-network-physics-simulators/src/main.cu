// ===========================================================================
// main.cu — entry point for project 12.20 (Graph-neural-network physics simulators)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.20 (graph-neural-network-physics-simulators)\n");
