# 12.15 — Deep-ensemble uncertainty in a single batched launch

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Deep-ensemble uncertainty in a single batched launch`
>
...
1. Open [`build/deep-ensemble-uncertainty-in-a-single-batched.sln`](build/deep-ensemble-uncertainty-in-a-single-batched.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/deep-ensemble-uncertainty-in-a-single-batched.exe`.
