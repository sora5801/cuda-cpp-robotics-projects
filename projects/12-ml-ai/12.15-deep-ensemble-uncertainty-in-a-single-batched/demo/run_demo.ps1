# ===========================================================================
# run_demo.ps1 — one-command demo for 12.15 (Deep-ensemble uncertainty in a single batched launch)
#
...
$Slug       = 'deep-ensemble-uncertainty-in-a-single-batched'                     # substituted by scaffold.py
