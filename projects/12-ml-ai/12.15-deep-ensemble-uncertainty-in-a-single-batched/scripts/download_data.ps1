# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.15 (Deep-ensemble uncertainty in a single batched launch)
#
...
Write-Host "[download_data] Project 12.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
