#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.15 (Deep-ensemble uncertainty in a single batched launch)
...
echo "[download_data] Project 12.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
