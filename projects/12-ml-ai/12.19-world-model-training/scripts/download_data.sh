#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.19 (World-model training: latent-rollout kernels)
...
echo "[download_data] Project 12.19 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
