# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.19 (World-model training: latent-rollout kernels)
#
...
Write-Host "[download_data] Project 12.19 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
