# 12.19 — World-model training: latent-rollout kernels

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `World-model training: latent-rollout kernels [R&D]`
>
...
World-model training: latent-rollout kernels
...
1. Open [`build/world-model-training.sln`](build/world-model-training.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/world-model-training.exe`.
