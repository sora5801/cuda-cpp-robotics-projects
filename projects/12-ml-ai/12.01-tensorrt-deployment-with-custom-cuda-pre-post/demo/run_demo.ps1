# ===========================================================================
# run_demo.ps1 — one-command demo for 12.01 (TensorRT deployment with custom CUDA pre/post kernels: NMS, argmax decode, keypoint extraction)
#
...
$Slug       = 'tensorrt-deployment-with-custom-cuda-pre-post'                     # substituted by scaffold.py
