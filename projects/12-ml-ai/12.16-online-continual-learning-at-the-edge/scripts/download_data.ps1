# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.16 (Online/continual learning at the edge: LoRA fine-tuning kernels)
#
...
Write-Host "[download_data] Project 12.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
