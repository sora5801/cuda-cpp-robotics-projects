# ===========================================================================
# run_demo.ps1 — one-command demo for 12.16 (Online/continual learning at the edge: LoRA fine-tuning kernels)
#
...
$Slug       = 'online-continual-learning-at-the-edge'                     # substituted by scaffold.py
