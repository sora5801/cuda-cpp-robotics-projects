# 12.16 — Online/continual learning at the edge: LoRA fine-tuning kernels

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Online/continual learning at the edge: LoRA fine-tuning kernels [R&D]`
>
...
Online/continual learning at the edge: LoRA fine-tuning kernels
...
1. Open [`build/online-continual-learning-at-the-edge.sln`](build/online-continual-learning-at-the-edge.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/online-continual-learning-at-the-edge.exe`.
