# ===========================================================================
# run_demo.ps1 — one-command demo for 12.11 (Point-cloud network ops: furthest-point sampling, ball query, sparse convolution hashing)
#
...
$Slug       = 'point-cloud-network-ops'                     # substituted by scaffold.py
