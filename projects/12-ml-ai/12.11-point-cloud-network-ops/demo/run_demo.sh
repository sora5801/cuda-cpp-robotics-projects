#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 12.11 (Point-cloud network ops: furthest-point sampling, ball query, sparse convolution hashing)
