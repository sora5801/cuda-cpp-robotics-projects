# 12.11 — Point-cloud network ops: furthest-point sampling, ball query, sparse convolution hashing

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Point-cloud network ops: furthest-point sampling, ball query, sparse convolution hashing`
>
...
1. Open [`build/point-cloud-network-ops.sln`](build/point-cloud-network-ops.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/point-cloud-network-ops.exe`.
