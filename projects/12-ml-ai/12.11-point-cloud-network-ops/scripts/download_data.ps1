# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.11 (Point-cloud network ops: furthest-point sampling, ball query, sparse convolution hashing)
#
...
Write-Host "[download_data] Project 12.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
