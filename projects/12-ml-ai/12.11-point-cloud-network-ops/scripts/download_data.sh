#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.11 (Point-cloud network ops: furthest-point sampling, ball query, sparse convolution hashing)
...
echo "[download_data] Project 12.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
