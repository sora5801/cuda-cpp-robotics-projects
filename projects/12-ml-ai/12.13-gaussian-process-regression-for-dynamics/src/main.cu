// ===========================================================================
// main.cu — entry point for project 12.13 (Gaussian-process regression (batched Cholesky) for dynamics residuals)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.13 (gaussian-process-regression-for-dynamics)\n");
