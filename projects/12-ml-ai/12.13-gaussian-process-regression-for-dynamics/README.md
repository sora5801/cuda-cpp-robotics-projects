# 12.13 — Gaussian-process regression (batched Cholesky) for dynamics residuals

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Gaussian-process regression (batched Cholesky) for dynamics residuals`
>
...
1. Open [`build/gaussian-process-regression-for-dynamics.sln`](build/gaussian-process-regression-for-dynamics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gaussian-process-regression-for-dynamics.exe`.
