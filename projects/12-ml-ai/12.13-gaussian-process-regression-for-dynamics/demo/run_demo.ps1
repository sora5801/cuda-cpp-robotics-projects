# ===========================================================================
# run_demo.ps1 — one-command demo for 12.13 (Gaussian-process regression (batched Cholesky) for dynamics residuals)
#
...
$Slug       = 'gaussian-process-regression-for-dynamics'                     # substituted by scaffold.py
