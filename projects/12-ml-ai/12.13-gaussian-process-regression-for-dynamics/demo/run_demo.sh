#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 12.13 (Gaussian-process regression (batched Cholesky) for dynamics residuals)
...
SLUG='gaussian-process-regression-for-dynamics'
