# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.13 (Gaussian-process regression (batched Cholesky) for dynamics residuals)
#
...
Write-Host "[download_data] Project 12.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
