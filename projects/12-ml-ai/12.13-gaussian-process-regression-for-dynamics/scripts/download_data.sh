#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.13 (Gaussian-process regression (batched Cholesky) for dynamics residuals)
...
echo "[download_data] Project 12.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
