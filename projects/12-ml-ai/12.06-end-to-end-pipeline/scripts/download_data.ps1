# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.06 (End-to-end pipeline: your parallel sim + your PPO = locomotion trained from scratch)
#
...
Write-Host "[download_data] Project 12.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
