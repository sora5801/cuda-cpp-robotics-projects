# ===========================================================================
# run_demo.ps1 — one-command demo for 12.06 (End-to-end pipeline: your parallel sim + your PPO = locomotion trained from scratch)
#
...
$Slug       = 'end-to-end-pipeline'                     # substituted by scaffold.py
