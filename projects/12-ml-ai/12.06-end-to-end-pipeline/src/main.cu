// ===========================================================================
// main.cu — entry point for project 12.06 (End-to-end pipeline: your parallel sim + your PPO = locomotion trained from scratch)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.06 (end-to-end-pipeline)\n");
