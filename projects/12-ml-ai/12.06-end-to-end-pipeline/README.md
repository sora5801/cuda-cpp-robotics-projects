# 12.06 — End-to-end pipeline: your parallel sim + your PPO = locomotion trained from scratch

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `End-to-end pipeline: your parallel sim + your PPO = locomotion trained from scratch`
>
...
1. Open [`build/end-to-end-pipeline.sln`](build/end-to-end-pipeline.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/end-to-end-pipeline.exe`.
