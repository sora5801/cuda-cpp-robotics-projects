# 12.04 — GPU dataloader + augmentation pipeline for robot logs

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `GPU dataloader + augmentation pipeline for robot logs`
>
...
1. Open [`build/gpu-dataloader-augmentation-pipeline-for-robot.sln`](build/gpu-dataloader-augmentation-pipeline-for-robot.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-dataloader-augmentation-pipeline-for-robot.exe`.
