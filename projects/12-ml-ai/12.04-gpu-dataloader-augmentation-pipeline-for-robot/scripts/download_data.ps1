# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.04 (GPU dataloader + augmentation pipeline for robot logs)
#
...
Write-Host "[download_data] Project 12.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
