# ===========================================================================
# run_demo.ps1 — one-command demo for 12.04 (GPU dataloader + augmentation pipeline for robot logs)
#
...
$Slug       = 'gpu-dataloader-augmentation-pipeline-for-robot'                     # substituted by scaffold.py
