// ===========================================================================
// main.cu — entry point for project 12.07 (Evolution strategies / CMA-ES with parallel fitness simulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.07 (evolution-strategies-cma-es-with-parallel)\n");
