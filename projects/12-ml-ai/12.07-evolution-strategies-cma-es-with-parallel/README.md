# 12.07 — Evolution strategies / CMA-ES with parallel fitness simulation

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Evolution strategies / CMA-ES with parallel fitness simulation`
>
...
1. Open [`build/evolution-strategies-cma-es-with-parallel.sln`](build/evolution-strategies-cma-es-with-parallel.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/evolution-strategies-cma-es-with-parallel.exe`.
