# ===========================================================================
# run_demo.ps1 — one-command demo for 12.07 (Evolution strategies / CMA-ES with parallel fitness simulation)
#
...
$Slug       = 'evolution-strategies-cma-es-with-parallel'                     # substituted by scaffold.py
