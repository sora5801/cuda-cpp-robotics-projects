# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.07 (Evolution strategies / CMA-ES with parallel fitness simulation)
#
...
Write-Host "[download_data] Project 12.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
