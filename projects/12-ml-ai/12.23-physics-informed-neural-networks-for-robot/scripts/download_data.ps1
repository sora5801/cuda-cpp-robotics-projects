# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.23 (Physics-informed neural networks for robot thermal/structural/fluid fields)
#
...
Write-Host "[download_data] Project 12.23 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
