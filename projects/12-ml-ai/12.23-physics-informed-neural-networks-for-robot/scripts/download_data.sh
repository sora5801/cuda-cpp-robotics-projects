#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.23 (Physics-informed neural networks for robot thermal/structural/fluid fields)
...
echo "[download_data] Project 12.23 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
