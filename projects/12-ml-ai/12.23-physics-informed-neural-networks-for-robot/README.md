# 12.23 — Physics-informed neural networks for robot thermal/structural/fluid fields

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Physics-informed neural networks for robot thermal/structural/fluid fields [R&D]`
>
...
Physics-informed neural networks for robot thermal/structural/fluid fields
...
1. Open [`build/physics-informed-neural-networks-for-robot.sln`](build/physics-informed-neural-networks-for-robot.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/physics-informed-neural-networks-for-robot.exe`.
