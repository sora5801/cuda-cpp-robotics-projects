#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 12.23 (Physics-informed neural networks for robot thermal/structural/fluid fields)
...
SLUG='physics-informed-neural-networks-for-robot'
