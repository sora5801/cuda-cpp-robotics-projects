# ===========================================================================
# run_demo.ps1 — one-command demo for 12.23 (Physics-informed neural networks for robot thermal/structural/fluid fields)
#
...
$Slug       = 'physics-informed-neural-networks-for-robot'                     # substituted by scaffold.py
