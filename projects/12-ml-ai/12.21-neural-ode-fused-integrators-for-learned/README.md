# 12.21 — Neural ODE fused integrators for learned dynamics

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Neural ODE fused integrators for learned dynamics [R&D]`
>
...
Neural ODE fused integrators for learned dynamics
...
1. Open [`build/neural-ode-fused-integrators-for-learned.sln`](build/neural-ode-fused-integrators-for-learned.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/neural-ode-fused-integrators-for-learned.exe`.
