# ===========================================================================
# run_demo.ps1 — one-command demo for 12.21 (Neural ODE fused integrators for learned dynamics)
#
...
$Slug       = 'neural-ode-fused-integrators-for-learned'                     # substituted by scaffold.py
