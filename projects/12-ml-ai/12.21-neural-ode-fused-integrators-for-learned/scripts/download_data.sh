#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.21 (Neural ODE fused integrators for learned dynamics)
...
echo "[download_data] Project 12.21 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
