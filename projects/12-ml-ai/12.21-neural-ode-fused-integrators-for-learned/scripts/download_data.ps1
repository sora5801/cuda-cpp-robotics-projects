# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.21 (Neural ODE fused integrators for learned dynamics)
#
...
Write-Host "[download_data] Project 12.21 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
