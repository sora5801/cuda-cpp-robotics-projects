// ===========================================================================
// main.cu — entry point for project 12.21 (Neural ODE fused integrators for learned dynamics)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.21 (neural-ode-fused-integrators-for-learned)\n");
