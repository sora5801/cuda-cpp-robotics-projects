#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.14 (Bayesian optimization with GPU acquisition sweeps for controller tuning)
...
echo "[download_data] Project 12.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
