# 12.14 — Bayesian optimization with GPU acquisition sweeps for controller tuning

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Bayesian optimization with GPU acquisition sweeps for controller tuning`
>
...
1. Open [`build/bayesian-optimization-with-gpu-acquisition.sln`](build/bayesian-optimization-with-gpu-acquisition.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/bayesian-optimization-with-gpu-acquisition.exe`.
