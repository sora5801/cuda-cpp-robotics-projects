#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 12.14 (Bayesian optimization with GPU acquisition sweeps for controller tuning)
...
SLUG='bayesian-optimization-with-gpu-acquisition'
