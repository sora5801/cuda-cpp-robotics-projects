# ===========================================================================
# run_demo.ps1 — one-command demo for 12.14 (Bayesian optimization with GPU acquisition sweeps for controller tuning)
#
...
$Slug       = 'bayesian-optimization-with-gpu-acquisition'                     # substituted by scaffold.py
