# 12.17 — Spiking neural network simulator for neuromorphic control

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Spiking neural network simulator for neuromorphic control [R&D]`
>
...
Spiking neural network simulator for neuromorphic control
...
1. Open [`build/spiking-neural-network-simulator.sln`](build/spiking-neural-network-simulator.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/spiking-neural-network-simulator.exe`.
