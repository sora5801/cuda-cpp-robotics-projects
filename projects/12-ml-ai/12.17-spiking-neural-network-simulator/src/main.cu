// ===========================================================================
// main.cu — entry point for project 12.17 (Spiking neural network simulator for neuromorphic control)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.17 (spiking-neural-network-simulator)\n");
