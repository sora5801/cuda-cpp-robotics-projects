# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.17 (Spiking neural network simulator for neuromorphic control)
#
...
Write-Host "[download_data] Project 12.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
