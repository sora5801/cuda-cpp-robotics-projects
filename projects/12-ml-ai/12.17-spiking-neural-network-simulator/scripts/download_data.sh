#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.17 (Spiking neural network simulator for neuromorphic control)
...
echo "[download_data] Project 12.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
