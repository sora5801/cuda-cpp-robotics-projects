# ===========================================================================
# run_demo.ps1 — one-command demo for 12.17 (Spiking neural network simulator for neuromorphic control)
#
...
$Slug       = 'spiking-neural-network-simulator'                     # substituted by scaffold.py
