#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.24 (Active perception: information-gain over candidate views in parallel)
...
echo "[download_data] Project 12.24 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
