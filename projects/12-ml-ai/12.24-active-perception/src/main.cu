// ===========================================================================
// main.cu — entry point for project 12.24 (Active perception: information-gain over candidate views in parallel)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.24 (active-perception)\n");
