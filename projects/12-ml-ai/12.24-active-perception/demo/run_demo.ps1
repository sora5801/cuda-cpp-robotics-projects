# ===========================================================================
# run_demo.ps1 — one-command demo for 12.24 (Active perception: information-gain over candidate views in parallel)
#
...
$Slug       = 'active-perception'                     # substituted by scaffold.py
