#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.12 (Neural SDF / occupancy-network query kernels inside planners)
...
echo "[download_data] Project 12.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
