// ===========================================================================
// main.cu — entry point for project 12.12 (Neural SDF / occupancy-network query kernels inside planners)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.12 (neural-sdf-occupancy-network-query-kernels)\n");
