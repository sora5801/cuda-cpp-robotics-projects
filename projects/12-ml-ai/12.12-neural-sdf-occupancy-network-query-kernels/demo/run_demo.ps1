# ===========================================================================
# run_demo.ps1 — one-command demo for 12.12 (Neural SDF / occupancy-network query kernels inside planners)
#
...
$Slug       = 'neural-sdf-occupancy-network-query-kernels'                     # substituted by scaffold.py
