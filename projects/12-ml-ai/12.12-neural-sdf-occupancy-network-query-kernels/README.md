# 12.12 — Neural SDF / occupancy-network query kernels inside planners

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Neural SDF / occupancy-network query kernels inside planners`
>
...
1. Open [`build/neural-sdf-occupancy-network-query-kernels.sln`](build/neural-sdf-occupancy-network-query-kernels.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/neural-sdf-occupancy-network-query-kernels.exe`.
