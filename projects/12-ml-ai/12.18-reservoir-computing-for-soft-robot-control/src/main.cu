// ===========================================================================
// main.cu — entry point for project 12.18 (Reservoir computing (echo-state) for soft-robot control)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.18 (reservoir-computing-for-soft-robot-control)\n");
