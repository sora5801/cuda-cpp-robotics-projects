# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.18 (Reservoir computing (echo-state) for soft-robot control)
#
...
Write-Host "[download_data] Project 12.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
