#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.18 (Reservoir computing (echo-state) for soft-robot control)
...
echo "[download_data] Project 12.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
