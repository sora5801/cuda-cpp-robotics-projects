# 12.18 — Reservoir computing (echo-state) for soft-robot control

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Reservoir computing (echo-state) for soft-robot control [R&D]`
>
...
Reservoir computing (echo-state) for soft-robot control
...
1. Open [`build/reservoir-computing-for-soft-robot-control.sln`](build/reservoir-computing-for-soft-robot-control.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/reservoir-computing-for-soft-robot-control.exe`.
