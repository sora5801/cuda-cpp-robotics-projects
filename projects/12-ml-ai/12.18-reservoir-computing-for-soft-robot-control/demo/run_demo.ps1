# ===========================================================================
# run_demo.ps1 — one-command demo for 12.18 (Reservoir computing (echo-state) for soft-robot control)
#
...
$Slug       = 'reservoir-computing-for-soft-robot-control'                     # substituted by scaffold.py
