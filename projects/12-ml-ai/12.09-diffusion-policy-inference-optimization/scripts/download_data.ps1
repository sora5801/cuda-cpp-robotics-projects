# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.09 (Diffusion-policy inference optimization (fused denoising steps))
#
...
Write-Host "[download_data] Project 12.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
