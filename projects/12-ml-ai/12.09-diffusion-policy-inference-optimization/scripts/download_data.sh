#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.09 (Diffusion-policy inference optimization (fused denoising steps))
...
echo "[download_data] Project 12.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
