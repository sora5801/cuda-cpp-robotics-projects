# ===========================================================================
# run_demo.ps1 — one-command demo for 12.09 (Diffusion-policy inference optimization (fused denoising steps))
#
...
$Slug       = 'diffusion-policy-inference-optimization'                     # substituted by scaffold.py
