#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.10 (VLA (vision-language-action) serving on Jetson: quantized attention, KV-cache management, speculative decoding)
...
echo "[download_data] Project 12.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
