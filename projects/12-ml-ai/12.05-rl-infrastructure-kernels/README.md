# 12.05 — RL infrastructure kernels: GAE, PPO update, GPU-resident replay buffers

**Difficulty:** ★ beginner · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `★ RL infrastructure kernels: GAE, PPO update, GPU-resident replay buffers`
>
...
1. Open [`build/rl-infrastructure-kernels.sln`](build/rl-infrastructure-kernels.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/rl-infrastructure-kernels.exe`.
