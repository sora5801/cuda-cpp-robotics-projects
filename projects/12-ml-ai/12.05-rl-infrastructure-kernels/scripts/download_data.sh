#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.05 (RL infrastructure kernels: GAE, PPO update, GPU-resident replay buffers)
...
echo "[download_data] Project 12.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
