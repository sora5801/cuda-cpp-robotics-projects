# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.05 (RL infrastructure kernels: GAE, PPO update, GPU-resident replay buffers)
#
...
Write-Host "[download_data] Project 12.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
