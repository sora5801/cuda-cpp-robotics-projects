# ===========================================================================
# run_demo.ps1 — one-command demo for 12.05 (RL infrastructure kernels: GAE, PPO update, GPU-resident replay buffers)
#
...
$Slug       = 'rl-infrastructure-kernels'                     # substituted by scaffold.py
