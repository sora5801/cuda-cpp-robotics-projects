# 12.25 — Adversarial disturbance search for sim-to-real robustness

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Adversarial disturbance search for sim-to-real robustness [R&D]`
>
...
Adversarial disturbance search for sim-to-real robustness
...
1. Open [`build/adversarial-disturbance-search-for-sim-to-real.sln`](build/adversarial-disturbance-search-for-sim-to-real.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/adversarial-disturbance-search-for-sim-to-real.exe`.
