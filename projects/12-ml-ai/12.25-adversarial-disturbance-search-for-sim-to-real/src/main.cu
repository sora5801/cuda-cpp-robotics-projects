// ===========================================================================
// main.cu — entry point for project 12.25 (Adversarial disturbance search for sim-to-real robustness)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.25 (adversarial-disturbance-search-for-sim-to-real)\n");
