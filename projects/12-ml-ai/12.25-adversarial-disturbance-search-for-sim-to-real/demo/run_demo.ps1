# ===========================================================================
# run_demo.ps1 — one-command demo for 12.25 (Adversarial disturbance search for sim-to-real robustness)
#
...
$Slug       = 'adversarial-disturbance-search-for-sim-to-real'                     # substituted by scaffold.py
