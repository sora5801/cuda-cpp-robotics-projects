#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.25 (Adversarial disturbance search for sim-to-real robustness)
...
echo "[download_data] Project 12.25 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
