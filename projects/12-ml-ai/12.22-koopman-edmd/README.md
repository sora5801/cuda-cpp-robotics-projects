# 12.22 — Koopman/EDMD: giant lifted linear systems via cuBLAS

**Difficulty:** [R&D] research · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Koopman/EDMD: giant lifted linear systems via cuBLAS [R&D]`
>
...
Koopman/EDMD: giant lifted linear systems via cuBLAS
...
1. Open [`build/koopman-edmd.sln`](build/koopman-edmd.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/koopman-edmd.exe`.
