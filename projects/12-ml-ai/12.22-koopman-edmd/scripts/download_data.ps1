# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.22 (Koopman/EDMD: giant lifted linear systems via cuBLAS)
#
...
Write-Host "[download_data] Project 12.22 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
