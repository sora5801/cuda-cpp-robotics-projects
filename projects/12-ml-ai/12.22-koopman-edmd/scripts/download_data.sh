#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.22 (Koopman/EDMD: giant lifted linear systems via cuBLAS)
...
echo "[download_data] Project 12.22 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
