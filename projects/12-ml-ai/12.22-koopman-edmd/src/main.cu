// ===========================================================================
// main.cu — entry point for project 12.22 (Koopman/EDMD: giant lifted linear systems via cuBLAS)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.22 (koopman-edmd)\n");
