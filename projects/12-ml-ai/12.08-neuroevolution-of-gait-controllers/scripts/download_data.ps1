# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.08 (Neuroevolution of gait controllers)
#
...
Write-Host "[download_data] Project 12.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
