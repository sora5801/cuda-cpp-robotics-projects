#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.08 (Neuroevolution of gait controllers)
...
echo "[download_data] Project 12.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
