// ===========================================================================
// main.cu — entry point for project 12.08 (Neuroevolution of gait controllers)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.08 (neuroevolution-of-gait-controllers)\n");
