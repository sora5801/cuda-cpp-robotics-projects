# 12.08 — Neuroevolution of gait controllers

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Neuroevolution of gait controllers`
>
...
1. Open [`build/neuroevolution-of-gait-controllers.sln`](build/neuroevolution-of-gait-controllers.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/neuroevolution-of-gait-controllers.exe`.
