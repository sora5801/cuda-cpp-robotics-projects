// ===========================================================================
// main.cu — entry point for project 12.02 (Custom TensorRT plugins (deformable attention, rotary embeddings))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.02 (custom-tensorrt-plugins)\n");
