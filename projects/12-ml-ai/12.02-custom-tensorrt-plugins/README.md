# 12.02 — Custom TensorRT plugins (deformable attention, rotary embeddings)

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `Custom TensorRT plugins (deformable attention, rotary embeddings)`
>
...
1. Open [`build/custom-tensorrt-plugins.sln`](build/custom-tensorrt-plugins.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/custom-tensorrt-plugins.exe`.
