#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.02 (Custom TensorRT plugins (deformable attention, rotary embeddings))
...
echo "[download_data] Project 12.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
