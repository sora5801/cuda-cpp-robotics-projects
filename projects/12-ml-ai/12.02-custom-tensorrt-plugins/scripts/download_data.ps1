# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 12.02 (Custom TensorRT plugins (deformable attention, rotary embeddings))
#
...
Write-Host "[download_data] Project 12.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
