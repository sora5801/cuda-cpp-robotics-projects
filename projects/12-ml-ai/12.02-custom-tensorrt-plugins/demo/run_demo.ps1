# ===========================================================================
# run_demo.ps1 — one-command demo for 12.02 (Custom TensorRT plugins (deformable attention, rotary embeddings))
#
...
$Slug       = 'custom-tensorrt-plugins'                     # substituted by scaffold.py
