# 12.03 — INT8/FP8 calibration tooling for edge inference

**Difficulty:** intermediate · **Domain:** 12. Machine Learning & AI for Robots

> Catalog bullet (source of truth, verbatim): `INT8/FP8 calibration tooling for edge inference`
>
...
1. Open [`build/int8-fp8-calibration-tooling-for-edge-inference.sln`](build/int8-fp8-calibration-tooling-for-edge-inference.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/int8-fp8-calibration-tooling-for-edge-inference.exe`.
