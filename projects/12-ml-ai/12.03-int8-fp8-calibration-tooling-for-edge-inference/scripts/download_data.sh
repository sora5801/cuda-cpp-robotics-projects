#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 12.03 (INT8/FP8 calibration tooling for edge inference)
...
echo "[download_data] Project 12.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
