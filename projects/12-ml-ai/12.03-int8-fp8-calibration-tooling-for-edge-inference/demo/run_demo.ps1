# ===========================================================================
# run_demo.ps1 — one-command demo for 12.03 (INT8/FP8 calibration tooling for edge inference)
#
...
$Slug       = 'int8-fp8-calibration-tooling-for-edge-inference'                     # substituted by scaffold.py
