// ===========================================================================
// main.cu — entry point for project 12.03 (INT8/FP8 calibration tooling for edge inference)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 12.03 (int8-fp8-calibration-tooling-for-edge-inference)\n");
