#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.16 (Visual servoing for insertion at camera frame rate)
...
echo "[download_data] Project 19.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
