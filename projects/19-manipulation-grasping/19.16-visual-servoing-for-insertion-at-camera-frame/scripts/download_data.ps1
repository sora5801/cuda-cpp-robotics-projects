# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.16 (Visual servoing for insertion at camera frame rate)
#
...
Write-Host "[download_data] Project 19.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
