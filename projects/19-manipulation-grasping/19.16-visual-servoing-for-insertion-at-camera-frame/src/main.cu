// ===========================================================================
// main.cu — entry point for project 19.16 (Visual servoing for insertion at camera frame rate)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.16 (visual-servoing-for-insertion-at-camera-frame)\n");
