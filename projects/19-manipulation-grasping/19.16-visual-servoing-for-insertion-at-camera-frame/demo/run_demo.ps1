# ===========================================================================
# run_demo.ps1 — one-command demo for 19.16 (Visual servoing for insertion at camera frame rate)
#
...
$Slug       = 'visual-servoing-for-insertion-at-camera-frame'                     # substituted by scaffold.py
