# 19.16 — Visual servoing for insertion at camera frame rate

**Difficulty:** intermediate · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Visual servoing for insertion at camera frame rate`
>
...
1. Open [`build/visual-servoing-for-insertion-at-camera-frame.sln`](build/visual-servoing-for-insertion-at-camera-frame.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/visual-servoing-for-insertion-at-camera-frame.exe`.
