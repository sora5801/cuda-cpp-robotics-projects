# 19.14 — Bimanual coordination via sampling MPC

**Difficulty:** [R&D] research · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Bimanual coordination via sampling MPC [R&D]`
>
...
Bimanual coordination via sampling MPC
...
1. Open [`build/bimanual-coordination-via-sampling-mpc.sln`](build/bimanual-coordination-via-sampling-mpc.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/bimanual-coordination-via-sampling-mpc.exe`.
