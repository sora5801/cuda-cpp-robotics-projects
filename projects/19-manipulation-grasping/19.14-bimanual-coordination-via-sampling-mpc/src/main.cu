// ===========================================================================
// main.cu — entry point for project 19.14 (Bimanual coordination via sampling MPC)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.14 (bimanual-coordination-via-sampling-mpc)\n");
