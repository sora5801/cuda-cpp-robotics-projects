# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.14 (Bimanual coordination via sampling MPC)
#
...
Write-Host "[download_data] Project 19.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
