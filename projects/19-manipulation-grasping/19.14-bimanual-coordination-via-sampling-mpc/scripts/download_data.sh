#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.14 (Bimanual coordination via sampling MPC)
...
echo "[download_data] Project 19.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
