# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.15 (Fixture/jig auto-design through parallel stability evaluation)
#
...
Write-Host "[download_data] Project 19.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
