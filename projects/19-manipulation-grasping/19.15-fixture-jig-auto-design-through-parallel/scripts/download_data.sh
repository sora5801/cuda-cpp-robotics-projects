#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.15 (Fixture/jig auto-design through parallel stability evaluation)
...
echo "[download_data] Project 19.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
