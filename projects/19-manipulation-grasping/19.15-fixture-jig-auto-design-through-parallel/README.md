# 19.15 — Fixture/jig auto-design through parallel stability evaluation

**Difficulty:** intermediate · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Fixture/jig auto-design through parallel stability evaluation`
>
...
1. Open [`build/fixture-jig-auto-design-through-parallel.sln`](build/fixture-jig-auto-design-through-parallel.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/fixture-jig-auto-design-through-parallel.exe`.
