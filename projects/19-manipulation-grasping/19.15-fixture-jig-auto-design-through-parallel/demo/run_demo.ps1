# ===========================================================================
# run_demo.ps1 — one-command demo for 19.15 (Fixture/jig auto-design through parallel stability evaluation)
#
...
$Slug       = 'fixture-jig-auto-design-through-parallel'                     # substituted by scaffold.py
