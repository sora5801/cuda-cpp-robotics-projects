# 19.04 — 6-DoF object pose: PPF voting on GPU + ICP refinement; render-and-compare

**Difficulty:** [R&D] research · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `6-DoF object pose: PPF voting on GPU + ICP refinement; render-and-compare [R&D]`
>
...
6-DoF object pose: PPF voting on GPU + ICP refinement; render-and-compare
...
1. Open [`build/6-dof-object-pose.sln`](build/6-dof-object-pose.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/6-dof-object-pose.exe`.
