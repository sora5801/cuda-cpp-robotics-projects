// ===========================================================================
// main.cu — entry point for project 19.04 (6-DoF object pose: PPF voting on GPU + ICP refinement; render-and-compare)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.04 (6-dof-object-pose)\n");
