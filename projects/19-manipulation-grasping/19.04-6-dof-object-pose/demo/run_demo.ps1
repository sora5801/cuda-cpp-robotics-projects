# ===========================================================================
# run_demo.ps1 — one-command demo for 19.04 (6-DoF object pose: PPF voting on GPU + ICP refinement; render-and-compare)
#
...
$Slug       = '6-dof-object-pose'                     # substituted by scaffold.py
