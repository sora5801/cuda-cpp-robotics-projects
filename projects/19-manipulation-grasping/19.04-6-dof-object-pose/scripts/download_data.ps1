# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.04 (6-DoF object pose: PPF voting on GPU + ICP refinement; render-and-compare)
#
...
Write-Host "[download_data] Project 19.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
