// ===========================================================================
// main.cu — entry point for project 19.09 (Deformable manipulation: cloth folding, rope knotting, dough/clay via MPM)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.09 (deformable-manipulation)\n");
