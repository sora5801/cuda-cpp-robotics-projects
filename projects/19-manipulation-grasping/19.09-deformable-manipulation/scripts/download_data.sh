#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.09 (Deformable manipulation: cloth folding, rope knotting, dough/clay via MPM)
...
echo "[download_data] Project 19.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
