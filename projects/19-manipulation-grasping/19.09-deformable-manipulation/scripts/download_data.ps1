# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.09 (Deformable manipulation: cloth folding, rope knotting, dough/clay via MPM)
#
...
Write-Host "[download_data] Project 19.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
