# ===========================================================================
# run_demo.ps1 — one-command demo for 19.09 (Deformable manipulation: cloth folding, rope knotting, dough/clay via MPM)
#
...
$Slug       = 'deformable-manipulation'                     # substituted by scaffold.py
