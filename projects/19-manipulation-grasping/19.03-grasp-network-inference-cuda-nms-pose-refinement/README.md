# 19.03 — Grasp network inference + CUDA NMS/pose refinement

**Difficulty:** intermediate · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Grasp network inference + CUDA NMS/pose refinement`
>
...
1. Open [`build/grasp-network-inference-cuda-nms-pose-refinement.sln`](build/grasp-network-inference-cuda-nms-pose-refinement.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/grasp-network-inference-cuda-nms-pose-refinement.exe`.
