# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.03 (Grasp network inference + CUDA NMS/pose refinement)
#
...
Write-Host "[download_data] Project 19.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
