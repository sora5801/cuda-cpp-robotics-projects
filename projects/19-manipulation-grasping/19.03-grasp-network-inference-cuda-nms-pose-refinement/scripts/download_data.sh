#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.03 (Grasp network inference + CUDA NMS/pose refinement)
...
echo "[download_data] Project 19.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
