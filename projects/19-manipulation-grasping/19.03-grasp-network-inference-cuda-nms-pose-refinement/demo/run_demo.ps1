# ===========================================================================
# run_demo.ps1 — one-command demo for 19.03 (Grasp network inference + CUDA NMS/pose refinement)
#
...
$Slug       = 'grasp-network-inference-cuda-nms-pose-refinement'                     # substituted by scaffold.py
