// ===========================================================================
// main.cu — entry point for project 19.03 (Grasp network inference + CUDA NMS/pose refinement)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.03 (grasp-network-inference-cuda-nms-pose-refinement)\n");
