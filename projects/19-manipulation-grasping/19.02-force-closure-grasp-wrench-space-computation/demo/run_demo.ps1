# ===========================================================================
# run_demo.ps1 — one-command demo for 19.02 (Force-closure / grasp-wrench-space computation batched)
#
...
$Slug       = 'force-closure-grasp-wrench-space-computation'                     # substituted by scaffold.py
