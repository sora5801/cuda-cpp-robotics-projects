#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.02 (Force-closure / grasp-wrench-space computation batched)
...
echo "[download_data] Project 19.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
