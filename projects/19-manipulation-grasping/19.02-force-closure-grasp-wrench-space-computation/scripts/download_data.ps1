# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.02 (Force-closure / grasp-wrench-space computation batched)
#
...
Write-Host "[download_data] Project 19.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
