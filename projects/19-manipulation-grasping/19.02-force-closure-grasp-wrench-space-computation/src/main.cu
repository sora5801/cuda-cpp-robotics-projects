// ===========================================================================
// main.cu — entry point for project 19.02 (Force-closure / grasp-wrench-space computation batched)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.02 (force-closure-grasp-wrench-space-computation)\n");
