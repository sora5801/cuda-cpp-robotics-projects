# 19.08 — Batched-IK grasp reachability ranking for cycle-time optimization

**Difficulty:** intermediate · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Batched-IK grasp reachability ranking for cycle-time optimization`
>
...
1. Open [`build/batched-ik-grasp-reachability-ranking-for-cycle.sln`](build/batched-ik-grasp-reachability-ranking-for-cycle.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-ik-grasp-reachability-ranking-for-cycle.exe`.
