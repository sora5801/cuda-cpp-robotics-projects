# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.08 (Batched-IK grasp reachability ranking for cycle-time optimization)
#
...
Write-Host "[download_data] Project 19.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
