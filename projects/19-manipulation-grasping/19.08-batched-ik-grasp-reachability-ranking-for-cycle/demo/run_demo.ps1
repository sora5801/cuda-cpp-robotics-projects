# ===========================================================================
# run_demo.ps1 — one-command demo for 19.08 (Batched-IK grasp reachability ranking for cycle-time optimization)
#
...
$Slug       = 'batched-ik-grasp-reachability-ranking-for-cycle'                     # substituted by scaffold.py
