#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 19.08 (Batched-IK grasp reachability ranking for cycle-time optimization)
...
SLUG='batched-ik-grasp-reachability-ranking-for-cycle'
