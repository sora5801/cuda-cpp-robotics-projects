#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.10 (Assembly: peg-in-hole search policies tuned in parallel sim; wire-harness routing)
...
echo "[download_data] Project 19.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
