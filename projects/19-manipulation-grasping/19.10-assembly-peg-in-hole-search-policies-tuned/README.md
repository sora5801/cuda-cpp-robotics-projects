# 19.10 — Assembly: peg-in-hole search policies tuned in parallel sim; wire-harness routing

**Difficulty:** [R&D] research · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Assembly: peg-in-hole search policies tuned in parallel sim; wire-harness routing [R&D]`
>
...
Assembly: peg-in-hole search policies tuned in parallel sim; wire-harness routing
...
1. Open [`build/assembly-peg-in-hole-search-policies-tuned.sln`](build/assembly-peg-in-hole-search-policies-tuned.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/assembly-peg-in-hole-search-policies-tuned.exe`.
