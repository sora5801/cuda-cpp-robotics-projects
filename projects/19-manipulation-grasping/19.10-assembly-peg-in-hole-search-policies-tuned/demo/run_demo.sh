#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 19.10 (Assembly: peg-in-hole search policies tuned in parallel sim; wire-harness routing)
...
SLUG='assembly-peg-in-hole-search-policies-tuned'
