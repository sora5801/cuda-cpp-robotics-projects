# ===========================================================================
# run_demo.ps1 — one-command demo for 19.10 (Assembly: peg-in-hole search policies tuned in parallel sim; wire-harness routing)
#
...
$Slug       = 'assembly-peg-in-hole-search-policies-tuned'                     # substituted by scaffold.py
