// ===========================================================================
// main.cu — entry point for project 19.07 (Dexterous in-hand manipulation via parallel-sim RL (Allegro/Shadow hands))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.07 (dexterous-in-hand-manipulation-via-parallel-sim)\n");
