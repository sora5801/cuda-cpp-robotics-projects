# 19.07 — Dexterous in-hand manipulation via parallel-sim RL (Allegro/Shadow hands)

**Difficulty:** intermediate · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Dexterous in-hand manipulation via parallel-sim RL (Allegro/Shadow hands)`
>
...
1. Open [`build/dexterous-in-hand-manipulation-via-parallel-sim.sln`](build/dexterous-in-hand-manipulation-via-parallel-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/dexterous-in-hand-manipulation-via-parallel-sim.exe`.
