#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 19.07 (Dexterous in-hand manipulation via parallel-sim RL (Allegro/Shadow hands))
...
SLUG='dexterous-in-hand-manipulation-via-parallel-sim'
