# ===========================================================================
# run_demo.ps1 — one-command demo for 19.07 (Dexterous in-hand manipulation via parallel-sim RL (Allegro/Shadow hands))
#
...
$Slug       = 'dexterous-in-hand-manipulation-via-parallel-sim'                     # substituted by scaffold.py
