# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.07 (Dexterous in-hand manipulation via parallel-sim RL (Allegro/Shadow hands))
#
...
Write-Host "[download_data] Project 19.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
