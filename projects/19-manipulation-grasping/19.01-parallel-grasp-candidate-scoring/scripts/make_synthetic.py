#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 19.01 (Parallel grasp-candidate scoring: antipodal sampling over point clouds).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 19.01 (Parallel grasp-candidate scoring: antipodal sampling over point clouds).")
