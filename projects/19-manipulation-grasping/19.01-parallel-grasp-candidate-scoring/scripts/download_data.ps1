# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.01 (Parallel grasp-candidate scoring: antipodal sampling over point clouds)
#
...
# dataset (Cornell Grasp, YCB, GraspNet-1Billion, ...) provides that in a
# directly checkable form, so synthetic analytic shapes are the correct
# tool, not a fallback. This script is therefore an honest, permanent no-op.
#
...
Write-Host "[download_data] Project 19.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
