// ===========================================================================
// main.cu — entry point for project 19.01 (Parallel grasp-candidate scoring: antipodal sampling over point clouds)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.01 (parallel-grasp-candidate-scoring)\n");
