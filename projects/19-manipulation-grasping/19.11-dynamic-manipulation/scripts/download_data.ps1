# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.11 (Dynamic manipulation: throwing/catching trajectory search)
#
...
Write-Host "[download_data] Project 19.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
