#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.11 (Dynamic manipulation: throwing/catching trajectory search)
...
echo "[download_data] Project 19.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
