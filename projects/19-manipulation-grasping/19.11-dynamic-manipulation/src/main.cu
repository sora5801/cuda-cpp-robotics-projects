// ===========================================================================
// main.cu — entry point for project 19.11 (Dynamic manipulation: throwing/catching trajectory search)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.11 (dynamic-manipulation)\n");
