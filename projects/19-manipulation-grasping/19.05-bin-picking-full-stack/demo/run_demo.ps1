# ===========================================================================
# run_demo.ps1 — one-command demo for 19.05 (Bin-picking full stack: segmentation → pose → grasp → motion, all GPU-resident)
#
...
$Slug       = 'bin-picking-full-stack'                     # substituted by scaffold.py
