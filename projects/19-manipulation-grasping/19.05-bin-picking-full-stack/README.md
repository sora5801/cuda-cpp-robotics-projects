# 19.05 — Bin-picking full stack: segmentation → pose → grasp → motion, all GPU-resident

**Difficulty:** ★ beginner · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `★ Bin-picking full stack: segmentation → pose → grasp → motion, all GPU-resident`
>
...
1. Open [`build/bin-picking-full-stack.sln`](build/bin-picking-full-stack.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/bin-picking-full-stack.exe`.
