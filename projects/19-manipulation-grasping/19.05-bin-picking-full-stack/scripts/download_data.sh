#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.05 (Bin-picking full stack: segmentation → pose → grasp → motion, all GPU-resident)
...
echo "[download_data] Project 19.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
