// ===========================================================================
// main.cu — entry point for project 19.05 (Bin-picking full stack: segmentation → pose → grasp → motion, all GPU-resident)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.05 (bin-picking-full-stack)\n");
