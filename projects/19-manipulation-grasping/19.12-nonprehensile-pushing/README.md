# 19.12 — Nonprehensile pushing: planar-sliding LCP batches

**Difficulty:** [R&D] research · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Nonprehensile pushing: planar-sliding LCP batches [R&D]`
>
...
Nonprehensile pushing: planar-sliding LCP batches
...
1. Open [`build/nonprehensile-pushing.sln`](build/nonprehensile-pushing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/nonprehensile-pushing.exe`.
