# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.12 (Nonprehensile pushing: planar-sliding LCP batches)
#
...
Write-Host "[download_data] Project 19.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
