#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.12 (Nonprehensile pushing: planar-sliding LCP batches)
...
echo "[download_data] Project 19.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
