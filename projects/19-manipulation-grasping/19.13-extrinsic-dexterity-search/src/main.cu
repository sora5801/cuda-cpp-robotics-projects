// ===========================================================================
// main.cu — entry point for project 19.13 (Extrinsic dexterity (using environment contacts) search)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 19.13 (extrinsic-dexterity-search)\n");
