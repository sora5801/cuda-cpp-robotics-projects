# ===========================================================================
# run_demo.ps1 — one-command demo for 19.13 (Extrinsic dexterity (using environment contacts) search)
#
...
$Slug       = 'extrinsic-dexterity-search'                     # substituted by scaffold.py
