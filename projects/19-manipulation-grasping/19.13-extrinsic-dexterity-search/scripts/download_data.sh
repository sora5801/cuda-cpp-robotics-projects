#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 19.13 (Extrinsic dexterity (using environment contacts) search)
...
echo "[download_data] Project 19.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
