# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.13 (Extrinsic dexterity (using environment contacts) search)
#
...
Write-Host "[download_data] Project 19.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
