# 19.13 — Extrinsic dexterity (using environment contacts) search

**Difficulty:** [R&D] research · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Extrinsic dexterity (using environment contacts) search [R&D]`
>
...
Extrinsic dexterity (using environment contacts) search
...
1. Open [`build/extrinsic-dexterity-search.sln`](build/extrinsic-dexterity-search.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/extrinsic-dexterity-search.exe`.
