# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 19.06 (Suction grasp planning: normals + seal-quality evaluation)
#
...
Write-Host "[download_data] Project 19.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
