# 19.06 — Suction grasp planning: normals + seal-quality evaluation

**Difficulty:** intermediate · **Domain:** 19. Manipulation & Grasping

> Catalog bullet (source of truth, verbatim): `Suction grasp planning: normals + seal-quality evaluation`
>
...
1. Open [`build/suction-grasp-planning.sln`](build/suction-grasp-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/suction-grasp-planning.exe`.
