# 33.12 — Marching cubes library

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Marching cubes library`
>
...
1. Open [`build/marching-cubes-library.sln`](build/marching-cubes-library.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/marching-cubes-library.exe`.
