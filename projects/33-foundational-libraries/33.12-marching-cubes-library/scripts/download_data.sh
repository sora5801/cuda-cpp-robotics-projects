#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.12 (Marching cubes library)
...
echo "[download_data] Project 33.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
