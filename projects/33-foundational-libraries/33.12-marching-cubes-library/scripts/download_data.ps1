# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.12 (Marching cubes library)
#
...
Write-Host "[download_data] Project 33.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
