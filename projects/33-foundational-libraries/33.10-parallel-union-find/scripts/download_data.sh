#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.10 (Parallel union-find)
...
echo "[download_data] Project 33.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
