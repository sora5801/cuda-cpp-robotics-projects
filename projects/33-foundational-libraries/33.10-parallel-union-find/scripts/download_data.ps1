# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.10 (Parallel union-find)
#
...
Write-Host "[download_data] Project 33.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
