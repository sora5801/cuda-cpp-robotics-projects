# 33.10 — Parallel union-find

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Parallel union-find`
>
...
1. Open [`build/parallel-union-find.sln`](build/parallel-union-find.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/parallel-union-find.exe`.
