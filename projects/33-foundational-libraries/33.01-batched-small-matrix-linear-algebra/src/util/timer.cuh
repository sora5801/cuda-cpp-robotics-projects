...
//                  (project 33.01; copied from docs/PROJECT_TEMPLATE
...
//    throughout (see gpu_matmul/gpu_solve in main.cu), so stream-0 events
//    time exactly the work they bracket; multi-stream projects record into
