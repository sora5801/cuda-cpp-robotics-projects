// ===========================================================================
// main.cu — entry point for project 33.01 (Batched small-matrix linear algebra (3×3, 4×4, 6×6 — the robotics sizes))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.01 (batched-small-matrix-linear-algebra)\n");
