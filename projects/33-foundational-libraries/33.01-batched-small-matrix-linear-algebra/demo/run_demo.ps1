# ===========================================================================
# run_demo.ps1 — one-command demo for 33.01 (Batched small-matrix linear algebra (3×3, 4×4, 6×6 — the robotics sizes))
#
...
# 33.01: the real implementation is in; this script is unchanged from the
...
$Slug       = 'batched-small-matrix-linear-algebra'                     # substituted by scaffold.py
