#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 33.01 (Batched small-matrix linear algebra (3×3, 4×4, 6×6 — the robotics sizes))
...
# 33.01: expected_output.txt carries the real implementation's stable lines
...
SLUG='batched-small-matrix-linear-algebra'
