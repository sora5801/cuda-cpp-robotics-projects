# 33.13 — Interval arithmetic on GPU

**Difficulty:** [R&D] research · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Interval arithmetic on GPU [R&D]`
>
...
1. Open [`build/interval-arithmetic-on-gpu.sln`](build/interval-arithmetic-on-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/interval-arithmetic-on-gpu.exe`.
