#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.13 (Interval arithmetic on GPU)
...
echo "[download_data] Project 33.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
