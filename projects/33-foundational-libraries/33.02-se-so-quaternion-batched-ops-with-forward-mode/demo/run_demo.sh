#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 33.02 (SE(3)/SO(3)/quaternion batched ops with forward-mode autodiff (dual numbers))
...
SLUG='se-so-quaternion-batched-ops-with-forward-mode'
