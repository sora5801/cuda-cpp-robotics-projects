# ===========================================================================
# run_demo.ps1 — one-command demo for 33.02 (SE(3)/SO(3)/quaternion batched ops with forward-mode autodiff (dual numbers))
#
...
$Slug       = 'se-so-quaternion-batched-ops-with-forward-mode'                     # substituted by scaffold.py
