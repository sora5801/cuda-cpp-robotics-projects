#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.02 (SE(3)/SO(3)/quaternion batched ops with forward-mode autodiff (dual numbers))
...
echo "[download_data] Project 33.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
