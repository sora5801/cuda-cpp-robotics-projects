# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.02 (SE(3)/SO(3)/quaternion batched ops with forward-mode autodiff (dual numbers))
#
...
Write-Host "[download_data] Project 33.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
