// ===========================================================================
// main.cu — entry point for project 33.02 (SE(3)/SO(3)/quaternion batched ops with forward-mode autodiff (dual numbers))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.02 (se-so-quaternion-batched-ops-with-forward-mode)\n");
