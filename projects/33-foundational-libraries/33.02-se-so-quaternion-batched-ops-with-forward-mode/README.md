# 33.02 — SE(3)/SO(3)/quaternion batched ops with forward-mode autodiff (dual numbers)

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `SE(3)/SO(3)/quaternion batched ops with forward-mode autodiff (dual numbers)`
>
...
1. Open [`build/se-so-quaternion-batched-ops-with-forward-mode.sln`](build/se-so-quaternion-batched-ops-with-forward-mode.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/se-so-quaternion-batched-ops-with-forward-mode.exe`.
