# 33.05 — Reusable KNN / radius-search library

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Reusable KNN / radius-search library`
>
...
1. Open [`build/reusable-knn-radius-search-library.sln`](build/reusable-knn-radius-search-library.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/reusable-knn-radius-search-library.exe`.
