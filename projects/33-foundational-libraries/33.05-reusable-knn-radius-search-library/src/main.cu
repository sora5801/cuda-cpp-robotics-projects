// ===========================================================================
// main.cu — entry point for project 33.05 (Reusable KNN / radius-search library)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.05 (reusable-knn-radius-search-library)\n");
