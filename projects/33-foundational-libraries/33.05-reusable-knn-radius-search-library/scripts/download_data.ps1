# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.05 (Reusable KNN / radius-search library)
#
...
Write-Host "[download_data] Project 33.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
