#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.05 (Reusable KNN / radius-search library)
...
echo "[download_data] Project 33.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
