#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.03 (B-spline / polynomial trajectory evaluation + derivatives, batched)
...
echo "[download_data] Project 33.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
