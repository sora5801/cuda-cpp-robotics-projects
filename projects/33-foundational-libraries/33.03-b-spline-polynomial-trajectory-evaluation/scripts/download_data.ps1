# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.03 (B-spline / polynomial trajectory evaluation + derivatives, batched)
#
...
Write-Host "[download_data] Project 33.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
