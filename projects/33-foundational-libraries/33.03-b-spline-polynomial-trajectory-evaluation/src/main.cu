// ===========================================================================
// main.cu — entry point for project 33.03 (B-spline / polynomial trajectory evaluation + derivatives, batched)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.03 (b-spline-polynomial-trajectory-evaluation)\n");
