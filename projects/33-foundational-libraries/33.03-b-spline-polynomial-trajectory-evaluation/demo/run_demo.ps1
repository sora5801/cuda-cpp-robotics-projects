# ===========================================================================
# run_demo.ps1 — one-command demo for 33.03 (B-spline / polynomial trajectory evaluation + derivatives, batched)
#
...
$Slug       = 'b-spline-polynomial-trajectory-evaluation'                     # substituted by scaffold.py
