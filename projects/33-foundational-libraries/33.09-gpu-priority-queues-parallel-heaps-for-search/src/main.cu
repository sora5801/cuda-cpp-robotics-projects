// ===========================================================================
// main.cu — entry point for project 33.09 (GPU priority queues / parallel heaps for search)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.09 (gpu-priority-queues-parallel-heaps-for-search)\n");
