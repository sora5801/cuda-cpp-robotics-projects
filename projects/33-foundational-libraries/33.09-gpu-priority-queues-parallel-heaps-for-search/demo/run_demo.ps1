# ===========================================================================
# run_demo.ps1 — one-command demo for 33.09 (GPU priority queues / parallel heaps for search)
#
...
$Slug       = 'gpu-priority-queues-parallel-heaps-for-search'                     # substituted by scaffold.py
