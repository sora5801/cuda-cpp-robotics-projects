# 33.09 — GPU priority queues / parallel heaps for search

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `GPU priority queues / parallel heaps for search`
>
...
1. Open [`build/gpu-priority-queues-parallel-heaps-for-search.sln`](build/gpu-priority-queues-parallel-heaps-for-search.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-priority-queues-parallel-heaps-for-search.exe`.
