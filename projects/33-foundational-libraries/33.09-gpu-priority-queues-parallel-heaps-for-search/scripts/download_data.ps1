# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.09 (GPU priority queues / parallel heaps for search)
#
...
Write-Host "[download_data] Project 33.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
