#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.09 (GPU priority queues / parallel heaps for search)
...
echo "[download_data] Project 33.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
