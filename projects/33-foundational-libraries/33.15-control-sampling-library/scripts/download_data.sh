#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.15 (Control-sampling library (the MPPI building block: noise generation + cost softmin reductions))
...
echo "[download_data] Project 33.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
