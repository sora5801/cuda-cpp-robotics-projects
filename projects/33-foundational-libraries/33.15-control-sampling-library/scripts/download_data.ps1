# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.15 (Control-sampling library (the MPPI building block: noise generation + cost softmin reductions))
#
...
Write-Host "[download_data] Project 33.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
