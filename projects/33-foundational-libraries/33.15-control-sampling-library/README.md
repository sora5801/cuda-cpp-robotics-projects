# 33.15 — Control-sampling library (the MPPI building block: noise generation + cost softmin reductions)

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Control-sampling library (the MPPI building block: noise generation + cost softmin reductions)`
>
...
1. Open [`build/control-sampling-library.sln`](build/control-sampling-library.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/control-sampling-library.exe`.
