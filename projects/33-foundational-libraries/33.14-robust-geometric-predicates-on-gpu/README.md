# 33.14 — Robust geometric predicates on GPU

**Difficulty:** [R&D] research · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Robust geometric predicates on GPU [R&D]`
>
...
Robust geometric predicates on GPU
...
1. Open [`build/robust-geometric-predicates-on-gpu.sln`](build/robust-geometric-predicates-on-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/robust-geometric-predicates-on-gpu.exe`.
