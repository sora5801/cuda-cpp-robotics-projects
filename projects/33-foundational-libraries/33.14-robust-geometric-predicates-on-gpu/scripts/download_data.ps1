# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.14 (Robust geometric predicates on GPU)
#
...
Write-Host "[download_data] Project 33.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
