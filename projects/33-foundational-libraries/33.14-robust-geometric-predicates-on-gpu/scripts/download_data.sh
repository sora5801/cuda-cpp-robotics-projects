#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.14 (Robust geometric predicates on GPU)
...
echo "[download_data] Project 33.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
