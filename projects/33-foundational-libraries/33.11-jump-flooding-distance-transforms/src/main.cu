// ===========================================================================
// main.cu — entry point for project 33.11 (Jump-flooding distance transforms)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.11 (jump-flooding-distance-transforms)\n");
