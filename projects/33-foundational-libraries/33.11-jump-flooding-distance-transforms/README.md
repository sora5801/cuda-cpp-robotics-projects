# 33.11 — Jump-flooding distance transforms

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Jump-flooding distance transforms`
>
...
1. Open [`build/jump-flooding-distance-transforms.sln`](build/jump-flooding-distance-transforms.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/jump-flooding-distance-transforms.exe`.
