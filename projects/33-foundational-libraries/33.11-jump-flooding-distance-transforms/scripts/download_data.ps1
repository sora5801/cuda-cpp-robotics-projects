# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.11 (Jump-flooding distance transforms)
#
...
Write-Host "[download_data] Project 33.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
