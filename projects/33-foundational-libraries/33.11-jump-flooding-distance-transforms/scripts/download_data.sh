#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.11 (Jump-flooding distance transforms)
...
echo "[download_data] Project 33.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
