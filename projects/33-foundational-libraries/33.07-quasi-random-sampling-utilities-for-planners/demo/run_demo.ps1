# ===========================================================================
# run_demo.ps1 — one-command demo for 33.07 (Quasi-random sampling (Halton/Sobol) utilities for planners)
#
...
$Slug       = 'quasi-random-sampling-utilities-for-planners'                     # substituted by scaffold.py
