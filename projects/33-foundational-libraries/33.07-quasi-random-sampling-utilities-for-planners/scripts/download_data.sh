#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.07 (Quasi-random sampling (Halton/Sobol) utilities for planners)
...
echo "[download_data] Project 33.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
