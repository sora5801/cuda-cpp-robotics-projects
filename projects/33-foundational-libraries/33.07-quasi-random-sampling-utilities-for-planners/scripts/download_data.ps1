# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.07 (Quasi-random sampling (Halton/Sobol) utilities for planners)
#
...
Write-Host "[download_data] Project 33.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
