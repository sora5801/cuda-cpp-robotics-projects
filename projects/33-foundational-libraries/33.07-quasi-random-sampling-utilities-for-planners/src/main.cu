// ===========================================================================
// main.cu — entry point for project 33.07 (Quasi-random sampling (Halton/Sobol) utilities for planners)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.07 (quasi-random-sampling-utilities-for-planners)\n");
