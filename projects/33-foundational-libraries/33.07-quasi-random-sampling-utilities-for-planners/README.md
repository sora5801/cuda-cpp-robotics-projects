# 33.07 — Quasi-random sampling (Halton/Sobol) utilities for planners

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Quasi-random sampling (Halton/Sobol) utilities for planners`
>
...
1. Open [`build/quasi-random-sampling-utilities-for-planners.sln`](build/quasi-random-sampling-utilities-for-planners.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/quasi-random-sampling-utilities-for-planners.exe`.
