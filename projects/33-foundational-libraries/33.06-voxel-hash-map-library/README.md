# 33.06 — Voxel hash-map library

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Voxel hash-map library`
>
...
1. Open [`build/voxel-hash-map-library.sln`](build/voxel-hash-map-library.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/voxel-hash-map-library.exe`.
