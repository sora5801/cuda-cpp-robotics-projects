# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.06 (Voxel hash-map library)
#
...
Write-Host "[download_data] Project 33.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
