#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.06 (Voxel hash-map library)
...
echo "[download_data] Project 33.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
