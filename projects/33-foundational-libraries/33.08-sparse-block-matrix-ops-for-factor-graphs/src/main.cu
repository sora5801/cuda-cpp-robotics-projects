// ===========================================================================
// main.cu — entry point for project 33.08 (Sparse block-matrix ops for factor graphs)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.08 (sparse-block-matrix-ops-for-factor-graphs)\n");
