# 33.08 — Sparse block-matrix ops for factor graphs

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Sparse block-matrix ops for factor graphs`
>
...
1. Open [`build/sparse-block-matrix-ops-for-factor-graphs.sln`](build/sparse-block-matrix-ops-for-factor-graphs.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/sparse-block-matrix-ops-for-factor-graphs.exe`.
