# ===========================================================================
# run_demo.ps1 — one-command demo for 33.08 (Sparse block-matrix ops for factor graphs)
#
...
$Slug       = 'sparse-block-matrix-ops-for-factor-graphs'                     # substituted by scaffold.py
