# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.08 (Sparse block-matrix ops for factor graphs)
#
...
Write-Host "[download_data] Project 33.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
