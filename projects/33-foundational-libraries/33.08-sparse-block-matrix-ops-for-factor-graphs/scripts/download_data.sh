#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.08 (Sparse block-matrix ops for factor graphs)
...
echo "[download_data] Project 33.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
