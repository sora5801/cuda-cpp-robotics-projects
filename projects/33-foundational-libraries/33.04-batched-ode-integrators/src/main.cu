// ===========================================================================
// main.cu — entry point for project 33.04 (Batched ODE integrators: RK4, adaptive RK45, symplectic)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 33.04 (batched-ode-integrators)\n");
