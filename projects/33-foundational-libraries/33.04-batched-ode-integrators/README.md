# 33.04 — Batched ODE integrators: RK4, adaptive RK45, symplectic

**Difficulty:** intermediate · **Domain:** 33. Foundational GPU Libraries (Build-Your-Own)

> Catalog bullet (source of truth, verbatim): `Batched ODE integrators: RK4, adaptive RK45, symplectic`
>
...
1. Open [`build/batched-ode-integrators.sln`](build/batched-ode-integrators.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-ode-integrators.exe`.
