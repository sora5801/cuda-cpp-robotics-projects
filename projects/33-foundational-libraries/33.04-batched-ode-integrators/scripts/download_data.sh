#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 33.04 (Batched ODE integrators: RK4, adaptive RK45, symplectic)
...
echo "[download_data] Project 33.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
