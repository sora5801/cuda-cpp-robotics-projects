# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 33.04 (Batched ODE integrators: RK4, adaptive RK45, symplectic)
#
...
Write-Host "[download_data] Project 33.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
