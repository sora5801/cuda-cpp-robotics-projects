# 16.10 — Underwater glider path optimization across eddy fields

**Difficulty:** intermediate · **Domain:** 16. Locomotion — Marine & Underwater

> Catalog bullet (source of truth, verbatim): `Underwater glider path optimization across eddy fields`
>
...
1. Open [`build/underwater-glider-path-optimization-across-eddy.sln`](build/underwater-glider-path-optimization-across-eddy.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/underwater-glider-path-optimization-across-eddy.exe`.
