# ===========================================================================
# run_demo.ps1 — one-command demo for 16.10 (Underwater glider path optimization across eddy fields)
#
...
$Slug       = 'underwater-glider-path-optimization-across-eddy'                     # substituted by scaffold.py
