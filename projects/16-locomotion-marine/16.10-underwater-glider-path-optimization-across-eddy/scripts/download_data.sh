#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.10 (Underwater glider path optimization across eddy fields)
...
echo "[download_data] Project 16.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
