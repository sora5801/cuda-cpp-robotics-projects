# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.10 (Underwater glider path optimization across eddy fields)
#
...
Write-Host "[download_data] Project 16.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
