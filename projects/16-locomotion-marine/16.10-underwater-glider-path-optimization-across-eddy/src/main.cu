// ===========================================================================
// main.cu — entry point for project 16.10 (Underwater glider path optimization across eddy fields)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.10 (underwater-glider-path-optimization-across-eddy)\n");
