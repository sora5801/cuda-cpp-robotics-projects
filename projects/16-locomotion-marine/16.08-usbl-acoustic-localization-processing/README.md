# 16.08 — USBL acoustic localization processing

**Difficulty:** intermediate · **Domain:** 16. Locomotion — Marine & Underwater

> Catalog bullet (source of truth, verbatim): `USBL acoustic localization processing`
>
...
1. Open [`build/usbl-acoustic-localization-processing.sln`](build/usbl-acoustic-localization-processing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/usbl-acoustic-localization-processing.exe`.
