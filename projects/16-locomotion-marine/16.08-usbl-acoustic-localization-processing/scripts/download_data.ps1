# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.08 (USBL acoustic localization processing)
#
...
Write-Host "[download_data] Project 16.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
