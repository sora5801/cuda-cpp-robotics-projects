// ===========================================================================
// main.cu — entry point for project 16.08 (USBL acoustic localization processing)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.08 (usbl-acoustic-localization-processing)\n");
