# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.07 (Real-time underwater image restoration (color, dehazing))
#
...
Write-Host "[download_data] Project 16.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
