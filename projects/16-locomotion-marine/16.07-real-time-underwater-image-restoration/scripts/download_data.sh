#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.07 (Real-time underwater image restoration (color, dehazing))
...
echo "[download_data] Project 16.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
