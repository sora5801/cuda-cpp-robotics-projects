# ===========================================================================
# run_demo.ps1 — one-command demo for 16.07 (Real-time underwater image restoration (color, dehazing))
#
...
$Slug       = 'real-time-underwater-image-restoration'                     # substituted by scaffold.py
