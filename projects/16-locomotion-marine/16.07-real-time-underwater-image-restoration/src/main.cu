// ===========================================================================
// main.cu — entry point for project 16.07 (Real-time underwater image restoration (color, dehazing))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.07 (real-time-underwater-image-restoration)\n");
