// ===========================================================================
// main.cu — entry point for project 16.06 (Wave prediction for USV station-keeping and landing)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.06 (wave-prediction-for-usv-station-keeping)\n");
