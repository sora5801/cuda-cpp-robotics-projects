# ===========================================================================
# run_demo.ps1 — one-command demo for 16.06 (Wave prediction for USV station-keeping and landing)
#
...
$Slug       = 'wave-prediction-for-usv-station-keeping'                     # substituted by scaffold.py
