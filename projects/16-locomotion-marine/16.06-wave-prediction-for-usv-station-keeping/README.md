# 16.06 — Wave prediction for USV station-keeping and landing

**Difficulty:** [R&D] research · **Domain:** 16. Locomotion — Marine & Underwater

> Catalog bullet (source of truth, verbatim): `Wave prediction for USV station-keeping and landing [R&D]`
>
...
Wave prediction for USV station-keeping and landing
...
1. Open [`build/wave-prediction-for-usv-station-keeping.sln`](build/wave-prediction-for-usv-station-keeping.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/wave-prediction-for-usv-station-keeping.exe`.
