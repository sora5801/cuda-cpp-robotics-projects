#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.06 (Wave prediction for USV station-keeping and landing)
...
echo "[download_data] Project 16.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
