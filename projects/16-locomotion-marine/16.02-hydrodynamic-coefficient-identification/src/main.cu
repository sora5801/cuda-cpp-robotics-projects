// ===========================================================================
// main.cu — entry point for project 16.02 (Hydrodynamic coefficient identification via parallel strip-theory/CFD-lite)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.02 (hydrodynamic-coefficient-identification)\n");
