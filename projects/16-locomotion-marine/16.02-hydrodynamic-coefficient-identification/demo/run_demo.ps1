# ===========================================================================
# run_demo.ps1 — one-command demo for 16.02 (Hydrodynamic coefficient identification via parallel strip-theory/CFD-lite)
#
...
$Slug       = 'hydrodynamic-coefficient-identification'                     # substituted by scaffold.py
