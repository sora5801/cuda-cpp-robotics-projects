#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 16.02 (Hydrodynamic coefficient identification via parallel strip-theory/CFD-lite)
...
SLUG='hydrodynamic-coefficient-identification'
