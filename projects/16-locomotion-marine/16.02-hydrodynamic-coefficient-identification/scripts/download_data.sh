#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.02 (Hydrodynamic coefficient identification via parallel strip-theory/CFD-lite)
...
echo "[download_data] Project 16.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
