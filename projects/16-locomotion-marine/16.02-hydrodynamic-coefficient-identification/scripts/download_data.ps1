# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.02 (Hydrodynamic coefficient identification via parallel strip-theory/CFD-lite)
#
...
Write-Host "[download_data] Project 16.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
