# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.09 (Docking under current: MPPI with hydrodynamic rollouts)
#
...
Write-Host "[download_data] Project 16.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
