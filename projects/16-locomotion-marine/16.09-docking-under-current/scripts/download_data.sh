#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.09 (Docking under current: MPPI with hydrodynamic rollouts)
...
echo "[download_data] Project 16.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
