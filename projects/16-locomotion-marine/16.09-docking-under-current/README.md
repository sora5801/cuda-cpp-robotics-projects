# 16.09 — Docking under current: MPPI with hydrodynamic rollouts

**Difficulty:** intermediate · **Domain:** 16. Locomotion — Marine & Underwater

> Catalog bullet (source of truth, verbatim): `Docking under current: MPPI with hydrodynamic rollouts`
>
...
1. Open [`build/docking-under-current.sln`](build/docking-under-current.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/docking-under-current.exe`.
