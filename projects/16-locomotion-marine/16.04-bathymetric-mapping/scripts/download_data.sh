#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.04 (Bathymetric mapping: sonar TSDF-style fusion)
...
echo "[download_data] Project 16.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
