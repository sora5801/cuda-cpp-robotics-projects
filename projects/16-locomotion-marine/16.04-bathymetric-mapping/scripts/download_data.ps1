# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.04 (Bathymetric mapping: sonar TSDF-style fusion)
#
...
Write-Host "[download_data] Project 16.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
