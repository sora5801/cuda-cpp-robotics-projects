// ===========================================================================
// main.cu — entry point for project 16.04 (Bathymetric mapping: sonar TSDF-style fusion)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.04 (bathymetric-mapping)\n");
