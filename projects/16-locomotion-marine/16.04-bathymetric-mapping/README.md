# 16.04 — Bathymetric mapping: sonar TSDF-style fusion

**Difficulty:** intermediate · **Domain:** 16. Locomotion — Marine & Underwater

> Catalog bullet (source of truth, verbatim): `Bathymetric mapping: sonar TSDF-style fusion`
>
...
1. Open [`build/bathymetric-mapping.sln`](build/bathymetric-mapping.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/bathymetric-mapping.exe`.
