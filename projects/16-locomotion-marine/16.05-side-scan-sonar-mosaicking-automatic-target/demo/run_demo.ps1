# ===========================================================================
# run_demo.ps1 — one-command demo for 16.05 (Side-scan sonar mosaicking + automatic target detection)
#
...
$Slug       = 'side-scan-sonar-mosaicking-automatic-target'                     # substituted by scaffold.py
