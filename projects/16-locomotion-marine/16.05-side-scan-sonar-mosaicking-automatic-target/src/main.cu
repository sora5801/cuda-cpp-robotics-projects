// ===========================================================================
// main.cu — entry point for project 16.05 (Side-scan sonar mosaicking + automatic target detection)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.05 (side-scan-sonar-mosaicking-automatic-target)\n");
