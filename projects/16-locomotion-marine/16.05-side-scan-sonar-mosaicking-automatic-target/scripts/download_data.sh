#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.05 (Side-scan sonar mosaicking + automatic target detection)
...
echo "[download_data] Project 16.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
