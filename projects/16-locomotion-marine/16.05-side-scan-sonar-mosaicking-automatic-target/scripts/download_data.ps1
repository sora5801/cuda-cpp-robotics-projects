# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.05 (Side-scan sonar mosaicking + automatic target detection)
#
...
Write-Host "[download_data] Project 16.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
