// ===========================================================================
// main.cu — entry point for project 16.11 (Swimming-robot simulation: undulatory propulsion with fluid coupling)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.11 (swimming-robot-simulation)\n");
