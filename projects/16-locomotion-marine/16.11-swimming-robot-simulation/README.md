# 16.11 — Swimming-robot simulation: undulatory propulsion with fluid coupling

**Difficulty:** [R&D] research · **Domain:** 16. Locomotion — Marine & Underwater

> Catalog bullet (source of truth, verbatim): `Swimming-robot simulation: undulatory propulsion with fluid coupling [R&D]`
>
...
Swimming-robot simulation: undulatory propulsion with fluid coupling
...
1. Open [`build/swimming-robot-simulation.sln`](build/swimming-robot-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/swimming-robot-simulation.exe`.
