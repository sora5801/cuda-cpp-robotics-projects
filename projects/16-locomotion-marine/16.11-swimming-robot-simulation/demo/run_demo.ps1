# ===========================================================================
# run_demo.ps1 — one-command demo for 16.11 (Swimming-robot simulation: undulatory propulsion with fluid coupling)
#
...
$Slug       = 'swimming-robot-simulation'                     # substituted by scaffold.py
