#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.11 (Swimming-robot simulation: undulatory propulsion with fluid coupling)
...
echo "[download_data] Project 16.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
