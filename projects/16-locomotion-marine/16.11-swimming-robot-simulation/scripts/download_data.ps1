# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.11 (Swimming-robot simulation: undulatory propulsion with fluid coupling)
#
...
Write-Host "[download_data] Project 16.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
