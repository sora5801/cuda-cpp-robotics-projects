# ===========================================================================
# run_demo.ps1 — one-command demo for 16.01 (Thruster allocation for overactuated ROVs (batched QP))
#
...
#
# This script needed NO changes once the real implementation (project 16.01,
# thruster allocation) landed — it only drives the build and diffs stable
# output lines. expected_output.txt is kept in sync with the stable lines
# ../src/main.cu prints (see the "output contract" comment there).
#
...
$Slug       = 'thruster-allocation-for-overactuated-rovs'                     # substituted by scaffold.py
...
# (expected_output.txt's provenance/measurement notes are such comments).
