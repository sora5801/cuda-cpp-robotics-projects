#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 16.01 (Thruster allocation for overactuated ROVs (batched QP)).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 16.01 (Thruster allocation for overactuated ROVs (batched QP)).")
