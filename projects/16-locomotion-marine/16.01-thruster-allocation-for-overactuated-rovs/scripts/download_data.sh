#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.01 (Thruster allocation for overactuated ROVs (batched QP))
...
echo "[download_data] Project 16.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
