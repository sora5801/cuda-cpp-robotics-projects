// ===========================================================================
// main.cu — entry point for project 16.01 (Thruster allocation for overactuated ROVs (batched QP))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.01 (thruster-allocation-for-overactuated-rovs)\n");
