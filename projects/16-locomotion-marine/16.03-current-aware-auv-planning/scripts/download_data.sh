#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 16.03 (Current-aware AUV planning: GPU search over 4D forecast grids)
...
echo "[download_data] Project 16.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
