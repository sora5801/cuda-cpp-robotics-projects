# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 16.03 (Current-aware AUV planning: GPU search over 4D forecast grids)
#
...
Write-Host "[download_data] Project 16.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
