// ===========================================================================
// main.cu — entry point for project 16.03 (Current-aware AUV planning: GPU search over 4D forecast grids)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 16.03 (current-aware-auv-planning)\n");
