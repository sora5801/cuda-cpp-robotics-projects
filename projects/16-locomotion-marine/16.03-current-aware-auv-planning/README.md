# 16.03 — Current-aware AUV planning: GPU search over 4D forecast grids

**Difficulty:** intermediate · **Domain:** 16. Locomotion — Marine & Underwater

> Catalog bullet (source of truth, verbatim): `Current-aware AUV planning: GPU search over 4D forecast grids`
>
...
1. Open [`build/current-aware-auv-planning.sln`](build/current-aware-auv-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/current-aware-auv-planning.exe`.
