# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.02 (Climbing robots: gecko/electroadhesion contact models ; negative-pressure CFD)
#
...
Write-Host "[download_data] Project 18.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
