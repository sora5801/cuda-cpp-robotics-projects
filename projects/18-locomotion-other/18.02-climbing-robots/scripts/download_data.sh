#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.02 (Climbing robots: gecko/electroadhesion contact models ; negative-pressure CFD)
...
echo "[download_data] Project 18.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
