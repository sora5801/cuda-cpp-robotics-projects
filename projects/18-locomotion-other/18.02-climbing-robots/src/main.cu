// ===========================================================================
// main.cu — entry point for project 18.02 (Climbing robots: gecko/electroadhesion contact models ; negative-pressure CFD)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.02 (climbing-robots)\n");
