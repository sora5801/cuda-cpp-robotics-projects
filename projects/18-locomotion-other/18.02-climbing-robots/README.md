# 18.02 — Climbing robots: gecko/electroadhesion contact models ; negative-pressure CFD

**Difficulty:** [R&D] research · **Domain:** 18. Locomotion — Everything Else

> Catalog bullet (source of truth, verbatim): `Climbing robots: gecko/electroadhesion contact models [R&D]; negative-pressure CFD [R&D]`
>
...
Climbing robots: gecko/electroadhesion contact models ; negative-pressure CFD
...
1. Open [`build/climbing-robots.sln`](build/climbing-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/climbing-robots.exe`.
