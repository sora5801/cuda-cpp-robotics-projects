# ===========================================================================
# run_demo.ps1 — one-command demo for 18.02 (Climbing robots: gecko/electroadhesion contact models ; negative-pressure CFD)
#
...
$Slug       = 'climbing-robots'                     # substituted by scaffold.py
