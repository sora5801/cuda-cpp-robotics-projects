# ===========================================================================
# run_demo.ps1 — one-command demo for 18.01 (Snake robots: serpenoid gait sweeps coupled to granular sim)
#
...
#
# RESOLVED: the real implementation (the gait sweep, src/main.cu) has landed
# and this script needed no changes to drive it — it builds, runs, and diffs
# the real stable lines against the committed expected_output.txt exactly as
# it did for the scaffold's SAXPY placeholder (see the "output contract"
# comment in ../src/main.cu for what counts as a stable line).
#
...
$Slug       = 'snake-robots'                     # substituted by scaffold.py
