#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 18.01 (Snake robots: serpenoid gait sweeps coupled to granular sim)
...
# RESOLVED: expected_output.txt already holds the real project's stable
# output lines, measured from an actual Release run (see the "output
