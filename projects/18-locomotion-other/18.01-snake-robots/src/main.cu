// ===========================================================================
// main.cu — entry point for project 18.01 (Snake robots: serpenoid gait sweeps coupled to granular sim)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.01 (snake-robots)\n");
