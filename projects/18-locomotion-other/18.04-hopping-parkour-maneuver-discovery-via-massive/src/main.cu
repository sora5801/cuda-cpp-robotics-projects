// ===========================================================================
// main.cu — entry point for project 18.04 (Hopping/parkour maneuver discovery via massive sampling)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.04 (hopping-parkour-maneuver-discovery-via-massive)\n");
