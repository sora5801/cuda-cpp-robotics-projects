# 18.04 — Hopping/parkour maneuver discovery via massive sampling

**Difficulty:** intermediate · **Domain:** 18. Locomotion — Everything Else

> Catalog bullet (source of truth, verbatim): `Hopping/parkour maneuver discovery via massive sampling`
>
...
1. Open [`build/hopping-parkour-maneuver-discovery-via-massive.sln`](build/hopping-parkour-maneuver-discovery-via-massive.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/hopping-parkour-maneuver-discovery-via-massive.exe`.
