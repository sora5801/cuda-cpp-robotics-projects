# ===========================================================================
# run_demo.ps1 — one-command demo for 18.04 (Hopping/parkour maneuver discovery via massive sampling)
#
...
$Slug       = 'hopping-parkour-maneuver-discovery-via-massive'                     # substituted by scaffold.py
