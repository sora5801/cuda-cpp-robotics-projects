# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.04 (Hopping/parkour maneuver discovery via massive sampling)
#
...
Write-Host "[download_data] Project 18.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
