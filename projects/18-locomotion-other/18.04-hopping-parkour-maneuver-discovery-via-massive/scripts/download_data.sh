#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.04 (Hopping/parkour maneuver discovery via massive sampling)
...
echo "[download_data] Project 18.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
