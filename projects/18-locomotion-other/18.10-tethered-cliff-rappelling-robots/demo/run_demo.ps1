# ===========================================================================
# run_demo.ps1 — one-command demo for 18.10 (Tethered cliff/rappelling robots: cable dynamics + anchor planning)
#
...
$Slug       = 'tethered-cliff-rappelling-robots'                     # substituted by scaffold.py
