#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.10 (Tethered cliff/rappelling robots: cable dynamics + anchor planning)
...
echo "[download_data] Project 18.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
