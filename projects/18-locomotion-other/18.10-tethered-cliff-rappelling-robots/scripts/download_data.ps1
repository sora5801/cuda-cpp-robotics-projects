# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.10 (Tethered cliff/rappelling robots: cable dynamics + anchor planning)
#
...
Write-Host "[download_data] Project 18.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
