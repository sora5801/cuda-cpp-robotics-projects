// ===========================================================================
// main.cu — entry point for project 18.10 (Tethered cliff/rappelling robots: cable dynamics + anchor planning)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.10 (tethered-cliff-rappelling-robots)\n");
