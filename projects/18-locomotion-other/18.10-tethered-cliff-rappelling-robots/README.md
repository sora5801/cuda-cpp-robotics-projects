# 18.10 — Tethered cliff/rappelling robots: cable dynamics + anchor planning

**Difficulty:** [R&D] research · **Domain:** 18. Locomotion — Everything Else

> Catalog bullet (source of truth, verbatim): `Tethered cliff/rappelling robots: cable dynamics + anchor planning [R&D]`
>
...
Tethered cliff/rappelling robots: cable dynamics + anchor planning
...
1. Open [`build/tethered-cliff-rappelling-robots.sln`](build/tethered-cliff-rappelling-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tethered-cliff-rappelling-robots.exe`.
