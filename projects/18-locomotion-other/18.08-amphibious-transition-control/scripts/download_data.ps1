# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.08 (Amphibious transition control)
#
...
Write-Host "[download_data] Project 18.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
