#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.08 (Amphibious transition control)
...
echo "[download_data] Project 18.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
