# 18.08 — Amphibious transition control

**Difficulty:** [R&D] research · **Domain:** 18. Locomotion — Everything Else

> Catalog bullet (source of truth, verbatim): `Amphibious transition control [R&D]`
>
...
1. Open [`build/amphibious-transition-control.sln`](build/amphibious-transition-control.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/amphibious-transition-control.exe`.
