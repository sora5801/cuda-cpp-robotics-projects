#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.07 (Soft crawlers: MPM sim + evolved actuation patterns)
...
echo "[download_data] Project 18.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
