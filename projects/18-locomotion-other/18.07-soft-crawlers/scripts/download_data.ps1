# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.07 (Soft crawlers: MPM sim + evolved actuation patterns)
#
...
Write-Host "[download_data] Project 18.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
