// ===========================================================================
// main.cu — entry point for project 18.07 (Soft crawlers: MPM sim + evolved actuation patterns)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.07 (soft-crawlers)\n");
