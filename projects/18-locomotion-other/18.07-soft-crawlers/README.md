# 18.07 — Soft crawlers: MPM sim + evolved actuation patterns

**Difficulty:** [R&D] research · **Domain:** 18. Locomotion — Everything Else

> Catalog bullet (source of truth, verbatim): `Soft crawlers: MPM sim + evolved actuation patterns [R&D]`
>
...
Soft crawlers: MPM sim + evolved actuation patterns
...
1. Open [`build/soft-crawlers.sln`](build/soft-crawlers.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/soft-crawlers.exe`.
