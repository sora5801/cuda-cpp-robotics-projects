# ===========================================================================
# run_demo.ps1 — one-command demo for 18.03 (Brachiation swing-trajectory optimization)
#
...
$Slug       = 'brachiation-swing-trajectory-optimization'                     # substituted by scaffold.py
