# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.03 (Brachiation swing-trajectory optimization)
#
...
Write-Host "[download_data] Project 18.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
