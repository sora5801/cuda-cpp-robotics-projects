#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.03 (Brachiation swing-trajectory optimization)
...
echo "[download_data] Project 18.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
