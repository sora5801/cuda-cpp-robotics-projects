# ===========================================================================
# run_demo.ps1 — one-command demo for 18.06 (Wheel-leg hybrid mode-scheduling optimization)
#
...
$Slug       = 'wheel-leg-hybrid-mode-scheduling-optimization'                     # substituted by scaffold.py
