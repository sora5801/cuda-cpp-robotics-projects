// ===========================================================================
// main.cu — entry point for project 18.06 (Wheel-leg hybrid mode-scheduling optimization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.06 (wheel-leg-hybrid-mode-scheduling-optimization)\n");
