# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.06 (Wheel-leg hybrid mode-scheduling optimization)
#
...
Write-Host "[download_data] Project 18.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
