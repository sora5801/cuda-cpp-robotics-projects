#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.06 (Wheel-leg hybrid mode-scheduling optimization)
...
echo "[download_data] Project 18.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
