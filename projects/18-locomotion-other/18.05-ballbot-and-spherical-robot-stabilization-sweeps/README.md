# 18.05 — Ballbot and spherical-robot stabilization sweeps

**Difficulty:** intermediate · **Domain:** 18. Locomotion — Everything Else

> Catalog bullet (source of truth, verbatim): `Ballbot and spherical-robot stabilization sweeps`
>
...
1. Open [`build/ballbot-and-spherical-robot-stabilization-sweeps.sln`](build/ballbot-and-spherical-robot-stabilization-sweeps.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/ballbot-and-spherical-robot-stabilization-sweeps.exe`.
