// ===========================================================================
// main.cu — entry point for project 18.05 (Ballbot and spherical-robot stabilization sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.05 (ballbot-and-spherical-robot-stabilization-sweeps)\n");
