# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.05 (Ballbot and spherical-robot stabilization sweeps)
#
...
Write-Host "[download_data] Project 18.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
