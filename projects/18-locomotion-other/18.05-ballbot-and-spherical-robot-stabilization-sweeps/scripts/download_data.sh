#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.05 (Ballbot and spherical-robot stabilization sweeps)
...
echo "[download_data] Project 18.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
