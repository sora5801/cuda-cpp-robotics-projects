# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 18.09 (In-pipe robot localization from vision/LiDAR)
#
...
Write-Host "[download_data] Project 18.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
