#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 18.09 (In-pipe robot localization from vision/LiDAR)
...
echo "[download_data] Project 18.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
