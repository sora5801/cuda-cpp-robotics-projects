// ===========================================================================
// main.cu — entry point for project 18.09 (In-pipe robot localization from vision/LiDAR)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 18.09 (in-pipe-robot-localization-from-vision-lidar)\n");
