# ===========================================================================
# run_demo.ps1 — one-command demo for 18.09 (In-pipe robot localization from vision/LiDAR)
#
...
$Slug       = 'in-pipe-robot-localization-from-vision-lidar'                     # substituted by scaffold.py
