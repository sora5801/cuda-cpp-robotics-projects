# 18.09 — In-pipe robot localization from vision/LiDAR

**Difficulty:** intermediate · **Domain:** 18. Locomotion — Everything Else

> Catalog bullet (source of truth, verbatim): `In-pipe robot localization from vision/LiDAR`
>
...
1. Open [`build/in-pipe-robot-localization-from-vision-lidar.sln`](build/in-pipe-robot-localization-from-vision-lidar.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/in-pipe-robot-localization-from-vision-lidar.exe`.
