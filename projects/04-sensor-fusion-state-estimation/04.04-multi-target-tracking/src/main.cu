// ===========================================================================
// main.cu — entry point for project 04.04 (Multi-target tracking: GNN/JPDA cost matrices + GPU auction/Hungarian assignment)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.04 (multi-target-tracking)\n");
