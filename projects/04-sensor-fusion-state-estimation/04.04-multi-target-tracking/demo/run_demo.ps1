# ===========================================================================
# run_demo.ps1 — one-command demo for 04.04 (Multi-target tracking: GNN/JPDA cost matrices + GPU auction/Hungarian assignment)
#
...
$Slug       = 'multi-target-tracking'                     # substituted by scaffold.py
