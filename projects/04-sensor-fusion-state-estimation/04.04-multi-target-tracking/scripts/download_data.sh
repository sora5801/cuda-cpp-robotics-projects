#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.04 (Multi-target tracking: GNN/JPDA cost matrices + GPU auction/Hungarian assignment)
...
echo "[download_data] Project 04.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
