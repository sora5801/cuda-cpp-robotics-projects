# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.04 (Multi-target tracking: GNN/JPDA cost matrices + GPU auction/Hungarian assignment)
#
...
Write-Host "[download_data] Project 04.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
