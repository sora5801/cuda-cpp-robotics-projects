# 04.04 — Multi-target tracking: GNN/JPDA cost matrices + GPU auction/Hungarian assignment

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Multi-target tracking: GNN/JPDA cost matrices + GPU auction/Hungarian assignment`
>
...
1. Open [`build/multi-target-tracking.sln`](build/multi-target-tracking.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/multi-target-tracking.exe`.
