# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.12 (Covariance-intersection distributed fusion for swarms)
#
...
Write-Host "[download_data] Project 04.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
