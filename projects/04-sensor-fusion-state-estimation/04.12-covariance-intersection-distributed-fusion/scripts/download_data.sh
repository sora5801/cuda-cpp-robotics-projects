#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.12 (Covariance-intersection distributed fusion for swarms)
...
echo "[download_data] Project 04.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
