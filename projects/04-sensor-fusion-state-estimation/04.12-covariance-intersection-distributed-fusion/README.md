# 04.12 — Covariance-intersection distributed fusion for swarms

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Covariance-intersection distributed fusion for swarms`
>
...
1. Open [`build/covariance-intersection-distributed-fusion.sln`](build/covariance-intersection-distributed-fusion.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/covariance-intersection-distributed-fusion.exe`.
