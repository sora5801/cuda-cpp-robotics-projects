# ===========================================================================
# run_demo.ps1 — one-command demo for 04.12 (Covariance-intersection distributed fusion for swarms)
#
...
$Slug       = 'covariance-intersection-distributed-fusion'                     # substituted by scaffold.py
