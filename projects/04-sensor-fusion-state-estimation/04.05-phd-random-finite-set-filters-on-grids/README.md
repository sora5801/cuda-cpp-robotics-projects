# 04.05 — PHD / random-finite-set filters on grids

**Difficulty:** [R&D] research · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `PHD / random-finite-set filters on grids [R&D]`
>
...
PHD / random-finite-set filters on grids
...
1. Open [`build/phd-random-finite-set-filters-on-grids.sln`](build/phd-random-finite-set-filters-on-grids.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/phd-random-finite-set-filters-on-grids.exe`.
