# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.05 (PHD / random-finite-set filters on grids)
#
...
Write-Host "[download_data] Project 04.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
