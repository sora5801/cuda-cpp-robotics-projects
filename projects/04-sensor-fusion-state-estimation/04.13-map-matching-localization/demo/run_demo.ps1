# ===========================================================================
# run_demo.ps1 — one-command demo for 04.13 (Map-matching localization (correlative scan matching — brute-force over pose grid, ideal for GPU))
#
...
$Slug       = 'map-matching-localization'                     # substituted by scaffold.py
