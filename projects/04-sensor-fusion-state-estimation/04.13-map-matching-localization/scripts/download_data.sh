#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.13 (Map-matching localization (correlative scan matching — brute-force over pose grid, ideal for GPU))
...
echo "[download_data] Project 04.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
