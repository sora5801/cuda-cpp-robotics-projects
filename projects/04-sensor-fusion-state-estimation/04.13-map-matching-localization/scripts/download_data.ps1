# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.13 (Map-matching localization (correlative scan matching — brute-force over pose grid, ideal for GPU))
#
...
Write-Host "[download_data] Project 04.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
