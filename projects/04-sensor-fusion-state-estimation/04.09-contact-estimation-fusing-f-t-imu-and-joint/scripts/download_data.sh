#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.09 (Contact estimation fusing F/T, IMU, and joint-encoder banks)
...
echo "[download_data] Project 04.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
