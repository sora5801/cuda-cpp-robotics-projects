# 04.09 — Contact estimation fusing F/T, IMU, and joint-encoder banks

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Contact estimation fusing F/T, IMU, and joint-encoder banks`
>
...
1. Open [`build/contact-estimation-fusing-f-t-imu-and-joint.sln`](build/contact-estimation-fusing-f-t-imu-and-joint.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/contact-estimation-fusing-f-t-imu-and-joint.exe`.
