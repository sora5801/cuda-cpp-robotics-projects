# ===========================================================================
# run_demo.ps1 — one-command demo for 04.09 (Contact estimation fusing F/T, IMU, and joint-encoder banks)
#
...
$Slug       = 'contact-estimation-fusing-f-t-imu-and-joint'                     # substituted by scaffold.py
