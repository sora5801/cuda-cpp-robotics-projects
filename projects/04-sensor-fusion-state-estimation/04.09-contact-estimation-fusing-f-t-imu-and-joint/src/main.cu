// ===========================================================================
// main.cu — entry point for project 04.09 (Contact estimation fusing F/T, IMU, and joint-encoder banks)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.09 (contact-estimation-fusing-f-t-imu-and-joint)\n");
