# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.07 (Sliding-window VIO backend with GPU marginalization)
#
...
Write-Host "[download_data] Project 04.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
