#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.07 (Sliding-window VIO backend with GPU marginalization)
...
echo "[download_data] Project 04.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
