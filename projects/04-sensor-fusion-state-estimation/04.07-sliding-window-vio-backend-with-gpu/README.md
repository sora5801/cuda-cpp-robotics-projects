# 04.07 — Sliding-window VIO backend with GPU marginalization

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Sliding-window VIO backend with GPU marginalization`
>
...
1. Open [`build/sliding-window-vio-backend-with-gpu.sln`](build/sliding-window-vio-backend-with-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/sliding-window-vio-backend-with-gpu.exe`.
