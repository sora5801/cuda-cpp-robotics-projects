# ===========================================================================
# run_demo.ps1 — one-command demo for 04.07 (Sliding-window VIO backend with GPU marginalization)
#
...
$Slug       = 'sliding-window-vio-backend-with-gpu'                     # substituted by scaffold.py
