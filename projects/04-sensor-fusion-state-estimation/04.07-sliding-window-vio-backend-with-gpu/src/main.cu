// ===========================================================================
// main.cu — entry point for project 04.07 (Sliding-window VIO backend with GPU marginalization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.07 (sliding-window-vio-backend-with-gpu)\n");
