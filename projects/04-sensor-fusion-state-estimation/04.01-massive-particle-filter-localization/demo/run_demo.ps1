# ===========================================================================
# run_demo.ps1 — one-command demo for 04.01 (Massive particle filter localization (10⁵–10⁶ particles, GPU likelihoods + resampling))
#
...
#
# 04.01: the real implementation is in; this script is unchanged from the
...
# The demo writes demo/out/trajectory_est.csv (git-ignored) — plot est vs gt
# columns to watch the particle cloud track the loop through the map.
#
...
$Slug       = 'massive-particle-filter-localization'                     # substituted by scaffold.py
