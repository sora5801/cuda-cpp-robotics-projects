#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 04.01 (Massive particle filter localization (10⁵–10⁶ particles, GPU likelihoods + resampling))
...
# 04.01: expected_output.txt carries the real implementation's stable lines
...
SLUG='massive-particle-filter-localization'
