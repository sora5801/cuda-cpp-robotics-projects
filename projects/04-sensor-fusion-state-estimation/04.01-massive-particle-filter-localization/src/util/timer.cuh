...
//                  (project 04.01; copied from docs/PROJECT_TEMPLATE
...
//    (per filter step one predict + one weight kernel in stream 0; main.cu
//    brackets the pair — and the verify stage's lone weight kernel — with
//    GpuTimer); multi-stream projects record into their own streams instead.
