# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.01 (Massive particle filter localization (10⁵–10⁶ particles, GPU likelihoods + resampling))
#
...
Write-Host "[download_data] Project 04.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
