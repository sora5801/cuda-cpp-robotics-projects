#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.03 (IMU preintegration on GPU for batch relinearization)
...
echo "[download_data] Project 04.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
