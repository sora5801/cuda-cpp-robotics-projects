# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.03 (IMU preintegration on GPU for batch relinearization)
#
...
Write-Host "[download_data] Project 04.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
