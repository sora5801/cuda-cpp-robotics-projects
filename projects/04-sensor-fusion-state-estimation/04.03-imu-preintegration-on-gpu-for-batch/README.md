# 04.03 — IMU preintegration on GPU for batch relinearization

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `IMU preintegration on GPU for batch relinearization`
>
...
1. Open [`build/imu-preintegration-on-gpu-for-batch.sln`](build/imu-preintegration-on-gpu-for-batch.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/imu-preintegration-on-gpu-for-batch.exe`.
