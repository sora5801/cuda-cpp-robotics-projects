// ===========================================================================
// main.cu — entry point for project 04.03 (IMU preintegration on GPU for batch relinearization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.03 (imu-preintegration-on-gpu-for-batch)\n");
