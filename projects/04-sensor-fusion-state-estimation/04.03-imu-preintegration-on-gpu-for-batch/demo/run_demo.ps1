# ===========================================================================
# run_demo.ps1 — one-command demo for 04.03 (IMU preintegration on GPU for batch relinearization)
#
...
$Slug       = 'imu-preintegration-on-gpu-for-batch'                     # substituted by scaffold.py
