# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.10 (Zero-velocity detection on high-rate IMU streams)
#
...
Write-Host "[download_data] Project 04.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
