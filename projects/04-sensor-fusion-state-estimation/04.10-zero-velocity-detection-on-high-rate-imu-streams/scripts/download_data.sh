#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.10 (Zero-velocity detection on high-rate IMU streams)
...
echo "[download_data] Project 04.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
