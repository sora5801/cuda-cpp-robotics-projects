# 04.10 — Zero-velocity detection on high-rate IMU streams

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Zero-velocity detection on high-rate IMU streams`
>
...
1. Open [`build/zero-velocity-detection-on-high-rate-imu-streams.sln`](build/zero-velocity-detection-on-high-rate-imu-streams.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/zero-velocity-detection-on-high-rate-imu-streams.exe`.
