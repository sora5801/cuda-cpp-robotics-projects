# ===========================================================================
# run_demo.ps1 — one-command demo for 04.10 (Zero-velocity detection on high-rate IMU streams)
#
...
$Slug       = 'zero-velocity-detection-on-high-rate-imu-streams'                     # substituted by scaffold.py
