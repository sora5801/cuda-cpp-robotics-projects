// ===========================================================================
// main.cu — entry point for project 04.10 (Zero-velocity detection on high-rate IMU streams)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.10 (zero-velocity-detection-on-high-rate-imu-streams)\n");
