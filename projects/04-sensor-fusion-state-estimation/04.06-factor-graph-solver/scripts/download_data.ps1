# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.06 (Factor-graph solver: GPU sparse Cholesky + Schur complement (mini-GTSAM))
#
...
Write-Host "[download_data] Project 04.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
