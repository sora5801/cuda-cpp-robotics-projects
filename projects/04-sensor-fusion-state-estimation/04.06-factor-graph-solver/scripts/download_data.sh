#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.06 (Factor-graph solver: GPU sparse Cholesky + Schur complement (mini-GTSAM))
...
echo "[download_data] Project 04.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
