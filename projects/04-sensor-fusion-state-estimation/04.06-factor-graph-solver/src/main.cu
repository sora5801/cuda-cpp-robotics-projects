// ===========================================================================
// main.cu — entry point for project 04.06 (Factor-graph solver: GPU sparse Cholesky + Schur complement (mini-GTSAM))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.06 (factor-graph-solver)\n");
