# ===========================================================================
# run_demo.ps1 — one-command demo for 04.06 (Factor-graph solver: GPU sparse Cholesky + Schur complement (mini-GTSAM))
#
...
$Slug       = 'factor-graph-solver'                     # substituted by scaffold.py
