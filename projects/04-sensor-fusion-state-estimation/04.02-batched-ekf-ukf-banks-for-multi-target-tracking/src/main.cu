// ===========================================================================
// main.cu — entry point for project 04.02 (Batched EKF/UKF banks for multi-target tracking)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.02 (batched-ekf-ukf-banks-for-multi-target-tracking)\n");
