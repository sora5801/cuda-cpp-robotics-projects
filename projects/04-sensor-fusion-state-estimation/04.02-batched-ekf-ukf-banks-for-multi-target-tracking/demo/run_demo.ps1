# ===========================================================================
# run_demo.ps1 — one-command demo for 04.02 (Batched EKF/UKF banks for multi-target tracking)
#
...
$Slug       = 'batched-ekf-ukf-banks-for-multi-target-tracking'                     # substituted by scaffold.py
