# 04.02 — Batched EKF/UKF banks for multi-target tracking

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Batched EKF/UKF banks for multi-target tracking`
>
...
1. Open [`build/batched-ekf-ukf-banks-for-multi-target-tracking.sln`](build/batched-ekf-ukf-banks-for-multi-target-tracking.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-ekf-ukf-banks-for-multi-target-tracking.exe`.
