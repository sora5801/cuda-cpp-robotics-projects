#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.02 (Batched EKF/UKF banks for multi-target tracking)
...
echo "[download_data] Project 04.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
