# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.02 (Batched EKF/UKF banks for multi-target tracking)
#
...
Write-Host "[download_data] Project 04.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
