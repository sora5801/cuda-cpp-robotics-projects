#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.11 (Wheel-slip-aware odometry fusion)
...
echo "[download_data] Project 04.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
