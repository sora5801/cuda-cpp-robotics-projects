# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.11 (Wheel-slip-aware odometry fusion)
#
...
Write-Host "[download_data] Project 04.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
