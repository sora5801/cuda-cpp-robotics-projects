# 04.11 — Wheel-slip-aware odometry fusion

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Wheel-slip-aware odometry fusion`
>
...
1. Open [`build/wheel-slip-aware-odometry-fusion.sln`](build/wheel-slip-aware-odometry-fusion.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/wheel-slip-aware-odometry-fusion.exe`.
