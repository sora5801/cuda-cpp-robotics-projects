// ===========================================================================
// main.cu — entry point for project 04.11 (Wheel-slip-aware odometry fusion)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.11 (wheel-slip-aware-odometry-fusion)\n");
