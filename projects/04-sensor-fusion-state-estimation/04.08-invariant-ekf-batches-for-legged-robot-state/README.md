# 04.08 — Invariant EKF batches for legged-robot state estimation

**Difficulty:** intermediate · **Domain:** 4. Sensor Fusion & State Estimation

> Catalog bullet (source of truth, verbatim): `Invariant EKF batches for legged-robot state estimation`
>
...
1. Open [`build/invariant-ekf-batches-for-legged-robot-state.sln`](build/invariant-ekf-batches-for-legged-robot-state.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/invariant-ekf-batches-for-legged-robot-state.exe`.
