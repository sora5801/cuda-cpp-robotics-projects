#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 04.08 (Invariant EKF batches for legged-robot state estimation)
...
echo "[download_data] Project 04.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
