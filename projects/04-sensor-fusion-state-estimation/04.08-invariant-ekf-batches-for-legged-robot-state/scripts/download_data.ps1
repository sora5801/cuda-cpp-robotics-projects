# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 04.08 (Invariant EKF batches for legged-robot state estimation)
#
...
Write-Host "[download_data] Project 04.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
