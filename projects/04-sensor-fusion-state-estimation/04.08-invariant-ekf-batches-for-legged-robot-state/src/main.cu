// ===========================================================================
// main.cu — entry point for project 04.08 (Invariant EKF batches for legged-robot state estimation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 04.08 (invariant-ekf-batches-for-legged-robot-state)\n");
