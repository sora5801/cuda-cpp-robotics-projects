# ===========================================================================
# run_demo.ps1 — one-command demo for 04.08 (Invariant EKF batches for legged-robot state estimation)
#
...
$Slug       = 'invariant-ekf-batches-for-legged-robot-state'                     # substituted by scaffold.py
