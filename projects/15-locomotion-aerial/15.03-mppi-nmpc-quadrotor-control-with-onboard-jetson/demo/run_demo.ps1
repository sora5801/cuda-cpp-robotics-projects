# ===========================================================================
# run_demo.ps1 — one-command demo for 15.03 (MPPI/NMPC quadrotor control with onboard Jetson)
#
...
$Slug       = 'mppi-nmpc-quadrotor-control-with-onboard-jetson'                     # substituted by scaffold.py
