#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.03 (MPPI/NMPC quadrotor control with onboard Jetson)
...
echo "[download_data] Project 15.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
