# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.03 (MPPI/NMPC quadrotor control with onboard Jetson)
#
...
Write-Host "[download_data] Project 15.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
