// ===========================================================================
// main.cu — entry point for project 15.03 (MPPI/NMPC quadrotor control with onboard Jetson)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 15.03 (mppi-nmpc-quadrotor-control-with-onboard-jetson)\n");
