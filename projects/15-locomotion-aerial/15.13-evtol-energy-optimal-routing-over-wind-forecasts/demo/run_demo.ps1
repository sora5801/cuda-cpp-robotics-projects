# ===========================================================================
# run_demo.ps1 — one-command demo for 15.13 (eVTOL energy-optimal routing over wind forecasts)
#
...
$Slug       = 'evtol-energy-optimal-routing-over-wind-forecasts'                     # substituted by scaffold.py
