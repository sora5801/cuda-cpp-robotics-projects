// ===========================================================================
// main.cu — entry point for project 15.13 (eVTOL energy-optimal routing over wind forecasts)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 15.13 (evtol-energy-optimal-routing-over-wind-forecasts)\n");
