# 15.13 — eVTOL energy-optimal routing over wind forecasts

**Difficulty:** intermediate · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `eVTOL energy-optimal routing over wind forecasts`
>
...
1. Open [`build/evtol-energy-optimal-routing-over-wind-forecasts.sln`](build/evtol-energy-optimal-routing-over-wind-forecasts.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/evtol-energy-optimal-routing-over-wind-forecasts.exe`.
