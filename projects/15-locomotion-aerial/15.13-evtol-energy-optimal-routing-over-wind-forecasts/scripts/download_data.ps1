# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.13 (eVTOL energy-optimal routing over wind forecasts)
#
...
Write-Host "[download_data] Project 15.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
