#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.13 (eVTOL energy-optimal routing over wind forecasts)
...
echo "[download_data] Project 15.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
