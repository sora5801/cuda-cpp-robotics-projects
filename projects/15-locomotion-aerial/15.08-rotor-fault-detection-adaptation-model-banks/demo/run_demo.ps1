# ===========================================================================
# run_demo.ps1 — one-command demo for 15.08 (Rotor fault detection/adaptation model banks)
#
...
$Slug       = 'rotor-fault-detection-adaptation-model-banks'                     # substituted by scaffold.py
