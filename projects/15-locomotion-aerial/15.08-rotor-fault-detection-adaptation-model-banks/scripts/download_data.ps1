# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.08 (Rotor fault detection/adaptation model banks)
#
...
Write-Host "[download_data] Project 15.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
