# 15.08 — Rotor fault detection/adaptation model banks

**Difficulty:** intermediate · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Rotor fault detection/adaptation model banks`
>
...
1. Open [`build/rotor-fault-detection-adaptation-model-banks.sln`](build/rotor-fault-detection-adaptation-model-banks.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/rotor-fault-detection-adaptation-model-banks.exe`.
