#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.04 (Drone racing: fused gate-detection + state-estimation pipeline)
...
echo "[download_data] Project 15.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
