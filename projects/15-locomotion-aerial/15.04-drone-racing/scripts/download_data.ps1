# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.04 (Drone racing: fused gate-detection + state-estimation pipeline)
#
...
Write-Host "[download_data] Project 15.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
