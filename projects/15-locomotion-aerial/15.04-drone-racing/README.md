# 15.04 — Drone racing: fused gate-detection + state-estimation pipeline

**Difficulty:** intermediate · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Drone racing: fused gate-detection + state-estimation pipeline`
>
...
1. Open [`build/drone-racing.sln`](build/drone-racing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/drone-racing.exe`.
