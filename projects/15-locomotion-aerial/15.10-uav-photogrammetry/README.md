# 15.10 — UAV photogrammetry: GPU SfM matching + MVS densification

**Difficulty:** intermediate · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `UAV photogrammetry: GPU SfM matching + MVS densification`
>
...
1. Open [`build/uav-photogrammetry.sln`](build/uav-photogrammetry.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/uav-photogrammetry.exe`.
