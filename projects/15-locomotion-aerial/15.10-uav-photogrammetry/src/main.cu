// ===========================================================================
// main.cu — entry point for project 15.10 (UAV photogrammetry: GPU SfM matching + MVS densification)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 15.10 (uav-photogrammetry)\n");
