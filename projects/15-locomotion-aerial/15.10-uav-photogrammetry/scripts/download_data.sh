#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.10 (UAV photogrammetry: GPU SfM matching + MVS densification)
...
echo "[download_data] Project 15.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
