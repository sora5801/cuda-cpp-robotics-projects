# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.10 (UAV photogrammetry: GPU SfM matching + MVS densification)
#
...
Write-Host "[download_data] Project 15.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
