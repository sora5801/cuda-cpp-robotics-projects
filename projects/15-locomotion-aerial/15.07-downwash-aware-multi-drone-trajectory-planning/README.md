# 15.07 — Downwash-aware multi-drone trajectory planning

**Difficulty:** [R&D] research · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Downwash-aware multi-drone trajectory planning [R&D]`
>
...
Downwash-aware multi-drone trajectory planning
...
1. Open [`build/downwash-aware-multi-drone-trajectory-planning.sln`](build/downwash-aware-multi-drone-trajectory-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/downwash-aware-multi-drone-trajectory-planning.exe`.
