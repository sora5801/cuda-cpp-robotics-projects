#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.07 (Downwash-aware multi-drone trajectory planning)
...
echo "[download_data] Project 15.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
