# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.07 (Downwash-aware multi-drone trajectory planning)
#
...
Write-Host "[download_data] Project 15.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
