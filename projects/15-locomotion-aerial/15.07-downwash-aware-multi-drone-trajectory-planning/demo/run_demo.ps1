# ===========================================================================
# run_demo.ps1 — one-command demo for 15.07 (Downwash-aware multi-drone trajectory planning)
#
...
$Slug       = 'downwash-aware-multi-drone-trajectory-planning'                     # substituted by scaffold.py
