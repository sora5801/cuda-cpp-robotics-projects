// ===========================================================================
// main.cu — entry point for project 15.02 (Time-optimal quadrotor trajectories via GPU multiple shooting)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 15.02 (time-optimal-quadrotor-trajectories-via-gpu)\n");
