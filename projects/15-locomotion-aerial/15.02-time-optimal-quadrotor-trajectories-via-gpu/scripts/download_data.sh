#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.02 (Time-optimal quadrotor trajectories via GPU multiple shooting)
...
echo "[download_data] Project 15.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
