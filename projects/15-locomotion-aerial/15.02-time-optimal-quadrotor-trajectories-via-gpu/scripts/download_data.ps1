# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.02 (Time-optimal quadrotor trajectories via GPU multiple shooting)
#
...
Write-Host "[download_data] Project 15.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
