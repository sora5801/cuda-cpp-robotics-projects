# 15.02 — Time-optimal quadrotor trajectories via GPU multiple shooting

**Difficulty:** [R&D] research · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Time-optimal quadrotor trajectories via GPU multiple shooting [R&D]`
>
...
Time-optimal quadrotor trajectories via GPU multiple shooting
...
1. Open [`build/time-optimal-quadrotor-trajectories-via-gpu.sln`](build/time-optimal-quadrotor-trajectories-via-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/time-optimal-quadrotor-trajectories-via-gpu.exe`.
