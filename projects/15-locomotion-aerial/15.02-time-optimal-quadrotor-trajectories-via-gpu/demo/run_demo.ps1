# ===========================================================================
# run_demo.ps1 — one-command demo for 15.02 (Time-optimal quadrotor trajectories via GPU multiple shooting)
#
...
$Slug       = 'time-optimal-quadrotor-trajectories-via-gpu'                     # substituted by scaffold.py
