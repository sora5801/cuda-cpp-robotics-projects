# 15.06 — Wind-field estimation from flight logs; gust rejection with parallel models

**Difficulty:** intermediate · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Wind-field estimation from flight logs; gust rejection with parallel models`
>
...
1. Open [`build/wind-field-estimation-from-flight-logs-gust.sln`](build/wind-field-estimation-from-flight-logs-gust.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/wind-field-estimation-from-flight-logs-gust.exe`.
