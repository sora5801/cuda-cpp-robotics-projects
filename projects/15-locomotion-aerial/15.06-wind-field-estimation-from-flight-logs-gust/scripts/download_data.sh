#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.06 (Wind-field estimation from flight logs; gust rejection with parallel models)
...
echo "[download_data] Project 15.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
