# ===========================================================================
# run_demo.ps1 — one-command demo for 15.06 (Wind-field estimation from flight logs; gust rejection with parallel models)
#
...
$Slug       = 'wind-field-estimation-from-flight-logs-gust'                     # substituted by scaffold.py
