#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 15.06 (Wind-field estimation from flight logs; gust rejection with parallel models)
...
SLUG='wind-field-estimation-from-flight-logs-gust'
