// ===========================================================================
// main.cu — entry point for project 15.06 (Wind-field estimation from flight logs; gust rejection with parallel models)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 15.06 (wind-field-estimation-from-flight-logs-gust)\n");
