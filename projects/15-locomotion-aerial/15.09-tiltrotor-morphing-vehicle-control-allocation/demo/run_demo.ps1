# ===========================================================================
# run_demo.ps1 — one-command demo for 15.09 (Tiltrotor/morphing-vehicle control allocation)
#
...
$Slug       = 'tiltrotor-morphing-vehicle-control-allocation'                     # substituted by scaffold.py
