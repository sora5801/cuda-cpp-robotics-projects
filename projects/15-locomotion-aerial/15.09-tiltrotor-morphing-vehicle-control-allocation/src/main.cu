// ===========================================================================
// main.cu — entry point for project 15.09 (Tiltrotor/morphing-vehicle control allocation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 15.09 (tiltrotor-morphing-vehicle-control-allocation)\n");
