# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.09 (Tiltrotor/morphing-vehicle control allocation)
#
...
Write-Host "[download_data] Project 15.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
