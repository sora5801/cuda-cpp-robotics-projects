#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.09 (Tiltrotor/morphing-vehicle control allocation)
...
echo "[download_data] Project 15.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
