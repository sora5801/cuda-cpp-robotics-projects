# 15.09 — Tiltrotor/morphing-vehicle control allocation

**Difficulty:** [R&D] research · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Tiltrotor/morphing-vehicle control allocation [R&D]`
>
...
Tiltrotor/morphing-vehicle control allocation
...
1. Open [`build/tiltrotor-morphing-vehicle-control-allocation.sln`](build/tiltrotor-morphing-vehicle-control-allocation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tiltrotor-morphing-vehicle-control-allocation.exe`.
