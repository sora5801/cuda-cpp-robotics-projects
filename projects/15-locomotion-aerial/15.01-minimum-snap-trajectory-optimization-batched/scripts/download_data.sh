#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.01 (Minimum-snap trajectory optimization batched over waypoint sets)
# (Linux/macOS twin of download_data.ps1 — keep the two in sync.)
#
# 15.01 DECISION: no public dataset applies (see download_data.ps1's fuller
# comment) — waypoint sets are generated, not recorded. This script stays
...
echo "[download_data] Project 15.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
