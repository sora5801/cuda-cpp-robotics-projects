...
//                  (project 15.01; copied from docs/PROJECT_TEMPLATE
...
//    (one batched kernel launch covers the whole K-set batch), so no
//    adaptation is needed; multi-stream projects would record into their
//    own streams instead.
