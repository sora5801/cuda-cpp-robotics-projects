#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 15.01 (Minimum-snap trajectory optimization batched over waypoint sets)
...
# 15.01: expected_output.txt carries the real implementation's stable lines
...
SLUG='minimum-snap-trajectory-optimization-batched'
