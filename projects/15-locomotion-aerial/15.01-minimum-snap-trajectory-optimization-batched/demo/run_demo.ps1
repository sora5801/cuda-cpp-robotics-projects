# ===========================================================================
# run_demo.ps1 — one-command demo for 15.01 (Minimum-snap trajectory optimization batched over waypoint sets)
#
...
$Slug       = 'minimum-snap-trajectory-optimization-batched'                     # substituted by scaffold.py
