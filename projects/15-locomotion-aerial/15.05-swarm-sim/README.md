# 15.05 — Swarm sim: 10,000 drones with boids/ORCA collision avoidance

**Difficulty:** ★ beginner · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `★ Swarm sim: 10,000 drones with boids/ORCA collision avoidance`
>
...
1. Open [`build/swarm-sim.sln`](build/swarm-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/swarm-sim.exe`.
