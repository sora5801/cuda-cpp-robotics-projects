# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.05 (Swarm sim: 10,000 drones with boids/ORCA collision avoidance)
#
...
Write-Host "[download_data] Project 15.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
