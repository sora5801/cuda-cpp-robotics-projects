#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.14 (Flapping-wing aerodynamics simulation)
...
echo "[download_data] Project 15.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
