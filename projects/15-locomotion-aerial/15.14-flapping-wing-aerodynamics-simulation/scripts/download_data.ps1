# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.14 (Flapping-wing aerodynamics simulation)
#
...
Write-Host "[download_data] Project 15.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
