# 15.11 — Precision landing: fiducial + optical-flow fusion

**Difficulty:** intermediate · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Precision landing: fiducial + optical-flow fusion`
>
...
1. Open [`build/precision-landing.sln`](build/precision-landing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/precision-landing.exe`.
