# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.11 (Precision landing: fiducial + optical-flow fusion)
#
...
Write-Host "[download_data] Project 15.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
