# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.16 (Perching trajectory optimization)
#
...
Write-Host "[download_data] Project 15.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
