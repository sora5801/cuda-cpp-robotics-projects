#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.16 (Perching trajectory optimization)
...
echo "[download_data] Project 15.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
