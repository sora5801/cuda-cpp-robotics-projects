# 15.16 — Perching trajectory optimization

**Difficulty:** [R&D] research · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Perching trajectory optimization [R&D]`
>
...
Perching trajectory optimization
...
1. Open [`build/perching-trajectory-optimization.sln`](build/perching-trajectory-optimization.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/perching-trajectory-optimization.exe`.
