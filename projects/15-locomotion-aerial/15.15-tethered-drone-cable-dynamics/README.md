# 15.15 — Tethered-drone cable dynamics

**Difficulty:** intermediate · **Domain:** 15. Locomotion — Aerial

> Catalog bullet (source of truth, verbatim): `Tethered-drone cable dynamics`
>
...
1. Open [`build/tethered-drone-cable-dynamics.sln`](build/tethered-drone-cable-dynamics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tethered-drone-cable-dynamics.exe`.
