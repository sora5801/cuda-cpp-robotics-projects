#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 15.15 (Tethered-drone cable dynamics)
...
echo "[download_data] Project 15.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
