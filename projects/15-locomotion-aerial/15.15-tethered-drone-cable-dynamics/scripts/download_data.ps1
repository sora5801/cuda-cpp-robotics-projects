# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 15.15 (Tethered-drone cable dynamics)
#
...
Write-Host "[download_data] Project 15.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
