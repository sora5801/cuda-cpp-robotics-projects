// ===========================================================================
// main.cu — entry point for project 15.15 (Tethered-drone cable dynamics)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 15.15 (tethered-drone-cable-dynamics)\n");
