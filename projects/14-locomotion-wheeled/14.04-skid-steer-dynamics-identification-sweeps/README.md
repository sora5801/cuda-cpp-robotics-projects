# 14.04 — Skid-steer dynamics identification sweeps

**Difficulty:** intermediate · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Skid-steer dynamics identification sweeps`
>
...
1. Open [`build/skid-steer-dynamics-identification-sweeps.sln`](build/skid-steer-dynamics-identification-sweeps.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/skid-steer-dynamics-identification-sweeps.exe`.
