# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.04 (Skid-steer dynamics identification sweeps)
#
...
Write-Host "[download_data] Project 14.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
