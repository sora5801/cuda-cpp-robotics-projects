#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.04 (Skid-steer dynamics identification sweeps)
...
echo "[download_data] Project 14.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
