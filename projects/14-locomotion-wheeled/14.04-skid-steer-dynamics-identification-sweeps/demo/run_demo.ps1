# ===========================================================================
# run_demo.ps1 — one-command demo for 14.04 (Skid-steer dynamics identification sweeps)
#
...
$Slug       = 'skid-steer-dynamics-identification-sweeps'                     # substituted by scaffold.py
