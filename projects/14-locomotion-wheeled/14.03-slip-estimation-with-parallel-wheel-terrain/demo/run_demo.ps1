# ===========================================================================
# run_demo.ps1 — one-command demo for 14.03 (Slip estimation with parallel wheel-terrain model banks)
#
...
$Slug       = 'slip-estimation-with-parallel-wheel-terrain'                     # substituted by scaffold.py
