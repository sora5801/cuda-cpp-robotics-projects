# 14.03 — Slip estimation with parallel wheel-terrain model banks

**Difficulty:** intermediate · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Slip estimation with parallel wheel-terrain model banks`
>
...
1. Open [`build/slip-estimation-with-parallel-wheel-terrain.sln`](build/slip-estimation-with-parallel-wheel-terrain.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/slip-estimation-with-parallel-wheel-terrain.exe`.
