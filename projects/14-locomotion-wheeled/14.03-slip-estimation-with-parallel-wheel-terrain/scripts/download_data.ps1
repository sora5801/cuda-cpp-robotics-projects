# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.03 (Slip estimation with parallel wheel-terrain model banks)
#
...
Write-Host "[download_data] Project 14.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
