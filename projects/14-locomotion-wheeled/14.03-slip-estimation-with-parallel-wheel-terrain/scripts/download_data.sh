#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.03 (Slip estimation with parallel wheel-terrain model banks)
...
echo "[download_data] Project 14.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
