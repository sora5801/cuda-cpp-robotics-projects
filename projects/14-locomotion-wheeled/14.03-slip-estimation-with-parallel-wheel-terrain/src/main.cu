// ===========================================================================
// main.cu — entry point for project 14.03 (Slip estimation with parallel wheel-terrain model banks)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 14.03 (slip-estimation-with-parallel-wheel-terrain)\n");
