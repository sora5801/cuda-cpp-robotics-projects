# 14.06 — Mecanum/omniwheel allocation optimization

**Difficulty:** intermediate · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Mecanum/omniwheel allocation optimization`
>
...
1. Open [`build/mecanum-omniwheel-allocation-optimization.sln`](build/mecanum-omniwheel-allocation-optimization.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mecanum-omniwheel-allocation-optimization.exe`.
