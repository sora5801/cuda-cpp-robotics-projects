# ===========================================================================
# run_demo.ps1 — one-command demo for 14.06 (Mecanum/omniwheel allocation optimization)
#
...
$Slug       = 'mecanum-omniwheel-allocation-optimization'                     # substituted by scaffold.py
