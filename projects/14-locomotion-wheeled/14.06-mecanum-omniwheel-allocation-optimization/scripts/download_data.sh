#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.06 (Mecanum/omniwheel allocation optimization)
...
echo "[download_data] Project 14.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
