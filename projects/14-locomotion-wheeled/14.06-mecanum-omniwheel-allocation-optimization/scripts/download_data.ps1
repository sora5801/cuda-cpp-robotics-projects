# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.06 (Mecanum/omniwheel allocation optimization)
#
...
Write-Host "[download_data] Project 14.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
