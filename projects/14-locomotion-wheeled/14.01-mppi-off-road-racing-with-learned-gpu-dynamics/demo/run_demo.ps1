# ===========================================================================
# run_demo.ps1 — one-command demo for 14.01 (MPPI off-road racing with learned GPU dynamics models)
#
...
$Slug       = 'mppi-off-road-racing-with-learned-gpu-dynamics'                     # substituted by scaffold.py
