# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.01 (MPPI off-road racing with learned GPU dynamics models)
#
...
Write-Host "[download_data] Project 14.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
