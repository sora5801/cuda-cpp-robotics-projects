#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.01 (MPPI off-road racing with learned GPU dynamics models)
...
echo "[download_data] Project 14.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
