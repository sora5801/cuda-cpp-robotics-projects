// ===========================================================================
// main.cu — entry point for project 14.01 (MPPI off-road racing with learned GPU dynamics models)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 14.01 (mppi-off-road-racing-with-learned-gpu-dynamics)\n");
