# 14.01 — MPPI off-road racing with learned GPU dynamics models

**Difficulty:** ★ beginner · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `★ MPPI off-road racing with learned GPU dynamics models`
>
...
1. Open [`build/mppi-off-road-racing-with-learned-gpu-dynamics.sln`](build/mppi-off-road-racing-with-learned-gpu-dynamics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mppi-off-road-racing-with-learned-gpu-dynamics.exe`.
