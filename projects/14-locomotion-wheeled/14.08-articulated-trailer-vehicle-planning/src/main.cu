// ===========================================================================
// main.cu — entry point for project 14.08 (Articulated/trailer vehicle planning with jackknife-avoidance rollouts)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 14.08 (articulated-trailer-vehicle-planning)\n");
