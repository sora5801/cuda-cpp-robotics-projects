#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.08 (Articulated/trailer vehicle planning with jackknife-avoidance rollouts)
...
echo "[download_data] Project 14.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
