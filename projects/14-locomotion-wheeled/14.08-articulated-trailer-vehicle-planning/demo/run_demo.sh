#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 14.08 (Articulated/trailer vehicle planning with jackknife-avoidance rollouts)
...
SLUG='articulated-trailer-vehicle-planning'
