# ===========================================================================
# run_demo.ps1 — one-command demo for 14.08 (Articulated/trailer vehicle planning with jackknife-avoidance rollouts)
#
...
$Slug       = 'articulated-trailer-vehicle-planning'                     # substituted by scaffold.py
