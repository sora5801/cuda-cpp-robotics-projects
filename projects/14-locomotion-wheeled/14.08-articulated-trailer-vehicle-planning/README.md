# 14.08 — Articulated/trailer vehicle planning with jackknife-avoidance rollouts

**Difficulty:** intermediate · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Articulated/trailer vehicle planning with jackknife-avoidance rollouts`
>
...
1. Open [`build/articulated-trailer-vehicle-planning.sln`](build/articulated-trailer-vehicle-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/articulated-trailer-vehicle-planning.exe`.
