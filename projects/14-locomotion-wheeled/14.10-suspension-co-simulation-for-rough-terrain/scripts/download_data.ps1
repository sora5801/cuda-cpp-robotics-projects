# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.10 (Suspension co-simulation for rough terrain)
#
...
Write-Host "[download_data] Project 14.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
