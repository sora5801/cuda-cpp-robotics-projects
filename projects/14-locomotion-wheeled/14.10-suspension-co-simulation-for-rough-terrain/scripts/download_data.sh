#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.10 (Suspension co-simulation for rough terrain)
...
echo "[download_data] Project 14.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
