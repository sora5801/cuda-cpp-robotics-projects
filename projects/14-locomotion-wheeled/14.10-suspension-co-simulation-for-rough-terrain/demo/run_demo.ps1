# ===========================================================================
# run_demo.ps1 — one-command demo for 14.10 (Suspension co-simulation for rough terrain)
#
...
$Slug       = 'suspension-co-simulation-for-rough-terrain'                     # substituted by scaffold.py
