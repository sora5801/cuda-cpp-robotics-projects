# 14.10 — Suspension co-simulation for rough terrain

**Difficulty:** intermediate · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Suspension co-simulation for rough terrain`
>
...
1. Open [`build/suspension-co-simulation-for-rough-terrain.sln`](build/suspension-co-simulation-for-rough-terrain.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/suspension-co-simulation-for-rough-terrain.exe`.
