# ===========================================================================
# run_demo.ps1 — one-command demo for 14.02 (Traversability costmaps fusing semantics + geometry)
#
...
#
# This script needed NO changes for the real implementation: it builds
# whatever .sln/.vcxproj it finds and diffs the real executable's stable
# lines against expected_output.txt (see the "output contract" comment in
# ../src/main.cu) — the same generic contract every project in this repo
# shares.
#
...
$Slug       = 'traversability-costmaps-fusing-semantics'                     # substituted by scaffold.py
