#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 14.02 (Traversability costmaps fusing semantics + geometry)
...
# expected_output.txt's stable lines are kept in sync with main.cu's actual
# stdout (see the "output contract" comment in ../src/main.cu) in every commit.
# ===========================================================================
set -euo pipefail
...
SLUG='traversability-costmaps-fusing-semantics'
