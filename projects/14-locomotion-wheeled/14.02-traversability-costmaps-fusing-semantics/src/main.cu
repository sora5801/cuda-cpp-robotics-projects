// ===========================================================================
// main.cu — entry point for project 14.02 (Traversability costmaps fusing semantics + geometry)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 14.02 (traversability-costmaps-fusing-semantics)\n");
