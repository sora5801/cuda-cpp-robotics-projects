# 14.05 — Tire-friction estimation Monte Carlo for high-speed driving

**Difficulty:** intermediate · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Tire-friction estimation Monte Carlo for high-speed driving`
>
...
1. Open [`build/tire-friction-estimation-monte-carlo-for-high.sln`](build/tire-friction-estimation-monte-carlo-for-high.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tire-friction-estimation-monte-carlo-for-high.exe`.
