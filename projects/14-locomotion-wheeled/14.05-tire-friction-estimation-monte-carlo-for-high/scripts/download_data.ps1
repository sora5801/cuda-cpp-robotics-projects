# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.05 (Tire-friction estimation Monte Carlo for high-speed driving)
#
...
Write-Host "[download_data] Project 14.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
