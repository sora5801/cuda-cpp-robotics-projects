// ===========================================================================
// main.cu — entry point for project 14.05 (Tire-friction estimation Monte Carlo for high-speed driving)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 14.05 (tire-friction-estimation-monte-carlo-for-high)\n");
