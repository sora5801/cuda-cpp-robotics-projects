# ===========================================================================
# run_demo.ps1 — one-command demo for 14.05 (Tire-friction estimation Monte Carlo for high-speed driving)
#
...
$Slug       = 'tire-friction-estimation-monte-carlo-for-high'                     # substituted by scaffold.py
