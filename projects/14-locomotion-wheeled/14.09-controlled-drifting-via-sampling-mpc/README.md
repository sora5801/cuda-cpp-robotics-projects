# 14.09 — Controlled drifting via sampling MPC

**Difficulty:** [R&D] research · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Controlled drifting via sampling MPC [R&D]`
>
...
Controlled drifting via sampling MPC
...
1. Open [`build/controlled-drifting-via-sampling-mpc.sln`](build/controlled-drifting-via-sampling-mpc.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/controlled-drifting-via-sampling-mpc.exe`.
