// ===========================================================================
// main.cu — entry point for project 14.09 (Controlled drifting via sampling MPC)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 14.09 (controlled-drifting-via-sampling-mpc)\n");
