#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.09 (Controlled drifting via sampling MPC)
...
echo "[download_data] Project 14.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
