# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.09 (Controlled drifting via sampling MPC)
#
...
Write-Host "[download_data] Project 14.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
