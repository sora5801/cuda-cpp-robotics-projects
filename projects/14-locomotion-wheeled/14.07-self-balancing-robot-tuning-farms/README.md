# 14.07 — Self-balancing robot tuning farms

**Difficulty:** intermediate · **Domain:** 14. Locomotion — Wheeled & Tracked

> Catalog bullet (source of truth, verbatim): `Self-balancing robot tuning farms`
>
...
1. Open [`build/self-balancing-robot-tuning-farms.sln`](build/self-balancing-robot-tuning-farms.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/self-balancing-robot-tuning-farms.exe`.
