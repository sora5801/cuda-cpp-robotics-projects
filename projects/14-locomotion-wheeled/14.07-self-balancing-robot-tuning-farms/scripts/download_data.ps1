# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 14.07 (Self-balancing robot tuning farms)
#
...
Write-Host "[download_data] Project 14.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
