#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 14.07 (Self-balancing robot tuning farms)
...
echo "[download_data] Project 14.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
