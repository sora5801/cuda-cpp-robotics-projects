// ===========================================================================
// main.cu — entry point for project 14.07 (Self-balancing robot tuning farms)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 14.07 (self-balancing-robot-tuning-farms)\n");
