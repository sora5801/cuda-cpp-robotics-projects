// ===========================================================================
// main.cu — entry point for project 20.02 (E-skin taxel arrays: contact clustering + force reconstruction (inverse FEM))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 20.02 (e-skin-taxel-arrays)\n");
