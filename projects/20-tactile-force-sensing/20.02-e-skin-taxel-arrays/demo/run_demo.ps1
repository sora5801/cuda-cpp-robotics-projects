# ===========================================================================
# run_demo.ps1 — one-command demo for 20.02 (E-skin taxel arrays: contact clustering + force reconstruction (inverse FEM))
#
...
$Slug       = 'e-skin-taxel-arrays'                     # substituted by scaffold.py
