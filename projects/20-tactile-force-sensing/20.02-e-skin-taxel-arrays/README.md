# 20.02 — E-skin taxel arrays: contact clustering + force reconstruction (inverse FEM)

**Difficulty:** [R&D] research · **Domain:** 20. Tactile & Force Sensing

> Catalog bullet (source of truth, verbatim): `E-skin taxel arrays: contact clustering + force reconstruction (inverse FEM) [R&D]`
>
...
E-skin taxel arrays: contact clustering + force reconstruction (inverse FEM)
...
1. Open [`build/e-skin-taxel-arrays.sln`](build/e-skin-taxel-arrays.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/e-skin-taxel-arrays.exe`.
