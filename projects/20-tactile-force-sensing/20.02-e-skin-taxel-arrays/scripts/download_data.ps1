# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 20.02 (E-skin taxel arrays: contact clustering + force reconstruction (inverse FEM))
#
...
Write-Host "[download_data] Project 20.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
