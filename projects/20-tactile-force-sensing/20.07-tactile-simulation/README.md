# 20.07 — Tactile simulation: FEM gel deformation + rendering for sim-to-real

**Difficulty:** [R&D] research · **Domain:** 20. Tactile & Force Sensing

> Catalog bullet (source of truth, verbatim): `Tactile simulation: FEM gel deformation + rendering for sim-to-real [R&D]`
>
...
Tactile simulation: FEM gel deformation + rendering for sim-to-real
...
1. Open [`build/tactile-simulation.sln`](build/tactile-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tactile-simulation.exe`.
