# ===========================================================================
# run_demo.ps1 — one-command demo for 20.07 (Tactile simulation: FEM gel deformation + rendering for sim-to-real)
#
...
$Slug       = 'tactile-simulation'                     # substituted by scaffold.py
