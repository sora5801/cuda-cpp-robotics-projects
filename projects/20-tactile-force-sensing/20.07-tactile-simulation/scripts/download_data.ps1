# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 20.07 (Tactile simulation: FEM gel deformation + rendering for sim-to-real)
#
...
Write-Host "[download_data] Project 20.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
