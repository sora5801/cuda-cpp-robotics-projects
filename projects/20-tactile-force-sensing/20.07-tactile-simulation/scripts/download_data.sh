#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 20.07 (Tactile simulation: FEM gel deformation + rendering for sim-to-real)
...
echo "[download_data] Project 20.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
