// ===========================================================================
// main.cu — entry point for project 20.07 (Tactile simulation: FEM gel deformation + rendering for sim-to-real)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 20.07 (tactile-simulation)\n");
