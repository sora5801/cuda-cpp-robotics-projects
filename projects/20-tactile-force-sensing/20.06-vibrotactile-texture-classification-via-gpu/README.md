# 20.06 — Vibrotactile texture classification via GPU spectrograms

**Difficulty:** intermediate · **Domain:** 20. Tactile & Force Sensing

> Catalog bullet (source of truth, verbatim): `Vibrotactile texture classification via GPU spectrograms`
>
...
1. Open [`build/vibrotactile-texture-classification-via-gpu.sln`](build/vibrotactile-texture-classification-via-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/vibrotactile-texture-classification-via-gpu.exe`.
