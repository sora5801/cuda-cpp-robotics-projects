#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 20.06 (Vibrotactile texture classification via GPU spectrograms)
...
echo "[download_data] Project 20.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
