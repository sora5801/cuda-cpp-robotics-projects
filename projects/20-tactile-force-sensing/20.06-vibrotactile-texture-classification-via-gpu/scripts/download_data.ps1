# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 20.06 (Vibrotactile texture classification via GPU spectrograms)
#
...
Write-Host "[download_data] Project 20.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
