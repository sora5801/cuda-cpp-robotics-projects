# ===========================================================================
# run_demo.ps1 — one-command demo for 20.06 (Vibrotactile texture classification via GPU spectrograms)
#
...
$Slug       = 'vibrotactile-texture-classification-via-gpu'                     # substituted by scaffold.py
