// ===========================================================================
// main.cu — entry point for project 20.06 (Vibrotactile texture classification via GPU spectrograms)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 20.06 (vibrotactile-texture-classification-via-gpu)\n");
