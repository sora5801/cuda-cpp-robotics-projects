# ===========================================================================
# run_demo.ps1 — one-command demo for 20.01 (GelSight/DIGIT processing: contact patch, shear field via optical flow, slip detection in real time)
#
...
# The demo writes demo/out/contact_mask.pgm, shear_field.csv, and
# slip_timeline.csv (git-ignored) — see demo/README.md for what each shows.
#
...
$Slug       = 'gelsight-digit-processing'                     # substituted by scaffold.py
