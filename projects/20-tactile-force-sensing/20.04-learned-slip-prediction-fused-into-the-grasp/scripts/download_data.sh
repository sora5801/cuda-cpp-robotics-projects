#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 20.04 (Learned slip prediction fused into the grasp control loop)
...
echo "[download_data] Project 20.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
