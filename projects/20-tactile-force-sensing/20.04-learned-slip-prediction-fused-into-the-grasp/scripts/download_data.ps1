# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 20.04 (Learned slip prediction fused into the grasp control loop)
#
...
Write-Host "[download_data] Project 20.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
