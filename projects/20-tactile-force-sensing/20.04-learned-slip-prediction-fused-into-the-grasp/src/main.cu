// ===========================================================================
// main.cu — entry point for project 20.04 (Learned slip prediction fused into the grasp control loop)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 20.04 (learned-slip-prediction-fused-into-the-grasp)\n");
