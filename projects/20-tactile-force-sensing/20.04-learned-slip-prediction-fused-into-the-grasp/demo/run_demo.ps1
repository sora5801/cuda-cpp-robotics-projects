# ===========================================================================
# run_demo.ps1 — one-command demo for 20.04 (Learned slip prediction fused into the grasp control loop)
#
...
$Slug       = 'learned-slip-prediction-fused-into-the-grasp'                     # substituted by scaffold.py
