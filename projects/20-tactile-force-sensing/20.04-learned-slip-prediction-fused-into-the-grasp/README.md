# 20.04 — Learned slip prediction fused into the grasp control loop

**Difficulty:** intermediate · **Domain:** 20. Tactile & Force Sensing

> Catalog bullet (source of truth, verbatim): `Learned slip prediction fused into the grasp control loop`
>
...
1. Open [`build/learned-slip-prediction-fused-into-the-grasp.sln`](build/learned-slip-prediction-fused-into-the-grasp.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/learned-slip-prediction-fused-into-the-grasp.exe`.
