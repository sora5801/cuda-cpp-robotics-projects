# 20.03 — Tactile SLAM: object shape from touch sequences

**Difficulty:** [R&D] research · **Domain:** 20. Tactile & Force Sensing

> Catalog bullet (source of truth, verbatim): `Tactile SLAM: object shape from touch sequences [R&D]`
>
...
Tactile SLAM: object shape from touch sequences
...
1. Open [`build/tactile-slam.sln`](build/tactile-slam.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tactile-slam.exe`.
