# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 20.03 (Tactile SLAM: object shape from touch sequences)
#
...
Write-Host "[download_data] Project 20.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
