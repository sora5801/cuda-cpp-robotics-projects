# 20.05 — F/T processing: batched momentum observers for collision detection

**Difficulty:** intermediate · **Domain:** 20. Tactile & Force Sensing

> Catalog bullet (source of truth, verbatim): `F/T processing: batched momentum observers for collision detection`
>
...
1. Open [`build/f-t-processing.sln`](build/f-t-processing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/f-t-processing.exe`.
