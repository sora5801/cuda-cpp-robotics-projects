// ===========================================================================
// main.cu — entry point for project 20.05 (F/T processing: batched momentum observers for collision detection)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 20.05 (f-t-processing)\n");
