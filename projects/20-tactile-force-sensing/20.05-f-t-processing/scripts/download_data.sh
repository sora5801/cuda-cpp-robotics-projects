#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 20.05 (F/T processing: batched momentum observers for collision detection)
...
echo "[download_data] Project 20.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
