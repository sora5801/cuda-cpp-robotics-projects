# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 20.05 (F/T processing: batched momentum observers for collision detection)
#
...
Write-Host "[download_data] Project 20.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
