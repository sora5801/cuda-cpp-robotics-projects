# ===========================================================================
# run_demo.ps1 — one-command demo for 20.05 (F/T processing: batched momentum observers for collision detection)
#
...
$Slug       = 'f-t-processing'                     # substituted by scaffold.py
