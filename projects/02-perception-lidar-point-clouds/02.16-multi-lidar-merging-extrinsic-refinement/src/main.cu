// ===========================================================================
// main.cu — entry point for project 02.16 (Multi-LiDAR merging + extrinsic refinement)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.16 (multi-lidar-merging-extrinsic-refinement)\n");
