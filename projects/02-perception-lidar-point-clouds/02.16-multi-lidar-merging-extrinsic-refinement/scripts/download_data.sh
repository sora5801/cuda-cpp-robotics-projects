#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 02.16 (Multi-LiDAR merging + extrinsic refinement)
...
echo "[download_data] Project 02.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
