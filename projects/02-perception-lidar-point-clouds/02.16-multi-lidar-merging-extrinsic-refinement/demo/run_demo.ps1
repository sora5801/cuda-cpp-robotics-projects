# ===========================================================================
# run_demo.ps1 — one-command demo for 02.16 (Multi-LiDAR merging + extrinsic refinement)
#
...
#
# RESOLVED: this project's real implementation needed NO changes to this
# script beyond what already shipped with the template — only
# expected_output.txt was regenerated to match the stable lines main.cu
# actually prints (see the "output contract" comment in ../src/main.cu).
#
...
$Slug       = 'multi-lidar-merging-extrinsic-refinement'                     # substituted by scaffold.py
