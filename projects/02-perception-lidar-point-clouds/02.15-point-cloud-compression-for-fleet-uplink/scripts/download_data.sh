#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 02.15 (Point cloud compression (octree/entropy) for fleet uplink)
...
echo "[download_data] Project 02.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
