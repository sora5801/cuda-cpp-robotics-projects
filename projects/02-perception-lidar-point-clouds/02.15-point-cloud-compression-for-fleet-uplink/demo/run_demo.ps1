# ===========================================================================
# run_demo.ps1 — one-command demo for 02.15 (Point cloud compression (octree/entropy) for fleet uplink)
#
...
# just builds, runs, and diffs stdout against expected_output.txt (kept in
# sync with the stable lines ../src/main.cu prints — see that file's
# "output contract" comment).
#
...
$Slug       = 'point-cloud-compression-for-fleet-uplink'                     # substituted by scaffold.py
