#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.15 (Point cloud compression (octree/entropy) for fleet uplink)
...
# expected_output.txt is kept in sync with the stable output lines
# ../src/main.cu prints (see that file's "output contract" comment).
# ===========================================================================
set -euo pipefail
...
SLUG='point-cloud-compression-for-fleet-uplink'
