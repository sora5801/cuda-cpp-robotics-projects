// ===========================================================================
// main.cu — entry point for project 02.15 (Point cloud compression (octree/entropy) for fleet uplink)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.15 (point-cloud-compression-for-fleet-uplink)\n");
