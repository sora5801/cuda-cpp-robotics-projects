// ===========================================================================
// main.cu — entry point for project 02.05 (KD-tree or LBVH construction + KNN/radius search on GPU)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.05 (kd-tree-or-lbvh-construction-knn-radius-search)\n");
