// ===========================================================================
// paths.h — data-file and artifact-directory resolution for project 02.05
//           (KD-tree or LBVH construction + KNN/radius search on GPU)
//
// Role in the project
// -------------------
// Host-only helpers answering the two questions every real project in this
// repository eventually asks:
//
//   1) "Where is data/sample/<file>?"   -> find_data_file()
//   2) "Where do I write demo/out/…?"   -> resolve_out_dir()
//
// main.cu includes this the moment it loads the committed point-cloud/query
// sample and writes its PPM/CSV artifacts (CLAUDE.md §6.3).
//
...
//   filename — the file's name inside data/sample/, e.g. "scan.bin".
