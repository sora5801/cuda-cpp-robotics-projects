#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 02.05 (KD-tree or LBVH construction + KNN/radius search on GPU)
...
echo "[download_data] Project 02.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
