# ===========================================================================
# run_demo.ps1 — one-command demo for 02.05 (KD-tree or LBVH construction + KNN/radius search on GPU)
#
...
# lines main.cu actually prints (see the "output contract" comment in
# ../src/main.cu).
#
...
$Slug       = 'kd-tree-or-lbvh-construction-knn-radius-search'                     # substituted by scaffold.py
