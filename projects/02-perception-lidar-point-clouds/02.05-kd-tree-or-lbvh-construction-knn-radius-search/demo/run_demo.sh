#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.05 (KD-tree or LBVH construction + KNN/radius search on GPU)
...
# expected_output.txt is kept in sync with main.cu's real stable output lines
...
SLUG='kd-tree-or-lbvh-construction-knn-radius-search'
