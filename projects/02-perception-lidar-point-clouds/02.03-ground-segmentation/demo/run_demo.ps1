# ===========================================================================
# run_demo.ps1 — one-command demo for 02.03 (Ground segmentation: RANSAC plane fit; Patchwork++-style GPU port)
#
...
$Slug       = 'ground-segmentation'                     # substituted by scaffold.py
