// ===========================================================================
// main.cu — entry point for project 02.03 (Ground segmentation: RANSAC plane fit; Patchwork++-style GPU port)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.03 (ground-segmentation)\n");
