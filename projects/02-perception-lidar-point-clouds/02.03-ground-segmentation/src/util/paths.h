...
//           02.03 (Ground segmentation: RANSAC plane fit; Patchwork++-style
//           GPU port). Copied verbatim from docs/PROJECT_TEMPLATE/src/util/
//           (project ID filled in) — see util/README.md for the deliberate-
//           duplication rule and 02.01's copy for the ratified precedent.
//
// Role in the project
// -------------------
...
//
// This project loads data/sample/ground_scan.bin and writes several
// demo/out/ artifacts (top-view/side-view PPM renders, per-zone stats CSV,
// gates_metrics.csv) — see main.cu's use of both functions below.
//
...
//   filename — the file's name inside data/sample/, e.g. "ground_scan.bin".
