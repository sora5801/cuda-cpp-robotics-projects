#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 02.13 (Dynamic point removal (raycast free-space carving))
...
echo "[download_data] Project 02.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
