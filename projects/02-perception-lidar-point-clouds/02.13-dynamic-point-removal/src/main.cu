// ===========================================================================
// main.cu — entry point for project 02.13 (Dynamic point removal (raycast free-space carving))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.13 (dynamic-point-removal)\n");
