# ===========================================================================
# run_demo.ps1 — one-command demo for 02.13 (Dynamic point removal (raycast free-space carving))
#
...
#
# 02.13: the real implementation is in; this script is unchanged from the
...
# The demo writes demo/out/triptych.ppm, demo/out/pedestrian_evidence.csv,
# and demo/out/gates_metrics.csv (all git-ignored) — see demo/README.md for
# what each one shows.
#
...
$Slug       = 'dynamic-point-removal'                     # substituted by scaffold.py
