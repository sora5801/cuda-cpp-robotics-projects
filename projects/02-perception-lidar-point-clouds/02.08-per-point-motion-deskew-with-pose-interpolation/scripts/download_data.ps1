# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 02.08 (Per-point motion deskew with pose interpolation)
#
...
Write-Host "[download_data] Project 02.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
