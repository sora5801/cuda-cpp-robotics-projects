// ===========================================================================
// main.cu — entry point for project 02.08 (Per-point motion deskew with pose interpolation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.08 (per-point-motion-deskew-with-pose-interpolation)\n");
