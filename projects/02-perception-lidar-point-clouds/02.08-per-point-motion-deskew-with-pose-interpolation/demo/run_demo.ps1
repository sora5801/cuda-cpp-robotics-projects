# ===========================================================================
# run_demo.ps1 — one-command demo for 02.08 (Per-point motion deskew with pose interpolation)
#
...
#
# This script needed NO changes once the real implementation landed — it
# just builds, runs, and diffs; keep expected_output.txt in sync with the
# stable lines main.cu prints (see the "output contract" comment in
...
$Slug       = 'per-point-motion-deskew-with-pose-interpolation'                     # substituted by scaffold.py
...
# (the provenance/format notes at the top of expected_output.txt are such
# comments, ignored here the same as everywhere else).
