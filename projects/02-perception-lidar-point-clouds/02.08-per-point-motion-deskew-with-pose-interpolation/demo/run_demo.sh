#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.08 (Per-point motion deskew with pose interpolation)
...
# Keep expected_output.txt in sync with main.cu's stable output lines
# whenever they change (see the "output contract" comment in ../src/main.cu).
# ===========================================================================
set -euo pipefail
...
SLUG='per-point-motion-deskew-with-pose-interpolation'
