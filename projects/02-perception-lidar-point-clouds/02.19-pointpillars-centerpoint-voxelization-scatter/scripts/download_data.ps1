# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 02.19 (PointPillars/CenterPoint voxelization + scatter kernels feeding TensorRT)
#
...
Write-Host "[download_data] Project 02.19 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
