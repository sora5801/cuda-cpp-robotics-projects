#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.19 (PointPillars/CenterPoint voxelization + scatter kernels feeding TensorRT)
...
SLUG='pointpillars-centerpoint-voxelization-scatter'
