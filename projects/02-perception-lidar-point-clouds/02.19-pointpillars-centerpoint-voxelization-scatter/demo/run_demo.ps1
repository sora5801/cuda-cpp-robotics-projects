# ===========================================================================
# run_demo.ps1 — one-command demo for 02.19 (PointPillars/CenterPoint voxelization + scatter kernels feeding TensorRT)
#
...
#
# STATUS: this generic build+run+diff harness needed NO changes for the real
# implementation — only expected_output.txt changed, to match the stable
# VERIFY/GATE/RESULT lines main.cu actually prints (see the "output contract"
# comment in ../src/main.cu).
#
...
$Slug       = 'pointpillars-centerpoint-voxelization-scatter'                     # substituted by scaffold.py
