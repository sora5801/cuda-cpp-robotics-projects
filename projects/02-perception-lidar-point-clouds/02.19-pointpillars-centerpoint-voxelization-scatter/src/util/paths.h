...
//           02.19 (PointPillars/CenterPoint voxelization + scatter kernels
//           feeding TensorRT; copied from docs/PROJECT_TEMPLATE — see
...
//
// main.cu uses find_data_file() for points.bin, scene_meta.csv,
// object_truths.csv and pfn_lite_weights.csv, and resolve_out_dir() for the
// PGM/CSV artifacts it writes.
//
...
//   filename — the file's name inside data/sample/, e.g. "points.bin".
