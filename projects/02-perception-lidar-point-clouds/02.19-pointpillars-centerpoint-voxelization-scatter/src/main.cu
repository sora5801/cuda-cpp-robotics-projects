// ===========================================================================
// main.cu — entry point for project 02.19 (PointPillars/CenterPoint voxelization + scatter kernels feeding TensorRT)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.19 (pointpillars-centerpoint-voxelization-scatter)\n");
