# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 02.14 (Moving-object segmentation from sequential scans)
#
...
Write-Host "[download_data] Project 02.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
