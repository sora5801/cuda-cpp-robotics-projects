#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.14 (Moving-object segmentation from sequential scans)
...
# 02.14: the real implementation is in; expected_output.txt carries the real
# stable lines (see the "output contract" comment in ../src/main.cu).
# ===========================================================================
set -euo pipefail
...
SLUG='moving-object-segmentation-from-sequential-scans'
