# ===========================================================================
# run_demo.ps1 — one-command demo for 02.14 (Moving-object segmentation from sequential scans)
#
...
#
# 02.14: the real implementation is in; this script is unchanged from the
...
# The demo writes demo/out/residual_image.pgm, demo/out/label_vs_truth.ppm,
# demo/out/disocclusion_band.ppm, demo/out/per_cohort_metrics.csv, and
# demo/out/gates_metrics.csv (all git-ignored) — see demo/README.md.
#
...
$Slug       = 'moving-object-segmentation-from-sequential-scans'                     # substituted by scaffold.py
...
# (expected_output.txt's own header notes are such comments).
