// ===========================================================================
// main.cu — entry point for project 02.14 (Moving-object segmentation from sequential scans)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.14 (moving-object-segmentation-from-sequential-scans)\n");
