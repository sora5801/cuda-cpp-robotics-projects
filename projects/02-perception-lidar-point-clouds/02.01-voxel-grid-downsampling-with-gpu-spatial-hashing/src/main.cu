// ===========================================================================
// main.cu — entry point for project 02.01 (Voxel-grid downsampling with GPU spatial hashing)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.01 (voxel-grid-downsampling-with-gpu-spatial-hashing)\n");
