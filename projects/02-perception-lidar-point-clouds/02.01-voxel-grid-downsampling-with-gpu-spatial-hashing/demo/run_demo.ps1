# ===========================================================================
# run_demo.ps1 — one-command demo for 02.01 (Voxel-grid downsampling with GPU spatial hashing)
#
...
$Slug       = 'voxel-grid-downsampling-with-gpu-spatial-hashing'                     # substituted by scaffold.py
