// ===========================================================================
// main.cu — entry point for project 02.20 (LiDAR intensity calibration across channels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.20 (lidar-intensity-calibration-across-channels)\n");
