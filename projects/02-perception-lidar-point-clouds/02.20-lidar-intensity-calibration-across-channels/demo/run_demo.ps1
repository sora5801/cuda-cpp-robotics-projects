# ===========================================================================
# run_demo.ps1 — one-command demo for 02.20 (LiDAR intensity calibration across channels)
#
...
#
# This script needed no changes for the real implementation: it builds if
# needed, runs the real intensity-calibration demo, and diffs its stable
# lines against expected_output.txt (kept in sync with main.cu's output
# contract — see the comment at the top of ../src/main.cu).
#
...
$Slug       = 'lidar-intensity-calibration-across-channels'                     # substituted by scaffold.py
...
# (the leading provenance/contract comments at the top of expected_output.txt
# are exactly such lines).
