# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 02.20 (LiDAR intensity calibration across channels)
#
...
Write-Host "[download_data] Project 02.20 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
