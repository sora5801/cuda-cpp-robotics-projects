#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 02.11 (Scan Context / ring-descriptor loop-closure search).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 02.11 (Scan Context / ring-descriptor loop-closure search).")
