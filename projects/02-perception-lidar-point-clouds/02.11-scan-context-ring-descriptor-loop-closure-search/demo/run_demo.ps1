# ===========================================================================
# run_demo.ps1 — one-command demo for 02.11 (Scan Context / ring-descriptor loop-closure search)
#
...
#
# This script needed NO changes from the scaffolded template once the real
# implementation landed — only expected_output.txt changed, to match the
# stable lines main.cu now prints (see the "output contract" comment in
# ../src/main.cu).
#
...
$Slug       = 'scan-context-ring-descriptor-loop-closure-search'                     # substituted by scaffold.py
...
# (the provenance header line at the top of expected_output.txt is such a comment).
