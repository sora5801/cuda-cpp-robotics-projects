// ===========================================================================
// paths.h — data-file and artifact-directory resolution for project 02.11
...
//
// main.cu uses BOTH: find_data_file() locates scans.bin/trajectory.csv/
// loop_pairs.csv/world.csv, and resolve_out_dir() finds demo/out/ for the
// PR-curve CSV, the Scan Context heatmaps, the trajectory view, and
// gates_metrics.csv (CLAUDE.md §6.3).
//
