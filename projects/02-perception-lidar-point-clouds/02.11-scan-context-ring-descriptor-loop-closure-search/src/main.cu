// ===========================================================================
// main.cu — entry point for project 02.11 (Scan Context / ring-descriptor loop-closure search)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.11 (scan-context-ring-descriptor-loop-closure-search)\n");
