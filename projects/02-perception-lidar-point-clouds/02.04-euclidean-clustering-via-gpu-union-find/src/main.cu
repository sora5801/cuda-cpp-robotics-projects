// ===========================================================================
// main.cu — entry point for project 02.04 (Euclidean clustering via GPU union-find / connected components)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.04 (euclidean-clustering-via-gpu-union-find)\n");
