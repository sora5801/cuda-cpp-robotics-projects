#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.04 (Euclidean clustering via GPU union-find / connected components)
...
# expected_output.txt is kept in sync with main.cu's real stable output
...
SLUG='euclidean-clustering-via-gpu-union-find'
