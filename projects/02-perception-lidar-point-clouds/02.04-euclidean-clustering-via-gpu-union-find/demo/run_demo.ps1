# ===========================================================================
# run_demo.ps1 — one-command demo for 02.04 (Euclidean clustering via GPU union-find / connected components)
#
...
#
# STATUS: this generic build+run+diff harness needed NO changes for the
# real implementation — only expected_output.txt changed, to match the
# stable lines main.cu actually prints (see the "output contract" comment
# in ../src/main.cu).
#
...
$Slug       = 'euclidean-clustering-via-gpu-union-find'                     # substituted by scaffold.py
