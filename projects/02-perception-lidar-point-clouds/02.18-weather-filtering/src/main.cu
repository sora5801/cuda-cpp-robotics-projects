// ===========================================================================
// main.cu — entry point for project 02.18 (Weather filtering: snow/rain/dust outlier removal (DROR/LIOR))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.18 (weather-filtering)\n");
