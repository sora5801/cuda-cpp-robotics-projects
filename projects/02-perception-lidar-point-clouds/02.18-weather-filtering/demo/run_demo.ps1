# ===========================================================================
# run_demo.ps1 — one-command demo for 02.18 (Weather filtering: snow/rain/dust outlier removal (DROR/LIOR))
#
...
#
# This script is generic (unchanged from the template): it builds if needed,
# runs the real weather-filtering demo, and diffs its stable lines against
# expected_output.txt. See the "output contract" comment at the top of
# ../src/main.cu for exactly which lines are stable vs. deliberately unchecked.
#
...
$Slug       = 'weather-filtering'                     # substituted by scaffold.py
