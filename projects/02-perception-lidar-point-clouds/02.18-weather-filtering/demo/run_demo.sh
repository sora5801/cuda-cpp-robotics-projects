#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.18 (Weather filtering: snow/rain/dust outlier removal (DROR/LIOR))
...
# See the "output contract" comment at the top of ../src/main.cu for exactly
# which lines are stable vs. deliberately unchecked.
# ===========================================================================
set -euo pipefail
