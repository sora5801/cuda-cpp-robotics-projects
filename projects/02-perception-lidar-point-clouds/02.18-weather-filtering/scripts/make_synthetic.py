#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 02.18 (Weather filtering: snow/rain/dust outlier removal (DROR/LIOR)).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 02.18 (Weather filtering: snow/rain/dust outlier removal (DROR/LIOR)).")
