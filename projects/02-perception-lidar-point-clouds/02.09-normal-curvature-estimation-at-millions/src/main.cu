// ===========================================================================
// main.cu — entry point for project 02.09 (Normal + curvature estimation at millions of points/sec)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.09 (normal-curvature-estimation-at-millions)\n");
