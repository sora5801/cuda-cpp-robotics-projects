# ===========================================================================
# run_demo.ps1 — one-command demo for 02.09 (Normal + curvature estimation at millions of points/sec)
#
...
#
# Unchanged from the scaffold: this script's build-if-missing + subset-diff
# logic needed no project-specific changes for the real implementation —
# only expected_output.txt (kept in sync with main.cu's stable output lines,
# see the "Output contract" comment in ../src/main.cu) changed.
#
...
$Slug       = 'normal-curvature-estimation-at-millions'                     # substituted by scaffold.py
