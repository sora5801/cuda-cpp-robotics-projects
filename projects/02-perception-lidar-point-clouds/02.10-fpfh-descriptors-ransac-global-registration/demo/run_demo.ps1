# ===========================================================================
# run_demo.ps1 — one-command demo for 02.10 (FPFH descriptors + RANSAC global registration)
#
...
$Slug       = 'fpfh-descriptors-ransac-global-registration'                     # substituted by scaffold.py
