#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 02.10 (FPFH descriptors + RANSAC global registration)
...
echo "[download_data] Project 02.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
