// ===========================================================================
// main.cu — entry point for project 02.10 (FPFH descriptors + RANSAC global registration)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.10 (fpfh-descriptors-ransac-global-registration)\n");
