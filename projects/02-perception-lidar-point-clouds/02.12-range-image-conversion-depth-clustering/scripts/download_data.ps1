# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 02.12 (Range-image conversion + depth-clustering segmentation)
#
...
Write-Host "[download_data] Project 02.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
