# ===========================================================================
# run_demo.ps1 — one-command demo for 02.12 (Range-image conversion + depth-clustering segmentation)
#
...
$Slug       = 'range-image-conversion-depth-clustering'                     # substituted by scaffold.py
