// ===========================================================================
// main.cu — entry point for project 02.12 (Range-image conversion + depth-clustering segmentation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.12 (range-image-conversion-depth-clustering)\n");
