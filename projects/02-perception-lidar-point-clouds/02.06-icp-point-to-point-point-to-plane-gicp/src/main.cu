// ===========================================================================
// main.cu — entry point for project 02.06 (ICP: point-to-point → point-to-plane → GICP, all batched)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.06 (icp-point-to-point-point-to-plane-gicp)\n");
