# ===========================================================================
# run_demo.ps1 — one-command demo for 02.06 (ICP: point-to-point → point-to-plane → GICP, all batched)
#
...
#
# This script needed NO changes once the real ICP implementation landed —
# it just builds src/{main,kernels}.cu + reference_cpu.cpp and diffs stdout
# against expected_output.txt, same as every project in the repo. Keep
# expected_output.txt in sync with the stable lines main.cu prints (see the
# "Output contract" comment in ../src/main.cu) whenever they change.
#
...
$Slug       = 'icp-point-to-point-point-to-plane-gicp'                     # substituted by scaffold.py
