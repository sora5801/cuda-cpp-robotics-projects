#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.06 (ICP: point-to-point → point-to-plane → GICP, all batched)
...
# the "Output contract" comment in ../src/main.cu) whenever they change.
# ===========================================================================
set -euo pipefail
...
SLUG='icp-point-to-point-point-to-plane-gicp'
