// ===========================================================================
// main.cu — entry point for project 02.17 (LiDAR-camera projection/coloring fusion kernels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.17 (lidar-camera-projection-coloring-fusion-kernels)\n");
