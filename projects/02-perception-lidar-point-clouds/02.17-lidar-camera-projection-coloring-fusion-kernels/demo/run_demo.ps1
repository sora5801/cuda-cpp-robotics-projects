# ===========================================================================
# run_demo.ps1 — one-command demo for 02.17 (LiDAR-camera projection/coloring fusion kernels)
#
...
#
# This script needed NO changes for the real implementation — only
# expected_output.txt (kept in sync with the stable lines main.cu prints;
# see the "output contract" comment in ../src/main.cu) and the exe name.
#
...
$Slug       = 'lidar-camera-projection-coloring-fusion-kernels'                     # substituted by scaffold.py
