#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.17 (LiDAR-camera projection/coloring fusion kernels)
...
# Keep expected_output.txt in sync with the stable output lines main.cu
...
SLUG='lidar-camera-projection-coloring-fusion-kernels'
