// ===========================================================================
// main.cu — entry point for project 02.02 (ROI crop, passthrough, organized↔unorganized conversion kernels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 02.02 (roi-crop-passthrough-organizedunorganized)\n");
