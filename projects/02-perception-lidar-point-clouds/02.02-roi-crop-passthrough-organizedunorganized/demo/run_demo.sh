#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 02.02 (ROI crop, passthrough, organized↔unorganized conversion kernels)
...
# RESOLVED: expected_output.txt holds this project's real VERIFY/GATE/RESULT
# lines, copied from an actual run (see the "output contract" comment in
# ../src/main.cu).
# ===========================================================================
set -euo pipefail
...
SLUG='roi-crop-passthrough-organizedunorganized'
