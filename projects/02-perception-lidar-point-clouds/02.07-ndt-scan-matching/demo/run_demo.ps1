# ===========================================================================
# run_demo.ps1 — one-command demo for 02.07 (NDT scan matching (Autoware-style map localizer))
#
...
#
# NEEDED NO CHANGES from the scaffolded template for the real NDT
# implementation below — it just builds+runs the real executable and diffs
# its stable lines against expected_output.txt, exactly as it did for the
# toolchain-validation SAXPY placeholder.
#
...
$Slug       = 'ndt-scan-matching'                     # substituted by scaffold.py
