#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 02.07 (NDT scan matching (Autoware-style map localizer))
...
echo "[download_data] Project 02.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
