# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.02 (DWA local planner scoring 10⁵ velocity samples per cycle)
#
...
Write-Host "[download_data] Project 23.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
