// ===========================================================================
// main.cu — entry point for project 23.02 (DWA local planner scoring 10⁵ velocity samples per cycle)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 23.02 (dwa-local-planner-scoring-105-velocity-samples)\n");
