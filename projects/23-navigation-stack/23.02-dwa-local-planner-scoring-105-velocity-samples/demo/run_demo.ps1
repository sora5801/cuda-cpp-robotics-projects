# ===========================================================================
# run_demo.ps1 — one-command demo for 23.02 (DWA local planner scoring 10⁵ velocity samples per cycle)
#
...
$Slug       = 'dwa-local-planner-scoring-105-velocity-samples'                     # substituted by scaffold.py
