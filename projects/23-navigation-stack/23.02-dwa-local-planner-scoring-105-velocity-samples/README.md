# 23.02 — DWA local planner scoring 10⁵ velocity samples per cycle

**Difficulty:** intermediate · **Domain:** 23. Navigation Stack (Mobile Robots)

> Catalog bullet (source of truth, verbatim): `DWA local planner scoring 10⁵ velocity samples per cycle`
>
...
1. Open [`build/dwa-local-planner-scoring-105-velocity-samples.sln`](build/dwa-local-planner-scoring-105-velocity-samples.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/dwa-local-planner-scoring-105-velocity-samples.exe`.
