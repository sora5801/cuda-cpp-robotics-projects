# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.10 (Dynamic obstacle tracking + velocity obstacles)
#
...
Write-Host "[download_data] Project 23.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
