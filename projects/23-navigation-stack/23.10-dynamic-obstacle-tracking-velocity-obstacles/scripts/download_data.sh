#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 23.10 (Dynamic obstacle tracking + velocity obstacles)
...
echo "[download_data] Project 23.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
