# 23.10 — Dynamic obstacle tracking + velocity obstacles

**Difficulty:** intermediate · **Domain:** 23. Navigation Stack (Mobile Robots)

> Catalog bullet (source of truth, verbatim): `Dynamic obstacle tracking + velocity obstacles`
>
...
1. Open [`build/dynamic-obstacle-tracking-velocity-obstacles.sln`](build/dynamic-obstacle-tracking-velocity-obstacles.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/dynamic-obstacle-tracking-velocity-obstacles.exe`.
