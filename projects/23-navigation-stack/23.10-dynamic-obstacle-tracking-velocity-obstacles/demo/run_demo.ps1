# ===========================================================================
# run_demo.ps1 — one-command demo for 23.10 (Dynamic obstacle tracking + velocity obstacles)
#
...
$Slug       = 'dynamic-obstacle-tracking-velocity-obstacles'                     # substituted by scaffold.py
