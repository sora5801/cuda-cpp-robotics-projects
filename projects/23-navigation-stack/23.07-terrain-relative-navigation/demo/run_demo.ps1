# ===========================================================================
# run_demo.ps1 — one-command demo for 23.07 (Terrain-relative navigation: TERCOM-style map correlation (brute-force = GPU-perfect))
#
...
$Slug       = 'terrain-relative-navigation'                     # substituted by scaffold.py
