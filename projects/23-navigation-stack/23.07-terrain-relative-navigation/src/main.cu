// ===========================================================================
// main.cu — entry point for project 23.07 (Terrain-relative navigation: TERCOM-style map correlation (brute-force = GPU-perfect))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 23.07 (terrain-relative-navigation)\n");
