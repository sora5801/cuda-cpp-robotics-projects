# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.07 (Terrain-relative navigation: TERCOM-style map correlation (brute-force = GPU-perfect))
#
...
Write-Host "[download_data] Project 23.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
