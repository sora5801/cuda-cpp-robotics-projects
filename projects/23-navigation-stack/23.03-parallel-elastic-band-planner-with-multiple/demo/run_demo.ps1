# ===========================================================================
# run_demo.ps1 — one-command demo for 23.03 (Parallel elastic-band planner with multiple homotopy candidates)
#
...
$Slug       = 'parallel-elastic-band-planner-with-multiple'                     # substituted by scaffold.py
