#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 23.03 (Parallel elastic-band planner with multiple homotopy candidates)
...
SLUG='parallel-elastic-band-planner-with-multiple'
