#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 23.03 (Parallel elastic-band planner with multiple homotopy candidates)
...
echo "[download_data] Project 23.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
