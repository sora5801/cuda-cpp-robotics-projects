# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.03 (Parallel elastic-band planner with multiple homotopy candidates)
#
...
Write-Host "[download_data] Project 23.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
