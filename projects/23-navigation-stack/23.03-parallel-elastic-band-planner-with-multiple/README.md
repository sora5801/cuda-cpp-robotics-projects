# 23.03 — Parallel elastic-band planner with multiple homotopy candidates

**Difficulty:** intermediate · **Domain:** 23. Navigation Stack (Mobile Robots)

> Catalog bullet (source of truth, verbatim): `Parallel elastic-band planner with multiple homotopy candidates`
>
...
1. Open [`build/parallel-elastic-band-planner-with-multiple.sln`](build/parallel-elastic-band-planner-with-multiple.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/parallel-elastic-band-planner-with-multiple.exe`.
