// ===========================================================================
// main.cu — entry point for project 23.09 (Exploration: per-viewpoint information gain in parallel)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 23.09 (exploration)\n");
