# 23.09 — Exploration: per-viewpoint information gain in parallel

**Difficulty:** intermediate · **Domain:** 23. Navigation Stack (Mobile Robots)

> Catalog bullet (source of truth, verbatim): `Exploration: per-viewpoint information gain in parallel`
>
...
1. Open [`build/exploration.sln`](build/exploration.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/exploration.exe`.
