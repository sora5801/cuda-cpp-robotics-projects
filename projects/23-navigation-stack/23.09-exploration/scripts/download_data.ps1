# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.09 (Exploration: per-viewpoint information gain in parallel)
#
...
Write-Host "[download_data] Project 23.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
