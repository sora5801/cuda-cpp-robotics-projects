# ===========================================================================
# run_demo.ps1 — one-command demo for 23.01 (GPU costmaps: inflation, raytrace clearing, multi-layer fusion)
#
...
#
# STATUS: this script needed NO changes once the real implementation (GPU
# costmaps + DWA) landed — it only builds, runs, and diffs stable lines.
# Keep expected_output.txt in sync with the stable lines main.cu prints (see
# the "output contract" comment in ../src/main.cu) whenever those change.
#
...
$Slug       = 'gpu-costmaps'                     # substituted by scaffold.py
