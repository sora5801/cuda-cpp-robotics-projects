# ===========================================================================
# run_demo.ps1 — one-command demo for 23.11 (Vegetation-vs-obstacle classification for off-road (LiDAR intensity + ML))
#
...
$Slug       = 'vegetation-vs-obstacle-classification-for-off'                     # substituted by scaffold.py
