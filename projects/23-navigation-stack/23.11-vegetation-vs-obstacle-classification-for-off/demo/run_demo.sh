#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 23.11 (Vegetation-vs-obstacle classification for off-road (LiDAR intensity + ML))
...
SLUG='vegetation-vs-obstacle-classification-for-off'
