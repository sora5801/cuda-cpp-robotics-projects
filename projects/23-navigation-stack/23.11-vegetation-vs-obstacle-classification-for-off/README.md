# 23.11 — Vegetation-vs-obstacle classification for off-road (LiDAR intensity + ML)

**Difficulty:** intermediate · **Domain:** 23. Navigation Stack (Mobile Robots)

> Catalog bullet (source of truth, verbatim): `Vegetation-vs-obstacle classification for off-road (LiDAR intensity + ML)`
>
...
1. Open [`build/vegetation-vs-obstacle-classification-for-off.sln`](build/vegetation-vs-obstacle-classification-for-off.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/vegetation-vs-obstacle-classification-for-off.exe`.
