// ===========================================================================
// main.cu — entry point for project 23.11 (Vegetation-vs-obstacle classification for off-road (LiDAR intensity + ML))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 23.11 (vegetation-vs-obstacle-classification-for-off)\n");
