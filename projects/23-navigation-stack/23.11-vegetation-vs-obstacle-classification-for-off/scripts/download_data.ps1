# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.11 (Vegetation-vs-obstacle classification for off-road (LiDAR intensity + ML))
#
...
Write-Host "[download_data] Project 23.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
