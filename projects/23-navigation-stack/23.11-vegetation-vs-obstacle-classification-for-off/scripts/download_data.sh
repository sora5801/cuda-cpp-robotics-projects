#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 23.11 (Vegetation-vs-obstacle classification for off-road (LiDAR intensity + ML))
...
echo "[download_data] Project 23.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
