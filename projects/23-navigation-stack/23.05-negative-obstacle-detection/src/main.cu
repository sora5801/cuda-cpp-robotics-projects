// ===========================================================================
// main.cu — entry point for project 23.05 (Negative-obstacle detection (depth discontinuity kernels))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 23.05 (negative-obstacle-detection)\n");
