# ===========================================================================
# run_demo.ps1 — one-command demo for 23.05 (Negative-obstacle detection (depth discontinuity kernels))
#
...
$Slug       = 'negative-obstacle-detection'                     # substituted by scaffold.py
