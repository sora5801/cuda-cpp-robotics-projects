# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.05 (Negative-obstacle detection (depth discontinuity kernels))
#
...
Write-Host "[download_data] Project 23.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
