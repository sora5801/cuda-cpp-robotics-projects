#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 23.05 (Negative-obstacle detection (depth discontinuity kernels))
...
echo "[download_data] Project 23.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
