# ===========================================================================
# run_demo.ps1 — one-command demo for 23.04 (Freespace segmentation + drivable-corridor extraction)
#
...
$Slug       = 'freespace-segmentation-drivable-corridor'                     # substituted by scaffold.py
