#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 23.04 (Freespace segmentation + drivable-corridor extraction)
...
echo "[download_data] Project 23.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
