# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.04 (Freespace segmentation + drivable-corridor extraction)
#
...
Write-Host "[download_data] Project 23.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
