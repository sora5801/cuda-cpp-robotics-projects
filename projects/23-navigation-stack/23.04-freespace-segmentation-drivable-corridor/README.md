# 23.04 — Freespace segmentation + drivable-corridor extraction

**Difficulty:** intermediate · **Domain:** 23. Navigation Stack (Mobile Robots)

> Catalog bullet (source of truth, verbatim): `Freespace segmentation + drivable-corridor extraction`
>
...
1. Open [`build/freespace-segmentation-drivable-corridor.sln`](build/freespace-segmentation-drivable-corridor.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/freespace-segmentation-drivable-corridor.exe`.
