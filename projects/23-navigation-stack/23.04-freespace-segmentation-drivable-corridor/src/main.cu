// ===========================================================================
// main.cu — entry point for project 23.04 (Freespace segmentation + drivable-corridor extraction)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 23.04 (freespace-segmentation-drivable-corridor)\n");
