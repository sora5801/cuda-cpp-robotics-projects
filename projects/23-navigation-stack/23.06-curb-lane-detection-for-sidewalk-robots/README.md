# 23.06 — Curb/lane detection for sidewalk robots

**Difficulty:** intermediate · **Domain:** 23. Navigation Stack (Mobile Robots)

> Catalog bullet (source of truth, verbatim): `Curb/lane detection for sidewalk robots`
>
...
1. Open [`build/curb-lane-detection-for-sidewalk-robots.sln`](build/curb-lane-detection-for-sidewalk-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/curb-lane-detection-for-sidewalk-robots.exe`.
