#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 23.06 (Curb/lane detection for sidewalk robots)
...
echo "[download_data] Project 23.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
