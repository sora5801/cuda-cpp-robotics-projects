#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 23.08 (Semantic navigation: language-embedding map similarity search)
...
echo "[download_data] Project 23.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
