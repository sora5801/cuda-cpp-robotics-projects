# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 23.08 (Semantic navigation: language-embedding map similarity search)
#
...
Write-Host "[download_data] Project 23.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
