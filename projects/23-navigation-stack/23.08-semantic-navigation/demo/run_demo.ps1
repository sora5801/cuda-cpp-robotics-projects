# ===========================================================================
# run_demo.ps1 — one-command demo for 23.08 (Semantic navigation: language-embedding map similarity search)
#
...
$Slug       = 'semantic-navigation'                     # substituted by scaffold.py
