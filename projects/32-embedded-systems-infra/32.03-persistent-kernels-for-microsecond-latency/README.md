# 32.03 — Persistent kernels for microsecond-latency control

**Difficulty:** [R&D] research · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Persistent kernels for microsecond-latency control [R&D]`
>
...
Persistent kernels for microsecond-latency control
...
1. Open [`build/persistent-kernels-for-microsecond-latency.sln`](build/persistent-kernels-for-microsecond-latency.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/persistent-kernels-for-microsecond-latency.exe`.
