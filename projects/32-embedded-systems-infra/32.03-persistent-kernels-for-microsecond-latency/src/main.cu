// ===========================================================================
// main.cu — entry point for project 32.03 (Persistent kernels for microsecond-latency control)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.03 (persistent-kernels-for-microsecond-latency)\n");
