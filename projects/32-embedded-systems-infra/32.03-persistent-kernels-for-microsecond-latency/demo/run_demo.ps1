# ===========================================================================
# run_demo.ps1 — one-command demo for 32.03 (Persistent kernels for microsecond-latency control)
#
...
$Slug       = 'persistent-kernels-for-microsecond-latency'                     # substituted by scaffold.py
