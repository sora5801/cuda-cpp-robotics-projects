#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.03 (Persistent kernels for microsecond-latency control)
...
echo "[download_data] Project 32.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
