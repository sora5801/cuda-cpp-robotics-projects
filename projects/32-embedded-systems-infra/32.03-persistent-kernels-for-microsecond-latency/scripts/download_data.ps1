# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.03 (Persistent kernels for microsecond-latency control)
#
...
Write-Host "[download_data] Project 32.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
