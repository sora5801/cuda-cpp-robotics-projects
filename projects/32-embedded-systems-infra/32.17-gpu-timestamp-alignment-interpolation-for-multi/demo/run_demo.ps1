# ===========================================================================
# run_demo.ps1 — one-command demo for 32.17 (GPU timestamp alignment/interpolation for multi-sensor sync)
#
...
$Slug       = 'gpu-timestamp-alignment-interpolation-for-multi'                     # substituted by scaffold.py
