#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 32.17 (GPU timestamp alignment/interpolation for multi-sensor sync)
...
SLUG='gpu-timestamp-alignment-interpolation-for-multi'
