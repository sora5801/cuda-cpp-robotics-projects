# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.17 (GPU timestamp alignment/interpolation for multi-sensor sync)
#
...
Write-Host "[download_data] Project 32.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
