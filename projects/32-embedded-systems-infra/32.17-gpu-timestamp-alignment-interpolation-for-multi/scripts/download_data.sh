#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.17 (GPU timestamp alignment/interpolation for multi-sensor sync)
...
echo "[download_data] Project 32.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
