# 32.17 — GPU timestamp alignment/interpolation for multi-sensor sync

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `GPU timestamp alignment/interpolation for multi-sensor sync`
>
...
1. Open [`build/gpu-timestamp-alignment-interpolation-for-multi.sln`](build/gpu-timestamp-alignment-interpolation-for-multi.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-timestamp-alignment-interpolation-for-multi.exe`.
