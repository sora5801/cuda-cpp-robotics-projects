#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.14 (Multi-GPU pipelines for autonomous-vehicle compute racks)
...
echo "[download_data] Project 32.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
