# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.14 (Multi-GPU pipelines for autonomous-vehicle compute racks)
#
...
Write-Host "[download_data] Project 32.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
