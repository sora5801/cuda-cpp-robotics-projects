# 32.14 — Multi-GPU pipelines for autonomous-vehicle compute racks

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Multi-GPU pipelines for autonomous-vehicle compute racks`
>
...
1. Open [`build/multi-gpu-pipelines-for-autonomous-vehicle.sln`](build/multi-gpu-pipelines-for-autonomous-vehicle.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/multi-gpu-pipelines-for-autonomous-vehicle.exe`.
