# ===========================================================================
# run_demo.ps1 — one-command demo for 32.14 (Multi-GPU pipelines for autonomous-vehicle compute racks)
#
...
$Slug       = 'multi-gpu-pipelines-for-autonomous-vehicle'                     # substituted by scaffold.py
