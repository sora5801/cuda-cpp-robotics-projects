// ===========================================================================
// main.cu — entry point for project 32.14 (Multi-GPU pipelines for autonomous-vehicle compute racks)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.14 (multi-gpu-pipelines-for-autonomous-vehicle)\n");
