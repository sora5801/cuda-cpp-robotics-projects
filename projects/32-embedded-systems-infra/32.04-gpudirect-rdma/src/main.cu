// ===========================================================================
// main.cu — entry point for project 32.04 (GPUDirect RDMA: NIC → GPU LiDAR/camera ingest at 100 GbE)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.04 (gpudirect-rdma)\n");
