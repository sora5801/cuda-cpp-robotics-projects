# 32.04 — GPUDirect RDMA: NIC → GPU LiDAR/camera ingest at 100 GbE

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `GPUDirect RDMA: NIC → GPU LiDAR/camera ingest at 100 GbE`
>
...
1. Open [`build/gpudirect-rdma.sln`](build/gpudirect-rdma.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpudirect-rdma.exe`.
