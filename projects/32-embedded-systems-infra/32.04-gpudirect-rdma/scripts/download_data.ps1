# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.04 (GPUDirect RDMA: NIC → GPU LiDAR/camera ingest at 100 GbE)
#
...
Write-Host "[download_data] Project 32.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
