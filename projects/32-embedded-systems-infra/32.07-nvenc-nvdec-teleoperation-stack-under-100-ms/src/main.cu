// ===========================================================================
// main.cu — entry point for project 32.07 (NVENC/NVDEC teleoperation stack under 100 ms glass-to-glass)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.07 (nvenc-nvdec-teleoperation-stack-under-100-ms)\n");
