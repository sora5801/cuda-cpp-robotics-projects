# 32.07 — NVENC/NVDEC teleoperation stack under 100 ms glass-to-glass

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `NVENC/NVDEC teleoperation stack under 100 ms glass-to-glass`
>
...
1. Open [`build/nvenc-nvdec-teleoperation-stack-under-100-ms.sln`](build/nvenc-nvdec-teleoperation-stack-under-100-ms.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/nvenc-nvdec-teleoperation-stack-under-100-ms.exe`.
