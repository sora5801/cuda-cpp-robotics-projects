# ===========================================================================
# run_demo.ps1 — one-command demo for 32.07 (NVENC/NVDEC teleoperation stack under 100 ms glass-to-glass)
#
...
$Slug       = 'nvenc-nvdec-teleoperation-stack-under-100-ms'                     # substituted by scaffold.py
