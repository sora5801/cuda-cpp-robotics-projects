#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.07 (NVENC/NVDEC teleoperation stack under 100 ms glass-to-glass)
...
echo "[download_data] Project 32.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
