# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.07 (NVENC/NVDEC teleoperation stack under 100 ms glass-to-glass)
#
...
Write-Host "[download_data] Project 32.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
