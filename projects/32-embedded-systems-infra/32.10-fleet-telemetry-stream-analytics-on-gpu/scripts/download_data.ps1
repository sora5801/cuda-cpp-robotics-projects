# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.10 (Fleet telemetry stream analytics on GPU)
#
...
Write-Host "[download_data] Project 32.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
