# 32.10 — Fleet telemetry stream analytics on GPU

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Fleet telemetry stream analytics on GPU`
>
...
1. Open [`build/fleet-telemetry-stream-analytics-on-gpu.sln`](build/fleet-telemetry-stream-analytics-on-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/fleet-telemetry-stream-analytics-on-gpu.exe`.
