#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 32.02 (CUDA Graphs for jitter-free fixed-rate perception-control loops)
...
# STATUS: expected_output.txt's stable lines are kept in sync with main.cu's
...
SLUG='cuda-graphs-for-jitter-free-fixed-rate'
