# ===========================================================================
# run_demo.ps1 — one-command demo for 32.02 (CUDA Graphs for jitter-free fixed-rate perception-control loops)
#
...
#
# STATUS: this project's real implementation (the three-mode CUDA Graphs
# study) needed NO changes to this script beyond the generic scaffold —
# expected_output.txt's stable lines are kept in sync with main.cu's
# "Output contract" comment by hand whenever a stable line changes.
#
...
$Slug       = 'cuda-graphs-for-jitter-free-fixed-rate'                     # substituted by scaffold.py
