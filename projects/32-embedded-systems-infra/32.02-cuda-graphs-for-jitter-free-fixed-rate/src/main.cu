// ===========================================================================
// main.cu — entry point for project 32.02 (CUDA Graphs for jitter-free fixed-rate perception-control loops)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.02 (cuda-graphs-for-jitter-free-fixed-rate)\n");
