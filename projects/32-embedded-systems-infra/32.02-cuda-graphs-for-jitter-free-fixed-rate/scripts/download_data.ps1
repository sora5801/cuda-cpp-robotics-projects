# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.02 (CUDA Graphs for jitter-free fixed-rate perception-control loops)
#
...
Write-Host "[download_data] Project 32.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
