# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.01 (Zero-copy Jetson pipeline: camera → CUDA → TensorRT → control, no CPU touches)
#
...
Write-Host "[download_data] Project 32.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
