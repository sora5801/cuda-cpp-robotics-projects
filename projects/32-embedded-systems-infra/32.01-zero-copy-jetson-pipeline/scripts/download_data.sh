#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.01 (Zero-copy Jetson pipeline: camera → CUDA → TensorRT → control, no CPU touches)
...
echo "[download_data] Project 32.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
