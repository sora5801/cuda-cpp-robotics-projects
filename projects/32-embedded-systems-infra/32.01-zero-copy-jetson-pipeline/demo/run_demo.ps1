# ===========================================================================
# run_demo.ps1 — one-command demo for 32.01 (Zero-copy Jetson pipeline: camera → CUDA → TensorRT → control, no CPU touches)
#
...
$Slug       = 'zero-copy-jetson-pipeline'                     # substituted by scaffold.py
