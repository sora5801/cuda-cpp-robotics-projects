// ===========================================================================
// main.cu — entry point for project 32.01 (Zero-copy Jetson pipeline: camera → CUDA → TensorRT → control, no CPU touches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.01 (zero-copy-jetson-pipeline)\n");
