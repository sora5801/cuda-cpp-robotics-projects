# 32.15 — Kernel-fusion framework for perception graphs

**Difficulty:** [R&D] research · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Kernel-fusion framework for perception graphs [R&D]`
>
...
Kernel-fusion framework for perception graphs
...
1. Open [`build/kernel-fusion-framework-for-perception-graphs.sln`](build/kernel-fusion-framework-for-perception-graphs.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/kernel-fusion-framework-for-perception-graphs.exe`.
