# ===========================================================================
# run_demo.ps1 — one-command demo for 32.15 (Kernel-fusion framework for perception graphs)
#
...
$Slug       = 'kernel-fusion-framework-for-perception-graphs'                     # substituted by scaffold.py
