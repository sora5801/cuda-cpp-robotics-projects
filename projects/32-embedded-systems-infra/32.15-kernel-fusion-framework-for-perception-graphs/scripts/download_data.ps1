# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.15 (Kernel-fusion framework for perception graphs)
#
...
Write-Host "[download_data] Project 32.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
