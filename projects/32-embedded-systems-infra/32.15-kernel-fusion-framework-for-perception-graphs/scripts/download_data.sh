#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.15 (Kernel-fusion framework for perception graphs)
...
echo "[download_data] Project 32.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
