# ===========================================================================
# run_demo.ps1 — one-command demo for 32.13 (Power/thermal-aware (DVFS-aware) kernel scheduling on Jetson)
#
...
$Slug       = 'power-thermal-aware-kernel-scheduling-on-jetson'                     # substituted by scaffold.py
