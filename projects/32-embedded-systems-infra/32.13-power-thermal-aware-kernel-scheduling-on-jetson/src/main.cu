// ===========================================================================
// main.cu — entry point for project 32.13 (Power/thermal-aware (DVFS-aware) kernel scheduling on Jetson)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.13 (power-thermal-aware-kernel-scheduling-on-jetson)\n");
