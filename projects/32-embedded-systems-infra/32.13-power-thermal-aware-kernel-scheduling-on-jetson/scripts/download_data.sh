#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.13 (Power/thermal-aware (DVFS-aware) kernel scheduling on Jetson)
...
echo "[download_data] Project 32.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
