# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.13 (Power/thermal-aware (DVFS-aware) kernel scheduling on Jetson)
#
...
Write-Host "[download_data] Project 32.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
