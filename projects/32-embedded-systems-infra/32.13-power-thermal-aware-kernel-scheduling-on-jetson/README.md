# 32.13 — Power/thermal-aware (DVFS-aware) kernel scheduling on Jetson

**Difficulty:** [R&D] research · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Power/thermal-aware (DVFS-aware) kernel scheduling on Jetson [R&D]`
>
...
Power/thermal-aware (DVFS-aware) kernel scheduling on Jetson
...
1. Open [`build/power-thermal-aware-kernel-scheduling-on-jetson.sln`](build/power-thermal-aware-kernel-scheduling-on-jetson.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/power-thermal-aware-kernel-scheduling-on-jetson.exe`.
