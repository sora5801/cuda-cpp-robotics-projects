#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.16 (FPGA↔GPU hybrid pipelines with DMA handoff)
...
echo "[download_data] Project 32.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
