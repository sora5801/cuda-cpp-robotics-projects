# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.16 (FPGA↔GPU hybrid pipelines with DMA handoff)
#
...
Write-Host "[download_data] Project 32.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
