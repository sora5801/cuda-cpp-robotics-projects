# 32.16 — FPGA↔GPU hybrid pipelines with DMA handoff

**Difficulty:** [R&D] research · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `FPGA↔GPU hybrid pipelines with DMA handoff [R&D]`
>
...
FPGA↔GPU hybrid pipelines with DMA handoff
...
1. Open [`build/fpgagpu-hybrid-pipelines-with-dma-handoff.sln`](build/fpgagpu-hybrid-pipelines-with-dma-handoff.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/fpgagpu-hybrid-pipelines-with-dma-handoff.exe`.
