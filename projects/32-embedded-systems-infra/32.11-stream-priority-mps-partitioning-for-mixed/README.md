# 32.11 — Stream-priority / MPS partitioning for mixed-criticality workloads

**Difficulty:** [R&D] research · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Stream-priority / MPS partitioning for mixed-criticality workloads [R&D]`
>
...
Stream-priority / MPS partitioning for mixed-criticality workloads
...
1. Open [`build/stream-priority-mps-partitioning-for-mixed.sln`](build/stream-priority-mps-partitioning-for-mixed.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/stream-priority-mps-partitioning-for-mixed.exe`.
