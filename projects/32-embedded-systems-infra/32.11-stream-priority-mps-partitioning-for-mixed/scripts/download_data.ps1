# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.11 (Stream-priority / MPS partitioning for mixed-criticality workloads)
#
...
Write-Host "[download_data] Project 32.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
