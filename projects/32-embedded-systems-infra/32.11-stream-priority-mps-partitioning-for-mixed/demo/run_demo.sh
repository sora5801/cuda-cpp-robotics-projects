#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 32.11 (Stream-priority / MPS partitioning for mixed-criticality workloads)
...
SLUG='stream-priority-mps-partitioning-for-mixed'
