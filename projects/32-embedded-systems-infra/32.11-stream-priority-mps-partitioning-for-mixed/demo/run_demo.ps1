# ===========================================================================
# run_demo.ps1 — one-command demo for 32.11 (Stream-priority / MPS partitioning for mixed-criticality workloads)
#
...
$Slug       = 'stream-priority-mps-partitioning-for-mixed'                     # substituted by scaffold.py
