# ===========================================================================
# run_demo.ps1 — one-command demo for 32.05 (Deterministic memory: pool/arena allocators for robotics pipelines)
#
...
$Slug       = 'deterministic-memory'                     # substituted by scaffold.py
