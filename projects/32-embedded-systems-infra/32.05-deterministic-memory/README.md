# 32.05 — Deterministic memory: pool/arena allocators for robotics pipelines

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Deterministic memory: pool/arena allocators for robotics pipelines`
>
...
1. Open [`build/deterministic-memory.sln`](build/deterministic-memory.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/deterministic-memory.exe`.
