# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.05 (Deterministic memory: pool/arena allocators for robotics pipelines)
#
...
Write-Host "[download_data] Project 32.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
