#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.05 (Deterministic memory: pool/arena allocators for robotics pipelines)
...
echo "[download_data] Project 32.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
