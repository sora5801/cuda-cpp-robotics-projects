# 32.12 — Safety-rated GPU patterns: redundant kernels + checksum voting

**Difficulty:** [R&D] research · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `Safety-rated GPU patterns: redundant kernels + checksum voting [R&D]`
>
...
Safety-rated GPU patterns: redundant kernels + checksum voting
...
1. Open [`build/safety-rated-gpu-patterns.sln`](build/safety-rated-gpu-patterns.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/safety-rated-gpu-patterns.exe`.
