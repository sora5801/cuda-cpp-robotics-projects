# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.12 (Safety-rated GPU patterns: redundant kernels + checksum voting)
#
...
Write-Host "[download_data] Project 32.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
