#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.12 (Safety-rated GPU patterns: redundant kernels + checksum voting)
...
echo "[download_data] Project 32.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
