# ===========================================================================
# run_demo.ps1 — one-command demo for 32.12 (Safety-rated GPU patterns: redundant kernels + checksum voting)
#
...
$Slug       = 'safety-rated-gpu-patterns'                     # substituted by scaffold.py
