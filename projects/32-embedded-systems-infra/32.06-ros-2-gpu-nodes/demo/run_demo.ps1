# ===========================================================================
# run_demo.ps1 — one-command demo for 32.06 (ROS 2 GPU nodes: NITROS-style type adaptation, zero-copy GPU messages; port image_proc/PCL nodes to CUDA)
#
...
$Slug       = 'ros-2-gpu-nodes'                     # substituted by scaffold.py
