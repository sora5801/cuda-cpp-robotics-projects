# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.06 (ROS 2 GPU nodes: NITROS-style type adaptation, zero-copy GPU messages; port image_proc/PCL nodes to CUDA)
#
...
Write-Host "[download_data] Project 32.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
