# 32.09 — GPU-accelerated rosbag/MCAP processing: decode, filter, index terabyte logs

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `GPU-accelerated rosbag/MCAP processing: decode, filter, index terabyte logs`
>
...
1. Open [`build/gpu-accelerated-rosbag-mcap-processing.sln`](build/gpu-accelerated-rosbag-mcap-processing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-accelerated-rosbag-mcap-processing.exe`.
