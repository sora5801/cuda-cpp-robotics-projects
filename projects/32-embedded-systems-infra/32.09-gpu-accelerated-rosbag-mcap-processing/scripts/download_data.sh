#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.09 (GPU-accelerated rosbag/MCAP processing: decode, filter, index terabyte logs)
...
echo "[download_data] Project 32.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
