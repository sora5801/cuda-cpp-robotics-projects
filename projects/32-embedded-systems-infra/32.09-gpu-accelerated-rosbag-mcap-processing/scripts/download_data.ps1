# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 32.09 (GPU-accelerated rosbag/MCAP processing: decode, filter, index terabyte logs)
#
...
Write-Host "[download_data] Project 32.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
