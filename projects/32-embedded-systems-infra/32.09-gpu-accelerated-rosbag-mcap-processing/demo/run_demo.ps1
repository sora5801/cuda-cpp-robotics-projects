# ===========================================================================
# run_demo.ps1 — one-command demo for 32.09 (GPU-accelerated rosbag/MCAP processing: decode, filter, index terabyte logs)
#
...
$Slug       = 'gpu-accelerated-rosbag-mcap-processing'                     # substituted by scaffold.py
