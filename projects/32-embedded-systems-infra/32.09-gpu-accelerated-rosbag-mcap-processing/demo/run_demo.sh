#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 32.09 (GPU-accelerated rosbag/MCAP processing: decode, filter, index terabyte logs)
...
SLUG='gpu-accelerated-rosbag-mcap-processing'
