// ===========================================================================
// main.cu — entry point for project 32.08 (WebRTC GPU pipeline for browser-based teleop)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 32.08 (webrtc-gpu-pipeline-for-browser-based-teleop)\n");
