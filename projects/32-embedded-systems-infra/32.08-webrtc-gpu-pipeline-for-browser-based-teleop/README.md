# 32.08 — WebRTC GPU pipeline for browser-based teleop

**Difficulty:** intermediate · **Domain:** 32. Embedded, Jetson & Systems Infrastructure

> Catalog bullet (source of truth, verbatim): `WebRTC GPU pipeline for browser-based teleop`
>
...
1. Open [`build/webrtc-gpu-pipeline-for-browser-based-teleop.sln`](build/webrtc-gpu-pipeline-for-browser-based-teleop.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/webrtc-gpu-pipeline-for-browser-based-teleop.exe`.
