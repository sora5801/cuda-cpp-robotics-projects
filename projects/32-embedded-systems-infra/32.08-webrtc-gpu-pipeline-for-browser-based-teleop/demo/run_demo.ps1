# ===========================================================================
# run_demo.ps1 — one-command demo for 32.08 (WebRTC GPU pipeline for browser-based teleop)
#
...
$Slug       = 'webrtc-gpu-pipeline-for-browser-based-teleop'                     # substituted by scaffold.py
