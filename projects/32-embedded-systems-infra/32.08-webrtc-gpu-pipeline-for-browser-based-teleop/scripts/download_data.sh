#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 32.08 (WebRTC GPU pipeline for browser-based teleop)
...
echo "[download_data] Project 32.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
