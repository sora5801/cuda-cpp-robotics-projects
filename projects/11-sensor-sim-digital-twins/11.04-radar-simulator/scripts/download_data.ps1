# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.04 (Radar simulator: raytraced multipath + RCS models)
#
...
Write-Host "[download_data] Project 11.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
