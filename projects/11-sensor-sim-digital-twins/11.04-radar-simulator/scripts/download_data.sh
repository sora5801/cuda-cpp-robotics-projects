#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.04 (Radar simulator: raytraced multipath + RCS models)
...
echo "[download_data] Project 11.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
