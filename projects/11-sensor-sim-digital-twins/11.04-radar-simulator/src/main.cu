// ===========================================================================
// main.cu — entry point for project 11.04 (Radar simulator: raytraced multipath + RCS models)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.04 (radar-simulator)\n");
