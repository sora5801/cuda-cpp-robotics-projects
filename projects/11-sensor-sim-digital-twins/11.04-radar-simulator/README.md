# 11.04 — Radar simulator: raytraced multipath + RCS models

**Difficulty:** [R&D] research · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Radar simulator: raytraced multipath + RCS models [R&D]`
>
...
Radar simulator: raytraced multipath + RCS models
...
1. Open [`build/radar-simulator.sln`](build/radar-simulator.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/radar-simulator.exe`.
