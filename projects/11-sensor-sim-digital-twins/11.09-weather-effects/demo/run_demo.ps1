# ===========================================================================
# run_demo.ps1 — one-command demo for 11.09 (Weather effects: fog scattering, raindrops on lenses, for perception robustness testing)
#
...
$Slug       = 'weather-effects'                     # substituted by scaffold.py
