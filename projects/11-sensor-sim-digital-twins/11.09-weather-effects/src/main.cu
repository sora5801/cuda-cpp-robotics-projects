// ===========================================================================
// main.cu — entry point for project 11.09 (Weather effects: fog scattering, raindrops on lenses, for perception robustness testing)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.09 (weather-effects)\n");
