# 11.09 — Weather effects: fog scattering, raindrops on lenses, for perception robustness testing

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Weather effects: fog scattering, raindrops on lenses, for perception robustness testing`
>
...
1. Open [`build/weather-effects.sln`](build/weather-effects.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/weather-effects.exe`.
