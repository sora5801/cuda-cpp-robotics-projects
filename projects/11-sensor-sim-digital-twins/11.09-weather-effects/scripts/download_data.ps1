# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.09 (Weather effects: fog scattering, raindrops on lenses, for perception robustness testing)
#
...
Write-Host "[download_data] Project 11.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
