# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.05 (Sonar simulator for AUV development)
#
...
Write-Host "[download_data] Project 11.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
