#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.05 (Sonar simulator for AUV development)
...
echo "[download_data] Project 11.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
