# 11.05 — Sonar simulator for AUV development

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Sonar simulator for AUV development`
>
...
1. Open [`build/sonar-simulator-for-auv-development.sln`](build/sonar-simulator-for-auv-development.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/sonar-simulator-for-auv-development.exe`.
