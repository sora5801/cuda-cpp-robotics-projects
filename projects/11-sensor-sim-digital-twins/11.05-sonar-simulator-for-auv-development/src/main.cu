// ===========================================================================
// main.cu — entry point for project 11.05 (Sonar simulator for AUV development)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.05 (sonar-simulator-for-auv-development)\n");
