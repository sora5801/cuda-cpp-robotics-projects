# ===========================================================================
# run_demo.ps1 — one-command demo for 11.03 (Event-camera simulator from high-FPS rendered frames)
#
...
$Slug       = 'event-camera-simulator-from-high-fps-rendered'                     # substituted by scaffold.py
