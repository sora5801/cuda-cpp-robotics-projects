# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.03 (Event-camera simulator from high-FPS rendered frames)
#
...
Write-Host "[download_data] Project 11.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
