#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.03 (Event-camera simulator from high-FPS rendered frames)
...
echo "[download_data] Project 11.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
