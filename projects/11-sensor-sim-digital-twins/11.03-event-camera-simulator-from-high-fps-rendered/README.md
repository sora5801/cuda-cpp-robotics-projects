# 11.03 — Event-camera simulator from high-FPS rendered frames

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Event-camera simulator from high-FPS rendered frames`
>
...
1. Open [`build/event-camera-simulator-from-high-fps-rendered.sln`](build/event-camera-simulator-from-high-fps-rendered.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/event-camera-simulator-from-high-fps-rendered.exe`.
