# ===========================================================================
# run_demo.ps1 — one-command demo for 11.06 (IMU error simulation: bias random walks across Monte Carlo runs)
#
...
$Slug       = 'imu-error-simulation'                     # substituted by scaffold.py
