# 11.06 — IMU error simulation: bias random walks across Monte Carlo runs

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `IMU error simulation: bias random walks across Monte Carlo runs`
>
...
1. Open [`build/imu-error-simulation.sln`](build/imu-error-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/imu-error-simulation.exe`.
