// ===========================================================================
// main.cu — entry point for project 11.06 (IMU error simulation: bias random walks across Monte Carlo runs)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.06 (imu-error-simulation)\n");
