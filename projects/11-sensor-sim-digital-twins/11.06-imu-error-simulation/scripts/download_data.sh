#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.06 (IMU error simulation: bias random walks across Monte Carlo runs)
...
echo "[download_data] Project 11.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
