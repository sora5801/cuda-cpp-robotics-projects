# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.06 (IMU error simulation: bias random walks across Monte Carlo runs)
#
...
Write-Host "[download_data] Project 11.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
