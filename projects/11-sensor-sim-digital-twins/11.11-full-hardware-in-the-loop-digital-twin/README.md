# 11.11 — Full hardware-in-the-loop digital twin of a robot work cell

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Full hardware-in-the-loop digital twin of a robot work cell`
>
...
1. Open [`build/full-hardware-in-the-loop-digital-twin.sln`](build/full-hardware-in-the-loop-digital-twin.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/full-hardware-in-the-loop-digital-twin.exe`.
