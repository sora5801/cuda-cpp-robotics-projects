# ===========================================================================
# run_demo.ps1 — one-command demo for 11.11 (Full hardware-in-the-loop digital twin of a robot work cell)
#
...
$Slug       = 'full-hardware-in-the-loop-digital-twin'                     # substituted by scaffold.py
