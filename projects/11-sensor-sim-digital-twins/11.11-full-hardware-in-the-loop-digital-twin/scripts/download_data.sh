#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.11 (Full hardware-in-the-loop digital twin of a robot work cell)
...
echo "[download_data] Project 11.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
