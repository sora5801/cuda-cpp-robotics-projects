// ===========================================================================
// main.cu — entry point for project 11.08 (Photoreal camera sim: PBR rendering, lens distortion, rolling shutter, motion blur)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.08 (photoreal-camera-sim)\n");
