# 11.08 — Photoreal camera sim: PBR rendering, lens distortion, rolling shutter, motion blur

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Photoreal camera sim: PBR rendering, lens distortion, rolling shutter, motion blur`
>
...
1. Open [`build/photoreal-camera-sim.sln`](build/photoreal-camera-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/photoreal-camera-sim.exe`.
