# ===========================================================================
# run_demo.ps1 — one-command demo for 11.08 (Photoreal camera sim: PBR rendering, lens distortion, rolling shutter, motion blur)
#
...
$Slug       = 'photoreal-camera-sim'                     # substituted by scaffold.py
