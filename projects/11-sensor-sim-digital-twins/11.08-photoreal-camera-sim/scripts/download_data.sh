#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.08 (Photoreal camera sim: PBR rendering, lens distortion, rolling shutter, motion blur)
...
echo "[download_data] Project 11.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
