# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.08 (Photoreal camera sim: PBR rendering, lens distortion, rolling shutter, motion blur)
#
...
Write-Host "[download_data] Project 11.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
