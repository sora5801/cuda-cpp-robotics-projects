#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.10 (Synthetic dataset factory: procedural scenes + auto-labels (boxes, masks, depth, flow))
...
echo "[download_data] Project 11.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
