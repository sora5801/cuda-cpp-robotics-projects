# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.10 (Synthetic dataset factory: procedural scenes + auto-labels (boxes, masks, depth, flow))
#
...
Write-Host "[download_data] Project 11.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
