// ===========================================================================
// main.cu — entry point for project 11.10 (Synthetic dataset factory: procedural scenes + auto-labels (boxes, masks, depth, flow))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.10 (synthetic-dataset-factory)\n");
