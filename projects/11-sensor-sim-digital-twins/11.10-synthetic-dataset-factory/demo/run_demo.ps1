# ===========================================================================
# run_demo.ps1 — one-command demo for 11.10 (Synthetic dataset factory: procedural scenes + auto-labels (boxes, masks, depth, flow))
#
...
$Slug       = 'synthetic-dataset-factory'                     # substituted by scaffold.py
