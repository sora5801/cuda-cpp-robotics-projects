# 11.10 — Synthetic dataset factory: procedural scenes + auto-labels (boxes, masks, depth, flow)

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Synthetic dataset factory: procedural scenes + auto-labels (boxes, masks, depth, flow)`
>
...
1. Open [`build/synthetic-dataset-factory.sln`](build/synthetic-dataset-factory.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/synthetic-dataset-factory.exe`.
