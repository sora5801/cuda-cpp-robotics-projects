# 11.07 — GNSS multipath simulation in urban canyons (raytracing)

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `GNSS multipath simulation in urban canyons (raytracing)`
>
...
1. Open [`build/gnss-multipath-simulation-in-urban-canyons.sln`](build/gnss-multipath-simulation-in-urban-canyons.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gnss-multipath-simulation-in-urban-canyons.exe`.
