#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.07 (GNSS multipath simulation in urban canyons (raytracing))
...
echo "[download_data] Project 11.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
