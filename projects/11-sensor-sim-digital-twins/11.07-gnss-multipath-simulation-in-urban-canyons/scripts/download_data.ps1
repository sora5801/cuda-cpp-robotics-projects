# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.07 (GNSS multipath simulation in urban canyons (raytracing))
#
...
Write-Host "[download_data] Project 11.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
