// ===========================================================================
// main.cu — entry point for project 11.07 (GNSS multipath simulation in urban canyons (raytracing))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.07 (gnss-multipath-simulation-in-urban-canyons)\n");
