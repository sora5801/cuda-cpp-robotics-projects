# ===========================================================================
# run_demo.ps1 — one-command demo for 11.07 (GNSS multipath simulation in urban canyons (raytracing))
#
...
$Slug       = 'gnss-multipath-simulation-in-urban-canyons'                     # substituted by scaffold.py
