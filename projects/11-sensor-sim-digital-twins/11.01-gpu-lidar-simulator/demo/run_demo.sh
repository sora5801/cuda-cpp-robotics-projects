#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 11.01 (GPU LiDAR simulator: BVH raycasting + beam divergence, intensity, dropout noise)
...
# 11.01: expected_output.txt carries this project's real stable lines (the
# output contract lives at the top of ../src/main.cu; change both together).
# ===========================================================================
set -euo pipefail
