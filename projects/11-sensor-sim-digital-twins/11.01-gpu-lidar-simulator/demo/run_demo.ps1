# ===========================================================================
# run_demo.ps1 — one-command demo for 11.01 (GPU LiDAR simulator: BVH raycasting + beam divergence, intensity, dropout noise)
#
...
#
# 11.01: this script is unchanged from the template — it needed no changes
# for the real implementation. expected_output.txt carries this project's
# real stable lines (the output contract lives at the top of ../src/main.cu;
# change the two together). The demo writes demo/out/cloud.csv and
# demo/out/range_image.pgm (both git-ignored) — see demo/README.md for how
# to view them.
#
...
$Slug       = 'gpu-lidar-simulator'                     # substituted by scaffold.py
...
# (the header notes at the top of expected_output.txt are such comments).
