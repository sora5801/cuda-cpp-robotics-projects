...
//                  (project 11.01; copied from docs/PROJECT_TEMPLATE
...
//    (one raycast kernel per frame; main.cu brackets it with GpuTimer);
//    multi-stream projects would record into their own streams instead.
