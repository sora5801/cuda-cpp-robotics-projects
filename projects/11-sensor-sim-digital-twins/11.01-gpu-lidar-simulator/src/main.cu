// ===========================================================================
// main.cu — entry point for project 11.01 (GPU LiDAR simulator: BVH raycasting + beam divergence, intensity, dropout noise)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.01 (gpu-lidar-simulator)\n");
