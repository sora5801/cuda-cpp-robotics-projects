# ===========================================================================
# run_demo.ps1 — one-command demo for 11.02 (Depth-camera simulator with realistic (Kinect-model) noise)
#
...
$Slug       = 'depth-camera-simulator-with-realistic-noise'                     # substituted by scaffold.py
