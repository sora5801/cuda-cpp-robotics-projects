# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 11.02 (Depth-camera simulator with realistic (Kinect-model) noise)
#
...
Write-Host "[download_data] Project 11.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
