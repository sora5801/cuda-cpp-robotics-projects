#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 11.02 (Depth-camera simulator with realistic (Kinect-model) noise)
...
echo "[download_data] Project 11.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
