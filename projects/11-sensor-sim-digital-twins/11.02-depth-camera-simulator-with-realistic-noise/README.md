# 11.02 — Depth-camera simulator with realistic (Kinect-model) noise

**Difficulty:** intermediate · **Domain:** 11. Sensor Simulation & Digital Twins

> Catalog bullet (source of truth, verbatim): `Depth-camera simulator with realistic (Kinect-model) noise`
>
...
1. Open [`build/depth-camera-simulator-with-realistic-noise.sln`](build/depth-camera-simulator-with-realistic-noise.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/depth-camera-simulator-with-realistic-noise.exe`.
