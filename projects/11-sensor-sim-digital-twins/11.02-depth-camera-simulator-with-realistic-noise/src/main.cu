// ===========================================================================
// main.cu — entry point for project 11.02 (Depth-camera simulator with realistic (Kinect-model) noise)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 11.02 (depth-camera-simulator-with-realistic-noise)\n");
