// ===========================================================================
// main.cu — entry point for project 07.09 (Jump-flooding Voronoi/distance transforms (easy, visual, useful))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.09 (jump-flooding-voronoi-distance-transforms)\n");
