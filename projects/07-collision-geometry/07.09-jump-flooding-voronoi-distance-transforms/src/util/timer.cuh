...
//                  (project 07.09; copied from docs/PROJECT_TEMPLATE
...
//    (all JFA passes enqueue on stream 0; main.cu times launch_jfa with
//    CpuTimer + a device sync because the interesting figure spans several
//    launches plus internal transfers); multi-stream projects record into
//    their own streams instead.
