# ===========================================================================
# run_demo.ps1 — one-command demo for 07.09 (Jump-flooding Voronoi/distance transforms (easy, visual, useful))
#
...
#
# 07.09: the real implementation is in; this script is unchanged from the
...
# The demo also writes viewable images into demo/out/ (git-ignored):
# voronoi.pgm and distance.pgm — open them after a run.
#
...
$Slug       = 'jump-flooding-voronoi-distance-transforms'                     # substituted by scaffold.py
