#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 07.09 (Jump-flooding Voronoi/distance transforms (easy, visual, useful))
...
# 07.09: expected_output.txt carries the real implementation's stable lines
...
SLUG='jump-flooding-voronoi-distance-transforms'
