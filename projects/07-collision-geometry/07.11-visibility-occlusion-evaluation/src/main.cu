// ===========================================================================
// main.cu — entry point for project 07.11 (Visibility/occlusion evaluation: next-best-view scoring over candidate poses)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.11 (visibility-occlusion-evaluation)\n");
