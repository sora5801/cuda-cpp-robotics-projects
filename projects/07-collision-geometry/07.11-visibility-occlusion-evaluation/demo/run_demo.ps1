# ===========================================================================
# run_demo.ps1 — one-command demo for 07.11 (Visibility/occlusion evaluation: next-best-view scoring over candidate poses)
#
...
$Slug       = 'visibility-occlusion-evaluation'                     # substituted by scaffold.py
