#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 07.11 (Visibility/occlusion evaluation: next-best-view scoring over candidate poses)
...
SLUG='visibility-occlusion-evaluation'
