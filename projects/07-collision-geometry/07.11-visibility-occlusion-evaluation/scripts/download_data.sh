#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.11 (Visibility/occlusion evaluation: next-best-view scoring over candidate poses)
...
echo "[download_data] Project 07.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
