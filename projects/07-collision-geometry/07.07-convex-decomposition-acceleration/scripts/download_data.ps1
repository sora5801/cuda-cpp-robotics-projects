# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.07 (Convex decomposition (V-HACD-style) acceleration)
#
...
Write-Host "[download_data] Project 07.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
