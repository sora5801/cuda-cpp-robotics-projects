// ===========================================================================
// main.cu — entry point for project 07.07 (Convex decomposition (V-HACD-style) acceleration)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.07 (convex-decomposition-acceleration)\n");
