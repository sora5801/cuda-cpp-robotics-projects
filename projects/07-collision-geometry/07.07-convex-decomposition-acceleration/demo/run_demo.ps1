# ===========================================================================
# run_demo.ps1 — one-command demo for 07.07 (Convex decomposition (V-HACD-style) acceleration)
#
...
$Slug       = 'convex-decomposition-acceleration'                     # substituted by scaffold.py
