// ===========================================================================
// main.cu — entry point for project 07.10 (Ray-mesh intersection library or OptiX wrapper for planning + sensor sim)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.10 (ray-mesh-intersection-library-or-optix-wrapper)\n");
