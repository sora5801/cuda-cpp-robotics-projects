# 07.10 — Ray-mesh intersection library or OptiX wrapper for planning + sensor sim

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Ray-mesh intersection library or OptiX wrapper for planning + sensor sim`
>
...
1. Open [`build/ray-mesh-intersection-library-or-optix-wrapper.sln`](build/ray-mesh-intersection-library-or-optix-wrapper.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/ray-mesh-intersection-library-or-optix-wrapper.exe`.
