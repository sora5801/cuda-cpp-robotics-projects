#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 07.10 (Ray-mesh intersection library or OptiX wrapper for planning + sensor sim)
...
SLUG='ray-mesh-intersection-library-or-optix-wrapper'
