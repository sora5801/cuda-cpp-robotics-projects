# ===========================================================================
# run_demo.ps1 — one-command demo for 07.10 (Ray-mesh intersection library or OptiX wrapper for planning + sensor sim)
#
...
$Slug       = 'ray-mesh-intersection-library-or-optix-wrapper'                     # substituted by scaffold.py
