# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.10 (Ray-mesh intersection library or OptiX wrapper for planning + sensor sim)
#
...
Write-Host "[download_data] Project 07.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
