#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.10 (Ray-mesh intersection library or OptiX wrapper for planning + sensor sim)
...
echo "[download_data] Project 07.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
