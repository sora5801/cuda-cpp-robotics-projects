// ===========================================================================
// main.cu — entry point for project 07.13 (Batched inertia-tensor / mass-property computation from CAD meshes)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.13 (batched-inertia-tensor-mass-property-computation)\n");
