# ===========================================================================
# run_demo.ps1 — one-command demo for 07.13 (Batched inertia-tensor / mass-property computation from CAD meshes)
#
...
$Slug       = 'batched-inertia-tensor-mass-property-computation'                     # substituted by scaffold.py
