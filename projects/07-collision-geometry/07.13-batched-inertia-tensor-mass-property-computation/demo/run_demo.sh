#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 07.13 (Batched inertia-tensor / mass-property computation from CAD meshes)
...
SLUG='batched-inertia-tensor-mass-property-computation'
