# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.13 (Batched inertia-tensor / mass-property computation from CAD meshes)
#
...
Write-Host "[download_data] Project 07.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
