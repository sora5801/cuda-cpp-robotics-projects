# 07.13 — Batched inertia-tensor / mass-property computation from CAD meshes

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Batched inertia-tensor / mass-property computation from CAD meshes`
>
...
1. Open [`build/batched-inertia-tensor-mass-property-computation.sln`](build/batched-inertia-tensor-mass-property-computation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-inertia-tensor-mass-property-computation.exe`.
