# ===========================================================================
# run_demo.ps1 — one-command demo for 07.12 (Mesh decimation/simplification for collision proxies)
#
...
$Slug       = 'mesh-decimation-simplification-for-collision'                     # substituted by scaffold.py
