# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.12 (Mesh decimation/simplification for collision proxies)
#
...
Write-Host "[download_data] Project 07.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
