#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.12 (Mesh decimation/simplification for collision proxies)
...
echo "[download_data] Project 07.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
