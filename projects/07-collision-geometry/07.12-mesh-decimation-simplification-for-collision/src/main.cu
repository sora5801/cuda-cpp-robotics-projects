// ===========================================================================
// main.cu — entry point for project 07.12 (Mesh decimation/simplification for collision proxies)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.12 (mesh-decimation-simplification-for-collision)\n");
