# 07.12 — Mesh decimation/simplification for collision proxies

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Mesh decimation/simplification for collision proxies`
>
...
1. Open [`build/mesh-decimation-simplification-for-collision.sln`](build/mesh-decimation-simplification-for-collision.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mesh-decimation-simplification-for-collision.exe`.
