# ===========================================================================
# run_demo.ps1 — one-command demo for 07.06 (Continuous collision detection (conservative advancement) batches)
#
...
$Slug       = 'continuous-collision-detection-batches'                     # substituted by scaffold.py
