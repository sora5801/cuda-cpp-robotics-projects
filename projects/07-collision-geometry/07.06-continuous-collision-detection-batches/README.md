# 07.06 — Continuous collision detection (conservative advancement) batches

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Continuous collision detection (conservative advancement) batches`
>
...
1. Open [`build/continuous-collision-detection-batches.sln`](build/continuous-collision-detection-batches.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/continuous-collision-detection-batches.exe`.
