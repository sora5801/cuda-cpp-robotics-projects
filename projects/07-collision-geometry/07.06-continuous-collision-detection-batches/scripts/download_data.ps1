# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.06 (Continuous collision detection (conservative advancement) batches)
#
...
Write-Host "[download_data] Project 07.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
