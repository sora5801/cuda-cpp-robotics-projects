#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.06 (Continuous collision detection (conservative advancement) batches)
...
echo "[download_data] Project 07.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
