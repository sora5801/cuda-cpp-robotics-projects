// ===========================================================================
// main.cu — entry point for project 07.06 (Continuous collision detection (conservative advancement) batches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.06 (continuous-collision-detection-batches)\n");
