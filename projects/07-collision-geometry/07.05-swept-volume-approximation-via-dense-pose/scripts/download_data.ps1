# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.05 (Swept-volume approximation via dense pose sampling)
#
...
Write-Host "[download_data] Project 07.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
