# ===========================================================================
# run_demo.ps1 — one-command demo for 07.05 (Swept-volume approximation via dense pose sampling)
#
...
$Slug       = 'swept-volume-approximation-via-dense-pose'                     # substituted by scaffold.py
