// ===========================================================================
// main.cu — entry point for project 07.05 (Swept-volume approximation via dense pose sampling)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.05 (swept-volume-approximation-via-dense-pose)\n");
