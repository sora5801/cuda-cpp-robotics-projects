# 07.05 — Swept-volume approximation via dense pose sampling

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Swept-volume approximation via dense pose sampling`
>
...
1. Open [`build/swept-volume-approximation-via-dense-pose.sln`](build/swept-volume-approximation-via-dense-pose.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/swept-volume-approximation-via-dense-pose.exe`.
