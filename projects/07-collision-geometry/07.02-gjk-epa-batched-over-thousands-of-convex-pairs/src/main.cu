// ===========================================================================
// main.cu — entry point for project 07.02 (GJK + EPA batched over thousands of convex pairs)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.02 (gjk-epa-batched-over-thousands-of-convex-pairs)\n");
