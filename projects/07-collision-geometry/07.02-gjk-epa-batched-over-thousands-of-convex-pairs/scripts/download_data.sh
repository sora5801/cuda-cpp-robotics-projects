#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.02 (GJK + EPA batched over thousands of convex pairs)
...
echo "[download_data] Project 07.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
