# ===========================================================================
# run_demo.ps1 — one-command demo for 07.02 (GJK + EPA batched over thousands of convex pairs)
#
...
$Slug       = 'gjk-epa-batched-over-thousands-of-convex-pairs'                     # substituted by scaffold.py
