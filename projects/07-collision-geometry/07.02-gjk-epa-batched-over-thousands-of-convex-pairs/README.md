# 07.02 — GJK + EPA batched over thousands of convex pairs

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `GJK + EPA batched over thousands of convex pairs`
>
...
1. Open [`build/gjk-epa-batched-over-thousands-of-convex-pairs.sln`](build/gjk-epa-batched-over-thousands-of-convex-pairs.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gjk-epa-batched-over-thousands-of-convex-pairs.exe`.
