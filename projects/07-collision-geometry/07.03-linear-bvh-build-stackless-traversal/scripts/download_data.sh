#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.03 (Linear BVH (Morton codes) build + stackless traversal)
...
echo "[download_data] Project 07.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
