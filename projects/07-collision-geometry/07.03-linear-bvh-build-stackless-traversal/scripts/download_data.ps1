# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.03 (Linear BVH (Morton codes) build + stackless traversal)
#
...
Write-Host "[download_data] Project 07.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
