// ===========================================================================
// main.cu — entry point for project 07.03 (Linear BVH (Morton codes) build + stackless traversal)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.03 (linear-bvh-build-stackless-traversal)\n");
