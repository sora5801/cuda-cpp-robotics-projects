# 07.03 — Linear BVH (Morton codes) build + stackless traversal

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Linear BVH (Morton codes) build + stackless traversal`
>
...
1. Open [`build/linear-bvh-build-stackless-traversal.sln`](build/linear-bvh-build-stackless-traversal.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/linear-bvh-build-stackless-traversal.exe`.
