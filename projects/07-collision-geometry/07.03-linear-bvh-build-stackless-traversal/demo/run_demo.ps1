# ===========================================================================
# run_demo.ps1 — one-command demo for 07.03 (Linear BVH (Morton codes) build + stackless traversal)
#
...
$Slug       = 'linear-bvh-build-stackless-traversal'                     # substituted by scaffold.py
