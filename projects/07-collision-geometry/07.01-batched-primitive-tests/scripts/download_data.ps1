# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.01 (Batched primitive tests: sphere/capsule/OBB vs. voxel worlds)
#
...
Write-Host "[download_data] Project 07.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
