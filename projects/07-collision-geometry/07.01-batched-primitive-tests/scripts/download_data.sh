#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.01 (Batched primitive tests: sphere/capsule/OBB vs. voxel worlds)
...
echo "[download_data] Project 07.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
