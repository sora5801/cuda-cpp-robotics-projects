# ===========================================================================
# run_demo.ps1 — one-command demo for 07.01 (Batched primitive tests: sphere/capsule/OBB vs. voxel worlds)
#
...
$Slug       = 'batched-primitive-tests'                     # substituted by scaffold.py
