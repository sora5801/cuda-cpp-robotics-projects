# 07.01 — Batched primitive tests: sphere/capsule/OBB vs. voxel worlds

**Difficulty:** ★ beginner · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `★ Batched primitive tests: sphere/capsule/OBB vs. voxel worlds`
>
...
1. Open [`build/batched-primitive-tests.sln`](build/batched-primitive-tests.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-primitive-tests.exe`.
