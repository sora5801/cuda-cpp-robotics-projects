// ===========================================================================
// main.cu — entry point for project 07.01 (Batched primitive tests: sphere/capsule/OBB vs. voxel worlds)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.01 (batched-primitive-tests)\n");
