# 07.08 — Minkowski-sum C-space obstacle grids

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Minkowski-sum C-space obstacle grids`
>
...
1. Open [`build/minkowski-sum-c-space-obstacle-grids.sln`](build/minkowski-sum-c-space-obstacle-grids.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/minkowski-sum-c-space-obstacle-grids.exe`.
