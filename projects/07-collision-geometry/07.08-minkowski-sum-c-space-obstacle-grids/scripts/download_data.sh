#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.08 (Minkowski-sum C-space obstacle grids)
...
echo "[download_data] Project 07.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
