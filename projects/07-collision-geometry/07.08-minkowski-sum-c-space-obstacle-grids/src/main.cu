// ===========================================================================
// main.cu — entry point for project 07.08 (Minkowski-sum C-space obstacle grids)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.08 (minkowski-sum-c-space-obstacle-grids)\n");
