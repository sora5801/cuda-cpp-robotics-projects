# ===========================================================================
# run_demo.ps1 — one-command demo for 07.04 (Signed distance field generation from meshes (fast sweeping / exact))
#
...
$Slug       = 'signed-distance-field-generation-from-meshes'                     # substituted by scaffold.py
