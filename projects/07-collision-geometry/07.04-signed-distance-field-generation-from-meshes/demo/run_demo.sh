#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 07.04 (Signed distance field generation from meshes (fast sweeping / exact))
...
SLUG='signed-distance-field-generation-from-meshes'
