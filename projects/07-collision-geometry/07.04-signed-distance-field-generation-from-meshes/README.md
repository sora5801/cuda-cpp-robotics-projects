# 07.04 — Signed distance field generation from meshes (fast sweeping / exact)

**Difficulty:** intermediate · **Domain:** 7. Collision Detection & Geometry

> Catalog bullet (source of truth, verbatim): `Signed distance field generation from meshes (fast sweeping / exact)`
>
...
1. Open [`build/signed-distance-field-generation-from-meshes.sln`](build/signed-distance-field-generation-from-meshes.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/signed-distance-field-generation-from-meshes.exe`.
