# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 07.04 (Signed distance field generation from meshes (fast sweeping / exact))
#
...
Write-Host "[download_data] Project 07.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
