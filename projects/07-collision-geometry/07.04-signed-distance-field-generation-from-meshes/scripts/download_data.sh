#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 07.04 (Signed distance field generation from meshes (fast sweeping / exact))
...
echo "[download_data] Project 07.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
