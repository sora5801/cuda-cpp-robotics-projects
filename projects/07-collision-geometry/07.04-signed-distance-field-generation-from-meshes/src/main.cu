// ===========================================================================
// main.cu — entry point for project 07.04 (Signed distance field generation from meshes (fast sweeping / exact))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 07.04 (signed-distance-field-generation-from-meshes)\n");
