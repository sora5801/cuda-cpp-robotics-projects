# ===========================================================================
# run_demo.ps1 — one-command demo for 26.14 (Tensegrity form-finding and control sim)
#
...
$Slug       = 'tensegrity-form-finding-and-control-sim'                     # substituted by scaffold.py
