#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.14 (Tensegrity form-finding and control sim)
...
echo "[download_data] Project 26.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
