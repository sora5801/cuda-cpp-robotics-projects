# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.14 (Tensegrity form-finding and control sim)
#
...
Write-Host "[download_data] Project 26.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
