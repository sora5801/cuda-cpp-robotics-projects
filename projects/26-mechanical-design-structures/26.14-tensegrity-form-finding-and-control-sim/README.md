# 26.14 — Tensegrity form-finding and control sim

**Difficulty:** [R&D] research · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Tensegrity form-finding and control sim [R&D]`
>
...
Tensegrity form-finding and control sim
...
1. Open [`build/tensegrity-form-finding-and-control-sim.sln`](build/tensegrity-form-finding-and-control-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tensegrity-form-finding-and-control-sim.exe`.
