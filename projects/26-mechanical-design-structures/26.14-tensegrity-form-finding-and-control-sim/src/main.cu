// ===========================================================================
// main.cu — entry point for project 26.14 (Tensegrity form-finding and control sim)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.14 (tensegrity-form-finding-and-control-sim)\n");
