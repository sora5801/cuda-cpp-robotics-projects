#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.16 (Housing aerodynamics/thermal CFD for outdoor robots)
...
echo "[download_data] Project 26.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
