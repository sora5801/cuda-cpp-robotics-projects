# ===========================================================================
# run_demo.ps1 — one-command demo for 26.16 (Housing aerodynamics/thermal CFD for outdoor robots)
#
...
$Slug       = 'housing-aerodynamics-thermal-cfd-for-outdoor'                     # substituted by scaffold.py
