# 26.16 — Housing aerodynamics/thermal CFD for outdoor robots

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Housing aerodynamics/thermal CFD for outdoor robots`
>
...
1. Open [`build/housing-aerodynamics-thermal-cfd-for-outdoor.sln`](build/housing-aerodynamics-thermal-cfd-for-outdoor.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/housing-aerodynamics-thermal-cfd-for-outdoor.exe`.
