# 26.05 — Linkage synthesis: four-bar/six-bar dimensional synthesis via massive parameter sweeps

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Linkage synthesis: four-bar/six-bar dimensional synthesis via massive parameter sweeps`
>
...
1. Open [`build/linkage-synthesis.sln`](build/linkage-synthesis.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/linkage-synthesis.exe`.
