# ===========================================================================
# run_demo.ps1 — one-command demo for 26.05 (Linkage synthesis: four-bar/six-bar dimensional synthesis via massive parameter sweeps)
#
...
$Slug       = 'linkage-synthesis'                     # substituted by scaffold.py
