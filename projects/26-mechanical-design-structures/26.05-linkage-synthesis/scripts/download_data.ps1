# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.05 (Linkage synthesis: four-bar/six-bar dimensional synthesis via massive parameter sweeps)
#
...
Write-Host "[download_data] Project 26.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
