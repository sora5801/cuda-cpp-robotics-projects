// ===========================================================================
// main.cu — entry point for project 26.05 (Linkage synthesis: four-bar/six-bar dimensional synthesis via massive parameter sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.05 (linkage-synthesis)\n");
