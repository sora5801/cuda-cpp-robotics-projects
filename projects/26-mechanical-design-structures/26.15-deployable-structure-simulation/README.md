# 26.15 — Deployable structure simulation

**Difficulty:** [R&D] research · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Deployable structure simulation [R&D]`
>
...
1. Open [`build/deployable-structure-simulation.sln`](build/deployable-structure-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/deployable-structure-simulation.exe`.
