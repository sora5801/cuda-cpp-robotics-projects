#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.15 (Deployable structure simulation)
...
echo "[download_data] Project 26.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
