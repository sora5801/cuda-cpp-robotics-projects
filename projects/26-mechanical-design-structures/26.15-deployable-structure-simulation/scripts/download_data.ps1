# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.15 (Deployable structure simulation)
#
...
Write-Host "[download_data] Project 26.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
