# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.11 (Cable routing / drag-chain simulation)
#
...
Write-Host "[download_data] Project 26.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
