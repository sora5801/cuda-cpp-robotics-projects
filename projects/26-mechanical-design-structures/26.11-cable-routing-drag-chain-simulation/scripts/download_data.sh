#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.11 (Cable routing / drag-chain simulation)
...
echo "[download_data] Project 26.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
