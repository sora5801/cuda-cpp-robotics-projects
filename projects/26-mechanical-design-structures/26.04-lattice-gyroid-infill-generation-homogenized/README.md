# 26.04 — Lattice/gyroid infill generation + homogenized property computation

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Lattice/gyroid infill generation + homogenized property computation`
>
...
1. Open [`build/lattice-gyroid-infill-generation-homogenized.sln`](build/lattice-gyroid-infill-generation-homogenized.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/lattice-gyroid-infill-generation-homogenized.exe`.
