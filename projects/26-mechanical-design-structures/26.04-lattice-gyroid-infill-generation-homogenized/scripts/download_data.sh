#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.04 (Lattice/gyroid infill generation + homogenized property computation)
...
echo "[download_data] Project 26.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
