# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.04 (Lattice/gyroid infill generation + homogenized property computation)
#
...
Write-Host "[download_data] Project 26.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
