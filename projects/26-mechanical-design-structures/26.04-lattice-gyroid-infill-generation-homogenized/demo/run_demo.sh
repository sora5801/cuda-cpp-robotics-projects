#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 26.04 (Lattice/gyroid infill generation + homogenized property computation)
...
SLUG='lattice-gyroid-infill-generation-homogenized'
