# ===========================================================================
# run_demo.ps1 — one-command demo for 26.04 (Lattice/gyroid infill generation + homogenized property computation)
#
...
$Slug       = 'lattice-gyroid-infill-generation-homogenized'                     # substituted by scaffold.py
