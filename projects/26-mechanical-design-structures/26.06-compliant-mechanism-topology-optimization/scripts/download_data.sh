#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.06 (Compliant mechanism (flexure) topology optimization)
...
echo "[download_data] Project 26.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
