# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.06 (Compliant mechanism (flexure) topology optimization)
#
...
Write-Host "[download_data] Project 26.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
