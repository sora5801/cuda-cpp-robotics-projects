# ===========================================================================
# run_demo.ps1 — one-command demo for 26.06 (Compliant mechanism (flexure) topology optimization)
#
...
$Slug       = 'compliant-mechanism-topology-optimization'                     # substituted by scaffold.py
