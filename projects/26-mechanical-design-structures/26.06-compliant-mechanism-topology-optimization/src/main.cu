// ===========================================================================
// main.cu — entry point for project 26.06 (Compliant mechanism (flexure) topology optimization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.06 (compliant-mechanism-topology-optimization)\n");
