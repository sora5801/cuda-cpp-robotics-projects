#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 26.12 (Co-design: joint morphology + controller optimization (evolution over parallel sim))
...
SLUG='co-design-joint-morphology-controller'
