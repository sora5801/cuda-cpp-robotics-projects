# ===========================================================================
# run_demo.ps1 — one-command demo for 26.12 (Co-design: joint morphology + controller optimization (evolution over parallel sim))
#
...
$Slug       = 'co-design-joint-morphology-controller'                     # substituted by scaffold.py
