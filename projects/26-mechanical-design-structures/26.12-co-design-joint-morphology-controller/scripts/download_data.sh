#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.12 (Co-design: joint morphology + controller optimization (evolution over parallel sim))
...
echo "[download_data] Project 26.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
