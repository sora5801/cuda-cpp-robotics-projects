# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.12 (Co-design: joint morphology + controller optimization (evolution over parallel sim))
#
...
Write-Host "[download_data] Project 26.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
