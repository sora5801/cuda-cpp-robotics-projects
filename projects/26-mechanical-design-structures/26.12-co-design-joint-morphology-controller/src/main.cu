// ===========================================================================
// main.cu — entry point for project 26.12 (Co-design: joint morphology + controller optimization (evolution over parallel sim))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.12 (co-design-joint-morphology-controller)\n");
