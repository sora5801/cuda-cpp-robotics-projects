# 26.12 — Co-design: joint morphology + controller optimization (evolution over parallel sim)

**Difficulty:** ★ beginner · [R&D] · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `★ Co-design: joint morphology + controller optimization (evolution over parallel sim) [R&D]`
>
...
Co-design: joint morphology + controller optimization (evolution over parallel sim)
...
1. Open [`build/co-design-joint-morphology-controller.sln`](build/co-design-joint-morphology-controller.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/co-design-joint-morphology-controller.exe`.
