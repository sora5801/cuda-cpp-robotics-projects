# ===========================================================================
# run_demo.ps1 — one-command demo for 26.09 (Joint/fastener fatigue-life Monte Carlo)
#
...
$Slug       = 'joint-fastener-fatigue-life-monte-carlo'                     # substituted by scaffold.py
