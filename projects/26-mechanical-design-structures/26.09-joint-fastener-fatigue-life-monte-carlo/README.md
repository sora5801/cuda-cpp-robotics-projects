# 26.09 — Joint/fastener fatigue-life Monte Carlo

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Joint/fastener fatigue-life Monte Carlo`
>
...
1. Open [`build/joint-fastener-fatigue-life-monte-carlo.sln`](build/joint-fastener-fatigue-life-monte-carlo.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/joint-fastener-fatigue-life-monte-carlo.exe`.
