# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.09 (Joint/fastener fatigue-life Monte Carlo)
#
...
Write-Host "[download_data] Project 26.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
