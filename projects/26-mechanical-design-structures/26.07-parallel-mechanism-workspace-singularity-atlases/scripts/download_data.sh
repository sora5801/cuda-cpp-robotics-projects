#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.07 (Parallel-mechanism workspace + singularity atlases over dense grids)
...
echo "[download_data] Project 26.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
