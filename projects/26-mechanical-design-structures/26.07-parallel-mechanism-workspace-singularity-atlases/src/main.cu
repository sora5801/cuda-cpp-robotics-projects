// ===========================================================================
// main.cu — entry point for project 26.07 (Parallel-mechanism workspace + singularity atlases over dense grids)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.07 (parallel-mechanism-workspace-singularity-atlases)\n");
