#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 26.07 (Parallel-mechanism workspace + singularity atlases over dense grids)
...
SLUG='parallel-mechanism-workspace-singularity-atlases'
