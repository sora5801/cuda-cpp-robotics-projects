# ===========================================================================
# run_demo.ps1 — one-command demo for 26.07 (Parallel-mechanism workspace + singularity atlases over dense grids)
#
...
$Slug       = 'parallel-mechanism-workspace-singularity-atlases'                     # substituted by scaffold.py
