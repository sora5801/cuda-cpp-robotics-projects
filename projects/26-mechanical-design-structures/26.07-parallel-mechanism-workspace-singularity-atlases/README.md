# 26.07 — Parallel-mechanism workspace + singularity atlases over dense grids

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Parallel-mechanism workspace + singularity atlases over dense grids`
>
...
1. Open [`build/parallel-mechanism-workspace-singularity-atlases.sln`](build/parallel-mechanism-workspace-singularity-atlases.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/parallel-mechanism-workspace-singularity-atlases.exe`.
