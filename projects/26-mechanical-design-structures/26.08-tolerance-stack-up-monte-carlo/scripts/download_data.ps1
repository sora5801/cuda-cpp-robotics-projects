# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.08 (Tolerance stack-up Monte Carlo)
#
...
Write-Host "[download_data] Project 26.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
