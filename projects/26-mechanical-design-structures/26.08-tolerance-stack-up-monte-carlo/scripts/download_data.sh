#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.08 (Tolerance stack-up Monte Carlo)
...
echo "[download_data] Project 26.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
