// ===========================================================================
// main.cu — entry point for project 26.08 (Tolerance stack-up Monte Carlo)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.08 (tolerance-stack-up-monte-carlo)\n");
