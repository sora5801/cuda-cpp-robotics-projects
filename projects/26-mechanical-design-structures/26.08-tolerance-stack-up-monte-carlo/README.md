# 26.08 — Tolerance stack-up Monte Carlo

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Tolerance stack-up Monte Carlo`
>
...
1. Open [`build/tolerance-stack-up-monte-carlo.sln`](build/tolerance-stack-up-monte-carlo.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/tolerance-stack-up-monte-carlo.exe`.
