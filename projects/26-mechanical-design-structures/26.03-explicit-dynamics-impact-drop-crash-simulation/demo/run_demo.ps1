# ===========================================================================
# run_demo.ps1 — one-command demo for 26.03 (Explicit-dynamics impact/drop/crash simulation for drones)
#
...
$Slug       = 'explicit-dynamics-impact-drop-crash-simulation'                     # substituted by scaffold.py
