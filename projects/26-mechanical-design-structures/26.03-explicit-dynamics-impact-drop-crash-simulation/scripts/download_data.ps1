# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.03 (Explicit-dynamics impact/drop/crash simulation for drones)
#
...
Write-Host "[download_data] Project 26.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
