// ===========================================================================
// main.cu — entry point for project 26.03 (Explicit-dynamics impact/drop/crash simulation for drones)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.03 (explicit-dynamics-impact-drop-crash-simulation)\n");
