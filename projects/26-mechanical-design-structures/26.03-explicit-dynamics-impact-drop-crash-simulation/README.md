# 26.03 — Explicit-dynamics impact/drop/crash simulation for drones

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Explicit-dynamics impact/drop/crash simulation for drones`
>
...
1. Open [`build/explicit-dynamics-impact-drop-crash-simulation.sln`](build/explicit-dynamics-impact-drop-crash-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/explicit-dynamics-impact-drop-crash-simulation.exe`.
