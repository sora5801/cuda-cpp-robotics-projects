// ===========================================================================
// main.cu — entry point for project 26.02 (GPU FEA: static, modal (arm vibration modes), harmonic response)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.02 (gpu-fea)\n");
