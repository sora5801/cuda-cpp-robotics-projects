# 26.02 — GPU FEA: static, modal (arm vibration modes), harmonic response

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `GPU FEA: static, modal (arm vibration modes), harmonic response`
>
...
1. Open [`build/gpu-fea.sln`](build/gpu-fea.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-fea.exe`.
