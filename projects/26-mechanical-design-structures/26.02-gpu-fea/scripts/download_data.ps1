# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.02 (GPU FEA: static, modal (arm vibration modes), harmonic response)
#
...
Write-Host "[download_data] Project 26.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
