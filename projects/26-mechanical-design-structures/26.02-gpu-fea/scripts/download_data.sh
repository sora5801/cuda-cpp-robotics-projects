#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.02 (GPU FEA: static, modal (arm vibration modes), harmonic response)
...
echo "[download_data] Project 26.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
