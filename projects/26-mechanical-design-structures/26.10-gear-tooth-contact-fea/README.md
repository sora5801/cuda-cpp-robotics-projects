# 26.10 — Gear-tooth contact FEA

**Difficulty:** intermediate · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Gear-tooth contact FEA`
>
...
1. Open [`build/gear-tooth-contact-fea.sln`](build/gear-tooth-contact-fea.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gear-tooth-contact-fea.exe`.
