# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.10 (Gear-tooth contact FEA)
#
...
Write-Host "[download_data] Project 26.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
