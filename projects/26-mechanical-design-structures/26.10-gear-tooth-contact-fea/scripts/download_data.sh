#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.10 (Gear-tooth contact FEA)
...
echo "[download_data] Project 26.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
