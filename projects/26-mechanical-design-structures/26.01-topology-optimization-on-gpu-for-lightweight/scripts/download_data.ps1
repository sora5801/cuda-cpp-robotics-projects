# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.01 (Topology optimization (SIMP/level-set) on GPU for lightweight links and brackets — flagship design project)
#
...
Write-Host "[download_data] Project 26.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
