# ===========================================================================
# run_demo.ps1 — one-command demo for 26.01 (Topology optimization (SIMP/level-set) on GPU for lightweight links and brackets — flagship design project)
#
...
#
# This script needed NO changes once the real SIMP topology-optimization
# pipeline replaced the scaffolded SAXPY placeholder — only expected_output.txt
# changed, to match the stable lines main.cu now prints (see the "output
# contract" comment in ../src/main.cu).
#
...
$Slug       = 'topology-optimization-on-gpu-for-lightweight'                     # substituted by scaffold.py
