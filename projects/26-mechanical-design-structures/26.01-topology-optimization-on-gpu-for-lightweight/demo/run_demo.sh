#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 26.01 (Topology optimization (SIMP/level-set) on GPU for lightweight links and brackets — flagship design project)
...
# expected_output.txt is kept in sync with the stable output lines main.cu
...
SLUG='topology-optimization-on-gpu-for-lightweight'
