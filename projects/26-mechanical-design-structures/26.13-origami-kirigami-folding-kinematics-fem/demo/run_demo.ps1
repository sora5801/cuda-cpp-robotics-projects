# ===========================================================================
# run_demo.ps1 — one-command demo for 26.13 (Origami/kirigami folding kinematics + FEM)
#
...
$Slug       = 'origami-kirigami-folding-kinematics-fem'                     # substituted by scaffold.py
