// ===========================================================================
// main.cu — entry point for project 26.13 (Origami/kirigami folding kinematics + FEM)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 26.13 (origami-kirigami-folding-kinematics-fem)\n");
