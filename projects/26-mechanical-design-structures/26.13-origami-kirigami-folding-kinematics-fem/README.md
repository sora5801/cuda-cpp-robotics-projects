# 26.13 — Origami/kirigami folding kinematics + FEM

**Difficulty:** [R&D] research · **Domain:** 26. Mechanical Design & Structures

> Catalog bullet (source of truth, verbatim): `Origami/kirigami folding kinematics + FEM [R&D]`
>
...
Origami/kirigami folding kinematics + FEM
...
1. Open [`build/origami-kirigami-folding-kinematics-fem.sln`](build/origami-kirigami-folding-kinematics-fem.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/origami-kirigami-folding-kinematics-fem.exe`.
