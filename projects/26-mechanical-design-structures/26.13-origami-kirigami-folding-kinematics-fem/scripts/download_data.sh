#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 26.13 (Origami/kirigami folding kinematics + FEM)
...
echo "[download_data] Project 26.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
