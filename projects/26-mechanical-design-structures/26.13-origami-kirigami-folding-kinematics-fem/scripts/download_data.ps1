# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 26.13 (Origami/kirigami folding kinematics + FEM)
#
...
Write-Host "[download_data] Project 26.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
