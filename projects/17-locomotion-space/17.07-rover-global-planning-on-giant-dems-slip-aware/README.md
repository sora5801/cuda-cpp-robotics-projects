# 17.07 — Rover global planning on giant DEMs (parallel D*), slip-aware traverses

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Rover global planning on giant DEMs (parallel D*), slip-aware traverses`
>
...
1. Open [`build/rover-global-planning-on-giant-dems-slip-aware.sln`](build/rover-global-planning-on-giant-dems-slip-aware.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/rover-global-planning-on-giant-dems-slip-aware.exe`.
