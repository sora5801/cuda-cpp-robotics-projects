#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.07 (Rover global planning on giant DEMs (parallel D*), slip-aware traverses)
...
echo "[download_data] Project 17.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
