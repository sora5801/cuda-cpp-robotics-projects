# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.07 (Rover global planning on giant DEMs (parallel D*), slip-aware traverses)
#
...
Write-Host "[download_data] Project 17.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
