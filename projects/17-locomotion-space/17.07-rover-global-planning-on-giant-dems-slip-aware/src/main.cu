// ===========================================================================
// main.cu — entry point for project 17.07 (Rover global planning on giant DEMs (parallel D*), slip-aware traverses)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.07 (rover-global-planning-on-giant-dems-slip-aware)\n");
