# ===========================================================================
# run_demo.ps1 — one-command demo for 17.07 (Rover global planning on giant DEMs (parallel D*), slip-aware traverses)
#
...
$Slug       = 'rover-global-planning-on-giant-dems-slip-aware'                     # substituted by scaffold.py
