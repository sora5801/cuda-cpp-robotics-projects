#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 17.07 (Rover global planning on giant DEMs (parallel D*), slip-aware traverses)
...
SLUG='rover-global-planning-on-giant-dems-slip-aware'
