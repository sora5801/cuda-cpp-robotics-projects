# 17.10 — Debris capture: net/harpoon simulation (cloth + cable dynamics)

**Difficulty:** [R&D] research · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Debris capture: net/harpoon simulation (cloth + cable dynamics) [R&D]`
>
...
Debris capture: net/harpoon simulation (cloth + cable dynamics)
...
1. Open [`build/debris-capture.sln`](build/debris-capture.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/debris-capture.exe`.
