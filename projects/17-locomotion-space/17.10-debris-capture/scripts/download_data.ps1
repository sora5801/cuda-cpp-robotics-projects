# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.10 (Debris capture: net/harpoon simulation (cloth + cable dynamics))
#
...
Write-Host "[download_data] Project 17.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
