#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.08 (Regolith DEM simulation for wheels and scoops)
...
echo "[download_data] Project 17.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
