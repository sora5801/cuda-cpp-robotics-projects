# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.08 (Regolith DEM simulation for wheels and scoops)
#
...
Write-Host "[download_data] Project 17.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
