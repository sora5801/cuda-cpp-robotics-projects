// ===========================================================================
// main.cu — entry point for project 17.08 (Regolith DEM simulation for wheels and scoops)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.08 (regolith-dem-simulation-for-wheels-and-scoops)\n");
