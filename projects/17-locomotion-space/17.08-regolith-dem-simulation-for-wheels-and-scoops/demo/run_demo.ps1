# ===========================================================================
# run_demo.ps1 — one-command demo for 17.08 (Regolith DEM simulation for wheels and scoops)
#
...
$Slug       = 'regolith-dem-simulation-for-wheels-and-scoops'                     # substituted by scaffold.py
