# 17.08 — Regolith DEM simulation for wheels and scoops

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Regolith DEM simulation for wheels and scoops`
>
...
1. Open [`build/regolith-dem-simulation-for-wheels-and-scoops.sln`](build/regolith-dem-simulation-for-wheels-and-scoops.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/regolith-dem-simulation-for-wheels-and-scoops.exe`.
