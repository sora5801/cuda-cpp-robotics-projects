#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.13 (Fault-tolerant GPU compute patterns for radiation environments)
...
echo "[download_data] Project 17.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
