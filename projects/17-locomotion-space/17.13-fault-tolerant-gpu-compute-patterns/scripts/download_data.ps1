# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.13 (Fault-tolerant GPU compute patterns for radiation environments)
#
...
Write-Host "[download_data] Project 17.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
