# ===========================================================================
# run_demo.ps1 — one-command demo for 17.13 (Fault-tolerant GPU compute patterns for radiation environments)
#
...
$Slug       = 'fault-tolerant-gpu-compute-patterns'                     # substituted by scaffold.py
