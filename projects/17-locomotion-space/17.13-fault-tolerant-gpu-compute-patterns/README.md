# 17.13 — Fault-tolerant GPU compute patterns for radiation environments

**Difficulty:** [R&D] research · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Fault-tolerant GPU compute patterns for radiation environments [R&D]`
>
...
Fault-tolerant GPU compute patterns for radiation environments
...
1. Open [`build/fault-tolerant-gpu-compute-patterns.sln`](build/fault-tolerant-gpu-compute-patterns.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/fault-tolerant-gpu-compute-patterns.exe`.
