// ===========================================================================
// main.cu — entry point for project 17.06 (Entry-descent-landing Monte Carlo dispersion analysis)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.06 (entry-descent-landing-monte-carlo-dispersion)\n");
