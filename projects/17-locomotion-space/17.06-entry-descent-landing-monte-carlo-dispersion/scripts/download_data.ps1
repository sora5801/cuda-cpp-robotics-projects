# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.06 (Entry-descent-landing Monte Carlo dispersion analysis)
#
...
Write-Host "[download_data] Project 17.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
