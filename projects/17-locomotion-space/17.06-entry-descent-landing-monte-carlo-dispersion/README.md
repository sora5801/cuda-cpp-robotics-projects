# 17.06 — Entry-descent-landing Monte Carlo dispersion analysis

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Entry-descent-landing Monte Carlo dispersion analysis`
>
...
1. Open [`build/entry-descent-landing-monte-carlo-dispersion.sln`](build/entry-descent-landing-monte-carlo-dispersion.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/entry-descent-landing-monte-carlo-dispersion.exe`.
