// ===========================================================================
// main.cu — entry point for project 17.05 (All-vs-all conjunction screening (embarrassingly parallel propagation))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.05 (all-vs-all-conjunction-screening)\n");
