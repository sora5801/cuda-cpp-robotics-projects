# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.05 (All-vs-all conjunction screening (embarrassingly parallel propagation))
#
...
Write-Host "[download_data] Project 17.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
