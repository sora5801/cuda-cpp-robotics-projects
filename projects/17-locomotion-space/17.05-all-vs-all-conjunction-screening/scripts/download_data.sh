#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.05 (All-vs-all conjunction screening (embarrassingly parallel propagation))
...
echo "[download_data] Project 17.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
