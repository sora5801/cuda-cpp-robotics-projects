# ===========================================================================
# run_demo.ps1 — one-command demo for 17.05 (All-vs-all conjunction screening (embarrassingly parallel propagation))
#
...
$Slug       = 'all-vs-all-conjunction-screening'                     # substituted by scaffold.py
