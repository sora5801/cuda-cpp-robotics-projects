# 17.05 — All-vs-all conjunction screening (embarrassingly parallel propagation)

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `All-vs-all conjunction screening (embarrassingly parallel propagation)`
>
...
1. Open [`build/all-vs-all-conjunction-screening.sln`](build/all-vs-all-conjunction-screening.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/all-vs-all-conjunction-screening.exe`.
