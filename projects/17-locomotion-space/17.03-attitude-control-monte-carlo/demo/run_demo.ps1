# ===========================================================================
# run_demo.ps1 — one-command demo for 17.03 (Attitude control Monte Carlo: reaction wheels/CMGs, momentum management)
#
...
$Slug       = 'attitude-control-monte-carlo'                     # substituted by scaffold.py
