// ===========================================================================
// main.cu — entry point for project 17.03 (Attitude control Monte Carlo: reaction wheels/CMGs, momentum management)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.03 (attitude-control-monte-carlo)\n");
