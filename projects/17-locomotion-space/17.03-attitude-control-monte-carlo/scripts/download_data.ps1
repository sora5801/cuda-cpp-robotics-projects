# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.03 (Attitude control Monte Carlo: reaction wheels/CMGs, momentum management)
#
...
Write-Host "[download_data] Project 17.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
