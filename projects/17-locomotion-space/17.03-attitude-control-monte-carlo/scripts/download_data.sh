#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.03 (Attitude control Monte Carlo: reaction wheels/CMGs, momentum management)
...
echo "[download_data] Project 17.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
