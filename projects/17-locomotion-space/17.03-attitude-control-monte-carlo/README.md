# 17.03 — Attitude control Monte Carlo: reaction wheels/CMGs, momentum management

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Attitude control Monte Carlo: reaction wheels/CMGs, momentum management`
>
...
1. Open [`build/attitude-control-monte-carlo.sln`](build/attitude-control-monte-carlo.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/attitude-control-monte-carlo.exe`.
