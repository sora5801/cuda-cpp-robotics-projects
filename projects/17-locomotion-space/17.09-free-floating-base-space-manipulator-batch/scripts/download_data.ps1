# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.09 (Free-floating-base space manipulator batch dynamics)
#
...
Write-Host "[download_data] Project 17.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
