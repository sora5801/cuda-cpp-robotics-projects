// ===========================================================================
// main.cu — entry point for project 17.09 (Free-floating-base space manipulator batch dynamics)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.09 (free-floating-base-space-manipulator-batch)\n");
