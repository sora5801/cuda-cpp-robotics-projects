# ===========================================================================
# run_demo.ps1 — one-command demo for 17.09 (Free-floating-base space manipulator batch dynamics)
#
...
$Slug       = 'free-floating-base-space-manipulator-batch'                     # substituted by scaffold.py
