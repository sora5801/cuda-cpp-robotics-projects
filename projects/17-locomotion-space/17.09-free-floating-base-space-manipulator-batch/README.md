# 17.09 — Free-floating-base space manipulator batch dynamics

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Free-floating-base space manipulator batch dynamics`
>
...
1. Open [`build/free-floating-base-space-manipulator-batch.sln`](build/free-floating-base-space-manipulator-batch.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/free-floating-base-space-manipulator-batch.exe`.
