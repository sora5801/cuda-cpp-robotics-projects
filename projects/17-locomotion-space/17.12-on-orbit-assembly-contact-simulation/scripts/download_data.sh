#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.12 (On-orbit assembly contact simulation)
...
echo "[download_data] Project 17.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
