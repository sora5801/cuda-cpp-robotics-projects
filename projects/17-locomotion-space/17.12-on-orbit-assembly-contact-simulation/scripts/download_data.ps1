# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.12 (On-orbit assembly contact simulation)
#
...
Write-Host "[download_data] Project 17.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
