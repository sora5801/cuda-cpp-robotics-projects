# 17.04 — Spacecraft pose estimation for rendezvous/servicing (keypoints + batched PnP)

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Spacecraft pose estimation for rendezvous/servicing (keypoints + batched PnP)`
>
...
1. Open [`build/spacecraft-pose-estimation-for-rendezvous.sln`](build/spacecraft-pose-estimation-for-rendezvous.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/spacecraft-pose-estimation-for-rendezvous.exe`.
