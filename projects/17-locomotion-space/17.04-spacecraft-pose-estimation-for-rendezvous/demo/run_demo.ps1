# ===========================================================================
# run_demo.ps1 — one-command demo for 17.04 (Spacecraft pose estimation for rendezvous/servicing (keypoints + batched PnP))
#
...
$Slug       = 'spacecraft-pose-estimation-for-rendezvous'                     # substituted by scaffold.py
