// ===========================================================================
// main.cu — entry point for project 17.04 (Spacecraft pose estimation for rendezvous/servicing (keypoints + batched PnP))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.04 (spacecraft-pose-estimation-for-rendezvous)\n");
