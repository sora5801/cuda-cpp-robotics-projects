#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.04 (Spacecraft pose estimation for rendezvous/servicing (keypoints + batched PnP))
...
echo "[download_data] Project 17.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
