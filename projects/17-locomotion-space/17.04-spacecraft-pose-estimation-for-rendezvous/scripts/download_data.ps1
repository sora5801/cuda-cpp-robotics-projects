# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.04 (Spacecraft pose estimation for rendezvous/servicing (keypoints + batched PnP))
#
...
Write-Host "[download_data] Project 17.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
