#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.02 (Low-thrust trajectory optimization via parallel shooting)
...
echo "[download_data] Project 17.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
