# ===========================================================================
# run_demo.ps1 — one-command demo for 17.02 (Low-thrust trajectory optimization via parallel shooting)
#
...
$Slug       = 'low-thrust-trajectory-optimization-via-parallel'                     # substituted by scaffold.py
