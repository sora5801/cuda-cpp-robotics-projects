// ===========================================================================
// main.cu — entry point for project 17.02 (Low-thrust trajectory optimization via parallel shooting)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.02 (low-thrust-trajectory-optimization-via-parallel)\n");
