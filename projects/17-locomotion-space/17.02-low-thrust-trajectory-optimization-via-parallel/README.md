# 17.02 — Low-thrust trajectory optimization via parallel shooting

**Difficulty:** [R&D] research · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Low-thrust trajectory optimization via parallel shooting [R&D]`
>
...
Low-thrust trajectory optimization via parallel shooting
...
1. Open [`build/low-thrust-trajectory-optimization-via-parallel.sln`](build/low-thrust-trajectory-optimization-via-parallel.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/low-thrust-trajectory-optimization-via-parallel.exe`.
