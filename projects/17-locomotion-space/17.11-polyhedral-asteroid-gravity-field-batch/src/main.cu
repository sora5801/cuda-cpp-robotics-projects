// ===========================================================================
// main.cu — entry point for project 17.11 (Polyhedral asteroid gravity-field batch evaluation for hovering control)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.11 (polyhedral-asteroid-gravity-field-batch)\n");
