# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 17.11 (Polyhedral asteroid gravity-field batch evaluation for hovering control)
#
...
Write-Host "[download_data] Project 17.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
