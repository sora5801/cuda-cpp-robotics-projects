#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 17.11 (Polyhedral asteroid gravity-field batch evaluation for hovering control)
...
echo "[download_data] Project 17.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
