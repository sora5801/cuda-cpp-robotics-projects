# 17.11 — Polyhedral asteroid gravity-field batch evaluation for hovering control

**Difficulty:** intermediate · **Domain:** 17. Locomotion — Space

> Catalog bullet (source of truth, verbatim): `Polyhedral asteroid gravity-field batch evaluation for hovering control`
>
...
1. Open [`build/polyhedral-asteroid-gravity-field-batch.sln`](build/polyhedral-asteroid-gravity-field-batch.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/polyhedral-asteroid-gravity-field-batch.exe`.
