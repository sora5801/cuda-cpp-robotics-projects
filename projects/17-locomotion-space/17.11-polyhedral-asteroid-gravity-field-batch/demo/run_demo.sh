#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 17.11 (Polyhedral asteroid gravity-field batch evaluation for hovering control)
...
SLUG='polyhedral-asteroid-gravity-field-batch'
