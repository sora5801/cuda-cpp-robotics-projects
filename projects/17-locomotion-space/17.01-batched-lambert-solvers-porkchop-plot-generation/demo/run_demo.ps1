# ===========================================================================
# run_demo.ps1 — one-command demo for 17.01 (Batched Lambert solvers + porkchop plot generation)
#
...
$Slug       = 'batched-lambert-solvers-porkchop-plot-generation'                     # substituted by scaffold.py
