#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 17.01 (Batched Lambert solvers + porkchop plot generation)
...
# 17.01: expected_output.txt carries the real implementation's stable lines
...
SLUG='batched-lambert-solvers-porkchop-plot-generation'
