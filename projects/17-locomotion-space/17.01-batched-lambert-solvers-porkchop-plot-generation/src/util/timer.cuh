...
//                  (project 17.01; copied from docs/PROJECT_TEMPLATE
...
//    single-stream structure of the demos. This project launches exactly
//    one kernel (the whole porkchop grid solved in a single call) bracketed
//    by one GpuTimer — no streams needed; multi-stream projects would
