// ===========================================================================
// main.cu — entry point for project 17.01 (Batched Lambert solvers + porkchop plot generation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 17.01 (batched-lambert-solvers-porkchop-plot-generation)\n");
