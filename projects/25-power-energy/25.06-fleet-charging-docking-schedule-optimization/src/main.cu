// ===========================================================================
// main.cu — entry point for project 25.06 (Fleet charging/docking schedule optimization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 25.06 (fleet-charging-docking-schedule-optimization)\n");
