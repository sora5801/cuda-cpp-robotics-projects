# ===========================================================================
# run_demo.ps1 — one-command demo for 25.06 (Fleet charging/docking schedule optimization)
#
...
$Slug       = 'fleet-charging-docking-schedule-optimization'                     # substituted by scaffold.py
