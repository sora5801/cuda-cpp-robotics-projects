#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.06 (Fleet charging/docking schedule optimization)
...
echo "[download_data] Project 25.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
