# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.06 (Fleet charging/docking schedule optimization)
#
...
Write-Host "[download_data] Project 25.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
