# 25.13 — Vibration energy-harvesting resonance sweeps

**Difficulty:** [R&D] research · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Vibration energy-harvesting resonance sweeps [R&D]`
>
...
Vibration energy-harvesting resonance sweeps
...
1. Open [`build/vibration-energy-harvesting-resonance-sweeps.sln`](build/vibration-energy-harvesting-resonance-sweeps.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/vibration-energy-harvesting-resonance-sweeps.exe`.
