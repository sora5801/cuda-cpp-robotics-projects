# ===========================================================================
# run_demo.ps1 — one-command demo for 25.13 (Vibration energy-harvesting resonance sweeps)
#
...
$Slug       = 'vibration-energy-harvesting-resonance-sweeps'                     # substituted by scaffold.py
