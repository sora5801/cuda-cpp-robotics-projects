# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.13 (Vibration energy-harvesting resonance sweeps)
#
...
Write-Host "[download_data] Project 25.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
