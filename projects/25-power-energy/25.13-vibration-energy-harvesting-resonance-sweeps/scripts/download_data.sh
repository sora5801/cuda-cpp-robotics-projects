#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.13 (Vibration energy-harvesting resonance sweeps)
...
echo "[download_data] Project 25.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
