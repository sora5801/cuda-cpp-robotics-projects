// ===========================================================================
// main.cu — entry point for project 25.13 (Vibration energy-harvesting resonance sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 25.13 (vibration-energy-harvesting-resonance-sweeps)\n");
