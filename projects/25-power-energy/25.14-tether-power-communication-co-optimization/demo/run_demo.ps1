# ===========================================================================
# run_demo.ps1 — one-command demo for 25.14 (Tether power/communication co-optimization)
#
...
$Slug       = 'tether-power-communication-co-optimization'                     # substituted by scaffold.py
