#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.14 (Tether power/communication co-optimization)
...
echo "[download_data] Project 25.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
