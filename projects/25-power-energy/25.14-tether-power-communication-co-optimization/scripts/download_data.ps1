# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.14 (Tether power/communication co-optimization)
#
...
Write-Host "[download_data] Project 25.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
