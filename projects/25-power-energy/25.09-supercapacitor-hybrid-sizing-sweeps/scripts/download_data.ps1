# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.09 (Supercapacitor hybrid sizing sweeps)
#
...
Write-Host "[download_data] Project 25.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
