#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.09 (Supercapacitor hybrid sizing sweeps)
...
echo "[download_data] Project 25.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
