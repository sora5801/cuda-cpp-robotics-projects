// ===========================================================================
// main.cu — entry point for project 25.09 (Supercapacitor hybrid sizing sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 25.09 (supercapacitor-hybrid-sizing-sweeps)\n");
