# 25.09 — Supercapacitor hybrid sizing sweeps

**Difficulty:** intermediate · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Supercapacitor hybrid sizing sweeps`
>
...
1. Open [`build/supercapacitor-hybrid-sizing-sweeps.sln`](build/supercapacitor-hybrid-sizing-sweeps.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/supercapacitor-hybrid-sizing-sweeps.exe`.
