# 25.03 — Pack architecture optimization: series/parallel topology, busbar resistance

**Difficulty:** intermediate · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Pack architecture optimization: series/parallel topology, busbar resistance`
>
...
1. Open [`build/pack-architecture-optimization.sln`](build/pack-architecture-optimization.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/pack-architecture-optimization.exe`.
