# ===========================================================================
# run_demo.ps1 — one-command demo for 25.03 (Pack architecture optimization: series/parallel topology, busbar resistance)
#
...
$Slug       = 'pack-architecture-optimization'                     # substituted by scaffold.py
