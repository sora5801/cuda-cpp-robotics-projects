#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.03 (Pack architecture optimization: series/parallel topology, busbar resistance)
...
echo "[download_data] Project 25.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
