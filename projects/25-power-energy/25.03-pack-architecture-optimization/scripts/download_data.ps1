# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.03 (Pack architecture optimization: series/parallel topology, busbar resistance)
#
...
Write-Host "[download_data] Project 25.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
