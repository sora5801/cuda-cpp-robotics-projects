# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.02 (Per-cell SOC/SOH estimation with particle-filter/EKF banks)
#
...
Write-Host "[download_data] Project 25.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
