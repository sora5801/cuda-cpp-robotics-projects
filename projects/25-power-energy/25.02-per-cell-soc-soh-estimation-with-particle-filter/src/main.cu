// ===========================================================================
// main.cu — entry point for project 25.02 (Per-cell SOC/SOH estimation with particle-filter/EKF banks)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 25.02 (per-cell-soc-soh-estimation-with-particle-filter)\n");
