#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 25.02 (Per-cell SOC/SOH estimation with particle-filter/EKF banks)
...
SLUG='per-cell-soc-soh-estimation-with-particle-filter'
