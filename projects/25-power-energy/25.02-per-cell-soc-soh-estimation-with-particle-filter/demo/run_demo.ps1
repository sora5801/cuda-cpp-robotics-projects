# ===========================================================================
# run_demo.ps1 — one-command demo for 25.02 (Per-cell SOC/SOH estimation with particle-filter/EKF banks)
#
...
$Slug       = 'per-cell-soc-soh-estimation-with-particle-filter'                     # substituted by scaffold.py
