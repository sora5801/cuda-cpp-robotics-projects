# 25.02 — Per-cell SOC/SOH estimation with particle-filter/EKF banks

**Difficulty:** intermediate · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Per-cell SOC/SOH estimation with particle-filter/EKF banks`
>
...
1. Open [`build/per-cell-soc-soh-estimation-with-particle-filter.sln`](build/per-cell-soc-soh-estimation-with-particle-filter.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/per-cell-soc-soh-estimation-with-particle-filter.exe`.
