#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.08 (Fuel-cell polarization + balance-of-plant sim)
...
echo "[download_data] Project 25.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
