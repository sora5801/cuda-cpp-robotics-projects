# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.08 (Fuel-cell polarization + balance-of-plant sim)
#
...
Write-Host "[download_data] Project 25.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
