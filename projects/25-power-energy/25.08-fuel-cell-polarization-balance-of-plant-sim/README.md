# 25.08 — Fuel-cell polarization + balance-of-plant sim

**Difficulty:** [R&D] research · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Fuel-cell polarization + balance-of-plant sim [R&D]`
>
...
1. Open [`build/fuel-cell-polarization-balance-of-plant-sim.sln`](build/fuel-cell-polarization-balance-of-plant-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/fuel-cell-polarization-balance-of-plant-sim.exe`.
