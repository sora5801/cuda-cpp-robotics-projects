# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.04 (Degradation Monte Carlo over robot mission profiles)
#
...
Write-Host "[download_data] Project 25.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
