# ===========================================================================
# run_demo.ps1 — one-command demo for 25.04 (Degradation Monte Carlo over robot mission profiles)
#
...
$Slug       = 'degradation-monte-carlo-over-robot-mission'                     # substituted by scaffold.py
