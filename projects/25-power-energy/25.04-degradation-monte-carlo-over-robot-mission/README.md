# 25.04 — Degradation Monte Carlo over robot mission profiles

**Difficulty:** intermediate · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Degradation Monte Carlo over robot mission profiles`
>
...
1. Open [`build/degradation-monte-carlo-over-robot-mission.sln`](build/degradation-monte-carlo-over-robot-mission.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/degradation-monte-carlo-over-robot-mission.exe`.
