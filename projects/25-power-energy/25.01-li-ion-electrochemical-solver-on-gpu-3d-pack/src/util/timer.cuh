...
//                  (project 25.01; copied from docs/PROJECT_TEMPLATE
...
//    single-stream structure of this project's demo: every launch (both the
//    electrochemistry and thermal kernels) goes through the default stream,
//    so a single pair of events per launch is sufficient and no multi-stream
