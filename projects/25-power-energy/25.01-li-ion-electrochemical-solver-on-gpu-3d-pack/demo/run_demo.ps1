# ===========================================================================
# run_demo.ps1 — one-command demo for 25.01 (Li-ion electrochemical (P2D/SPMe) solver on GPU + 3D pack thermal simulation + cooling-design sweeps)
#
...
#
# RESOLVED (not a placeholder): this script needed NO changes for the real
# implementation, exactly as the template predicted — it builds the real
# electrochemistry+thermal solver and diffs its stable output lines against
# the real expected_output.txt (kept in sync with ../src/main.cu's "output
# contract" comment as part of this project's implementation).
#
...
$Slug       = 'li-ion-electrochemical-solver-on-gpu-3d-pack'                     # substituted by scaffold.py
...
# (expected_output.txt's provenance header is such a comment block).
