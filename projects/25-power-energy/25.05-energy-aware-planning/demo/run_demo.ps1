# ===========================================================================
# run_demo.ps1 — one-command demo for 25.05 (Energy-aware planning: energy cost layers + range-prediction ensembles)
#
...
$Slug       = 'energy-aware-planning'                     # substituted by scaffold.py
