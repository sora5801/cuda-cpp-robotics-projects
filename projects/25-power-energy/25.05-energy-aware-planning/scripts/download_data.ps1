# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.05 (Energy-aware planning: energy cost layers + range-prediction ensembles)
#
...
Write-Host "[download_data] Project 25.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
