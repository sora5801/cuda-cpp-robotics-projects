// ===========================================================================
// main.cu — entry point for project 25.05 (Energy-aware planning: energy cost layers + range-prediction ensembles)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 25.05 (energy-aware-planning)\n");
