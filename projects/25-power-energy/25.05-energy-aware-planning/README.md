# 25.05 — Energy-aware planning: energy cost layers + range-prediction ensembles

**Difficulty:** intermediate · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Energy-aware planning: energy cost layers + range-prediction ensembles`
>
...
1. Open [`build/energy-aware-planning.sln`](build/energy-aware-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/energy-aware-planning.exe`.
