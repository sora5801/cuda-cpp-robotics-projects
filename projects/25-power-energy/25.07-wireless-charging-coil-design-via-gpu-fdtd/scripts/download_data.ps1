# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.07 (Wireless-charging coil design via GPU FDTD electromagnetics)
#
...
Write-Host "[download_data] Project 25.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
