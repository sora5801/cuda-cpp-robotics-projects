#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.07 (Wireless-charging coil design via GPU FDTD electromagnetics)
...
echo "[download_data] Project 25.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
