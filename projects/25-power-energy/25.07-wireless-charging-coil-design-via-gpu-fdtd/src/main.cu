// ===========================================================================
// main.cu — entry point for project 25.07 (Wireless-charging coil design via GPU FDTD electromagnetics)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 25.07 (wireless-charging-coil-design-via-gpu-fdtd)\n");
