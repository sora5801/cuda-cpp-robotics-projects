# ===========================================================================
# run_demo.ps1 — one-command demo for 25.07 (Wireless-charging coil design via GPU FDTD electromagnetics)
#
...
$Slug       = 'wireless-charging-coil-design-via-gpu-fdtd'                     # substituted by scaffold.py
