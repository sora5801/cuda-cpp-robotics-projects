# 25.07 — Wireless-charging coil design via GPU FDTD electromagnetics

**Difficulty:** [R&D] research · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Wireless-charging coil design via GPU FDTD electromagnetics [R&D]`
>
...
Wireless-charging coil design via GPU FDTD electromagnetics
...
1. Open [`build/wireless-charging-coil-design-via-gpu-fdtd.sln`](build/wireless-charging-coil-design-via-gpu-fdtd.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/wireless-charging-coil-design-via-gpu-fdtd.exe`.
