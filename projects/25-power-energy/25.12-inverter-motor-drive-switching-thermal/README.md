# 25.12 — Inverter/motor-drive switching + thermal simulation; EMI spectrum analysis

**Difficulty:** intermediate · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Inverter/motor-drive switching + thermal simulation; EMI spectrum analysis`
>
...
1. Open [`build/inverter-motor-drive-switching-thermal.sln`](build/inverter-motor-drive-switching-thermal.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/inverter-motor-drive-switching-thermal.exe`.
