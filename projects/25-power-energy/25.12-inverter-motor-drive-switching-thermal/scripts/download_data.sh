#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.12 (Inverter/motor-drive switching + thermal simulation; EMI spectrum analysis)
...
echo "[download_data] Project 25.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
