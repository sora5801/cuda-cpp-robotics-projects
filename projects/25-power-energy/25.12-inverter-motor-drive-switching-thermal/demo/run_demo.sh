#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 25.12 (Inverter/motor-drive switching + thermal simulation; EMI spectrum analysis)
...
SLUG='inverter-motor-drive-switching-thermal'
