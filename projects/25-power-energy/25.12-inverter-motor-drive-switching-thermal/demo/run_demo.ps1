# ===========================================================================
# run_demo.ps1 — one-command demo for 25.12 (Inverter/motor-drive switching + thermal simulation; EMI spectrum analysis)
#
...
$Slug       = 'inverter-motor-drive-switching-thermal'                     # substituted by scaffold.py
