# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.10 (Solar robots: terrain irradiance raytracing + panel placement optimization)
#
...
Write-Host "[download_data] Project 25.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
