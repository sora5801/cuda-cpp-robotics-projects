#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.10 (Solar robots: terrain irradiance raytracing + panel placement optimization)
...
echo "[download_data] Project 25.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
