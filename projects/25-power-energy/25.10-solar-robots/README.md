# 25.10 — Solar robots: terrain irradiance raytracing + panel placement optimization

**Difficulty:** intermediate · **Domain:** 25. Power & Energy

> Catalog bullet (source of truth, verbatim): `Solar robots: terrain irradiance raytracing + panel placement optimization`
>
...
1. Open [`build/solar-robots.sln`](build/solar-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/solar-robots.exe`.
