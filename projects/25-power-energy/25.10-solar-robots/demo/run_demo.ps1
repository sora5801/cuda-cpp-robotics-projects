# ===========================================================================
# run_demo.ps1 — one-command demo for 25.10 (Solar robots: terrain irradiance raytracing + panel placement optimization)
#
...
$Slug       = 'solar-robots'                     # substituted by scaffold.py
