# ===========================================================================
# run_demo.ps1 — one-command demo for 25.11 (Regenerative-braking harvest optimization over drive cycles)
#
...
$Slug       = 'regenerative-braking-harvest-optimization'                     # substituted by scaffold.py
