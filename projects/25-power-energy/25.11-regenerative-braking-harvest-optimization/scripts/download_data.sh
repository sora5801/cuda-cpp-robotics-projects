#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 25.11 (Regenerative-braking harvest optimization over drive cycles)
...
echo "[download_data] Project 25.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
