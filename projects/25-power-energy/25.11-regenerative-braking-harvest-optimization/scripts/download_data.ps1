# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 25.11 (Regenerative-braking harvest optimization over drive cycles)
#
...
Write-Host "[download_data] Project 25.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
