# 22.05 — Formation control: batched consensus sim, graph-rigidity checks

**Difficulty:** intermediate · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Formation control: batched consensus sim, graph-rigidity checks`
>
...
1. Open [`build/formation-control.sln`](build/formation-control.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/formation-control.exe`.
