// ===========================================================================
// main.cu — entry point for project 22.05 (Formation control: batched consensus sim, graph-rigidity checks)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.05 (formation-control)\n");
