#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.05 (Formation control: batched consensus sim, graph-rigidity checks)
...
echo "[download_data] Project 22.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
