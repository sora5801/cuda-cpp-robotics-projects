# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.05 (Formation control: batched consensus sim, graph-rigidity checks)
#
...
Write-Host "[download_data] Project 22.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
