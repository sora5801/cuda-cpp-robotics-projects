# ===========================================================================
# run_demo.ps1 — one-command demo for 22.05 (Formation control: batched consensus sim, graph-rigidity checks)
#
...
$Slug       = 'formation-control'                     # substituted by scaffold.py
