# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.01 (100k-agent swarm simulator: flocking, pheromone grids, stigmergy)
#
...
Write-Host "[download_data] Project 22.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
