// ===========================================================================
// main.cu — entry point for project 22.01 (100k-agent swarm simulator: flocking, pheromone grids, stigmergy)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.01 (100k-agent-swarm-simulator)\n");
