#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 22.01 (100k-agent swarm simulator: flocking, pheromone grids, stigmergy)
...
# 22.01: expected_output.txt carries the real implementation's stable lines
...
SLUG='100k-agent-swarm-simulator'
