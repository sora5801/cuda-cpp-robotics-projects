# ===========================================================================
# run_demo.ps1 — one-command demo for 22.01 (100k-agent swarm simulator: flocking, pheromone grids, stigmergy)
#
...
#
# 22.01: the real implementation is in; this script is unchanged from the
...
# The demo writes demo/out/ artifacts (git-ignored): density.pgm (agent
# density heatmap), pheromone.pgm (the stigmergy field — open both in any
# image viewer to SEE the flocks and their trails), and positions.csv
# (first 1000 agents: id, x_m, y_m, vx_ms, vy_ms).
#
...
$Slug       = '100k-agent-swarm-simulator'                     # substituted by scaffold.py
