# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.09 (Communication-aware planning over RF propagation grids)
#
...
Write-Host "[download_data] Project 22.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
