#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.09 (Communication-aware planning over RF propagation grids)
...
echo "[download_data] Project 22.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
