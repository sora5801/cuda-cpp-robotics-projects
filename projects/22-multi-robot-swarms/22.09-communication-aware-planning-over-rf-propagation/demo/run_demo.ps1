# ===========================================================================
# run_demo.ps1 — one-command demo for 22.09 (Communication-aware planning over RF propagation grids)
#
...
$Slug       = 'communication-aware-planning-over-rf-propagation'                     # substituted by scaffold.py
