// ===========================================================================
// main.cu — entry point for project 22.09 (Communication-aware planning over RF propagation grids)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.09 (communication-aware-planning-over-rf-propagation)\n");
