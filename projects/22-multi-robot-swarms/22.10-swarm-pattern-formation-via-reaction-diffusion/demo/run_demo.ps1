# ===========================================================================
# run_demo.ps1 — one-command demo for 22.10 (Swarm pattern formation via reaction-diffusion on GPU)
#
...
$Slug       = 'swarm-pattern-formation-via-reaction-diffusion'                     # substituted by scaffold.py
