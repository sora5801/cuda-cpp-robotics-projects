# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.10 (Swarm pattern formation via reaction-diffusion on GPU)
#
...
Write-Host "[download_data] Project 22.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
