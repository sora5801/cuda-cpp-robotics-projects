#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.10 (Swarm pattern formation via reaction-diffusion on GPU)
...
echo "[download_data] Project 22.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
