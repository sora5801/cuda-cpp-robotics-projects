// ===========================================================================
// main.cu — entry point for project 22.10 (Swarm pattern formation via reaction-diffusion on GPU)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.10 (swarm-pattern-formation-via-reaction-diffusion)\n");
