# 22.10 — Swarm pattern formation via reaction-diffusion on GPU

**Difficulty:** [R&D] research · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Swarm pattern formation via reaction-diffusion on GPU [R&D]`
>
...
Swarm pattern formation via reaction-diffusion on GPU
...
1. Open [`build/swarm-pattern-formation-via-reaction-diffusion.sln`](build/swarm-pattern-formation-via-reaction-diffusion.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/swarm-pattern-formation-via-reaction-diffusion.exe`.
