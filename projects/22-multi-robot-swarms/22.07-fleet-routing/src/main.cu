// ===========================================================================
// main.cu — entry point for project 22.07 (Fleet routing: VRP with GPU-parallel local search (2-opt at scale))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.07 (fleet-routing)\n");
