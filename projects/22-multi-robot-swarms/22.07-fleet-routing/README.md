# 22.07 — Fleet routing: VRP with GPU-parallel local search (2-opt at scale)

**Difficulty:** intermediate · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Fleet routing: VRP with GPU-parallel local search (2-opt at scale)`
>
...
1. Open [`build/fleet-routing.sln`](build/fleet-routing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/fleet-routing.exe`.
