#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.07 (Fleet routing: VRP with GPU-parallel local search (2-opt at scale))
...
echo "[download_data] Project 22.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
