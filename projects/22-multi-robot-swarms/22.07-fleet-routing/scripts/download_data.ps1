# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.07 (Fleet routing: VRP with GPU-parallel local search (2-opt at scale))
#
...
Write-Host "[download_data] Project 22.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
