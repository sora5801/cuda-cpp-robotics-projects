# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.12 (Multi-agent RL training infrastructure)
#
...
Write-Host "[download_data] Project 22.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
