#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.12 (Multi-agent RL training infrastructure)
...
echo "[download_data] Project 22.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
