# 22.12 — Multi-agent RL training infrastructure

**Difficulty:** [R&D] research · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Multi-agent RL training infrastructure [R&D]`
>
...
1. Open [`build/multi-agent-rl-training-infrastructure.sln`](build/multi-agent-rl-training-infrastructure.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/multi-agent-rl-training-infrastructure.exe`.
