// ===========================================================================
// main.cu — entry point for project 22.04 (Coverage control: weighted Voronoi (jump flooding) + Lloyd iterations)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.04 (coverage-control)\n");
