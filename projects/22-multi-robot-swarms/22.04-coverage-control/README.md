# 22.04 — Coverage control: weighted Voronoi (jump flooding) + Lloyd iterations

**Difficulty:** intermediate · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Coverage control: weighted Voronoi (jump flooding) + Lloyd iterations`
>
...
1. Open [`build/coverage-control.sln`](build/coverage-control.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/coverage-control.exe`.
