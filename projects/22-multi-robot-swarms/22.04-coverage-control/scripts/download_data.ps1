# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.04 (Coverage control: weighted Voronoi (jump flooding) + Lloyd iterations)
#
...
Write-Host "[download_data] Project 22.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
