#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.04 (Coverage control: weighted Voronoi (jump flooding) + Lloyd iterations)
...
echo "[download_data] Project 22.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
