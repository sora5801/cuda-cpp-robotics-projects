# ===========================================================================
# run_demo.ps1 — one-command demo for 22.04 (Coverage control: weighted Voronoi (jump flooding) + Lloyd iterations)
#
...
$Slug       = 'coverage-control'                     # substituted by scaffold.py
