// ===========================================================================
// main.cu — entry point for project 22.03 (Task allocation: GPU cost matrices + auction/Hungarian solvers)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.03 (task-allocation)\n");
