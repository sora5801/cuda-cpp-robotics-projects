#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.03 (Task allocation: GPU cost matrices + auction/Hungarian solvers)
...
echo "[download_data] Project 22.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
