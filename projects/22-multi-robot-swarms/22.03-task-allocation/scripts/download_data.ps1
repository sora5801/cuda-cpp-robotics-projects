# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.03 (Task allocation: GPU cost matrices + auction/Hungarian solvers)
#
...
Write-Host "[download_data] Project 22.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
