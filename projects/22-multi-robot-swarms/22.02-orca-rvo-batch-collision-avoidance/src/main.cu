// ===========================================================================
// main.cu — entry point for project 22.02 (ORCA/RVO batch collision avoidance)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.02 (orca-rvo-batch-collision-avoidance)\n");
