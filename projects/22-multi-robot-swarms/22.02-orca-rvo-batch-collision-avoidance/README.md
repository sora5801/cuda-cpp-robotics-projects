# 22.02 — ORCA/RVO batch collision avoidance

**Difficulty:** intermediate · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `ORCA/RVO batch collision avoidance`
>
...
1. Open [`build/orca-rvo-batch-collision-avoidance.sln`](build/orca-rvo-batch-collision-avoidance.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/orca-rvo-batch-collision-avoidance.exe`.
