#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.02 (ORCA/RVO batch collision avoidance)
...
echo "[download_data] Project 22.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
