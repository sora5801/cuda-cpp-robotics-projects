// ===========================================================================
// main.cu — entry point for project 22.08 (Warehouse traffic microsimulation + deadlock detection)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.08 (warehouse-traffic-microsimulation-deadlock)\n");
