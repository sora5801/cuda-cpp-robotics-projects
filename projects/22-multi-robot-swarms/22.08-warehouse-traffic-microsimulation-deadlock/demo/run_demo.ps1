# ===========================================================================
# run_demo.ps1 — one-command demo for 22.08 (Warehouse traffic microsimulation + deadlock detection)
#
...
$Slug       = 'warehouse-traffic-microsimulation-deadlock'                     # substituted by scaffold.py
