#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.08 (Warehouse traffic microsimulation + deadlock detection)
...
echo "[download_data] Project 22.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
