# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.08 (Warehouse traffic microsimulation + deadlock detection)
#
...
Write-Host "[download_data] Project 22.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
