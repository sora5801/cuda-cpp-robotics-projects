# 22.08 — Warehouse traffic microsimulation + deadlock detection

**Difficulty:** intermediate · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Warehouse traffic microsimulation + deadlock detection`
>
...
1. Open [`build/warehouse-traffic-microsimulation-deadlock.sln`](build/warehouse-traffic-microsimulation-deadlock.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/warehouse-traffic-microsimulation-deadlock.exe`.
