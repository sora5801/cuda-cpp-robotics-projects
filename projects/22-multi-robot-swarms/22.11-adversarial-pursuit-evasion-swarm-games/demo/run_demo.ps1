# ===========================================================================
# run_demo.ps1 — one-command demo for 22.11 (Adversarial/pursuit-evasion swarm games)
#
...
$Slug       = 'adversarial-pursuit-evasion-swarm-games'                     # substituted by scaffold.py
