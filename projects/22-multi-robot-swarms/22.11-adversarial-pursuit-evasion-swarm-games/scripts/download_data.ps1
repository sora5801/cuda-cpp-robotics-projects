# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.11 (Adversarial/pursuit-evasion swarm games)
#
...
Write-Host "[download_data] Project 22.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
