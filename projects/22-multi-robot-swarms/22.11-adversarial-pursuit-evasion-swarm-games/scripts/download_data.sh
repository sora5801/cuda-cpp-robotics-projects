#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 22.11 (Adversarial/pursuit-evasion swarm games)
...
echo "[download_data] Project 22.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
