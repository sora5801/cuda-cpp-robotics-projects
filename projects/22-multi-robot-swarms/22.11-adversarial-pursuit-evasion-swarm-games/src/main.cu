// ===========================================================================
// main.cu — entry point for project 22.11 (Adversarial/pursuit-evasion swarm games)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.11 (adversarial-pursuit-evasion-swarm-games)\n");
