# 22.11 — Adversarial/pursuit-evasion swarm games

**Difficulty:** [R&D] research · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Adversarial/pursuit-evasion swarm games [R&D]`
>
...
Adversarial/pursuit-evasion swarm games
...
1. Open [`build/adversarial-pursuit-evasion-swarm-games.sln`](build/adversarial-pursuit-evasion-swarm-games.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/adversarial-pursuit-evasion-swarm-games.exe`.
