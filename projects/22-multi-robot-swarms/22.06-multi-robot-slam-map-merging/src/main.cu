// ===========================================================================
// main.cu — entry point for project 22.06 (Multi-robot SLAM map merging: descriptor search + alignment)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 22.06 (multi-robot-slam-map-merging)\n");
