# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 22.06 (Multi-robot SLAM map merging: descriptor search + alignment)
#
...
Write-Host "[download_data] Project 22.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
