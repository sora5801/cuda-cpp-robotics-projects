# 22.06 — Multi-robot SLAM map merging: descriptor search + alignment

**Difficulty:** intermediate · **Domain:** 22. Multi-Robot Systems & Swarms

> Catalog bullet (source of truth, verbatim): `Multi-robot SLAM map merging: descriptor search + alignment`
>
...
1. Open [`build/multi-robot-slam-map-merging.sln`](build/multi-robot-slam-map-merging.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/multi-robot-slam-map-merging.exe`.
