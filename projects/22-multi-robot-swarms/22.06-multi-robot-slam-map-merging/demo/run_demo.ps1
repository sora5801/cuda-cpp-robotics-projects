# ===========================================================================
# run_demo.ps1 — one-command demo for 22.06 (Multi-robot SLAM map merging: descriptor search + alignment)
#
...
$Slug       = 'multi-robot-slam-map-merging'                     # substituted by scaffold.py
