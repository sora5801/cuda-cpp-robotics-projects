#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 30.04 (Mining: muck-pile volumetrics; drill-pattern optimization; dust-robust underground SLAM)
...
SLUG='mining-muck-pile-volumetrics-drill-pattern'
