# ===========================================================================
# run_demo.ps1 — one-command demo for 30.04 (Mining: muck-pile volumetrics; drill-pattern optimization; dust-robust underground SLAM)
#
...
$Slug       = 'mining-muck-pile-volumetrics-drill-pattern'                     # substituted by scaffold.py
