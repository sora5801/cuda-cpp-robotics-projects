# 30.04 — Mining: muck-pile volumetrics; drill-pattern optimization; dust-robust underground SLAM

**Difficulty:** intermediate · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Mining: muck-pile volumetrics; drill-pattern optimization; dust-robust underground SLAM`
>
...
1. Open [`build/mining-muck-pile-volumetrics-drill-pattern.sln`](build/mining-muck-pile-volumetrics-drill-pattern.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mining-muck-pile-volumetrics-drill-pattern.exe`.
