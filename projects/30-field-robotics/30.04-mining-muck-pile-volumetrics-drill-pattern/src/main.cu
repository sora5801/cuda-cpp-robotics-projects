// ===========================================================================
// main.cu — entry point for project 30.04 (Mining: muck-pile volumetrics; drill-pattern optimization; dust-robust underground SLAM)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 30.04 (mining-muck-pile-volumetrics-drill-pattern)\n");
