# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.04 (Mining: muck-pile volumetrics; drill-pattern optimization; dust-robust underground SLAM)
#
...
Write-Host "[download_data] Project 30.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
