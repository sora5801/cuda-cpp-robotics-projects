#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.04 (Mining: muck-pile volumetrics; drill-pattern optimization; dust-robust underground SLAM)
...
echo "[download_data] Project 30.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
