#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 30.05 (Forestry: tree segmentation + diameter estimation from point clouds)
...
SLUG='forestry-tree-segmentation-diameter-estimation'
