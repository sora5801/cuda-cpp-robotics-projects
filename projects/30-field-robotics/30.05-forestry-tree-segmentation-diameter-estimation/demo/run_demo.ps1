# ===========================================================================
# run_demo.ps1 — one-command demo for 30.05 (Forestry: tree segmentation + diameter estimation from point clouds)
#
...
$Slug       = 'forestry-tree-segmentation-diameter-estimation'                     # substituted by scaffold.py
