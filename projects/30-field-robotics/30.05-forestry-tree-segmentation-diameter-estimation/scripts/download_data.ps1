# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.05 (Forestry: tree segmentation + diameter estimation from point clouds)
#
...
Write-Host "[download_data] Project 30.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
