# 30.05 — Forestry: tree segmentation + diameter estimation from point clouds

**Difficulty:** intermediate · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Forestry: tree segmentation + diameter estimation from point clouds`
>
...
1. Open [`build/forestry-tree-segmentation-diameter-estimation.sln`](build/forestry-tree-segmentation-diameter-estimation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/forestry-tree-segmentation-diameter-estimation.exe`.
