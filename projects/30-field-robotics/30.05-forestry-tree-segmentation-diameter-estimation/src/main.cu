// ===========================================================================
// main.cu — entry point for project 30.05 (Forestry: tree segmentation + diameter estimation from point clouds)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 30.05 (forestry-tree-segmentation-diameter-estimation)\n");
