#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 30.03 (Construction: excavation soil DEM + bucket-fill optimization ; rebar/stud detection; scan-to-BIM registration; crane anti-sway tuning sweeps)
