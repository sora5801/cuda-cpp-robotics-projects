// ===========================================================================
// main.cu — entry point for project 30.03 (Construction: excavation soil DEM + bucket-fill optimization ; rebar/stud detection; scan-to-BIM registration; crane anti-sway tuning sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 30.03 (construction)\n");
