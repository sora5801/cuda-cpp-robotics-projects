#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.03 (Construction: excavation soil DEM + bucket-fill optimization ; rebar/stud detection; scan-to-BIM registration; crane anti-sway tuning sweeps)
...
echo "[download_data] Project 30.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
