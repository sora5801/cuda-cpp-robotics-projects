// ===========================================================================
// main.cu — entry point for project 30.10 (Warehouse/retail: shelf-scan planogram compliance; pallet pose estimation; AprilTag fleet infrastructure)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 30.10 (warehouse-retail)\n");
