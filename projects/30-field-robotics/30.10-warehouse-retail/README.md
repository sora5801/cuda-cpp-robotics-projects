# 30.10 — Warehouse/retail: shelf-scan planogram compliance; pallet pose estimation; AprilTag fleet infrastructure

**Difficulty:** intermediate · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Warehouse/retail: shelf-scan planogram compliance; pallet pose estimation; AprilTag fleet infrastructure`
>
...
1. Open [`build/warehouse-retail.sln`](build/warehouse-retail.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/warehouse-retail.exe`.
