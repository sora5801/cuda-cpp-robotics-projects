# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.10 (Warehouse/retail: shelf-scan planogram compliance; pallet pose estimation; AprilTag fleet infrastructure)
#
...
Write-Host "[download_data] Project 30.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
