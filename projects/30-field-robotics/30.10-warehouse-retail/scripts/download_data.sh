#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.10 (Warehouse/retail: shelf-scan planogram compliance; pallet pose estimation; AprilTag fleet infrastructure)
...
echo "[download_data] Project 30.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
