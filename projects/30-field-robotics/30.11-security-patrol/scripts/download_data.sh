#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.11 (Security patrol: multi-camera re-identification pipelines)
...
echo "[download_data] Project 30.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
