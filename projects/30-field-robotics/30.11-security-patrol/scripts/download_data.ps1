# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.11 (Security patrol: multi-camera re-identification pipelines)
#
...
Write-Host "[download_data] Project 30.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
