# 30.11 — Security patrol: multi-camera re-identification pipelines

**Difficulty:** intermediate · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Security patrol: multi-camera re-identification pipelines`
>
...
1. Open [`build/security-patrol.sln`](build/security-patrol.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/security-patrol.exe`.
