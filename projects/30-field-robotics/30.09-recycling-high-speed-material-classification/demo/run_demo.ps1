# ===========================================================================
# run_demo.ps1 — one-command demo for 30.09 (Recycling: high-speed material classification + tracking on conveyor belts)
#
...
$Slug       = 'recycling-high-speed-material-classification'                     # substituted by scaffold.py
