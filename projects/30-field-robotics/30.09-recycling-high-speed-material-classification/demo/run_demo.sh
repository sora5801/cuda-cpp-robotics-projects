#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 30.09 (Recycling: high-speed material classification + tracking on conveyor belts)
...
SLUG='recycling-high-speed-material-classification'
