# 30.09 — Recycling: high-speed material classification + tracking on conveyor belts

**Difficulty:** intermediate · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Recycling: high-speed material classification + tracking on conveyor belts`
>
...
1. Open [`build/recycling-high-speed-material-classification.sln`](build/recycling-high-speed-material-classification.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/recycling-high-speed-material-classification.exe`.
