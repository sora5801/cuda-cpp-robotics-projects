# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.09 (Recycling: high-speed material classification + tracking on conveyor belts)
#
...
Write-Host "[download_data] Project 30.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
