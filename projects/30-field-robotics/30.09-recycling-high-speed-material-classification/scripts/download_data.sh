#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.09 (Recycling: high-speed material classification + tracking on conveyor belts)
...
echo "[download_data] Project 30.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
