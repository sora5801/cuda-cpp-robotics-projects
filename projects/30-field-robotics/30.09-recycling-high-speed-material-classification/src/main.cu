// ===========================================================================
// main.cu — entry point for project 30.09 (Recycling: high-speed material classification + tracking on conveyor belts)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 30.09 (recycling-high-speed-material-classification)\n");
