# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.08 (Wildfire: GPU fire-spread simulation + suppression planning)
#
...
Write-Host "[download_data] Project 30.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
