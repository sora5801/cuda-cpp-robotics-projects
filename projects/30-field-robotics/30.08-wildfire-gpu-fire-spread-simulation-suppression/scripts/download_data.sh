#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.08 (Wildfire: GPU fire-spread simulation + suppression planning)
...
echo "[download_data] Project 30.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
