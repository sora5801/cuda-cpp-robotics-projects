# 30.08 — Wildfire: GPU fire-spread simulation + suppression planning

**Difficulty:** [R&D] research · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Wildfire: GPU fire-spread simulation + suppression planning [R&D]`
>
...
Wildfire: GPU fire-spread simulation + suppression planning
...
1. Open [`build/wildfire-gpu-fire-spread-simulation-suppression.sln`](build/wildfire-gpu-fire-spread-simulation-suppression.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/wildfire-gpu-fire-spread-simulation-suppression.exe`.
