// ===========================================================================
// main.cu — entry point for project 30.08 (Wildfire: GPU fire-spread simulation + suppression planning)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 30.08 (wildfire-gpu-fire-spread-simulation-suppression)\n");
