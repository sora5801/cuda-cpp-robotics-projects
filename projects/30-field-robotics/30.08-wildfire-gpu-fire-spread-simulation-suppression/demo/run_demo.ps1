# ===========================================================================
# run_demo.ps1 — one-command demo for 30.08 (Wildfire: GPU fire-spread simulation + suppression planning)
#
...
$Slug       = 'wildfire-gpu-fire-spread-simulation-suppression'                     # substituted by scaffold.py
