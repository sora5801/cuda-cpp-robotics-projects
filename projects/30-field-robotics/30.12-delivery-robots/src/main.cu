// ===========================================================================
// main.cu — entry point for project 30.12 (Delivery robots: sidewalk hazard perception; snow/wet surface classification)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 30.12 (delivery-robots)\n");
