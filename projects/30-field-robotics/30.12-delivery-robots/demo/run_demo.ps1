# ===========================================================================
# run_demo.ps1 — one-command demo for 30.12 (Delivery robots: sidewalk hazard perception; snow/wet surface classification)
#
...
$Slug       = 'delivery-robots'                     # substituted by scaffold.py
