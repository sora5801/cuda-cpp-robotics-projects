#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.12 (Delivery robots: sidewalk hazard perception; snow/wet surface classification)
...
echo "[download_data] Project 30.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
