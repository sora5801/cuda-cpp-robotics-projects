# 30.12 — Delivery robots: sidewalk hazard perception; snow/wet surface classification

**Difficulty:** intermediate · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Delivery robots: sidewalk hazard perception; snow/wet surface classification`
>
...
1. Open [`build/delivery-robots.sln`](build/delivery-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/delivery-robots.exe`.
