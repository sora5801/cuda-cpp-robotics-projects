# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.07 (Disaster response: multi-modal victim detection; rubble traversability ; radiation field mapping + source seeking)
#
...
Write-Host "[download_data] Project 30.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
