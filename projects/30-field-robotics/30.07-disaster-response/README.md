# 30.07 — Disaster response: multi-modal victim detection; rubble traversability ; radiation field mapping + source seeking

**Difficulty:** [R&D] research · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Disaster response: multi-modal victim detection; rubble traversability [R&D]; radiation field mapping + source seeking`
>
...
Disaster response: multi-modal victim detection; rubble traversability ; radiation field mapping + source seeking
...
1. Open [`build/disaster-response.sln`](build/disaster-response.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/disaster-response.exe`.
