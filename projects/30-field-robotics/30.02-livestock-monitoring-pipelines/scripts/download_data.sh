#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.02 (Livestock monitoring pipelines)
...
echo "[download_data] Project 30.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
