# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 30.02 (Livestock monitoring pipelines)
#
...
Write-Host "[download_data] Project 30.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
