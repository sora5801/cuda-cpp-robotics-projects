# 30.02 — Livestock monitoring pipelines

**Difficulty:** intermediate · **Domain:** 30. Field & Industry-Specific Robotics

> Catalog bullet (source of truth, verbatim): `Livestock monitoring pipelines`
>
...
1. Open [`build/livestock-monitoring-pipelines.sln`](build/livestock-monitoring-pipelines.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/livestock-monitoring-pipelines.exe`.
