#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 30.06 (Inspection: crack/corrosion segmentation; solar-farm thermal anomaly detection; wind-turbine blade scan alignment; tank/pipe robot mapping; ultrasonic NDT scan processing)
...
echo "[download_data] Project 30.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
