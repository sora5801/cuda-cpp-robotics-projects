# ===========================================================================
# run_demo.ps1 — one-command demo for 30.06 (Inspection: crack/corrosion segmentation; solar-farm thermal anomaly detection; wind-turbine blade scan alignment; tank/pipe robot mapping; ultrasonic NDT scan processing)
#
...
$Slug       = 'inspection'                     # substituted by scaffold.py
