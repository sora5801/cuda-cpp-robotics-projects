# ===========================================================================
# run_demo.ps1 — one-command demo for 30.01 (Agriculture: fruit detection + 3D localization + ripeness; weed-vs-crop segmentation at frame rate; per-plant spray targeting; crop-row following; canopy volume from LiDAR; under-canopy navigation; yield mapping)
#
...
#
# This script needed NO changes once the real pipeline replaced the SAXPY
# placeholder — keep expected_output.txt in sync with the stable lines
# main.cu prints (see the "output contract" comment in ../src/main.cu).
#
...
$Slug       = 'agriculture'                     # substituted by scaffold.py
