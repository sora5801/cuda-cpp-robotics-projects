#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.12 (Capacitive e-skin / whisker array signal processing)
...
echo "[download_data] Project 03.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
