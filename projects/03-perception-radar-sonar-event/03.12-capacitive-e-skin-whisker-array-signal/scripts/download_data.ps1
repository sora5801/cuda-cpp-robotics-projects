# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.12 (Capacitive e-skin / whisker array signal processing)
#
...
Write-Host "[download_data] Project 03.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
