# ===========================================================================
# run_demo.ps1 — one-command demo for 03.12 (Capacitive e-skin / whisker array signal processing)
#
...
$Slug       = 'capacitive-e-skin-whisker-array-signal'                     # substituted by scaffold.py
