// ===========================================================================
// main.cu — entry point for project 03.12 (Capacitive e-skin / whisker array signal processing)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.12 (capacitive-e-skin-whisker-array-signal)\n");
