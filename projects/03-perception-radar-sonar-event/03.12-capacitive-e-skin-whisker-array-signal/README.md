# 03.12 — Capacitive e-skin / whisker array signal processing

**Difficulty:** [R&D] research · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Capacitive e-skin / whisker array signal processing [R&D]`
>
...
Capacitive e-skin / whisker array signal processing
...
1. Open [`build/capacitive-e-skin-whisker-array-signal.sln`](build/capacitive-e-skin-whisker-array-signal.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/capacitive-e-skin-whisker-array-signal.exe`.
