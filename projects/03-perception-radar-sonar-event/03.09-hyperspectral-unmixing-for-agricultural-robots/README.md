# 03.09 — Hyperspectral unmixing for agricultural robots

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Hyperspectral unmixing for agricultural robots`
>
...
1. Open [`build/hyperspectral-unmixing-for-agricultural-robots.sln`](build/hyperspectral-unmixing-for-agricultural-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/hyperspectral-unmixing-for-agricultural-robots.exe`.
