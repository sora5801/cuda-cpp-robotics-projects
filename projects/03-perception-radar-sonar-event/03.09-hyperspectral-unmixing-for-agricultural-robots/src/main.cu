// ===========================================================================
// main.cu — entry point for project 03.09 (Hyperspectral unmixing for agricultural robots)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.09 (hyperspectral-unmixing-for-agricultural-robots)\n");
