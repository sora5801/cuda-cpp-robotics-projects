#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.09 (Hyperspectral unmixing for agricultural robots)
...
echo "[download_data] Project 03.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
