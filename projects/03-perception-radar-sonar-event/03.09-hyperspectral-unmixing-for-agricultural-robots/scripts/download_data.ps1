# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.09 (Hyperspectral unmixing for agricultural robots)
#
...
Write-Host "[download_data] Project 03.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
