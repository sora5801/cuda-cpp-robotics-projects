# ===========================================================================
# run_demo.ps1 — one-command demo for 03.09 (Hyperspectral unmixing for agricultural robots)
#
...
$Slug       = 'hyperspectral-unmixing-for-agricultural-robots'                     # substituted by scaffold.py
