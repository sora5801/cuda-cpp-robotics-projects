#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.02 (Radar ego-velocity estimation (RANSAC over Doppler returns))
...
echo "[download_data] Project 03.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
