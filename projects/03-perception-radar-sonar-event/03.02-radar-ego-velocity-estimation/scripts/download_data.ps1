# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.02 (Radar ego-velocity estimation (RANSAC over Doppler returns))
#
...
Write-Host "[download_data] Project 03.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
