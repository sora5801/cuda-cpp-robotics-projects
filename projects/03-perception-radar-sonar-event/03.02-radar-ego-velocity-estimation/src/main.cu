// ===========================================================================
// main.cu — entry point for project 03.02 (Radar ego-velocity estimation (RANSAC over Doppler returns))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.02 (radar-ego-velocity-estimation)\n");
