# ===========================================================================
# run_demo.ps1 — one-command demo for 03.02 (Radar ego-velocity estimation (RANSAC over Doppler returns))
#
...
$Slug       = 'radar-ego-velocity-estimation'                     # substituted by scaffold.py
