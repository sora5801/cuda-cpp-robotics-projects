# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.03 (Radar occupancy grids and micro-Doppler preprocessing for classification)
#
...
Write-Host "[download_data] Project 03.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
