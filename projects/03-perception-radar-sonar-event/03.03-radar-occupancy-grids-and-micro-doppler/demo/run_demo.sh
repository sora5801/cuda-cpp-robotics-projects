#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 03.03 (Radar occupancy grids and micro-Doppler preprocessing for classification)
...
SLUG='radar-occupancy-grids-and-micro-doppler'
