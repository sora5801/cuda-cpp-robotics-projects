# ===========================================================================
# run_demo.ps1 — one-command demo for 03.03 (Radar occupancy grids and micro-Doppler preprocessing for classification)
#
...
$Slug       = 'radar-occupancy-grids-and-micro-doppler'                     # substituted by scaffold.py
