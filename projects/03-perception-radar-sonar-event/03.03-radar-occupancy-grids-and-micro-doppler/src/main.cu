// ===========================================================================
// main.cu — entry point for project 03.03 (Radar occupancy grids and micro-Doppler preprocessing for classification)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.03 (radar-occupancy-grids-and-micro-doppler)\n");
