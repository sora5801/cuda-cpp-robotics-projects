# 03.03 — Radar occupancy grids and micro-Doppler preprocessing for classification

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Radar occupancy grids and micro-Doppler preprocessing for classification`
>
...
1. Open [`build/radar-occupancy-grids-and-micro-doppler.sln`](build/radar-occupancy-grids-and-micro-doppler.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/radar-occupancy-grids-and-micro-doppler.exe`.
