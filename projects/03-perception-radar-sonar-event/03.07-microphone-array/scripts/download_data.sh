#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.07 (Microphone array: GPU beamforming + SRP-PHAT sound-source localization)
...
echo "[download_data] Project 03.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
