// ===========================================================================
// main.cu — entry point for project 03.07 (Microphone array: GPU beamforming + SRP-PHAT sound-source localization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.07 (microphone-array)\n");
