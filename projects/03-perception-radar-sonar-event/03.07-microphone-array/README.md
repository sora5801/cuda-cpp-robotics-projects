# 03.07 — Microphone array: GPU beamforming + SRP-PHAT sound-source localization

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Microphone array: GPU beamforming + SRP-PHAT sound-source localization`
>
...
1. Open [`build/microphone-array.sln`](build/microphone-array.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/microphone-array.exe`.
