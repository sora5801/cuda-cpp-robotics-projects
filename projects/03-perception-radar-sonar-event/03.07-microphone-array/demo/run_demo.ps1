# ===========================================================================
# run_demo.ps1 — one-command demo for 03.07 (Microphone array: GPU beamforming + SRP-PHAT sound-source localization)
#
...
$Slug       = 'microphone-array'                     # substituted by scaffold.py
