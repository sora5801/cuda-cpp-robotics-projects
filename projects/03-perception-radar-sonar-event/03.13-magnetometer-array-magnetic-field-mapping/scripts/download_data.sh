#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.13 (Magnetometer-array magnetic field mapping for indoor localization)
...
echo "[download_data] Project 03.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
