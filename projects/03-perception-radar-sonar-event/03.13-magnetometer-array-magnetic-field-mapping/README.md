# 03.13 — Magnetometer-array magnetic field mapping for indoor localization

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Magnetometer-array magnetic field mapping for indoor localization`
>
...
1. Open [`build/magnetometer-array-magnetic-field-mapping.sln`](build/magnetometer-array-magnetic-field-mapping.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/magnetometer-array-magnetic-field-mapping.exe`.
