// ===========================================================================
// main.cu — entry point for project 03.13 (Magnetometer-array magnetic field mapping for indoor localization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.13 (magnetometer-array-magnetic-field-mapping)\n");
