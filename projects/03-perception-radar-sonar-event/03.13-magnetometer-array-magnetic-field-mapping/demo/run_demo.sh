#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 03.13 (Magnetometer-array magnetic field mapping for indoor localization)
...
SLUG='magnetometer-array-magnetic-field-mapping'
