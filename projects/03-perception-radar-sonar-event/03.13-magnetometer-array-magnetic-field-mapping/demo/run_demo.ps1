# ===========================================================================
# run_demo.ps1 — one-command demo for 03.13 (Magnetometer-array magnetic field mapping for indoor localization)
#
...
$Slug       = 'magnetometer-array-magnetic-field-mapping'                     # substituted by scaffold.py
