#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.04 (Sonar beamforming: delay-and-sum, MVDR)
...
echo "[download_data] Project 03.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
