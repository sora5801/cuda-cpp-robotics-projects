# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.04 (Sonar beamforming: delay-and-sum, MVDR)
#
...
Write-Host "[download_data] Project 03.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
