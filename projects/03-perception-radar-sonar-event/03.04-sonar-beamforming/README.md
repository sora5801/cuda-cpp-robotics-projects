# 03.04 — Sonar beamforming: delay-and-sum, MVDR

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Sonar beamforming: delay-and-sum, MVDR`
>
...
1. Open [`build/sonar-beamforming.sln`](build/sonar-beamforming.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/sonar-beamforming.exe`.
