# ===========================================================================
# run_demo.ps1 — one-command demo for 03.10 (Ground-penetrating radar migration for subsurface inspection robots)
#
...
$Slug       = 'ground-penetrating-radar-migration'                     # substituted by scaffold.py
