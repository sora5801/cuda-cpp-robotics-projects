# 03.10 — Ground-penetrating radar migration for subsurface inspection robots

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Ground-penetrating radar migration for subsurface inspection robots`
>
...
1. Open [`build/ground-penetrating-radar-migration.sln`](build/ground-penetrating-radar-migration.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/ground-penetrating-radar-migration.exe`.
