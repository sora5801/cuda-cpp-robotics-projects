#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.10 (Ground-penetrating radar migration for subsurface inspection robots)
...
echo "[download_data] Project 03.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
