// ===========================================================================
// main.cu — entry point for project 03.10 (Ground-penetrating radar migration for subsurface inspection robots)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.10 (ground-penetrating-radar-migration)\n");
