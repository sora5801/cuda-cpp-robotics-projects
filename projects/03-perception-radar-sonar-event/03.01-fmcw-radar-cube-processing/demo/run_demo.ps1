# ===========================================================================
# run_demo.ps1 — one-command demo for 03.01 (FMCW radar cube processing: range-Doppler-angle FFTs + CA/OS-CFAR detection)
#
...
#
# This script needed NO changes for the real FMCW pipeline implementation —
# only expected_output.txt changed, to match the stable lines main.cu now
...
$Slug       = 'fmcw-radar-cube-processing'                     # substituted by scaffold.py
