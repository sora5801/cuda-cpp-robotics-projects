// ===========================================================================
// main.cu — entry point for project 03.01 (FMCW radar cube processing: range-Doppler-angle FFTs + CA/OS-CFAR detection)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.01 (fmcw-radar-cube-processing)\n");
