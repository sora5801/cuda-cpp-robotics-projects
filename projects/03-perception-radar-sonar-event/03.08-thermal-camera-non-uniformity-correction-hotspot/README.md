# 03.08 — Thermal camera non-uniformity correction + hotspot detection

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Thermal camera non-uniformity correction + hotspot detection`
>
...
1. Open [`build/thermal-camera-non-uniformity-correction-hotspot.sln`](build/thermal-camera-non-uniformity-correction-hotspot.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/thermal-camera-non-uniformity-correction-hotspot.exe`.
