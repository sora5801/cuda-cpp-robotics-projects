#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.08 (Thermal camera non-uniformity correction + hotspot detection)
...
echo "[download_data] Project 03.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
