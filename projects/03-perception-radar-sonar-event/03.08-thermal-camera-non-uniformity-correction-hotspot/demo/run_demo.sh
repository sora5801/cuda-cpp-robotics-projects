#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 03.08 (Thermal camera non-uniformity correction + hotspot detection)
...
SLUG='thermal-camera-non-uniformity-correction-hotspot'
