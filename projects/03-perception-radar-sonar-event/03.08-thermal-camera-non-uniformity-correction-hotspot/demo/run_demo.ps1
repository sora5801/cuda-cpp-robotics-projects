# ===========================================================================
# run_demo.ps1 — one-command demo for 03.08 (Thermal camera non-uniformity correction + hotspot detection)
#
...
$Slug       = 'thermal-camera-non-uniformity-correction-hotspot'                     # substituted by scaffold.py
