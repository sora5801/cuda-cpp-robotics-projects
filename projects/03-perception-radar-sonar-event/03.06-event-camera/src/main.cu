// ===========================================================================
// main.cu — entry point for project 03.06 (Event camera: event denoising, surface-of-active-events, eFAST corners, event optical flow, contrast maximization for ego-rotation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.06 (event-camera)\n");
