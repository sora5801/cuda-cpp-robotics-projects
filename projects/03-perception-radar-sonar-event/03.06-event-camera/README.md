# 03.06 — Event camera: event denoising, surface-of-active-events, eFAST corners, event optical flow, contrast maximization for ego-rotation

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Event camera: event denoising, surface-of-active-events, eFAST corners, event optical flow, contrast maximization for ego-rotation`
>
...
1. Open [`build/event-camera.sln`](build/event-camera.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/event-camera.exe`.
