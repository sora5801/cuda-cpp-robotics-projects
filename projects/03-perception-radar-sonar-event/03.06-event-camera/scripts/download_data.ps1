# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.06 (Event camera: event denoising, surface-of-active-events, eFAST corners, event optical flow, contrast maximization for ego-rotation)
#
...
Write-Host "[download_data] Project 03.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
