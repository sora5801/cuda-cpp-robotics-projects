# ===========================================================================
# run_demo.ps1 — one-command demo for 03.05 (Forward-looking sonar enhancement + frame registration)
#
...
$Slug       = 'forward-looking-sonar-enhancement-frame'                     # substituted by scaffold.py
