# 03.05 — Forward-looking sonar enhancement + frame registration

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `Forward-looking sonar enhancement + frame registration`
>
...
1. Open [`build/forward-looking-sonar-enhancement-frame.sln`](build/forward-looking-sonar-enhancement-frame.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/forward-looking-sonar-enhancement-frame.exe`.
