// ===========================================================================
// main.cu — entry point for project 03.05 (Forward-looking sonar enhancement + frame registration)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.05 (forward-looking-sonar-enhancement-frame)\n");
