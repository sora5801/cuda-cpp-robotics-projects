# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.05 (Forward-looking sonar enhancement + frame registration)
#
...
Write-Host "[download_data] Project 03.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
