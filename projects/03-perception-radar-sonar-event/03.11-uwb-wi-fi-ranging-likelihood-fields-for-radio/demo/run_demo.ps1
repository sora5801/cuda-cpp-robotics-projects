# ===========================================================================
# run_demo.ps1 — one-command demo for 03.11 (UWB/Wi-Fi ranging likelihood fields for radio SLAM)
#
...
$Slug       = 'uwb-wi-fi-ranging-likelihood-fields-for-radio'                     # substituted by scaffold.py
