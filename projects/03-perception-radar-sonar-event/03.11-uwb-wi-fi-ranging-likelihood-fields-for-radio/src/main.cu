// ===========================================================================
// main.cu — entry point for project 03.11 (UWB/Wi-Fi ranging likelihood fields for radio SLAM)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 03.11 (uwb-wi-fi-ranging-likelihood-fields-for-radio)\n");
