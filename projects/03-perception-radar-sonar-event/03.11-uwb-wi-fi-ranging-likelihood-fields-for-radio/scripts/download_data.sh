#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 03.11 (UWB/Wi-Fi ranging likelihood fields for radio SLAM)
...
echo "[download_data] Project 03.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
