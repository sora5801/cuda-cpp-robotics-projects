# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 03.11 (UWB/Wi-Fi ranging likelihood fields for radio SLAM)
#
...
Write-Host "[download_data] Project 03.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
