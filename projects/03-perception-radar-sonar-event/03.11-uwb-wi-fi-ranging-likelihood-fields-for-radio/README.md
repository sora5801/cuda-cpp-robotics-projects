# 03.11 — UWB/Wi-Fi ranging likelihood fields for radio SLAM

**Difficulty:** intermediate · **Domain:** 3. Perception — Radar, Sonar, Event & Exotic Sensors

> Catalog bullet (source of truth, verbatim): `UWB/Wi-Fi ranging likelihood fields for radio SLAM`
>
...
1. Open [`build/uwb-wi-fi-ranging-likelihood-fields-for-radio.sln`](build/uwb-wi-fi-ranging-likelihood-fields-for-radio.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/uwb-wi-fi-ranging-likelihood-fields-for-radio.exe`.
