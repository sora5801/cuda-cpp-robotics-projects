# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.07 (Streaming anomaly detection on robot telemetry)
#
...
Write-Host "[download_data] Project 31.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
