#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.07 (Streaming anomaly detection on robot telemetry)
...
echo "[download_data] Project 31.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
