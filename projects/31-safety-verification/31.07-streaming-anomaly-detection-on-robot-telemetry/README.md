# 31.07 — Streaming anomaly detection on robot telemetry

**Difficulty:** intermediate · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `Streaming anomaly detection on robot telemetry`
>
...
1. Open [`build/streaming-anomaly-detection-on-robot-telemetry.sln`](build/streaming-anomaly-detection-on-robot-telemetry.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/streaming-anomaly-detection-on-robot-telemetry.exe`.
