# ===========================================================================
# run_demo.ps1 — one-command demo for 31.07 (Streaming anomaly detection on robot telemetry)
#
...
$Slug       = 'streaming-anomaly-detection-on-robot-telemetry'                     # substituted by scaffold.py
