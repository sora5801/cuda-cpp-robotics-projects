// ===========================================================================
// main.cu — entry point for project 31.02 (Zonotope/interval reachability batched over uncertainty sets)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 31.02 (zonotope-interval-reachability-batched)\n");
