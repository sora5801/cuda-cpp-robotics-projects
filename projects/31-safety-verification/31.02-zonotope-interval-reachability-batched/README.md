# 31.02 — Zonotope/interval reachability batched over uncertainty sets

**Difficulty:** intermediate · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `Zonotope/interval reachability batched over uncertainty sets`
>
...
1. Open [`build/zonotope-interval-reachability-batched.sln`](build/zonotope-interval-reachability-batched.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/zonotope-interval-reachability-batched.exe`.
