#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.02 (Zonotope/interval reachability batched over uncertainty sets)
...
echo "[download_data] Project 31.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
