# ===========================================================================
# run_demo.ps1 — one-command demo for 31.02 (Zonotope/interval reachability batched over uncertainty sets)
#
...
$Slug       = 'zonotope-interval-reachability-batched'                     # substituted by scaffold.py
