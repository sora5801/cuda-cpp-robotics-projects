# 31.09 — Physics-of-failure prognostics Monte Carlo

**Difficulty:** intermediate · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `Physics-of-failure prognostics Monte Carlo`
>
...
1. Open [`build/physics-of-failure-prognostics-monte-carlo.sln`](build/physics-of-failure-prognostics-monte-carlo.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/physics-of-failure-prognostics-monte-carlo.exe`.
