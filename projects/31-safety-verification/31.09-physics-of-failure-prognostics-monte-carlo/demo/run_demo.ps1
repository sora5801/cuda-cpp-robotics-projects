# ===========================================================================
# run_demo.ps1 — one-command demo for 31.09 (Physics-of-failure prognostics Monte Carlo)
#
...
$Slug       = 'physics-of-failure-prognostics-monte-carlo'                     # substituted by scaffold.py
