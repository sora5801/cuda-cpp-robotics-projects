#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.09 (Physics-of-failure prognostics Monte Carlo)
...
echo "[download_data] Project 31.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
