# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.09 (Physics-of-failure prognostics Monte Carlo)
#
...
Write-Host "[download_data] Project 31.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
