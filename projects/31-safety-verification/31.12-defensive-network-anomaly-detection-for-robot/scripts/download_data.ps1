# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.12 (Defensive network anomaly detection for robot fleets)
#
...
Write-Host "[download_data] Project 31.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
