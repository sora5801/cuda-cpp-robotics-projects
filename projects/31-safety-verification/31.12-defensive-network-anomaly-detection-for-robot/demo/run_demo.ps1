# ===========================================================================
# run_demo.ps1 — one-command demo for 31.12 (Defensive network anomaly detection for robot fleets)
#
...
$Slug       = 'defensive-network-anomaly-detection-for-robot'                     # substituted by scaffold.py
