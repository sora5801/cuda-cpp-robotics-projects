# 31.12 — Defensive network anomaly detection for robot fleets

**Difficulty:** intermediate · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `Defensive network anomaly detection for robot fleets`
>
...
1. Open [`build/defensive-network-anomaly-detection-for-robot.sln`](build/defensive-network-anomaly-detection-for-robot.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/defensive-network-anomaly-detection-for-robot.exe`.
