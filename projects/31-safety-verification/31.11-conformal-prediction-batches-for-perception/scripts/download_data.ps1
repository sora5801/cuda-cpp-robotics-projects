# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.11 (Conformal prediction batches for perception uncertainty bounds)
#
...
Write-Host "[download_data] Project 31.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
