# ===========================================================================
# run_demo.ps1 — one-command demo for 31.11 (Conformal prediction batches for perception uncertainty bounds)
#
...
$Slug       = 'conformal-prediction-batches-for-perception'                     # substituted by scaffold.py
