// ===========================================================================
// main.cu — entry point for project 31.10 (Failure-boundary cartography: map where a controller breaks across parameter space)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 31.10 (failure-boundary-cartography)\n");
