# 31.10 — Failure-boundary cartography: map where a controller breaks across parameter space

**Difficulty:** intermediate · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `Failure-boundary cartography: map where a controller breaks across parameter space`
>
...
1. Open [`build/failure-boundary-cartography.sln`](build/failure-boundary-cartography.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/failure-boundary-cartography.exe`.
