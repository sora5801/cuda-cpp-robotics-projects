#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.10 (Failure-boundary cartography: map where a controller breaks across parameter space)
...
echo "[download_data] Project 31.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
