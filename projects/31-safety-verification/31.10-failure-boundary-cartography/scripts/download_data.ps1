# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.10 (Failure-boundary cartography: map where a controller breaks across parameter space)
#
...
Write-Host "[download_data] Project 31.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
