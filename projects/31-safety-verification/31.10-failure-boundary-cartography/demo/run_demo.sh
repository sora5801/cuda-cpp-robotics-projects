#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 31.10 (Failure-boundary cartography: map where a controller breaks across parameter space)
...
SLUG='failure-boundary-cartography'
