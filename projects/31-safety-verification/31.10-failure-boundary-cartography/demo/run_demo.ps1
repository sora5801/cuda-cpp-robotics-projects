# ===========================================================================
# run_demo.ps1 — one-command demo for 31.10 (Failure-boundary cartography: map where a controller breaks across parameter space)
#
...
$Slug       = 'failure-boundary-cartography'                     # substituted by scaffold.py
