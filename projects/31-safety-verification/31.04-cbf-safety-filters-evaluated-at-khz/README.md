# 31.04 — CBF safety filters evaluated at kHz over constraint batches

**Difficulty:** intermediate · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `CBF safety filters evaluated at kHz over constraint batches`
>
...
1. Open [`build/cbf-safety-filters-evaluated-at-khz.sln`](build/cbf-safety-filters-evaluated-at-khz.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/cbf-safety-filters-evaluated-at-khz.exe`.
