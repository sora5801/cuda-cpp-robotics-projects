// ===========================================================================
// main.cu — entry point for project 31.04 (CBF safety filters evaluated at kHz over constraint batches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 31.04 (cbf-safety-filters-evaluated-at-khz)\n");
