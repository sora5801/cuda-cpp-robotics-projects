# ===========================================================================
# run_demo.ps1 — one-command demo for 31.04 (CBF safety filters evaluated at kHz over constraint batches)
#
...
$Slug       = 'cbf-safety-filters-evaluated-at-khz'                     # substituted by scaffold.py
