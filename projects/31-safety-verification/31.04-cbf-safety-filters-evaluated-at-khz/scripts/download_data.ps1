# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.04 (CBF safety filters evaluated at kHz over constraint batches)
#
...
Write-Host "[download_data] Project 31.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
