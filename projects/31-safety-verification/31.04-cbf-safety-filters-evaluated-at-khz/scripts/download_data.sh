#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.04 (CBF safety filters evaluated at kHz over constraint batches)
...
echo "[download_data] Project 31.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
