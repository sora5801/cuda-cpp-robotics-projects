# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.05 (Scenario-based validation farm: massive Monte Carlo + adversarial falsification search)
#
...
Write-Host "[download_data] Project 31.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
