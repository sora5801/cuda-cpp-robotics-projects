#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.05 (Scenario-based validation farm: massive Monte Carlo + adversarial falsification search)
...
echo "[download_data] Project 31.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
