#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 31.05 (Scenario-based validation farm: massive Monte Carlo + adversarial falsification search)
...
SLUG='scenario-based-validation-farm'
