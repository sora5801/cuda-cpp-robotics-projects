# ===========================================================================
# run_demo.ps1 — one-command demo for 31.05 (Scenario-based validation farm: massive Monte Carlo + adversarial falsification search)
#
...
$Slug       = 'scenario-based-validation-farm'                     # substituted by scaffold.py
