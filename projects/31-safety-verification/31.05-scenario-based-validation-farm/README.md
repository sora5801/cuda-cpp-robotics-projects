# 31.05 — Scenario-based validation farm: massive Monte Carlo + adversarial falsification search

**Difficulty:** [R&D] research · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `Scenario-based validation farm: massive Monte Carlo + adversarial falsification search [R&D]`
>
...
Scenario-based validation farm: massive Monte Carlo + adversarial falsification search
...
1. Open [`build/scenario-based-validation-farm.sln`](build/scenario-based-validation-farm.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/scenario-based-validation-farm.exe`.
