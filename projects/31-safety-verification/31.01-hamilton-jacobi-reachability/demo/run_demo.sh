#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 31.01 (Hamilton-Jacobi reachability: level-set grid solvers (stencil ops — GPU-perfect))
...
# the "output contract" comment at the top of ../src/main.cu).
# ===========================================================================
set -euo pipefail
...
SLUG='hamilton-jacobi-reachability'
