// ===========================================================================
// main.cu — entry point for project 31.01 (Hamilton-Jacobi reachability: level-set grid solvers (stencil ops — GPU-perfect))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 31.01 (hamilton-jacobi-reachability)\n");
