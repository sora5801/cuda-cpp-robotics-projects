# ===========================================================================
# run_demo.ps1 — one-command demo for 31.08 (Runtime verification: signal temporal logic robustness monitoring batched on GPU)
#
...
$Slug       = 'runtime-verification'                     # substituted by scaffold.py
