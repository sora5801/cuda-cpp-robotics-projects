# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.08 (Runtime verification: signal temporal logic robustness monitoring batched on GPU)
#
...
Write-Host "[download_data] Project 31.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
