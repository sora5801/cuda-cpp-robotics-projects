#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.08 (Runtime verification: signal temporal logic robustness monitoring batched on GPU)
...
echo "[download_data] Project 31.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
