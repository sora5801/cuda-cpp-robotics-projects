# ===========================================================================
# run_demo.ps1 — one-command demo for 31.03 (Neural-network verification: interval bound propagation / CROWN-style kernels)
#
...
$Slug       = 'neural-network-verification'                     # substituted by scaffold.py
