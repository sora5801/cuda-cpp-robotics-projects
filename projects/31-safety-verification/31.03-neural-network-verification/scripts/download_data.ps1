# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.03 (Neural-network verification: interval bound propagation / CROWN-style kernels)
#
...
Write-Host "[download_data] Project 31.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
