#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.03 (Neural-network verification: interval bound propagation / CROWN-style kernels)
...
echo "[download_data] Project 31.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
