// ===========================================================================
// main.cu — entry point for project 31.03 (Neural-network verification: interval bound propagation / CROWN-style kernels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 31.03 (neural-network-verification)\n");
