# 31.06 — Parallel fault-injection campaigns (sensor/actuator failures across thousands of sims)

**Difficulty:** intermediate · **Domain:** 31. Safety, Verification & Testing

> Catalog bullet (source of truth, verbatim): `Parallel fault-injection campaigns (sensor/actuator failures across thousands of sims)`
>
...
1. Open [`build/parallel-fault-injection-campaigns.sln`](build/parallel-fault-injection-campaigns.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/parallel-fault-injection-campaigns.exe`.
