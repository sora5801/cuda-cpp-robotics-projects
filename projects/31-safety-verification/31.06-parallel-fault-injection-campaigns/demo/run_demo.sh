#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 31.06 (Parallel fault-injection campaigns (sensor/actuator failures across thousands of sims))
...
SLUG='parallel-fault-injection-campaigns'
