# ===========================================================================
# run_demo.ps1 — one-command demo for 31.06 (Parallel fault-injection campaigns (sensor/actuator failures across thousands of sims))
#
...
$Slug       = 'parallel-fault-injection-campaigns'                     # substituted by scaffold.py
