#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 31.06 (Parallel fault-injection campaigns (sensor/actuator failures across thousands of sims))
...
echo "[download_data] Project 31.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
