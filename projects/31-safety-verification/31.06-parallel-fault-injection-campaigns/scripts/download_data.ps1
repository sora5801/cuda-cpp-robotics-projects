# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 31.06 (Parallel fault-injection campaigns (sensor/actuator failures across thousands of sims))
#
...
Write-Host "[download_data] Project 31.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
