# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.03 (Human motion prediction batches for collaborative safety)
#
...
Write-Host "[download_data] Project 21.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
