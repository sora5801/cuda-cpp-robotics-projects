#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.03 (Human motion prediction batches for collaborative safety)
...
echo "[download_data] Project 21.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
