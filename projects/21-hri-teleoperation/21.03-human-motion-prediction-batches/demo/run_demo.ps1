# ===========================================================================
# run_demo.ps1 — one-command demo for 21.03 (Human motion prediction batches for collaborative safety)
#
...
$Slug       = 'human-motion-prediction-batches'                     # substituted by scaffold.py
