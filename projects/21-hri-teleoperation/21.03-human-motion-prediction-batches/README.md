# 21.03 — Human motion prediction batches for collaborative safety

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Human motion prediction batches for collaborative safety`
>
...
1. Open [`build/human-motion-prediction-batches.sln`](build/human-motion-prediction-batches.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/human-motion-prediction-batches.exe`.
