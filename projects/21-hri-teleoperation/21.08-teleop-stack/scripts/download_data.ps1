# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.08 (Teleop stack: NVENC low-latency video + GPU point-cloud compression/streaming)
#
...
Write-Host "[download_data] Project 21.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
