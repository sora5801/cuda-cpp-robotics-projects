#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.08 (Teleop stack: NVENC low-latency video + GPU point-cloud compression/streaming)
...
echo "[download_data] Project 21.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
