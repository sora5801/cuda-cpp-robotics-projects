# 21.08 — Teleop stack: NVENC low-latency video + GPU point-cloud compression/streaming

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Teleop stack: NVENC low-latency video + GPU point-cloud compression/streaming`
>
...
1. Open [`build/teleop-stack.sln`](build/teleop-stack.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/teleop-stack.exe`.
