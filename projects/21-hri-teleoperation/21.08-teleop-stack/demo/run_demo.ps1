# ===========================================================================
# run_demo.ps1 — one-command demo for 21.08 (Teleop stack: NVENC low-latency video + GPU point-cloud compression/streaming)
#
...
$Slug       = 'teleop-stack'                     # substituted by scaffold.py
