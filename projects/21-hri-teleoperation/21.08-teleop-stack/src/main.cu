// ===========================================================================
// main.cu — entry point for project 21.08 (Teleop stack: NVENC low-latency video + GPU point-cloud compression/streaming)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.08 (teleop-stack)\n");
