// ===========================================================================
// main.cu — entry point for project 21.11 (Shared autonomy: arbitration over parallel goal hypotheses)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.11 (shared-autonomy)\n");
