# 21.11 — Shared autonomy: arbitration over parallel goal hypotheses

**Difficulty:** [R&D] research · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Shared autonomy: arbitration over parallel goal hypotheses [R&D]`
>
...
Shared autonomy: arbitration over parallel goal hypotheses
...
1. Open [`build/shared-autonomy.sln`](build/shared-autonomy.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/shared-autonomy.exe`.
