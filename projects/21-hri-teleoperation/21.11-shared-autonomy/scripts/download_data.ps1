# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.11 (Shared autonomy: arbitration over parallel goal hypotheses)
#
...
Write-Host "[download_data] Project 21.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
