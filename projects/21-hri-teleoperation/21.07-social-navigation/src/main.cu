// ===========================================================================
// main.cu — entry point for project 21.07 (Social navigation: batched pedestrian forecasting + ORCA crowd simulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.07 (social-navigation)\n");
