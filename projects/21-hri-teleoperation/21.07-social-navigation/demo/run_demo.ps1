# ===========================================================================
# run_demo.ps1 — one-command demo for 21.07 (Social navigation: batched pedestrian forecasting + ORCA crowd simulation)
#
...
$Slug       = 'social-navigation'                     # substituted by scaffold.py
