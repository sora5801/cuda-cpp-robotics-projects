#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.07 (Social navigation: batched pedestrian forecasting + ORCA crowd simulation)
...
echo "[download_data] Project 21.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
