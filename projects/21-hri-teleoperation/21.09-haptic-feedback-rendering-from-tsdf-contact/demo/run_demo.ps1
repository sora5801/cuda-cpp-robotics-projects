# ===========================================================================
# run_demo.ps1 — one-command demo for 21.09 (Haptic feedback rendering from TSDF contact queries)
#
...
$Slug       = 'haptic-feedback-rendering-from-tsdf-contact'                     # substituted by scaffold.py
