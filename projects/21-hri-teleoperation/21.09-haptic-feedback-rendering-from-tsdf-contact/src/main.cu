// ===========================================================================
// main.cu — entry point for project 21.09 (Haptic feedback rendering from TSDF contact queries)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.09 (haptic-feedback-rendering-from-tsdf-contact)\n");
