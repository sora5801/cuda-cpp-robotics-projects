#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.09 (Haptic feedback rendering from TSDF contact queries)
...
echo "[download_data] Project 21.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
