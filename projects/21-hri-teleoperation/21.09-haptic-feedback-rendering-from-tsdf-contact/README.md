# 21.09 — Haptic feedback rendering from TSDF contact queries

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Haptic feedback rendering from TSDF contact queries`
>
...
1. Open [`build/haptic-feedback-rendering-from-tsdf-contact.sln`](build/haptic-feedback-rendering-from-tsdf-contact.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/haptic-feedback-rendering-from-tsdf-contact.exe`.
