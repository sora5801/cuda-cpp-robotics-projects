// ===========================================================================
// main.cu — entry point for project 21.10 (VR digital-twin rendering with live robot state)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.10 (vr-digital-twin-rendering-with-live-robot-state)\n");
