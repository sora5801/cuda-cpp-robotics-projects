# ===========================================================================
# run_demo.ps1 — one-command demo for 21.10 (VR digital-twin rendering with live robot state)
#
...
$Slug       = 'vr-digital-twin-rendering-with-live-robot-state'                     # substituted by scaffold.py
