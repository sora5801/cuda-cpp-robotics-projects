# 21.10 — VR digital-twin rendering with live robot state

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `VR digital-twin rendering with live robot state`
>
...
1. Open [`build/vr-digital-twin-rendering-with-live-robot-state.sln`](build/vr-digital-twin-rendering-with-live-robot-state.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/vr-digital-twin-rendering-with-live-robot-state.exe`.
