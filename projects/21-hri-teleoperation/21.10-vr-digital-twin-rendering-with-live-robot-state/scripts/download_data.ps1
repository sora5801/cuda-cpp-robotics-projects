# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.10 (VR digital-twin rendering with live robot state)
#
...
Write-Host "[download_data] Project 21.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
