#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.10 (VR digital-twin rendering with live robot state)
...
echo "[download_data] Project 21.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
