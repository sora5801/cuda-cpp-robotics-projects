// ===========================================================================
// main.cu — entry point for project 21.12 (Ergonomic (RULA/REBA) scoring from pose streams for cobot cells)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.12 (ergonomic-scoring-from-pose-streams-for-cobot)\n");
