# 21.12 — Ergonomic (RULA/REBA) scoring from pose streams for cobot cells

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Ergonomic (RULA/REBA) scoring from pose streams for cobot cells`
>
...
1. Open [`build/ergonomic-scoring-from-pose-streams-for-cobot.sln`](build/ergonomic-scoring-from-pose-streams-for-cobot.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/ergonomic-scoring-from-pose-streams-for-cobot.exe`.
