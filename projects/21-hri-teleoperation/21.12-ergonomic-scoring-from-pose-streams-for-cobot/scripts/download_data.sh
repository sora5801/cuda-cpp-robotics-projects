#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.12 (Ergonomic (RULA/REBA) scoring from pose streams for cobot cells)
...
echo "[download_data] Project 21.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
