# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.12 (Ergonomic (RULA/REBA) scoring from pose streams for cobot cells)
#
...
Write-Host "[download_data] Project 21.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
