# ===========================================================================
# run_demo.ps1 — one-command demo for 21.12 (Ergonomic (RULA/REBA) scoring from pose streams for cobot cells)
#
...
$Slug       = 'ergonomic-scoring-from-pose-streams-for-cobot'                     # substituted by scaffold.py
