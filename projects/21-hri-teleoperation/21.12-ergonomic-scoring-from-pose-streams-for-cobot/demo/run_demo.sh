#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 21.12 (Ergonomic (RULA/REBA) scoring from pose streams for cobot cells)
...
SLUG='ergonomic-scoring-from-pose-streams-for-cobot'
