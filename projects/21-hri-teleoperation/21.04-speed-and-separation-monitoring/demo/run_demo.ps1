# ===========================================================================
# run_demo.ps1 — one-command demo for 21.04 (Speed-and-separation monitoring: depth streams → minimum-distance fields at frame rate (ISO/TS 15066 helper))
#
...
#
# 21.04: the real implementation is in; this script is unchanged from the
...
# The demo writes demo/out/distance_field.pgm and demo/out/ssm_timeline.csv
# (both git-ignored) — see demo/README.md for how to read them.
#
...
$Slug       = 'speed-and-separation-monitoring'                     # substituted by scaffold.py
