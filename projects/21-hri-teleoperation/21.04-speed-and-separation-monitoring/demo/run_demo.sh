#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 21.04 (Speed-and-separation monitoring: depth streams → minimum-distance fields at frame rate (ISO/TS 15066 helper))
...
# 21.04: expected_output.txt carries the real implementation's stable lines
