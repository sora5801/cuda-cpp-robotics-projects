# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.01 (Multi-person, multi-camera pose tracking with GPU triangulation)
#
...
Write-Host "[download_data] Project 21.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
