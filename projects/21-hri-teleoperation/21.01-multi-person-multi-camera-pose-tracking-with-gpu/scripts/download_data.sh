#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.01 (Multi-person, multi-camera pose tracking with GPU triangulation)
...
echo "[download_data] Project 21.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
