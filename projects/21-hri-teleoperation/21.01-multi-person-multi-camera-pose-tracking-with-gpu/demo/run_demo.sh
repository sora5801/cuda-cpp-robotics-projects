#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 21.01 (Multi-person, multi-camera pose tracking with GPU triangulation)
...
SLUG='multi-person-multi-camera-pose-tracking-with-gpu'
