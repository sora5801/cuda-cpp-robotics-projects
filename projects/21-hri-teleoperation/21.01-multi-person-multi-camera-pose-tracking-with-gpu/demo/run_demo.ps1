# ===========================================================================
# run_demo.ps1 — one-command demo for 21.01 (Multi-person, multi-camera pose tracking with GPU triangulation)
#
...
$Slug       = 'multi-person-multi-camera-pose-tracking-with-gpu'                     # substituted by scaffold.py
