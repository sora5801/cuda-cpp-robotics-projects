# 21.01 — Multi-person, multi-camera pose tracking with GPU triangulation

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Multi-person, multi-camera pose tracking with GPU triangulation`
>
...
1. Open [`build/multi-person-multi-camera-pose-tracking-with-gpu.sln`](build/multi-person-multi-camera-pose-tracking-with-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/multi-person-multi-camera-pose-tracking-with-gpu.exe`.
