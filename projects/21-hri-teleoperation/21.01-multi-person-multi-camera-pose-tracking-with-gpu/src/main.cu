// ===========================================================================
// main.cu — entry point for project 21.01 (Multi-person, multi-camera pose tracking with GPU triangulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.01 (multi-person-multi-camera-pose-tracking-with-gpu)\n");
