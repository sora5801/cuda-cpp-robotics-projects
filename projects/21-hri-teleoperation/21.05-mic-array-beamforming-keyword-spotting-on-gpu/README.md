# 21.05 — Mic-array beamforming + keyword spotting on GPU

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Mic-array beamforming + keyword spotting on GPU`
>
...
1. Open [`build/mic-array-beamforming-keyword-spotting-on-gpu.sln`](build/mic-array-beamforming-keyword-spotting-on-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mic-array-beamforming-keyword-spotting-on-gpu.exe`.
