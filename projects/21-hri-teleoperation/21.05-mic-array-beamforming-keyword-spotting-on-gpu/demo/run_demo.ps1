# ===========================================================================
# run_demo.ps1 — one-command demo for 21.05 (Mic-array beamforming + keyword spotting on GPU)
#
...
$Slug       = 'mic-array-beamforming-keyword-spotting-on-gpu'                     # substituted by scaffold.py
