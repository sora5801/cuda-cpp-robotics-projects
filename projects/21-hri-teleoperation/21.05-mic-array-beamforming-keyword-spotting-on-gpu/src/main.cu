// ===========================================================================
// main.cu — entry point for project 21.05 (Mic-array beamforming + keyword spotting on GPU)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.05 (mic-array-beamforming-keyword-spotting-on-gpu)\n");
