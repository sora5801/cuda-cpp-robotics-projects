# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.05 (Mic-array beamforming + keyword spotting on GPU)
#
...
Write-Host "[download_data] Project 21.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
