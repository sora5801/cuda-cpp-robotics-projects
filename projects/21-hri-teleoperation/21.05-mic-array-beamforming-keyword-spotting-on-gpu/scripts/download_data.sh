#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.05 (Mic-array beamforming + keyword spotting on GPU)
...
echo "[download_data] Project 21.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
