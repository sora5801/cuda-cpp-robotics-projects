# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 21.06 (Gaze estimation for intent inference)
#
...
Write-Host "[download_data] Project 21.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
