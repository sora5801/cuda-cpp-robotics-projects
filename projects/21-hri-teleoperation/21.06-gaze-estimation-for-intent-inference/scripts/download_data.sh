#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.06 (Gaze estimation for intent inference)
...
echo "[download_data] Project 21.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
