// ===========================================================================
// main.cu — entry point for project 21.06 (Gaze estimation for intent inference)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.06 (gaze-estimation-for-intent-inference)\n");
