# 21.06 — Gaze estimation for intent inference

**Difficulty:** intermediate · **Domain:** 21. Human-Robot Interaction & Teleoperation

> Catalog bullet (source of truth, verbatim): `Gaze estimation for intent inference`
>
...
1. Open [`build/gaze-estimation-for-intent-inference.sln`](build/gaze-estimation-for-intent-inference.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gaze-estimation-for-intent-inference.exe`.
