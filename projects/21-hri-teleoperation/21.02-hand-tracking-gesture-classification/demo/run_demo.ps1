# ===========================================================================
# run_demo.ps1 — one-command demo for 21.02 (Hand tracking + gesture classification for commanding robots)
#
...
$Slug       = 'hand-tracking-gesture-classification'                     # substituted by scaffold.py
