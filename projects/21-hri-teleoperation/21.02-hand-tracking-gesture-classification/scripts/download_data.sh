#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 21.02 (Hand tracking + gesture classification for commanding robots)
...
echo "[download_data] Project 21.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
