// ===========================================================================
// main.cu — entry point for project 21.02 (Hand tracking + gesture classification for commanding robots)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 21.02 (hand-tracking-gesture-classification)\n");
