# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.10 (Cable-driven parallel robot tension-distribution optimization)
#
...
Write-Host "[download_data] Project 09.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
