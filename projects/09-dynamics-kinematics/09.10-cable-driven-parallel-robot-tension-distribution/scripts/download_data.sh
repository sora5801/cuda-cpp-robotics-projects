#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.10 (Cable-driven parallel robot tension-distribution optimization)
...
echo "[download_data] Project 09.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
