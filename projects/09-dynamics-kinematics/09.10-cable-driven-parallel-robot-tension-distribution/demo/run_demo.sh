#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 09.10 (Cable-driven parallel robot tension-distribution optimization)
...
SLUG='cable-driven-parallel-robot-tension-distribution'
