# ===========================================================================
# run_demo.ps1 — one-command demo for 09.10 (Cable-driven parallel robot tension-distribution optimization)
#
...
$Slug       = 'cable-driven-parallel-robot-tension-distribution'                     # substituted by scaffold.py
