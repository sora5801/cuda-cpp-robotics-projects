// ===========================================================================
// main.cu — entry point for project 09.10 (Cable-driven parallel robot tension-distribution optimization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.10 (cable-driven-parallel-robot-tension-distribution)\n");
