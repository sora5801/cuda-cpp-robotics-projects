// ===========================================================================
// main.cu — entry point for project 09.09 (Stewart platform / delta robot batch FK-IK + workspace + singularity mapping)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.09 (stewart-platform-delta-robot-batch-fk-ik)\n");
