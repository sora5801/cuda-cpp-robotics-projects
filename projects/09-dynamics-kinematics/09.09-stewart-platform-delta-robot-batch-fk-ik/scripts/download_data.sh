#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.09 (Stewart platform / delta robot batch FK-IK + workspace + singularity mapping)
...
echo "[download_data] Project 09.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
