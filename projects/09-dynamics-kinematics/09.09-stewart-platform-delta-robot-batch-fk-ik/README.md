# 09.09 — Stewart platform / delta robot batch FK-IK + workspace + singularity mapping

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Stewart platform / delta robot batch FK-IK + workspace + singularity mapping`
>
...
1. Open [`build/stewart-platform-delta-robot-batch-fk-ik.sln`](build/stewart-platform-delta-robot-batch-fk-ik.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/stewart-platform-delta-robot-batch-fk-ik.exe`.
