# ===========================================================================
# run_demo.ps1 — one-command demo for 09.09 (Stewart platform / delta robot batch FK-IK + workspace + singularity mapping)
#
...
$Slug       = 'stewart-platform-delta-robot-batch-fk-ik'                     # substituted by scaffold.py
