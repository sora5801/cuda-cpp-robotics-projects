#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 09.09 (Stewart platform / delta robot batch FK-IK + workspace + singularity mapping)
...
SLUG='stewart-platform-delta-robot-batch-fk-ik'
