# ===========================================================================
# run_demo.ps1 — one-command demo for 09.01 (Batched forward kinematics (10⁵ configurations — the foundation for everything above))
#
...
#
# 09.01: the real implementation is in; this script is unchanged from the
...
$Slug       = 'batched-forward-kinematics'                     # substituted by scaffold.py
