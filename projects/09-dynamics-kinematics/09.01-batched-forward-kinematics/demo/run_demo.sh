#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 09.01 (Batched forward kinematics (10⁵ configurations — the foundation for everything above))
...
# 09.01: expected_output.txt carries the real implementation's stable lines
...
SLUG='batched-forward-kinematics'
