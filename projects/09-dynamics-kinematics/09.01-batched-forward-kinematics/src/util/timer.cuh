...
//                  (project 09.01; copied from docs/PROJECT_TEMPLATE
...
//    throughout (see gpu_fk in main.cu), so stream-0 events time exactly
//    the work they bracket; multi-stream projects record into their own
//    streams instead.
