// ===========================================================================
// main.cu — entry point for project 09.01 (Batched forward kinematics (10⁵ configurations — the foundation for everything above))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.01 (batched-forward-kinematics)\n");
