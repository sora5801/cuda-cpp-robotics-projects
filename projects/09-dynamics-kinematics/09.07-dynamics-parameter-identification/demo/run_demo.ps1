# ===========================================================================
# run_demo.ps1 — one-command demo for 09.07 (Dynamics parameter identification: regressor construction + least squares over logs)
#
...
$Slug       = 'dynamics-parameter-identification'                     # substituted by scaffold.py
