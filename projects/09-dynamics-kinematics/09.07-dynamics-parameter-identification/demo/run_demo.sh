#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 09.07 (Dynamics parameter identification: regressor construction + least squares over logs)
...
SLUG='dynamics-parameter-identification'
