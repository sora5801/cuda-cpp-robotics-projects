// ===========================================================================
// main.cu — entry point for project 09.07 (Dynamics parameter identification: regressor construction + least squares over logs)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.07 (dynamics-parameter-identification)\n");
