#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.07 (Dynamics parameter identification: regressor construction + least squares over logs)
...
echo "[download_data] Project 09.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
