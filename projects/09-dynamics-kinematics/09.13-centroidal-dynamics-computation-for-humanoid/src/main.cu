// ===========================================================================
// main.cu — entry point for project 09.13 (Centroidal dynamics computation for humanoid planners)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.13 (centroidal-dynamics-computation-for-humanoid)\n");
