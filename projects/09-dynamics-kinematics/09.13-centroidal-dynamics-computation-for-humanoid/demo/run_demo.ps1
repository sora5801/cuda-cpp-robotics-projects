# ===========================================================================
# run_demo.ps1 — one-command demo for 09.13 (Centroidal dynamics computation for humanoid planners)
#
...
$Slug       = 'centroidal-dynamics-computation-for-humanoid'                     # substituted by scaffold.py
