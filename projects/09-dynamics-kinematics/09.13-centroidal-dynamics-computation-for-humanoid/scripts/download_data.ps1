# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.13 (Centroidal dynamics computation for humanoid planners)
#
...
Write-Host "[download_data] Project 09.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
