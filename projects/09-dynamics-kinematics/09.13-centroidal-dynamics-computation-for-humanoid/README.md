# 09.13 — Centroidal dynamics computation for humanoid planners

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Centroidal dynamics computation for humanoid planners`
>
...
1. Open [`build/centroidal-dynamics-computation-for-humanoid.sln`](build/centroidal-dynamics-computation-for-humanoid.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/centroidal-dynamics-computation-for-humanoid.exe`.
