# 09.06 — Analytic 6R IK batch evaluation and reachability maps

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Analytic 6R IK batch evaluation and reachability maps`
>
...
1. Open [`build/analytic-6r-ik-batch-evaluation-and-reachability.sln`](build/analytic-6r-ik-batch-evaluation-and-reachability.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/analytic-6r-ik-batch-evaluation-and-reachability.exe`.
