# ===========================================================================
# run_demo.ps1 — one-command demo for 09.06 (Analytic 6R IK batch evaluation and reachability maps)
#
...
$Slug       = 'analytic-6r-ik-batch-evaluation-and-reachability'                     # substituted by scaffold.py
