#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.06 (Analytic 6R IK batch evaluation and reachability maps)
...
echo "[download_data] Project 09.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
