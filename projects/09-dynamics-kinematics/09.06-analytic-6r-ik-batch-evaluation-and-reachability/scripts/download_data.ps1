# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.06 (Analytic 6R IK batch evaluation and reachability maps)
#
...
Write-Host "[download_data] Project 09.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
