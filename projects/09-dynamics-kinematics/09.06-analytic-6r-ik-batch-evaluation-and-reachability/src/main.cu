// ===========================================================================
// main.cu — entry point for project 09.06 (Analytic 6R IK batch evaluation and reachability maps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.06 (analytic-6r-ik-batch-evaluation-and-reachability)\n");
