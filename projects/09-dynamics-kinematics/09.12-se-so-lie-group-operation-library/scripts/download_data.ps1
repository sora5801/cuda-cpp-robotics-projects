# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.12 (SE(3)/SO(3) Lie-group operation library (exp/log/adjoint, batched, autodiff-ready))
#
...
Write-Host "[download_data] Project 09.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
