// ===========================================================================
// main.cu — entry point for project 09.12 (SE(3)/SO(3) Lie-group operation library (exp/log/adjoint, batched, autodiff-ready))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.12 (se-so-lie-group-operation-library)\n");
