# ===========================================================================
# run_demo.ps1 — one-command demo for 09.12 (SE(3)/SO(3) Lie-group operation library (exp/log/adjoint, batched, autodiff-ready))
#
...
$Slug       = 'se-so-lie-group-operation-library'                     # substituted by scaffold.py
