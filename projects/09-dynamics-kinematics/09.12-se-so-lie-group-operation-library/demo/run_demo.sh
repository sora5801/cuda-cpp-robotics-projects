#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 09.12 (SE(3)/SO(3) Lie-group operation library (exp/log/adjoint, batched, autodiff-ready))
...
SLUG='se-so-lie-group-operation-library'
