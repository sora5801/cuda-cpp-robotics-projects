# 09.12 — SE(3)/SO(3) Lie-group operation library (exp/log/adjoint, batched, autodiff-ready)

**Difficulty:** ★ beginner · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `★ SE(3)/SO(3) Lie-group operation library (exp/log/adjoint, batched, autodiff-ready)`
>
...
1. Open [`build/se-so-lie-group-operation-library.sln`](build/se-so-lie-group-operation-library.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/se-so-lie-group-operation-library.exe`.
