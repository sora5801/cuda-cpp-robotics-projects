// ===========================================================================
// main.cu — entry point for project 09.02 (Batched geometric/analytic Jacobians)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.02 (batched-geometric-analytic-jacobians)\n");
