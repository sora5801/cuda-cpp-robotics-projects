# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.02 (Batched geometric/analytic Jacobians)
#
...
Write-Host "[download_data] Project 09.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
