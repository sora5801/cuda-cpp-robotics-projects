#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.02 (Batched geometric/analytic Jacobians)
...
echo "[download_data] Project 09.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
