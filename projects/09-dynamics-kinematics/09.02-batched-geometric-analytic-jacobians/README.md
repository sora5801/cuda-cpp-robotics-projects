# 09.02 — Batched geometric/analytic Jacobians

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Batched geometric/analytic Jacobians`
>
...
1. Open [`build/batched-geometric-analytic-jacobians.sln`](build/batched-geometric-analytic-jacobians.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-geometric-analytic-jacobians.exe`.
