#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.08 (Contact LCP solvers (projected Gauss-Seidel) batched)
...
echo "[download_data] Project 09.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
