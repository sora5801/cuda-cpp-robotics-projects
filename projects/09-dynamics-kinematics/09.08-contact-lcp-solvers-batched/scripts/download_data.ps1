# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.08 (Contact LCP solvers (projected Gauss-Seidel) batched)
#
...
Write-Host "[download_data] Project 09.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
