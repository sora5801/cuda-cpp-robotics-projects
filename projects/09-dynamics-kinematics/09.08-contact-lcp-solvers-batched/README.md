# 09.08 — Contact LCP solvers (projected Gauss-Seidel) batched

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Contact LCP solvers (projected Gauss-Seidel) batched`
>
...
1. Open [`build/contact-lcp-solvers-batched.sln`](build/contact-lcp-solvers-batched.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/contact-lcp-solvers-batched.exe`.
