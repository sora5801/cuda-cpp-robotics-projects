// ===========================================================================
// main.cu — entry point for project 09.08 (Contact LCP solvers (projected Gauss-Seidel) batched)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.08 (contact-lcp-solvers-batched)\n");
