# ===========================================================================
# run_demo.ps1 — one-command demo for 09.14 (Screw-theory batch computations: twist/wrench transforms across mechanisms)
#
...
$Slug       = 'screw-theory-batch-computations'                     # substituted by scaffold.py
