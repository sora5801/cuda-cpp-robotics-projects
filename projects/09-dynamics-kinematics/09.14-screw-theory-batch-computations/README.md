# 09.14 — Screw-theory batch computations: twist/wrench transforms across mechanisms

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Screw-theory batch computations: twist/wrench transforms across mechanisms`
>
...
1. Open [`build/screw-theory-batch-computations.sln`](build/screw-theory-batch-computations.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/screw-theory-batch-computations.exe`.
