// ===========================================================================
// main.cu — entry point for project 09.14 (Screw-theory batch computations: twist/wrench transforms across mechanisms)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.14 (screw-theory-batch-computations)\n");
