#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.14 (Screw-theory batch computations: twist/wrench transforms across mechanisms)
...
echo "[download_data] Project 09.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
