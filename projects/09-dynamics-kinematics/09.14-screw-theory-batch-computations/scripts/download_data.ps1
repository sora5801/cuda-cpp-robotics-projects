# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.14 (Screw-theory batch computations: twist/wrench transforms across mechanisms)
#
...
Write-Host "[download_data] Project 09.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
