# 09.05 — Batched numerical IK (damped least squares / LM) with random restarts

**Difficulty:** ★ beginner · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `★ Batched numerical IK (damped least squares / LM) with random restarts`
>
...
1. Open [`build/batched-numerical-ik-with-random-restarts.sln`](build/batched-numerical-ik-with-random-restarts.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-numerical-ik-with-random-restarts.exe`.
