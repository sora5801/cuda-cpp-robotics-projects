// ===========================================================================
// main.cu — entry point for project 09.05 (Batched numerical IK (damped least squares / LM) with random restarts)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.05 (batched-numerical-ik-with-random-restarts)\n");
