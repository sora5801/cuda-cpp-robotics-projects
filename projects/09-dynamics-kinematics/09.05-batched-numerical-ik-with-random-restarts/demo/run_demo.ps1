# ===========================================================================
# run_demo.ps1 — one-command demo for 09.05 (Batched numerical IK (damped least squares / LM) with random restarts)
#
...
$Slug       = 'batched-numerical-ik-with-random-restarts'                     # substituted by scaffold.py
