#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 09.05 (Batched numerical IK (damped least squares / LM) with random restarts)
...
SLUG='batched-numerical-ik-with-random-restarts'
