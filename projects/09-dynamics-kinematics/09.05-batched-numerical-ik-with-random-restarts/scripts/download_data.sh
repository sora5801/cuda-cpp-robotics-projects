#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.05 (Batched numerical IK (damped least squares / LM) with random restarts)
...
echo "[download_data] Project 09.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
