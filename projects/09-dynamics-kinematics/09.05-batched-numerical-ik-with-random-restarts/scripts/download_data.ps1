# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.05 (Batched numerical IK (damped least squares / LM) with random restarts)
#
...
Write-Host "[download_data] Project 09.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
