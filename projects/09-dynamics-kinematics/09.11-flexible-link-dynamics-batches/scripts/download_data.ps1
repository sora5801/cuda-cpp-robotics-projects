# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.11 (Flexible-link dynamics (assumed-modes) batches)
#
...
Write-Host "[download_data] Project 09.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
