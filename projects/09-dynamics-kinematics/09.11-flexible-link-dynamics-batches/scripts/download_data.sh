#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.11 (Flexible-link dynamics (assumed-modes) batches)
...
echo "[download_data] Project 09.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
