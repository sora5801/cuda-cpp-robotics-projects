# 09.11 — Flexible-link dynamics (assumed-modes) batches

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Flexible-link dynamics (assumed-modes) batches`
>
...
1. Open [`build/flexible-link-dynamics-batches.sln`](build/flexible-link-dynamics-batches.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/flexible-link-dynamics-batches.exe`.
