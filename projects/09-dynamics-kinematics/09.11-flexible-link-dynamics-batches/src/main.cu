// ===========================================================================
// main.cu — entry point for project 09.11 (Flexible-link dynamics (assumed-modes) batches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.11 (flexible-link-dynamics-batches)\n");
