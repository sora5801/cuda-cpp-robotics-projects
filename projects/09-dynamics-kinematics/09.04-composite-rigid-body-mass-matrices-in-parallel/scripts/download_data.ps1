# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.04 (Composite-rigid-body mass matrices in parallel)
#
...
Write-Host "[download_data] Project 09.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
