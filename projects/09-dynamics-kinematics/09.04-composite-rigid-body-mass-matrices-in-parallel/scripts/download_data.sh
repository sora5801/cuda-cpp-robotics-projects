#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.04 (Composite-rigid-body mass matrices in parallel)
...
echo "[download_data] Project 09.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
