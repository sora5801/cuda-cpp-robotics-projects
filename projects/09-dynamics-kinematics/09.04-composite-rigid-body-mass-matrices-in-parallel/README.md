# 09.04 — Composite-rigid-body mass matrices in parallel

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `Composite-rigid-body mass matrices in parallel`
>
...
1. Open [`build/composite-rigid-body-mass-matrices-in-parallel.sln`](build/composite-rigid-body-mass-matrices-in-parallel.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/composite-rigid-body-mass-matrices-in-parallel.exe`.
