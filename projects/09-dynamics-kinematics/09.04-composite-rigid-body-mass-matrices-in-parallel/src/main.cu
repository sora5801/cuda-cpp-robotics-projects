// ===========================================================================
// main.cu — entry point for project 09.04 (Composite-rigid-body mass matrices in parallel)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.04 (composite-rigid-body-mass-matrices-in-parallel)\n");
