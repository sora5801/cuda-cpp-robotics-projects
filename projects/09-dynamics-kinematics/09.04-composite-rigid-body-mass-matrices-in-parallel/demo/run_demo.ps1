# ===========================================================================
# run_demo.ps1 — one-command demo for 09.04 (Composite-rigid-body mass matrices in parallel)
#
...
$Slug       = 'composite-rigid-body-mass-matrices-in-parallel'                     # substituted by scaffold.py
