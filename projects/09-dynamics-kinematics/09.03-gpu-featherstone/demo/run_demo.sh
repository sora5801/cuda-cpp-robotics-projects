#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 09.03 (GPU Featherstone: batched ABA forward dynamics + RNEA inverse dynamics (mini rigid-body library))
