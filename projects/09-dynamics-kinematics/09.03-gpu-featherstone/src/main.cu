// ===========================================================================
// main.cu — entry point for project 09.03 (GPU Featherstone: batched ABA forward dynamics + RNEA inverse dynamics (mini rigid-body library))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 09.03 (gpu-featherstone)\n");
