# 09.03 — GPU Featherstone: batched ABA forward dynamics + RNEA inverse dynamics (mini rigid-body library)

**Difficulty:** intermediate · **Domain:** 9. Robot Dynamics & Kinematics

> Catalog bullet (source of truth, verbatim): `GPU Featherstone: batched ABA forward dynamics + RNEA inverse dynamics (mini rigid-body library)`
>
...
1. Open [`build/gpu-featherstone.sln`](build/gpu-featherstone.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-featherstone.exe`.
