# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 09.03 (GPU Featherstone: batched ABA forward dynamics + RNEA inverse dynamics (mini rigid-body library))
#
...
Write-Host "[download_data] Project 09.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
