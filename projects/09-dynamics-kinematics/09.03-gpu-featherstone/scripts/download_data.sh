#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 09.03 (GPU Featherstone: batched ABA forward dynamics + RNEA inverse dynamics (mini rigid-body library))
...
echo "[download_data] Project 09.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
