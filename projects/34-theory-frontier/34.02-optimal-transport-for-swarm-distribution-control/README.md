# 34.02 — Optimal transport for swarm distribution control (GPU Sinkhorn)

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Optimal transport for swarm distribution control (GPU Sinkhorn) [R&D]`
>
...
Optimal transport for swarm distribution control (GPU Sinkhorn)
...
1. Open [`build/optimal-transport-for-swarm-distribution-control.sln`](build/optimal-transport-for-swarm-distribution-control.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/optimal-transport-for-swarm-distribution-control.exe`.
