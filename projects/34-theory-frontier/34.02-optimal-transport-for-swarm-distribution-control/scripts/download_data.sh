#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.02 (Optimal transport for swarm distribution control (GPU Sinkhorn))
...
echo "[download_data] Project 34.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
