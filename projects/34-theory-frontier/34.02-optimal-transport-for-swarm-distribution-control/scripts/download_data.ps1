# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.02 (Optimal transport for swarm distribution control (GPU Sinkhorn))
#
...
Write-Host "[download_data] Project 34.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
