#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 34.02 (Optimal transport for swarm distribution control (GPU Sinkhorn))
...
SLUG='optimal-transport-for-swarm-distribution-control'
