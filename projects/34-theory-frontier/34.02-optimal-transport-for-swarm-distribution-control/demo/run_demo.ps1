# ===========================================================================
# run_demo.ps1 — one-command demo for 34.02 (Optimal transport for swarm distribution control (GPU Sinkhorn))
#
...
$Slug       = 'optimal-transport-for-swarm-distribution-control'                     # substituted by scaffold.py
