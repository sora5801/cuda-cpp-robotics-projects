// ===========================================================================
// main.cu — entry point for project 34.02 (Optimal transport for swarm distribution control (GPU Sinkhorn))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.02 (optimal-transport-for-swarm-distribution-control)\n");
