# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.06 (High-dimensional Hamilton-Jacobi via tensor decompositions)
#
...
Write-Host "[download_data] Project 34.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
