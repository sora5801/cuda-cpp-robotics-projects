#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.06 (High-dimensional Hamilton-Jacobi via tensor decompositions)
...
echo "[download_data] Project 34.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
