# 34.06 — High-dimensional Hamilton-Jacobi via tensor decompositions

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `High-dimensional Hamilton-Jacobi via tensor decompositions [R&D]`
>
...
High-dimensional Hamilton-Jacobi via tensor decompositions
...
1. Open [`build/high-dimensional-hamilton-jacobi-via-tensor.sln`](build/high-dimensional-hamilton-jacobi-via-tensor.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/high-dimensional-hamilton-jacobi-via-tensor.exe`.
