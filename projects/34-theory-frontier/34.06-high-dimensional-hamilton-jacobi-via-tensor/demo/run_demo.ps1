# ===========================================================================
# run_demo.ps1 — one-command demo for 34.06 (High-dimensional Hamilton-Jacobi via tensor decompositions)
#
...
$Slug       = 'high-dimensional-hamilton-jacobi-via-tensor'                     # substituted by scaffold.py
