// ===========================================================================
// main.cu — entry point for project 34.06 (High-dimensional Hamilton-Jacobi via tensor decompositions)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.06 (high-dimensional-hamilton-jacobi-via-tensor)\n");
