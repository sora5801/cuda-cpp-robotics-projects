#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.14 (Port-Hamiltonian system simulation)
...
echo "[download_data] Project 34.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
