# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.14 (Port-Hamiltonian system simulation)
#
...
Write-Host "[download_data] Project 34.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
