# ===========================================================================
# run_demo.ps1 — one-command demo for 34.07 (Path-integral stochastic optimal control beyond MPPI)
#
...
$Slug       = 'path-integral-stochastic-optimal-control-beyond'                     # substituted by scaffold.py
