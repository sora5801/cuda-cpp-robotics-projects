# 34.07 — Path-integral stochastic optimal control beyond MPPI

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Path-integral stochastic optimal control beyond MPPI [R&D]`
>
...
Path-integral stochastic optimal control beyond MPPI
...
1. Open [`build/path-integral-stochastic-optimal-control-beyond.sln`](build/path-integral-stochastic-optimal-control-beyond.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/path-integral-stochastic-optimal-control-beyond.exe`.
