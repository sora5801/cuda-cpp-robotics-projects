# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.07 (Path-integral stochastic optimal control beyond MPPI)
#
...
Write-Host "[download_data] Project 34.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
