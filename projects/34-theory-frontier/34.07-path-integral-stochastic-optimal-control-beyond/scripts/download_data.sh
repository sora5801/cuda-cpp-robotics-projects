#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.07 (Path-integral stochastic optimal control beyond MPPI)
...
echo "[download_data] Project 34.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
