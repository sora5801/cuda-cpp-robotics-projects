# 34.16 — Information-theoretic exploration: mutual information over maps at scale

**Difficulty:** intermediate · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Information-theoretic exploration: mutual information over maps at scale`
>
...
1. Open [`build/information-theoretic-exploration.sln`](build/information-theoretic-exploration.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/information-theoretic-exploration.exe`.
