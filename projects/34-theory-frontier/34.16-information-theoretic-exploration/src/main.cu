// ===========================================================================
// main.cu — entry point for project 34.16 (Information-theoretic exploration: mutual information over maps at scale)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.16 (information-theoretic-exploration)\n");
