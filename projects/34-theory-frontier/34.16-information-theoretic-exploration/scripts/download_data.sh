#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.16 (Information-theoretic exploration: mutual information over maps at scale)
...
echo "[download_data] Project 34.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
