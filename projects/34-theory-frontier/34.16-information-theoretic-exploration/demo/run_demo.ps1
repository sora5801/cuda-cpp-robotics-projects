# ===========================================================================
# run_demo.ps1 — one-command demo for 34.16 (Information-theoretic exploration: mutual information over maps at scale)
#
...
$Slug       = 'information-theoretic-exploration'                     # substituted by scaffold.py
