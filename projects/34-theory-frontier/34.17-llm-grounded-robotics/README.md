# 34.17 — LLM-grounded robotics: GPU semantic-map queries, affordance fields, foundation world-model serving

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `LLM-grounded robotics: GPU semantic-map queries, affordance fields, foundation world-model serving [R&D]`
>
...
LLM-grounded robotics: GPU semantic-map queries, affordance fields, foundation world-model serving
...
1. Open [`build/llm-grounded-robotics.sln`](build/llm-grounded-robotics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/llm-grounded-robotics.exe`.
