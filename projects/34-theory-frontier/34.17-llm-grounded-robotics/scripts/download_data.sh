#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.17 (LLM-grounded robotics: GPU semantic-map queries, affordance fields, foundation world-model serving)
...
echo "[download_data] Project 34.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
