# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.17 (LLM-grounded robotics: GPU semantic-map queries, affordance fields, foundation world-model serving)
#
...
Write-Host "[download_data] Project 34.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
