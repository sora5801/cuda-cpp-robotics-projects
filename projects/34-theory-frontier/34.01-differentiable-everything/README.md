# 34.01 — Differentiable everything: simulation + rendering + planning, end-to-end gradients

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Differentiable everything: simulation + rendering + planning, end-to-end gradients [R&D]`
>
...
Differentiable everything: simulation + rendering + planning, end-to-end gradients
...
1. Open [`build/differentiable-everything.sln`](build/differentiable-everything.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/differentiable-everything.exe`.
