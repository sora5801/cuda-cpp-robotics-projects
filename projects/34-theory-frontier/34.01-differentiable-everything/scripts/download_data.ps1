# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.01 (Differentiable everything: simulation + rendering + planning, end-to-end gradients)
#
...
Write-Host "[download_data] Project 34.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
