#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.01 (Differentiable everything: simulation + rendering + planning, end-to-end gradients)
...
echo "[download_data] Project 34.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
