# ===========================================================================
# run_demo.ps1 — one-command demo for 34.01 (Differentiable everything: simulation + rendering + planning, end-to-end gradients)
#
...
$Slug       = 'differentiable-everything'                     # substituted by scaffold.py
