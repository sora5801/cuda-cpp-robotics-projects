// ===========================================================================
// main.cu — entry point for project 34.01 (Differentiable everything: simulation + rendering + planning, end-to-end gradients)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.01 (differentiable-everything)\n");
