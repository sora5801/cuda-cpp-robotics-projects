# ===========================================================================
# run_demo.ps1 — one-command demo for 34.11 (Neural cellular automata for self-organizing control)
#
...
$Slug       = 'neural-cellular-automata-for-self-organizing'                     # substituted by scaffold.py
