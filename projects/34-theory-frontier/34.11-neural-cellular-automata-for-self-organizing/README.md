# 34.11 — Neural cellular automata for self-organizing control

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Neural cellular automata for self-organizing control [R&D]`
>
...
Neural cellular automata for self-organizing control
...
1. Open [`build/neural-cellular-automata-for-self-organizing.sln`](build/neural-cellular-automata-for-self-organizing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/neural-cellular-automata-for-self-organizing.exe`.
