# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.11 (Neural cellular automata for self-organizing control)
#
...
Write-Host "[download_data] Project 34.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
