#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.11 (Neural cellular automata for self-organizing control)
...
echo "[download_data] Project 34.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
