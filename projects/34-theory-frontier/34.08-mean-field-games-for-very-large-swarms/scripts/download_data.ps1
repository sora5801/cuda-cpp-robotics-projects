# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.08 (Mean-field games for very large swarms)
#
...
Write-Host "[download_data] Project 34.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
