#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.08 (Mean-field games for very large swarms)
...
echo "[download_data] Project 34.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
