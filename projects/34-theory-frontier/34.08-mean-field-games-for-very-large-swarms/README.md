# 34.08 — Mean-field games for very large swarms

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Mean-field games for very large swarms [R&D]`
>
...
Mean-field games for very large swarms
...
1. Open [`build/mean-field-games-for-very-large-swarms.sln`](build/mean-field-games-for-very-large-swarms.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mean-field-games-for-very-large-swarms.exe`.
