// ===========================================================================
// main.cu — entry point for project 34.08 (Mean-field games for very large swarms)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.08 (mean-field-games-for-very-large-swarms)\n");
