# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.15 (Contact-rich trajectory optimization via ADMM splitting)
#
...
Write-Host "[download_data] Project 34.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
