#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.15 (Contact-rich trajectory optimization via ADMM splitting)
...
echo "[download_data] Project 34.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
