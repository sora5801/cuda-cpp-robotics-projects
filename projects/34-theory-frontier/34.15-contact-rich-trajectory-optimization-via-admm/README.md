# 34.15 — Contact-rich trajectory optimization via ADMM splitting

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Contact-rich trajectory optimization via ADMM splitting [R&D]`
>
...
Contact-rich trajectory optimization via ADMM splitting
...
1. Open [`build/contact-rich-trajectory-optimization-via-admm.sln`](build/contact-rich-trajectory-optimization-via-admm.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/contact-rich-trajectory-optimization-via-admm.exe`.
