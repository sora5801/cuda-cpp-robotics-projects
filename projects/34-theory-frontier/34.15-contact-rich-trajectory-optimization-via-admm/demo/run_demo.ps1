# ===========================================================================
# run_demo.ps1 — one-command demo for 34.15 (Contact-rich trajectory optimization via ADMM splitting)
#
...
$Slug       = 'contact-rich-trajectory-optimization-via-admm'                     # substituted by scaffold.py
