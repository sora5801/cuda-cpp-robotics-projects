// ===========================================================================
// main.cu — entry point for project 34.15 (Contact-rich trajectory optimization via ADMM splitting)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.15 (contact-rich-trajectory-optimization-via-admm)\n");
