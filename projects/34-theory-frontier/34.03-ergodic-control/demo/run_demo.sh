#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 34.03 (Ergodic control: spectral multiscale coverage (FFT-based — very GPU-friendly))
...
# the "output contract" comment in ../src/main.cu) as a single committed change.
# ===========================================================================
set -euo pipefail
