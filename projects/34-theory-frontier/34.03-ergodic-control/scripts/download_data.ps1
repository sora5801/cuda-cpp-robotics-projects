# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.03 (Ergodic control: spectral multiscale coverage (FFT-based — very GPU-friendly))
#
...
Write-Host "[download_data] Project 34.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
