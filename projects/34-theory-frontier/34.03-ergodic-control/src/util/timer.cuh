...
//                  (project 34.03; copied from docs/PROJECT_TEMPLATE
...
//    (one launch_build_phi_k call at setup, one launch_smc_step call per
//    control tick; main.cu brackets each with a GpuTimer); multi-stream
//    projects would record into their own streams instead.
