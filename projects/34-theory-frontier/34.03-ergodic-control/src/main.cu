// ===========================================================================
// main.cu — entry point for project 34.03 (Ergodic control: spectral multiscale coverage (FFT-based — very GPU-friendly))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.03 (ergodic-control)\n");
