#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 34.13 (Variational/geometric integrators batched (structure-preserving simulation))
...
SLUG='variational-geometric-integrators-batched'
