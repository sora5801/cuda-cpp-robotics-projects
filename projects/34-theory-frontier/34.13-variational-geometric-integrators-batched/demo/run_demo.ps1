# ===========================================================================
# run_demo.ps1 — one-command demo for 34.13 (Variational/geometric integrators batched (structure-preserving simulation))
#
...
$Slug       = 'variational-geometric-integrators-batched'                     # substituted by scaffold.py
