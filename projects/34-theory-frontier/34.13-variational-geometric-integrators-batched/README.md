# 34.13 — Variational/geometric integrators batched (structure-preserving simulation)

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Variational/geometric integrators batched (structure-preserving simulation) [R&D]`
>
...
Variational/geometric integrators batched (structure-preserving simulation)
...
1. Open [`build/variational-geometric-integrators-batched.sln`](build/variational-geometric-integrators-batched.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/variational-geometric-integrators-batched.exe`.
