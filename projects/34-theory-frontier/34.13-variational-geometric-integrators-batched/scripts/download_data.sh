#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.13 (Variational/geometric integrators batched (structure-preserving simulation))
...
echo "[download_data] Project 34.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
