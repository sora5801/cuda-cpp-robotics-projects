# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.13 (Variational/geometric integrators batched (structure-preserving simulation))
#
...
Write-Host "[download_data] Project 34.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
