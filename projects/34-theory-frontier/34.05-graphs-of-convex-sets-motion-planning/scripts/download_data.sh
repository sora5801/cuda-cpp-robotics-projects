#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.05 (Graphs-of-convex-sets motion planning acceleration)
...
echo "[download_data] Project 34.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
