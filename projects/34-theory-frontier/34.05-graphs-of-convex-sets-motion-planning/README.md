# 34.05 — Graphs-of-convex-sets motion planning acceleration

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Graphs-of-convex-sets motion planning acceleration [R&D]`
>
...
Graphs-of-convex-sets motion planning acceleration
...
1. Open [`build/graphs-of-convex-sets-motion-planning.sln`](build/graphs-of-convex-sets-motion-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/graphs-of-convex-sets-motion-planning.exe`.
