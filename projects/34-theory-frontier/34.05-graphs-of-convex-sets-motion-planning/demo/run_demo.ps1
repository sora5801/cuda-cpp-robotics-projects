# ===========================================================================
# run_demo.ps1 — one-command demo for 34.05 (Graphs-of-convex-sets motion planning acceleration)
#
...
$Slug       = 'graphs-of-convex-sets-motion-planning'                     # substituted by scaffold.py
