// ===========================================================================
// main.cu — entry point for project 34.05 (Graphs-of-convex-sets motion planning acceleration)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.05 (graphs-of-convex-sets-motion-planning)\n");
