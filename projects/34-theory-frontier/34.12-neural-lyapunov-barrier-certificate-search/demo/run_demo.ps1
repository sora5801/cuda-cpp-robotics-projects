# ===========================================================================
# run_demo.ps1 — one-command demo for 34.12 (Neural Lyapunov/barrier certificate search: train-verify loops on GPU)
#
...
$Slug       = 'neural-lyapunov-barrier-certificate-search'                     # substituted by scaffold.py
