#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 34.12 (Neural Lyapunov/barrier certificate search: train-verify loops on GPU)
...
SLUG='neural-lyapunov-barrier-certificate-search'
