# 34.12 — Neural Lyapunov/barrier certificate search: train-verify loops on GPU

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Neural Lyapunov/barrier certificate search: train-verify loops on GPU [R&D]`
>
...
Neural Lyapunov/barrier certificate search: train-verify loops on GPU
...
1. Open [`build/neural-lyapunov-barrier-certificate-search.sln`](build/neural-lyapunov-barrier-certificate-search.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/neural-lyapunov-barrier-certificate-search.exe`.
