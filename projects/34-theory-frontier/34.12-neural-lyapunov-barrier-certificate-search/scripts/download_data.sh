#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.12 (Neural Lyapunov/barrier certificate search: train-verify loops on GPU)
...
echo "[download_data] Project 34.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
