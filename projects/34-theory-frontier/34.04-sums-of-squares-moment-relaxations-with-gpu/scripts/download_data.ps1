# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.04 (Sums-of-squares / moment relaxations with GPU first-order SDP solvers)
#
...
Write-Host "[download_data] Project 34.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
