#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.04 (Sums-of-squares / moment relaxations with GPU first-order SDP solvers)
...
echo "[download_data] Project 34.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
