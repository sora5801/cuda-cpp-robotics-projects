# 34.04 — Sums-of-squares / moment relaxations with GPU first-order SDP solvers

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Sums-of-squares / moment relaxations with GPU first-order SDP solvers [R&D]`
>
...
Sums-of-squares / moment relaxations with GPU first-order SDP solvers
...
1. Open [`build/sums-of-squares-moment-relaxations-with-gpu.sln`](build/sums-of-squares-moment-relaxations-with-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/sums-of-squares-moment-relaxations-with-gpu.exe`.
