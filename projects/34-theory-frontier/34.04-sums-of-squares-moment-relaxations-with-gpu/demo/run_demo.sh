#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 34.04 (Sums-of-squares / moment relaxations with GPU first-order SDP solvers)
...
SLUG='sums-of-squares-moment-relaxations-with-gpu'
