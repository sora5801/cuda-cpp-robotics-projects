# ===========================================================================
# run_demo.ps1 — one-command demo for 34.04 (Sums-of-squares / moment relaxations with GPU first-order SDP solvers)
#
...
$Slug       = 'sums-of-squares-moment-relaxations-with-gpu'                     # substituted by scaffold.py
