// ===========================================================================
// main.cu — entry point for project 34.04 (Sums-of-squares / moment relaxations with GPU first-order SDP solvers)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.04 (sums-of-squares-moment-relaxations-with-gpu)\n");
