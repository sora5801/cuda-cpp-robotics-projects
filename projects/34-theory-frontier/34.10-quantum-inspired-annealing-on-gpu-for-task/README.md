# 34.10 — Quantum-inspired annealing on GPU for task allocation

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Quantum-inspired annealing on GPU for task allocation [R&D]`
>
...
Quantum-inspired annealing on GPU for task allocation
...
1. Open [`build/quantum-inspired-annealing-on-gpu-for-task.sln`](build/quantum-inspired-annealing-on-gpu-for-task.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/quantum-inspired-annealing-on-gpu-for-task.exe`.
