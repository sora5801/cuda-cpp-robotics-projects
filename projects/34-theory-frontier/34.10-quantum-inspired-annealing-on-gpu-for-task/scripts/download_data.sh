#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 34.10 (Quantum-inspired annealing on GPU for task allocation)
...
echo "[download_data] Project 34.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
