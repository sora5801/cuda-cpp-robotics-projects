# ===========================================================================
# run_demo.ps1 — one-command demo for 34.10 (Quantum-inspired annealing on GPU for task allocation)
#
...
$Slug       = 'quantum-inspired-annealing-on-gpu-for-task'                     # substituted by scaffold.py
