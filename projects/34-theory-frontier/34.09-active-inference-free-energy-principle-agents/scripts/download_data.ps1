# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 34.09 (Active inference / free-energy-principle agents)
#
...
Write-Host "[download_data] Project 34.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
