// ===========================================================================
// main.cu — entry point for project 34.09 (Active inference / free-energy-principle agents)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 34.09 (active-inference-free-energy-principle-agents)\n");
