# ===========================================================================
# run_demo.ps1 — one-command demo for 34.09 (Active inference / free-energy-principle agents)
#
...
$Slug       = 'active-inference-free-energy-principle-agents'                     # substituted by scaffold.py
