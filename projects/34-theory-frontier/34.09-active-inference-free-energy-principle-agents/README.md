# 34.09 — Active inference / free-energy-principle agents

**Difficulty:** [R&D] research · **Domain:** 34. Theoretical & Research Frontier

> Catalog bullet (source of truth, verbatim): `Active inference / free-energy-principle agents [R&D]`
>
...
Active inference / free-energy-principle agents
...
1. Open [`build/active-inference-free-energy-principle-agents.sln`](build/active-inference-free-energy-principle-agents.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/active-inference-free-energy-principle-agents.exe`.
