# ===========================================================================
# run_demo.ps1 — one-command demo for 29.13 (Lab automation: cell detection/tracking, pipetting verification vision)
#
...
$Slug       = 'lab-automation'                     # substituted by scaffold.py
