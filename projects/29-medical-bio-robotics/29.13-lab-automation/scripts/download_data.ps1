# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.13 (Lab automation: cell detection/tracking, pipetting verification vision)
#
...
Write-Host "[download_data] Project 29.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
