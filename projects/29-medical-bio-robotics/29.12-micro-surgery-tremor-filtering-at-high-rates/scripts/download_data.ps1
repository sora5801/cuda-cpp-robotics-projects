# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.12 (Micro-surgery tremor filtering at high rates)
#
...
Write-Host "[download_data] Project 29.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
