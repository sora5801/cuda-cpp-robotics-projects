#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.12 (Micro-surgery tremor filtering at high rates)
...
echo "[download_data] Project 29.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
