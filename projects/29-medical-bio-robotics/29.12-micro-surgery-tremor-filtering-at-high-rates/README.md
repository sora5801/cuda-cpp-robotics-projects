# 29.12 — Micro-surgery tremor filtering at high rates

**Difficulty:** intermediate · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Micro-surgery tremor filtering at high rates`
>
...
1. Open [`build/micro-surgery-tremor-filtering-at-high-rates.sln`](build/micro-surgery-tremor-filtering-at-high-rates.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/micro-surgery-tremor-filtering-at-high-rates.exe`.
