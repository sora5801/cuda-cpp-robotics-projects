// ===========================================================================
// main.cu — entry point for project 29.12 (Micro-surgery tremor filtering at high rates)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.12 (micro-surgery-tremor-filtering-at-high-rates)\n");
