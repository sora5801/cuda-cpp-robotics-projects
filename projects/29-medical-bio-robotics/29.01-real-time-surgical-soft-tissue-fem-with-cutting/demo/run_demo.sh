#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 29.01 (Real-time surgical soft-tissue FEM with cutting ; suture-thread simulation)
...
SLUG='real-time-surgical-soft-tissue-fem-with-cutting'
