# ===========================================================================
# run_demo.ps1 — one-command demo for 29.01 (Real-time surgical soft-tissue FEM with cutting ; suture-thread simulation)
#
...
$Slug       = 'real-time-surgical-soft-tissue-fem-with-cutting'                     # substituted by scaffold.py
