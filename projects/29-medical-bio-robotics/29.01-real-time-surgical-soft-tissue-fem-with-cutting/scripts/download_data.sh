#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.01 (Real-time surgical soft-tissue FEM with cutting ; suture-thread simulation)
...
echo "[download_data] Project 29.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
