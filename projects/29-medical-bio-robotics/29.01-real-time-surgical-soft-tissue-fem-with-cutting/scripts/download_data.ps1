# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.01 (Real-time surgical soft-tissue FEM with cutting ; suture-thread simulation)
#
...
Write-Host "[download_data] Project 29.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
