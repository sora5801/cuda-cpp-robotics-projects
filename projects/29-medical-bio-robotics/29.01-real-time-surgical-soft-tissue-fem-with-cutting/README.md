# 29.01 — Real-time surgical soft-tissue FEM with cutting ; suture-thread simulation

**Difficulty:** [R&D] research · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Real-time surgical soft-tissue FEM with cutting [R&D]; suture-thread simulation`
>
...
Real-time surgical soft-tissue FEM with cutting ; suture-thread simulation
...
1. Open [`build/real-time-surgical-soft-tissue-fem-with-cutting.sln`](build/real-time-surgical-soft-tissue-fem-with-cutting.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/real-time-surgical-soft-tissue-fem-with-cutting.exe`.
