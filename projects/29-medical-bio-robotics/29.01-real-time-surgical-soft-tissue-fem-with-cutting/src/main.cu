// ===========================================================================
// main.cu — entry point for project 29.01 (Real-time surgical soft-tissue FEM with cutting ; suture-thread simulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.01 (real-time-surgical-soft-tissue-fem-with-cutting)\n");
