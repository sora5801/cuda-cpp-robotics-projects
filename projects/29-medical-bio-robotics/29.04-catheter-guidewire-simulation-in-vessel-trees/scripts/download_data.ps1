# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.04 (Catheter/guidewire simulation in vessel trees)
#
...
Write-Host "[download_data] Project 29.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
