#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.04 (Catheter/guidewire simulation in vessel trees)
...
echo "[download_data] Project 29.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
