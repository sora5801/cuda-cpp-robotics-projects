# ===========================================================================
# run_demo.ps1 — one-command demo for 29.04 (Catheter/guidewire simulation in vessel trees)
#
...
$Slug       = 'catheter-guidewire-simulation-in-vessel-trees'                     # substituted by scaffold.py
