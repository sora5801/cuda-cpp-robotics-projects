// ===========================================================================
// main.cu — entry point for project 29.04 (Catheter/guidewire simulation in vessel trees)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.04 (catheter-guidewire-simulation-in-vessel-trees)\n");
