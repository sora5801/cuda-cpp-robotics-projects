# 29.04 — Catheter/guidewire simulation in vessel trees

**Difficulty:** [R&D] research · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Catheter/guidewire simulation in vessel trees [R&D]`
>
...
Catheter/guidewire simulation in vessel trees
...
1. Open [`build/catheter-guidewire-simulation-in-vessel-trees.sln`](build/catheter-guidewire-simulation-in-vessel-trees.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/catheter-guidewire-simulation-in-vessel-trees.exe`.
