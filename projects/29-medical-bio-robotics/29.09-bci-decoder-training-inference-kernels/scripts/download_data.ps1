# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.09 (BCI decoder training + inference kernels)
#
...
Write-Host "[download_data] Project 29.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
