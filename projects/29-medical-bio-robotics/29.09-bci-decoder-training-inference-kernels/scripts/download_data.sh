#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.09 (BCI decoder training + inference kernels)
...
echo "[download_data] Project 29.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
