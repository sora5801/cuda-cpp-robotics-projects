// ===========================================================================
// main.cu — entry point for project 29.09 (BCI decoder training + inference kernels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.09 (bci-decoder-training-inference-kernels)\n");
