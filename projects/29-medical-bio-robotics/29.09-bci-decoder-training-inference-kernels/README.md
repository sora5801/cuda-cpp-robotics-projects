# 29.09 — BCI decoder training + inference kernels

**Difficulty:** [R&D] research · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `BCI decoder training + inference kernels [R&D]`
>
...
BCI decoder training + inference kernels
...
1. Open [`build/bci-decoder-training-inference-kernels.sln`](build/bci-decoder-training-inference-kernels.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/bci-decoder-training-inference-kernels.exe`.
