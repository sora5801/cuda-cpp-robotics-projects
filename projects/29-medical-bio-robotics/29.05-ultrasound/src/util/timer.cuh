...
//                  (project 29.05; copied from docs/PROJECT_TEMPLATE
...
//    single-stream structure of the demos. This project's four beamforming
//    kernels all run in the default stream too — no multi-stream adaptation
//    needed here (a single-shot image reconstruction, not a streaming loop).
