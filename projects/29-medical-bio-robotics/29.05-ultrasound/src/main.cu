// ===========================================================================
// main.cu — entry point for project 29.05 (Ultrasound: GPU beamforming, elastography, image-based servoing)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.05 (ultrasound)\n");
