# ===========================================================================
# run_demo.ps1 — one-command demo for 29.05 (Ultrasound: GPU beamforming, elastography, image-based servoing)
#
...
#
# This script needed NO changes once the real beamforming implementation
# landed — it just diffs whatever stable lines ../src/main.cu prints against
# expected_output.txt (see the "output contract" comment there). Keep the
# two in sync if a stable line ever changes.
#
...
$Slug       = 'ultrasound'                     # substituted by scaffold.py
...
# (expected_output.txt's provenance/annotation lines are such comments).
