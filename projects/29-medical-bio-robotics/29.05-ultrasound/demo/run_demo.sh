#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 29.05 (Ultrasound: GPU beamforming, elastography, image-based servoing)
...
# lines (see the "output contract" comment there) in the same change as any
# edit to either file.
# ===========================================================================
set -euo pipefail
