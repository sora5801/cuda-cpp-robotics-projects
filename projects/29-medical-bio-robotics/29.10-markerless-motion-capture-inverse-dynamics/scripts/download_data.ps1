# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.10 (Markerless motion capture + inverse-dynamics muscle-force estimation (batched static optimization))
#
...
Write-Host "[download_data] Project 29.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
