#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.10 (Markerless motion capture + inverse-dynamics muscle-force estimation (batched static optimization))
...
echo "[download_data] Project 29.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
