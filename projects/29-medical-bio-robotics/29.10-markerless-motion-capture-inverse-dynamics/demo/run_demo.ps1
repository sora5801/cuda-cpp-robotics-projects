# ===========================================================================
# run_demo.ps1 — one-command demo for 29.10 (Markerless motion capture + inverse-dynamics muscle-force estimation (batched static optimization))
#
...
$Slug       = 'markerless-motion-capture-inverse-dynamics'                     # substituted by scaffold.py
