# 29.10 — Markerless motion capture + inverse-dynamics muscle-force estimation (batched static optimization)

**Difficulty:** intermediate · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Markerless motion capture + inverse-dynamics muscle-force estimation (batched static optimization)`
>
...
1. Open [`build/markerless-motion-capture-inverse-dynamics.sln`](build/markerless-motion-capture-inverse-dynamics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/markerless-motion-capture-inverse-dynamics.exe`.
