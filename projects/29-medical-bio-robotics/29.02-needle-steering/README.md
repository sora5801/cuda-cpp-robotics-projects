# 29.02 — Needle steering: bevel-tip models + replanning batches

**Difficulty:** [R&D] research · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Needle steering: bevel-tip models + replanning batches [R&D]`
>
...
Needle steering: bevel-tip models + replanning batches
...
1. Open [`build/needle-steering.sln`](build/needle-steering.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/needle-steering.exe`.
