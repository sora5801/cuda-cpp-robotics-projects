#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.02 (Needle steering: bevel-tip models + replanning batches)
...
echo "[download_data] Project 29.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
