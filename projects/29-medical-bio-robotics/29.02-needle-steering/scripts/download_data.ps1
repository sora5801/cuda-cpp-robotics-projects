# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.02 (Needle steering: bevel-tip models + replanning batches)
#
...
Write-Host "[download_data] Project 29.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
