// ===========================================================================
// main.cu — entry point for project 29.02 (Needle steering: bevel-tip models + replanning batches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.02 (needle-steering)\n");
