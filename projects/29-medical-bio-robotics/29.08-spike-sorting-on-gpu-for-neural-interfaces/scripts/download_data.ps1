# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.08 (Spike sorting on GPU (template matching at scale) for neural interfaces)
#
...
Write-Host "[download_data] Project 29.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
