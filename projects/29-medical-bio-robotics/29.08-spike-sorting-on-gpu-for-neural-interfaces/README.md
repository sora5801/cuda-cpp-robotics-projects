# 29.08 — Spike sorting on GPU (template matching at scale) for neural interfaces

**Difficulty:** intermediate · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Spike sorting on GPU (template matching at scale) for neural interfaces`
>
...
1. Open [`build/spike-sorting-on-gpu-for-neural-interfaces.sln`](build/spike-sorting-on-gpu-for-neural-interfaces.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/spike-sorting-on-gpu-for-neural-interfaces.exe`.
