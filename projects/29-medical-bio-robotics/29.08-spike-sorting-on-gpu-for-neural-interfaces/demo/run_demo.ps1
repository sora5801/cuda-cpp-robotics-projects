# ===========================================================================
# run_demo.ps1 — one-command demo for 29.08 (Spike sorting on GPU (template matching at scale) for neural interfaces)
#
...
$Slug       = 'spike-sorting-on-gpu-for-neural-interfaces'                     # substituted by scaffold.py
