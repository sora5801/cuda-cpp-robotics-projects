#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 29.08 (Spike sorting on GPU (template matching at scale) for neural interfaces)
...
SLUG='spike-sorting-on-gpu-for-neural-interfaces'
