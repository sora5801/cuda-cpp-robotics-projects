// ===========================================================================
// main.cu — entry point for project 29.08 (Spike sorting on GPU (template matching at scale) for neural interfaces)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.08 (spike-sorting-on-gpu-for-neural-interfaces)\n");
