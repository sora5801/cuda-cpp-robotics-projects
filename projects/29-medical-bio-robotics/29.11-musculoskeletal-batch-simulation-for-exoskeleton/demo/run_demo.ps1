# ===========================================================================
# run_demo.ps1 — one-command demo for 29.11 (Musculoskeletal (OpenSim-style) batch simulation for exoskeleton design)
#
...
$Slug       = 'musculoskeletal-batch-simulation-for-exoskeleton'                     # substituted by scaffold.py
