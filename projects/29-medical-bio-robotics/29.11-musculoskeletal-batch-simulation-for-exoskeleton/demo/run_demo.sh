#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 29.11 (Musculoskeletal (OpenSim-style) batch simulation for exoskeleton design)
...
SLUG='musculoskeletal-batch-simulation-for-exoskeleton'
