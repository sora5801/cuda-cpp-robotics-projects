# 29.11 — Musculoskeletal (OpenSim-style) batch simulation for exoskeleton design

**Difficulty:** intermediate · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Musculoskeletal (OpenSim-style) batch simulation for exoskeleton design`
>
...
1. Open [`build/musculoskeletal-batch-simulation-for-exoskeleton.sln`](build/musculoskeletal-batch-simulation-for-exoskeleton.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/musculoskeletal-batch-simulation-for-exoskeleton.exe`.
