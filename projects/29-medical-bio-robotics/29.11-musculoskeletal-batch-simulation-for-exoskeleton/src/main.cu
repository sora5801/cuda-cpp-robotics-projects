// ===========================================================================
// main.cu — entry point for project 29.11 (Musculoskeletal (OpenSim-style) batch simulation for exoskeleton design)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.11 (musculoskeletal-batch-simulation-for-exoskeleton)\n");
