#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.11 (Musculoskeletal (OpenSim-style) batch simulation for exoskeleton design)
...
echo "[download_data] Project 29.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
