# 29.06 — Endoscopy SLAM in deformable environments ; capsule-robot localization

**Difficulty:** [R&D] research · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Endoscopy SLAM in deformable environments [R&D]; capsule-robot localization`
>
...
Endoscopy SLAM in deformable environments ; capsule-robot localization
...
1. Open [`build/endoscopy-slam-in-deformable-environments.sln`](build/endoscopy-slam-in-deformable-environments.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/endoscopy-slam-in-deformable-environments.exe`.
