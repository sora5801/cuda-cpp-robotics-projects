#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 29.06 (Endoscopy SLAM in deformable environments ; capsule-robot localization)
...
SLUG='endoscopy-slam-in-deformable-environments'
