# ===========================================================================
# run_demo.ps1 — one-command demo for 29.06 (Endoscopy SLAM in deformable environments ; capsule-robot localization)
#
...
$Slug       = 'endoscopy-slam-in-deformable-environments'                     # substituted by scaffold.py
