#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.06 (Endoscopy SLAM in deformable environments ; capsule-robot localization)
...
echo "[download_data] Project 29.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
