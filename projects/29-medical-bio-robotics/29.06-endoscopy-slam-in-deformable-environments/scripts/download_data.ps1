# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.06 (Endoscopy SLAM in deformable environments ; capsule-robot localization)
#
...
Write-Host "[download_data] Project 29.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
