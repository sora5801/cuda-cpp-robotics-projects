// ===========================================================================
// main.cu — entry point for project 29.06 (Endoscopy SLAM in deformable environments ; capsule-robot localization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.06 (endoscopy-slam-in-deformable-environments)\n");
