# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.03 (Concentric-tube robot kinematics batches)
#
...
Write-Host "[download_data] Project 29.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
