#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.03 (Concentric-tube robot kinematics batches)
...
echo "[download_data] Project 29.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
