// ===========================================================================
// main.cu — entry point for project 29.03 (Concentric-tube robot kinematics batches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 29.03 (concentric-tube-robot-kinematics-batches)\n");
