# 29.03 — Concentric-tube robot kinematics batches

**Difficulty:** [R&D] research · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Concentric-tube robot kinematics batches [R&D]`
>
...
Concentric-tube robot kinematics batches
...
1. Open [`build/concentric-tube-robot-kinematics-batches.sln`](build/concentric-tube-robot-kinematics-batches.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/concentric-tube-robot-kinematics-batches.exe`.
