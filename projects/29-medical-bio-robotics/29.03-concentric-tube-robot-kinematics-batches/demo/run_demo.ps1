# ===========================================================================
# run_demo.ps1 — one-command demo for 29.03 (Concentric-tube robot kinematics batches)
#
...
$Slug       = 'concentric-tube-robot-kinematics-batches'                     # substituted by scaffold.py
