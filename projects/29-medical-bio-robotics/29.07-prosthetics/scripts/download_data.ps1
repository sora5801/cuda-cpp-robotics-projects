# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 29.07 (Prosthetics: kHz EMG decomposition + intent classification, batched)
#
...
Write-Host "[download_data] Project 29.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
