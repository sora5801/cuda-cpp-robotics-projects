#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 29.07 (Prosthetics: kHz EMG decomposition + intent classification, batched)
...
echo "[download_data] Project 29.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
