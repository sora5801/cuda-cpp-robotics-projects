# 29.07 — Prosthetics: kHz EMG decomposition + intent classification, batched

**Difficulty:** intermediate · **Domain:** 29. Medical & Bio-Robotics

> Catalog bullet (source of truth, verbatim): `Prosthetics: kHz EMG decomposition + intent classification, batched`
>
...
1. Open [`build/prosthetics.sln`](build/prosthetics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/prosthetics.exe`.
