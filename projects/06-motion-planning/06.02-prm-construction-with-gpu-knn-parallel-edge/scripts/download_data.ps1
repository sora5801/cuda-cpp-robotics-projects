# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.02 (PRM construction with GPU KNN + parallel edge checks)
#
...
Write-Host "[download_data] Project 06.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
