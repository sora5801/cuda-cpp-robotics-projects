#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.02 (PRM construction with GPU KNN + parallel edge checks)
...
echo "[download_data] Project 06.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
