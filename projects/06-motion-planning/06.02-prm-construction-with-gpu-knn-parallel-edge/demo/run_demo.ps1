# ===========================================================================
# run_demo.ps1 — one-command demo for 06.02 (PRM construction with GPU KNN + parallel edge checks)
#
...
$Slug       = 'prm-construction-with-gpu-knn-parallel-edge'                     # substituted by scaffold.py
