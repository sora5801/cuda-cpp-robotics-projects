// ===========================================================================
// main.cu — entry point for project 06.02 (PRM construction with GPU KNN + parallel edge checks)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.02 (prm-construction-with-gpu-knn-parallel-edge)\n");
