# 06.02 — PRM construction with GPU KNN + parallel edge checks

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `PRM construction with GPU KNN + parallel edge checks`
>
...
1. Open [`build/prm-construction-with-gpu-knn-parallel-edge.sln`](build/prm-construction-with-gpu-knn-parallel-edge.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/prm-construction-with-gpu-knn-parallel-edge.exe`.
