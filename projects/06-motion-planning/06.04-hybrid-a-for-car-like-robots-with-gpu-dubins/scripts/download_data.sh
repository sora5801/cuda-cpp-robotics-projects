#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.04 (Hybrid A* for car-like robots with GPU Dubins/Reeds-Shepp + swept collision)
...
echo "[download_data] Project 06.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
