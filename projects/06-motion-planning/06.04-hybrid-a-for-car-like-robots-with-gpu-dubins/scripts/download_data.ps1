# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.04 (Hybrid A* for car-like robots with GPU Dubins/Reeds-Shepp + swept collision)
#
...
Write-Host "[download_data] Project 06.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
