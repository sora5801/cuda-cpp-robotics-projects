#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 06.04 (Hybrid A* for car-like robots with GPU Dubins/Reeds-Shepp + swept collision)
...
SLUG='hybrid-a-for-car-like-robots-with-gpu-dubins'
