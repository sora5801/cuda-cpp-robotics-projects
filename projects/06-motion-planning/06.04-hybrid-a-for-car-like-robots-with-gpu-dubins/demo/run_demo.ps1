# ===========================================================================
# run_demo.ps1 — one-command demo for 06.04 (Hybrid A* for car-like robots with GPU Dubins/Reeds-Shepp + swept collision)
#
...
$Slug       = 'hybrid-a-for-car-like-robots-with-gpu-dubins'                     # substituted by scaffold.py
