// ===========================================================================
// main.cu — entry point for project 06.04 (Hybrid A* for car-like robots with GPU Dubins/Reeds-Shepp + swept collision)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.04 (hybrid-a-for-car-like-robots-with-gpu-dubins)\n");
