# 06.04 — Hybrid A* for car-like robots with GPU Dubins/Reeds-Shepp + swept collision

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Hybrid A* for car-like robots with GPU Dubins/Reeds-Shepp + swept collision`
>
...
1. Open [`build/hybrid-a-for-car-like-robots-with-gpu-dubins.sln`](build/hybrid-a-for-car-like-robots-with-gpu-dubins.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/hybrid-a-for-car-like-robots-with-gpu-dubins.exe`.
