# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.12 (Time-optimal path parameterization (TOPP) batched over paths)
#
...
Write-Host "[download_data] Project 06.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
