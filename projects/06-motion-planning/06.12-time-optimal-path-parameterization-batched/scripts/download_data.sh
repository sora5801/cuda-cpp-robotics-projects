#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.12 (Time-optimal path parameterization (TOPP) batched over paths)
...
echo "[download_data] Project 06.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
