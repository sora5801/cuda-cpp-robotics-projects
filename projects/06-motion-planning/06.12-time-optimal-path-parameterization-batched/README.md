# 06.12 — Time-optimal path parameterization (TOPP) batched over paths

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Time-optimal path parameterization (TOPP) batched over paths`
>
...
1. Open [`build/time-optimal-path-parameterization-batched.sln`](build/time-optimal-path-parameterization-batched.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/time-optimal-path-parameterization-batched.exe`.
