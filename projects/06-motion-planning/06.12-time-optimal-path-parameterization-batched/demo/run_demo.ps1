# ===========================================================================
# run_demo.ps1 — one-command demo for 06.12 (Time-optimal path parameterization (TOPP) batched over paths)
#
...
$Slug       = 'time-optimal-path-parameterization-batched'                     # substituted by scaffold.py
