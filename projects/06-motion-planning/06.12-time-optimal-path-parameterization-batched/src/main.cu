// ===========================================================================
// main.cu — entry point for project 06.12 (Time-optimal path parameterization (TOPP) batched over paths)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.12 (time-optimal-path-parameterization-batched)\n");
