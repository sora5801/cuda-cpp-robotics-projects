# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.06 (CHOMP with GPU ESDF gradients)
#
...
Write-Host "[download_data] Project 06.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
