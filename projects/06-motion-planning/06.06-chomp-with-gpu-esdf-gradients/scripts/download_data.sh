#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.06 (CHOMP with GPU ESDF gradients)
...
echo "[download_data] Project 06.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
