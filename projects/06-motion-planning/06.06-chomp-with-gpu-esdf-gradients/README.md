# 06.06 — CHOMP with GPU ESDF gradients

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `CHOMP with GPU ESDF gradients`
>
...
1. Open [`build/chomp-with-gpu-esdf-gradients.sln`](build/chomp-with-gpu-esdf-gradients.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/chomp-with-gpu-esdf-gradients.exe`.
