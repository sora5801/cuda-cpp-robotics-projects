# 06.09 — Motion-primitive library: score 10⁴ primitives per control cycle

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Motion-primitive library: score 10⁴ primitives per control cycle`
>
...
1. Open [`build/motion-primitive-library.sln`](build/motion-primitive-library.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/motion-primitive-library.exe`.
