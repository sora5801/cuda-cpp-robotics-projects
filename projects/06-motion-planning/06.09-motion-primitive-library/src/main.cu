// ===========================================================================
// main.cu — entry point for project 06.09 (Motion-primitive library: score 10⁴ primitives per control cycle)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.09 (motion-primitive-library)\n");
