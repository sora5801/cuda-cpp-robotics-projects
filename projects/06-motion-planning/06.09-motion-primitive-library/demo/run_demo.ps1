# ===========================================================================
# run_demo.ps1 — one-command demo for 06.09 (Motion-primitive library: score 10⁴ primitives per control cycle)
#
...
$Slug       = 'motion-primitive-library'                     # substituted by scaffold.py
