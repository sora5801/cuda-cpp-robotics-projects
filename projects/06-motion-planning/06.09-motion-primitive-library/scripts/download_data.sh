#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.09 (Motion-primitive library: score 10⁴ primitives per control cycle)
...
echo "[download_data] Project 06.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
