# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.09 (Motion-primitive library: score 10⁴ primitives per control cycle)
#
...
Write-Host "[download_data] Project 06.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
