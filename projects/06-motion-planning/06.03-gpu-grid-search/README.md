# 06.03 — GPU grid search: parallel-wavefront A*/Dijkstra, D* Lite replanning

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `GPU grid search: parallel-wavefront A*/Dijkstra, D* Lite replanning`
>
...
1. Open [`build/gpu-grid-search.sln`](build/gpu-grid-search.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-grid-search.exe`.
