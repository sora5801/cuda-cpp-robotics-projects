# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.03 (GPU grid search: parallel-wavefront A*/Dijkstra, D* Lite replanning)
#
...
Write-Host "[download_data] Project 06.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
