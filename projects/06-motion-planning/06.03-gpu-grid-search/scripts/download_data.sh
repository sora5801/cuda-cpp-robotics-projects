#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.03 (GPU grid search: parallel-wavefront A*/Dijkstra, D* Lite replanning)
...
echo "[download_data] Project 06.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
