# ===========================================================================
# run_demo.ps1 — one-command demo for 06.03 (GPU grid search: parallel-wavefront A*/Dijkstra, D* Lite replanning)
#
...
$Slug       = 'gpu-grid-search'                     # substituted by scaffold.py
