# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.16 (Anytime planning under compute budget with parallel rollouts)
#
...
Write-Host "[download_data] Project 06.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
