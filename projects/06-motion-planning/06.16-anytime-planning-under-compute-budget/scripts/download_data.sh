#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.16 (Anytime planning under compute budget with parallel rollouts)
...
echo "[download_data] Project 06.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
