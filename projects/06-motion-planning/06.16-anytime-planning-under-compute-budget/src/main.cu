// ===========================================================================
// main.cu — entry point for project 06.16 (Anytime planning under compute budget with parallel rollouts)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.16 (anytime-planning-under-compute-budget)\n");
