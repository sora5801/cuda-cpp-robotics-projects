# ===========================================================================
# run_demo.ps1 — one-command demo for 06.16 (Anytime planning under compute budget with parallel rollouts)
#
...
$Slug       = 'anytime-planning-under-compute-budget'                     # substituted by scaffold.py
