# 06.16 — Anytime planning under compute budget with parallel rollouts

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Anytime planning under compute budget with parallel rollouts`
>
...
1. Open [`build/anytime-planning-under-compute-budget.sln`](build/anytime-planning-under-compute-budget.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/anytime-planning-under-compute-budget.exe`.
