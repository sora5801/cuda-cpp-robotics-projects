# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.08 (MPPI planner for mobile robots (also see Control))
#
...
Write-Host "[download_data] Project 06.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
