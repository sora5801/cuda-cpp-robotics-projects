#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.08 (MPPI planner for mobile robots (also see Control))
...
echo "[download_data] Project 06.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
