# 06.08 — MPPI planner for mobile robots (also see Control)

**Difficulty:** ★ beginner · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `★ MPPI planner for mobile robots (also see Control)`
>
...
1. Open [`build/mppi-planner-for-mobile-robots.sln`](build/mppi-planner-for-mobile-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mppi-planner-for-mobile-robots.exe`.
