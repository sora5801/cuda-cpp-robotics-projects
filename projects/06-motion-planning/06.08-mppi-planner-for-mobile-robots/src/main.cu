// ===========================================================================
// main.cu — entry point for project 06.08 (MPPI planner for mobile robots (also see Control))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.08 (mppi-planner-for-mobile-robots)\n");
