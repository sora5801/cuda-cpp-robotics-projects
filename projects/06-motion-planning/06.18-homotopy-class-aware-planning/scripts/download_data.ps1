# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.18 (Homotopy-class-aware planning (h-signatures on GPU))
#
...
Write-Host "[download_data] Project 06.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
