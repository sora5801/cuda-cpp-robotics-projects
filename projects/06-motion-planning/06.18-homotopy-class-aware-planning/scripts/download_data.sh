#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.18 (Homotopy-class-aware planning (h-signatures on GPU))
...
echo "[download_data] Project 06.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
