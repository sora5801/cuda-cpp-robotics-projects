# 06.18 — Homotopy-class-aware planning (h-signatures on GPU)

**Difficulty:** [R&D] research · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Homotopy-class-aware planning (h-signatures on GPU) [R&D]`
>
...
Homotopy-class-aware planning (h-signatures on GPU)
...
1. Open [`build/homotopy-class-aware-planning.sln`](build/homotopy-class-aware-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/homotopy-class-aware-planning.exe`.
