# ===========================================================================
# run_demo.ps1 — one-command demo for 06.18 (Homotopy-class-aware planning (h-signatures on GPU))
#
...
$Slug       = 'homotopy-class-aware-planning'                     # substituted by scaffold.py
