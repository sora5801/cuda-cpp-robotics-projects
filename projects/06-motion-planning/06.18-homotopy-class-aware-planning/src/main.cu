// ===========================================================================
// main.cu — entry point for project 06.18 (Homotopy-class-aware planning (h-signatures on GPU))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.18 (homotopy-class-aware-planning)\n");
