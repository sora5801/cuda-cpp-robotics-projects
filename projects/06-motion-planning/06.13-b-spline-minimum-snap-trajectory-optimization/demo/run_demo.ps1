# ===========================================================================
# run_demo.ps1 — one-command demo for 06.13 (B-spline / minimum-snap trajectory optimization batches)
#
...
$Slug       = 'b-spline-minimum-snap-trajectory-optimization'                     # substituted by scaffold.py
