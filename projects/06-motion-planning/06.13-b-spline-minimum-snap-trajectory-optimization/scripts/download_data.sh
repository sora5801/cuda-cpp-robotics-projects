#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.13 (B-spline / minimum-snap trajectory optimization batches)
...
echo "[download_data] Project 06.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
