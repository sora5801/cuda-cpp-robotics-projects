# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.13 (B-spline / minimum-snap trajectory optimization batches)
#
...
Write-Host "[download_data] Project 06.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
