// ===========================================================================
// main.cu — entry point for project 06.13 (B-spline / minimum-snap trajectory optimization batches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.13 (b-spline-minimum-snap-trajectory-optimization)\n");
