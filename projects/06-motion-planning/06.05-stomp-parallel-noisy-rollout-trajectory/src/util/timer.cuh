...
//                  (project 06.05; copied from docs/PROJECT_TEMPLATE
...
//    (one STOMP scoring kernel per iteration; main.cu brackets each launch
//    with a GpuTimer); multi-stream projects record into their own streams
//    instead.
