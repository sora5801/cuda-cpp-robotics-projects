// ===========================================================================
// main.cu — entry point for project 06.05 (STOMP: parallel noisy-rollout trajectory optimization (born for GPU))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.05 (stomp-parallel-noisy-rollout-trajectory)\n");
