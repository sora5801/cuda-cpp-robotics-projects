# ===========================================================================
# run_demo.ps1 — one-command demo for 06.05 (STOMP: parallel noisy-rollout trajectory optimization (born for GPU))
#
...
#
# 06.05: the real STOMP implementation is in; this script is unchanged from
# the template (it needed none). expected_output.txt carries the real stable
# lines — the output contract lives at the top of ../src/main.cu; change the
# two together. The demo also writes demo/out/trajectory.csv and
# demo/out/costfield.pgm (both git-ignored) — see ../demo/README.md.
#
...
$Slug       = 'stomp-parallel-noisy-rollout-trajectory'                     # substituted by scaffold.py
...
# (the header comment lines in expected_output.txt are such comments).
