#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 06.05 (STOMP: parallel noisy-rollout trajectory optimization (born for GPU))
...
# 06.05: expected_output.txt carries the real STOMP implementation's stable
# lines (the output contract lives at the top of ../src/main.cu; change together).
# ===========================================================================
set -euo pipefail
...
SLUG='stomp-parallel-noisy-rollout-trajectory'
