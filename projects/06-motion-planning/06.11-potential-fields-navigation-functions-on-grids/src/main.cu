// ===========================================================================
// main.cu — entry point for project 06.11 (Potential fields / navigation functions on grids)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.11 (potential-fields-navigation-functions-on-grids)\n");
