# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.11 (Potential fields / navigation functions on grids)
#
...
Write-Host "[download_data] Project 06.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
