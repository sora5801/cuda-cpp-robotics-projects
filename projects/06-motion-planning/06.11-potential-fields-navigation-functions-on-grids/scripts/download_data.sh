#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.11 (Potential fields / navigation functions on grids)
...
echo "[download_data] Project 06.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
