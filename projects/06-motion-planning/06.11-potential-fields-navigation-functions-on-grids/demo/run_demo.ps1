# ===========================================================================
# run_demo.ps1 — one-command demo for 06.11 (Potential fields / navigation functions on grids)
#
...
$Slug       = 'potential-fields-navigation-functions-on-grids'                     # substituted by scaffold.py
