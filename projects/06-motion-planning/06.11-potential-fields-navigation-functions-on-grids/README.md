# 06.11 — Potential fields / navigation functions on grids

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Potential fields / navigation functions on grids`
>
...
1. Open [`build/potential-fields-navigation-functions-on-grids.sln`](build/potential-fields-navigation-functions-on-grids.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/potential-fields-navigation-functions-on-grids.exe`.
