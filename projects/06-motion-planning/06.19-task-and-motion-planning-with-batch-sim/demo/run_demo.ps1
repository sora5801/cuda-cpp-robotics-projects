# ===========================================================================
# run_demo.ps1 — one-command demo for 06.19 (Task-and-motion planning with batch-sim feasibility screening)
#
...
$Slug       = 'task-and-motion-planning-with-batch-sim'                     # substituted by scaffold.py
