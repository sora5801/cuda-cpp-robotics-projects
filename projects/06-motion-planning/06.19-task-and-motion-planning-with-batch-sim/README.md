# 06.19 — Task-and-motion planning with batch-sim feasibility screening

**Difficulty:** [R&D] research · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Task-and-motion planning with batch-sim feasibility screening [R&D]`
>
...
Task-and-motion planning with batch-sim feasibility screening
...
1. Open [`build/task-and-motion-planning-with-batch-sim.sln`](build/task-and-motion-planning-with-batch-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/task-and-motion-planning-with-batch-sim.exe`.
