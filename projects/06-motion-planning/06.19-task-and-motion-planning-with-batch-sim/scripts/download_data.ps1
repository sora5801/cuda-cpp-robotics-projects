# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.19 (Task-and-motion planning with batch-sim feasibility screening)
#
...
Write-Host "[download_data] Project 06.19 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
