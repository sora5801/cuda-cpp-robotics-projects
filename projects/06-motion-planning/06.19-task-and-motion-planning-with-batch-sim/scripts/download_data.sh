#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.19 (Task-and-motion planning with batch-sim feasibility screening)
...
echo "[download_data] Project 06.19 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
