// ===========================================================================
// main.cu — entry point for project 06.19 (Task-and-motion planning with batch-sim feasibility screening)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.19 (task-and-motion-planning-with-batch-sim)\n");
