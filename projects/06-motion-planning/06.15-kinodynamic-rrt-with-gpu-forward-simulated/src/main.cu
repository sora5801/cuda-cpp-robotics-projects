// ===========================================================================
// main.cu — entry point for project 06.15 (Kinodynamic RRT with GPU forward-simulated expansions)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.15 (kinodynamic-rrt-with-gpu-forward-simulated)\n");
