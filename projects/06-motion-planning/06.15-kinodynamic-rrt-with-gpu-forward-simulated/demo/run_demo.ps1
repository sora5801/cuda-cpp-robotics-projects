# ===========================================================================
# run_demo.ps1 — one-command demo for 06.15 (Kinodynamic RRT with GPU forward-simulated expansions)
#
...
$Slug       = 'kinodynamic-rrt-with-gpu-forward-simulated'                     # substituted by scaffold.py
