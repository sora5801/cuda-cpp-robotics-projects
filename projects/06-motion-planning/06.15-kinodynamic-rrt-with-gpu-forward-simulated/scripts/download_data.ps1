# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.15 (Kinodynamic RRT with GPU forward-simulated expansions)
#
...
Write-Host "[download_data] Project 06.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
