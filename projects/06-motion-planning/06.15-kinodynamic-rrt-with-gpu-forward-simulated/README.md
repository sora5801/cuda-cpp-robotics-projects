# 06.15 — Kinodynamic RRT with GPU forward-simulated expansions

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Kinodynamic RRT with GPU forward-simulated expansions`
>
...
1. Open [`build/kinodynamic-rrt-with-gpu-forward-simulated.sln`](build/kinodynamic-rrt-with-gpu-forward-simulated.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/kinodynamic-rrt-with-gpu-forward-simulated.exe`.
