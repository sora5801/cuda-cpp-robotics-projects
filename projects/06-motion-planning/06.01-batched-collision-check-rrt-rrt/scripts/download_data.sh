#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.01 (Batched-collision-check RRT/RRT* (parallel edge validation))
...
echo "[download_data] Project 06.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
