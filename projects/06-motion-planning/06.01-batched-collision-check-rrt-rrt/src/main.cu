// ===========================================================================
// main.cu — entry point for project 06.01 (Batched-collision-check RRT/RRT* (parallel edge validation))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.01 (batched-collision-check-rrt-rrt)\n");
