# ===========================================================================
# run_demo.ps1 — one-command demo for 06.01 (Batched-collision-check RRT/RRT* (parallel edge validation))
#
...
$Slug       = 'batched-collision-check-rrt-rrt'                     # substituted by scaffold.py
