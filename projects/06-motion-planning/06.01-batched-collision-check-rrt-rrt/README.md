# 06.01 — Batched-collision-check RRT/RRT* (parallel edge validation)

**Difficulty:** ★ beginner · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `★ Batched-collision-check RRT/RRT* (parallel edge validation)`
>
...
1. Open [`build/batched-collision-check-rrt-rrt.sln`](build/batched-collision-check-rrt-rrt.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/batched-collision-check-rrt-rrt.exe`.
