#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.07 (cuRobo-style arm planner: massively parallel seeded IK + trajectory opt + collision)
...
echo "[download_data] Project 06.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
