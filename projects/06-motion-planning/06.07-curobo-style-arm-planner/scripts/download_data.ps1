# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.07 (cuRobo-style arm planner: massively parallel seeded IK + trajectory opt + collision)
#
...
Write-Host "[download_data] Project 06.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
