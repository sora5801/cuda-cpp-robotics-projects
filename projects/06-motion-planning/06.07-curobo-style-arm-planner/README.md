# 06.07 — cuRobo-style arm planner: massively parallel seeded IK + trajectory opt + collision

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `cuRobo-style arm planner: massively parallel seeded IK + trajectory opt + collision`
>
...
1. Open [`build/curobo-style-arm-planner.sln`](build/curobo-style-arm-planner.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/curobo-style-arm-planner.exe`.
