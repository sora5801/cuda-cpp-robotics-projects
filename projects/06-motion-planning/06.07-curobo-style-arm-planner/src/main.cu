// ===========================================================================
// main.cu — entry point for project 06.07 (cuRobo-style arm planner: massively parallel seeded IK + trajectory opt + collision)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.07 (curobo-style-arm-planner)\n");
