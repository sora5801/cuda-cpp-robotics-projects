# ===========================================================================
# run_demo.ps1 — one-command demo for 06.07 (cuRobo-style arm planner: massively parallel seeded IK + trajectory opt + collision)
#
...
$Slug       = 'curobo-style-arm-planner'                     # substituted by scaffold.py
