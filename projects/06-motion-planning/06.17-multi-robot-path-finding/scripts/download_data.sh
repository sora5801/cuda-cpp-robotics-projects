#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.17 (Multi-robot path finding: CBS with GPU low-level searches)
...
echo "[download_data] Project 06.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
