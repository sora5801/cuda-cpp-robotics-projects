# 06.17 — Multi-robot path finding: CBS with GPU low-level searches

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Multi-robot path finding: CBS with GPU low-level searches`
>
...
1. Open [`build/multi-robot-path-finding.sln`](build/multi-robot-path-finding.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/multi-robot-path-finding.exe`.
