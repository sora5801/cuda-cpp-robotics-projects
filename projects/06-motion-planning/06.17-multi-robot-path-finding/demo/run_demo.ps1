# ===========================================================================
# run_demo.ps1 — one-command demo for 06.17 (Multi-robot path finding: CBS with GPU low-level searches)
#
...
$Slug       = 'multi-robot-path-finding'                     # substituted by scaffold.py
