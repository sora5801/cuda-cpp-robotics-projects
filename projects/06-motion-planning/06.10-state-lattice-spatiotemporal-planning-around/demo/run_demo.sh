#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 06.10 (State-lattice + spatiotemporal planning around dynamic obstacles)
...
SLUG='state-lattice-spatiotemporal-planning-around'
