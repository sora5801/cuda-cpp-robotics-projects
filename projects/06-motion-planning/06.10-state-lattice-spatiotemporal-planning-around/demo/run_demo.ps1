# ===========================================================================
# run_demo.ps1 — one-command demo for 06.10 (State-lattice + spatiotemporal planning around dynamic obstacles)
#
...
$Slug       = 'state-lattice-spatiotemporal-planning-around'                     # substituted by scaffold.py
