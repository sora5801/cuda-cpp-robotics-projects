// ===========================================================================
// main.cu — entry point for project 06.10 (State-lattice + spatiotemporal planning around dynamic obstacles)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.10 (state-lattice-spatiotemporal-planning-around)\n");
