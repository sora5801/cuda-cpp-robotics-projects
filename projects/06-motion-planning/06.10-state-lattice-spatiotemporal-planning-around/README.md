# 06.10 — State-lattice + spatiotemporal planning around dynamic obstacles

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `State-lattice + spatiotemporal planning around dynamic obstacles`
>
...
1. Open [`build/state-lattice-spatiotemporal-planning-around.sln`](build/state-lattice-spatiotemporal-planning-around.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/state-lattice-spatiotemporal-planning-around.exe`.
