# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.10 (State-lattice + spatiotemporal planning around dynamic obstacles)
#
...
Write-Host "[download_data] Project 06.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
