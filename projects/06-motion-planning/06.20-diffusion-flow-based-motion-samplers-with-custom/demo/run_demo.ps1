# ===========================================================================
# run_demo.ps1 — one-command demo for 06.20 (Diffusion/flow-based motion samplers with custom inference kernels)
#
...
$Slug       = 'diffusion-flow-based-motion-samplers-with-custom'                     # substituted by scaffold.py
