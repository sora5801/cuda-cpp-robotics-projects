#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 06.20 (Diffusion/flow-based motion samplers with custom inference kernels)
...
SLUG='diffusion-flow-based-motion-samplers-with-custom'
