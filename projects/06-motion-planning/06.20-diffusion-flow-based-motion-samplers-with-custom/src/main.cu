// ===========================================================================
// main.cu — entry point for project 06.20 (Diffusion/flow-based motion samplers with custom inference kernels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.20 (diffusion-flow-based-motion-samplers-with-custom)\n");
