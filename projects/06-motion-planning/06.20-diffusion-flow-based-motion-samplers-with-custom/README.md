# 06.20 — Diffusion/flow-based motion samplers with custom inference kernels

**Difficulty:** [R&D] research · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Diffusion/flow-based motion samplers with custom inference kernels [R&D]`
>
...
Diffusion/flow-based motion samplers with custom inference kernels
...
1. Open [`build/diffusion-flow-based-motion-samplers-with-custom.sln`](build/diffusion-flow-based-motion-samplers-with-custom.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/diffusion-flow-based-motion-samplers-with-custom.exe`.
