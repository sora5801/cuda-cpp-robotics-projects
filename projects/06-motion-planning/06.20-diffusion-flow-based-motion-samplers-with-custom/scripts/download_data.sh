#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.20 (Diffusion/flow-based motion samplers with custom inference kernels)
...
echo "[download_data] Project 06.20 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
