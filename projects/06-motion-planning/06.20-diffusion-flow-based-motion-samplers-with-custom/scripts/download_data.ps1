# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.20 (Diffusion/flow-based motion samplers with custom inference kernels)
#
...
Write-Host "[download_data] Project 06.20 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
