# 06.14 — Coverage path planning: cell decomposition + GPU TSP heuristics

**Difficulty:** intermediate · **Domain:** 6. Motion Planning

> Catalog bullet (source of truth, verbatim): `Coverage path planning: cell decomposition + GPU TSP heuristics`
>
...
1. Open [`build/coverage-path-planning.sln`](build/coverage-path-planning.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/coverage-path-planning.exe`.
