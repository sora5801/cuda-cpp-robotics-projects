# ===========================================================================
# run_demo.ps1 — one-command demo for 06.14 (Coverage path planning: cell decomposition + GPU TSP heuristics)
#
...
$Slug       = 'coverage-path-planning'                     # substituted by scaffold.py
