# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 06.14 (Coverage path planning: cell decomposition + GPU TSP heuristics)
#
...
Write-Host "[download_data] Project 06.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
