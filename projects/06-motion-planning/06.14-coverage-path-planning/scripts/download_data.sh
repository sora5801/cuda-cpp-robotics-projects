#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 06.14 (Coverage path planning: cell decomposition + GPU TSP heuristics)
...
echo "[download_data] Project 06.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
