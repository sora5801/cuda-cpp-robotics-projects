// ===========================================================================
// main.cu — entry point for project 06.14 (Coverage path planning: cell decomposition + GPU TSP heuristics)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 06.14 (coverage-path-planning)\n");
