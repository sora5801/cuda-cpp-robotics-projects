# 05.04 — Probabilistic 3D octree mapping (GPU OctoMap)

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Probabilistic 3D octree mapping (GPU OctoMap)`
>
...
1. Open [`build/probabilistic-3d-octree-mapping.sln`](build/probabilistic-3d-octree-mapping.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/probabilistic-3d-octree-mapping.exe`.
