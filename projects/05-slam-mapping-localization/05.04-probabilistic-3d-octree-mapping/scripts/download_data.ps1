# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.04 (Probabilistic 3D octree mapping (GPU OctoMap))
#
...
Write-Host "[download_data] Project 05.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
