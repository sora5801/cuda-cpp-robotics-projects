#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.04 (Probabilistic 3D octree mapping (GPU OctoMap))
...
echo "[download_data] Project 05.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
