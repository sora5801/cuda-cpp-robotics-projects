// ===========================================================================
// main.cu — entry point for project 05.04 (Probabilistic 3D octree mapping (GPU OctoMap))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.04 (probabilistic-3d-octree-mapping)\n");
