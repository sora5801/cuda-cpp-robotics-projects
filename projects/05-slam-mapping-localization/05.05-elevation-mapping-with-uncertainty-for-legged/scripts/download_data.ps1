# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.05 (Elevation (2.5D) mapping with uncertainty for legged/off-road robots)
#
...
Write-Host "[download_data] Project 05.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
