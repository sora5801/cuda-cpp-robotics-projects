# 05.05 — Elevation (2.5D) mapping with uncertainty for legged/off-road robots

**Difficulty:** ★ beginner · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `★ Elevation (2.5D) mapping with uncertainty for legged/off-road robots`
>
...
1. Open [`build/elevation-mapping-with-uncertainty-for-legged.sln`](build/elevation-mapping-with-uncertainty-for-legged.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/elevation-mapping-with-uncertainty-for-legged.exe`.
