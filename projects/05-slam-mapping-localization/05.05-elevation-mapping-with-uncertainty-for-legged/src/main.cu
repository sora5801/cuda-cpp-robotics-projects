// ===========================================================================
// main.cu — entry point for project 05.05 (Elevation (2.5D) mapping with uncertainty for legged/off-road robots)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.05 (elevation-mapping-with-uncertainty-for-legged)\n");
