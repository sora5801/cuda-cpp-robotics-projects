# ===========================================================================
# run_demo.ps1 — one-command demo for 05.05 (Elevation (2.5D) mapping with uncertainty for legged/off-road robots)
#
...
$Slug       = 'elevation-mapping-with-uncertainty-for-legged'                     # substituted by scaffold.py
