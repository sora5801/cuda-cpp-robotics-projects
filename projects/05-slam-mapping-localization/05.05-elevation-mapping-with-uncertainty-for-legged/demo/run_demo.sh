#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 05.05 (Elevation (2.5D) mapping with uncertainty for legged/off-road robots)
...
SLUG='elevation-mapping-with-uncertainty-for-legged'
