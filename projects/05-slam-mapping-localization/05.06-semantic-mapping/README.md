# 05.06 — Semantic mapping: fuse segmentation logits into voxels

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Semantic mapping: fuse segmentation logits into voxels`
>
...
1. Open [`build/semantic-mapping.sln`](build/semantic-mapping.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/semantic-mapping.exe`.
