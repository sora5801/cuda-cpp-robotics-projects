#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.06 (Semantic mapping: fuse segmentation logits into voxels)
...
echo "[download_data] Project 05.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
