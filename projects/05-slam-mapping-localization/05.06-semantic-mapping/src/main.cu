// ===========================================================================
// main.cu — entry point for project 05.06 (Semantic mapping: fuse segmentation logits into voxels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.06 (semantic-mapping)\n");
