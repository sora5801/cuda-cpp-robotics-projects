# ===========================================================================
# run_demo.ps1 — one-command demo for 05.09 (LiDAR-inertial odometry with GPU registration + map (FAST-LIO-style))
#
...
$Slug       = 'lidar-inertial-odometry-with-gpu-registration'                     # substituted by scaffold.py
