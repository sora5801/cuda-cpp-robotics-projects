#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 05.09 (LiDAR-inertial odometry with GPU registration + map (FAST-LIO-style))
...
SLUG='lidar-inertial-odometry-with-gpu-registration'
