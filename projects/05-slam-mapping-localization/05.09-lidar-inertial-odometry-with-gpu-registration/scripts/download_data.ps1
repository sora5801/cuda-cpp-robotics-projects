# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.09 (LiDAR-inertial odometry with GPU registration + map (FAST-LIO-style))
#
...
Write-Host "[download_data] Project 05.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
