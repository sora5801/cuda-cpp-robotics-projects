// ===========================================================================
// main.cu — entry point for project 05.09 (LiDAR-inertial odometry with GPU registration + map (FAST-LIO-style))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.09 (lidar-inertial-odometry-with-gpu-registration)\n");
