# 05.09 — LiDAR-inertial odometry with GPU registration + map (FAST-LIO-style)

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `LiDAR-inertial odometry with GPU registration + map (FAST-LIO-style)`
>
...
1. Open [`build/lidar-inertial-odometry-with-gpu-registration.sln`](build/lidar-inertial-odometry-with-gpu-registration.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/lidar-inertial-odometry-with-gpu-registration.exe`.
