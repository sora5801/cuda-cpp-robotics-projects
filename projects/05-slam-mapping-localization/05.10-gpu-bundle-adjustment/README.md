# 05.10 — GPU bundle adjustment (Schur + preconditioned CG — mini-Ceres)

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `GPU bundle adjustment (Schur + preconditioned CG — mini-Ceres)`
>
...
1. Open [`build/gpu-bundle-adjustment.sln`](build/gpu-bundle-adjustment.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gpu-bundle-adjustment.exe`.
