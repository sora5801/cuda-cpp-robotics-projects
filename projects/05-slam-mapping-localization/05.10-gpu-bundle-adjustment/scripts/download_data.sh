#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.10 (GPU bundle adjustment (Schur + preconditioned CG — mini-Ceres))
...
echo "[download_data] Project 05.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
