# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.10 (GPU bundle adjustment (Schur + preconditioned CG — mini-Ceres))
#
...
Write-Host "[download_data] Project 05.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
