// ===========================================================================
// main.cu — entry point for project 05.10 (GPU bundle adjustment (Schur + preconditioned CG — mini-Ceres))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.10 (gpu-bundle-adjustment)\n");
