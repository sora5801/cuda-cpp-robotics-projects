# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.13 (Poisson surface reconstruction on GPU)
#
...
Write-Host "[download_data] Project 05.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
