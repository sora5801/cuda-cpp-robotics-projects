#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.13 (Poisson surface reconstruction on GPU)
...
echo "[download_data] Project 05.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
