// ===========================================================================
// main.cu — entry point for project 05.13 (Poisson surface reconstruction on GPU)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.13 (poisson-surface-reconstruction-on-gpu)\n");
