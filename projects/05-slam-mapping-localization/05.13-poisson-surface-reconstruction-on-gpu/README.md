# 05.13 — Poisson surface reconstruction on GPU

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Poisson surface reconstruction on GPU`
>
...
1. Open [`build/poisson-surface-reconstruction-on-gpu.sln`](build/poisson-surface-reconstruction-on-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/poisson-surface-reconstruction-on-gpu.exe`.
