// ===========================================================================
// main.cu — entry point for project 05.07 (3D Gaussian splatting mapping + splat-based localization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.07 (3d-gaussian-splatting-mapping-splat-based)\n");
