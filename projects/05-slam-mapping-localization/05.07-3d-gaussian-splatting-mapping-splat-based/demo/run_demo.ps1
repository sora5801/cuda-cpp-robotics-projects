# ===========================================================================
# run_demo.ps1 — one-command demo for 05.07 (3D Gaussian splatting mapping + splat-based localization)
#
...
$Slug       = '3d-gaussian-splatting-mapping-splat-based'                     # substituted by scaffold.py
