#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.07 (3D Gaussian splatting mapping + splat-based localization)
...
echo "[download_data] Project 05.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
