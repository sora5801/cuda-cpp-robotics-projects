# 05.07 — 3D Gaussian splatting mapping + splat-based localization

**Difficulty:** [R&D] research · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `3D Gaussian splatting mapping + splat-based localization [R&D]`
>
...
3D Gaussian splatting mapping + splat-based localization
...
1. Open [`build/3d-gaussian-splatting-mapping-splat-based.sln`](build/3d-gaussian-splatting-mapping-splat-based.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/3d-gaussian-splatting-mapping-splat-based.exe`.
