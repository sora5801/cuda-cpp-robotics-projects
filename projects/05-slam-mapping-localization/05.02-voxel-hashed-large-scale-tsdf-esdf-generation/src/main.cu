// ===========================================================================
// main.cu — entry point for project 05.02 (Voxel-hashed large-scale TSDF; ESDF generation for planners (nvblox-style))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.02 (voxel-hashed-large-scale-tsdf-esdf-generation)\n");
