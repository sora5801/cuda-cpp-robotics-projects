#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 05.02 (Voxel-hashed large-scale TSDF; ESDF generation for planners (nvblox-style))
...
SLUG='voxel-hashed-large-scale-tsdf-esdf-generation'
