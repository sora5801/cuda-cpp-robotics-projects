# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.02 (Voxel-hashed large-scale TSDF; ESDF generation for planners (nvblox-style))
#
...
Write-Host "[download_data] Project 05.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
