// ===========================================================================
// main.cu — entry point for project 05.08 (NeRF / instant-NGP robot mapping; occupancy queries from neural fields)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.08 (nerf-instant-ngp-robot-mapping-occupancy-queries)\n");
