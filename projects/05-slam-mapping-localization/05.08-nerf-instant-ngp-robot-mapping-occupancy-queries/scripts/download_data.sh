#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.08 (NeRF / instant-NGP robot mapping; occupancy queries from neural fields)
...
echo "[download_data] Project 05.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
