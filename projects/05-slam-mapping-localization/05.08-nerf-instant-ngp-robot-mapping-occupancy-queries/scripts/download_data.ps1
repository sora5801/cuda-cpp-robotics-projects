# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.08 (NeRF / instant-NGP robot mapping; occupancy queries from neural fields)
#
...
Write-Host "[download_data] Project 05.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
