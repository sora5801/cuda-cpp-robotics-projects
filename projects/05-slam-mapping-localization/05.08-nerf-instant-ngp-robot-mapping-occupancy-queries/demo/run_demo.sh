#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 05.08 (NeRF / instant-NGP robot mapping; occupancy queries from neural fields)
...
SLUG='nerf-instant-ngp-robot-mapping-occupancy-queries'
