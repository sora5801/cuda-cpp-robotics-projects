# ===========================================================================
# run_demo.ps1 — one-command demo for 05.08 (NeRF / instant-NGP robot mapping; occupancy queries from neural fields)
#
...
$Slug       = 'nerf-instant-ngp-robot-mapping-occupancy-queries'                     # substituted by scaffold.py
