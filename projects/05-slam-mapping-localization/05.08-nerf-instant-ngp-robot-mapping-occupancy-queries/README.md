# 05.08 — NeRF / instant-NGP robot mapping; occupancy queries from neural fields

**Difficulty:** [R&D] research · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `NeRF / instant-NGP robot mapping; occupancy queries from neural fields [R&D]`
>
...
NeRF / instant-NGP robot mapping; occupancy queries from neural fields
...
1. Open [`build/nerf-instant-ngp-robot-mapping-occupancy-queries.sln`](build/nerf-instant-ngp-robot-mapping-occupancy-queries.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/nerf-instant-ngp-robot-mapping-occupancy-queries.exe`.
