# ===========================================================================
# run_demo.ps1 — one-command demo for 05.12 (Visual place recognition: global descriptor search w/ product quantization)
#
...
$Slug       = 'visual-place-recognition'                     # substituted by scaffold.py
