#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.12 (Visual place recognition: global descriptor search w/ product quantization)
...
echo "[download_data] Project 05.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
