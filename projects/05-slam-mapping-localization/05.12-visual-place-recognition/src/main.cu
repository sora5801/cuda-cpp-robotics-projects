// ===========================================================================
// main.cu — entry point for project 05.12 (Visual place recognition: global descriptor search w/ product quantization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.12 (visual-place-recognition)\n");
