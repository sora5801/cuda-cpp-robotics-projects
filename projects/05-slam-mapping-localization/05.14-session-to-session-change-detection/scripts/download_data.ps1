# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.14 (Session-to-session change detection)
#
...
Write-Host "[download_data] Project 05.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
