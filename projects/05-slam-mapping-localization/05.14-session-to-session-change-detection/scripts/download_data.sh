#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.14 (Session-to-session change detection)
...
echo "[download_data] Project 05.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
