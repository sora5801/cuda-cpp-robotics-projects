// ===========================================================================
// main.cu — entry point for project 05.14 (Session-to-session change detection)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.14 (session-to-session-change-detection)\n");
