#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.11 (Pose-graph optimization on GPU)
...
echo "[download_data] Project 05.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
