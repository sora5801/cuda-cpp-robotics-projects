# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.11 (Pose-graph optimization on GPU)
#
...
Write-Host "[download_data] Project 05.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
