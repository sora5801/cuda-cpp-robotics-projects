# 05.11 — Pose-graph optimization on GPU

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Pose-graph optimization on GPU`
>
...
1. Open [`build/pose-graph-optimization-on-gpu.sln`](build/pose-graph-optimization-on-gpu.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/pose-graph-optimization-on-gpu.exe`.
