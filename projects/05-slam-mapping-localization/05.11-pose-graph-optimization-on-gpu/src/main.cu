// ===========================================================================
// main.cu — entry point for project 05.11 (Pose-graph optimization on GPU)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.11 (pose-graph-optimization-on-gpu)\n");
