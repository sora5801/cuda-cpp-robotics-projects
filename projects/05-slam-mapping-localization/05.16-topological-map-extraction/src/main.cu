// ===========================================================================
// main.cu — entry point for project 05.16 (Topological map extraction (generalized Voronoi via GPU brushfire))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.16 (topological-map-extraction)\n");
