# ===========================================================================
# run_demo.ps1 — one-command demo for 05.16 (Topological map extraction (generalized Voronoi via GPU brushfire))
#
...
$Slug       = 'topological-map-extraction'                     # substituted by scaffold.py
