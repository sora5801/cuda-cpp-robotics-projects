#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.16 (Topological map extraction (generalized Voronoi via GPU brushfire))
...
echo "[download_data] Project 05.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
