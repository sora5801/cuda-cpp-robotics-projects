# 05.17 — Language-embedded maps: CLIP feature fusion into 3D for "find the mug" queries

**Difficulty:** [R&D] research · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Language-embedded maps: CLIP feature fusion into 3D for "find the mug" queries [R&D]`
>
...
Language-embedded maps: CLIP feature fusion into 3D for "find the mug" queries
...
1. Open [`build/language-embedded-maps.sln`](build/language-embedded-maps.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/language-embedded-maps.exe`.
