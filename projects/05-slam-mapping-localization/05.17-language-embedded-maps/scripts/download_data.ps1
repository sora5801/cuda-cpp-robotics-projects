# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.17 (Language-embedded maps: CLIP feature fusion into 3D for "find the mug" queries)
#
...
Write-Host "[download_data] Project 05.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
