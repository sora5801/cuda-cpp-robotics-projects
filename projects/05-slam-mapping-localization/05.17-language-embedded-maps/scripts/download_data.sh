#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.17 (Language-embedded maps: CLIP feature fusion into 3D for "find the mug" queries)
...
echo "[download_data] Project 05.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
