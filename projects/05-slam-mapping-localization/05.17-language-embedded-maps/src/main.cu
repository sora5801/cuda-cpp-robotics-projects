// ===========================================================================
// main.cu — entry point for project 05.17 (Language-embedded maps: CLIP feature fusion into 3D for "find the mug" queries)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.17 (language-embedded-maps)\n");
