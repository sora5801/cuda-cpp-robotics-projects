# ===========================================================================
# run_demo.ps1 — one-command demo for 05.17 (Language-embedded maps: CLIP feature fusion into 3D for "find the mug" queries)
#
...
$Slug       = 'language-embedded-maps'                     # substituted by scaffold.py
