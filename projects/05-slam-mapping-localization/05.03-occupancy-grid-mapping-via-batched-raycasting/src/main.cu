// ===========================================================================
// main.cu — entry point for project 05.03 (Occupancy-grid mapping via batched raycasting)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.03 (occupancy-grid-mapping-via-batched-raycasting)\n");
