# 05.03 — Occupancy-grid mapping via batched raycasting

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Occupancy-grid mapping via batched raycasting`
>
...
1. Open [`build/occupancy-grid-mapping-via-batched-raycasting.sln`](build/occupancy-grid-mapping-via-batched-raycasting.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/occupancy-grid-mapping-via-batched-raycasting.exe`.
