#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.03 (Occupancy-grid mapping via batched raycasting)
...
echo "[download_data] Project 05.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
