# ===========================================================================
# run_demo.ps1 — one-command demo for 05.03 (Occupancy-grid mapping via batched raycasting)
#
...
$Slug       = 'occupancy-grid-mapping-via-batched-raycasting'                     # substituted by scaffold.py
