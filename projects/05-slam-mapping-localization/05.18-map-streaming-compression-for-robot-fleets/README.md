# 05.18 — Map streaming/compression for robot fleets

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Map streaming/compression for robot fleets`
>
...
1. Open [`build/map-streaming-compression-for-robot-fleets.sln`](build/map-streaming-compression-for-robot-fleets.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/map-streaming-compression-for-robot-fleets.exe`.
