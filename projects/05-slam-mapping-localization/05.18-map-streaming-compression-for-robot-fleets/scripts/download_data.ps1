# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.18 (Map streaming/compression for robot fleets)
#
...
Write-Host "[download_data] Project 05.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
