// ===========================================================================
// main.cu — entry point for project 05.18 (Map streaming/compression for robot fleets)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.18 (map-streaming-compression-for-robot-fleets)\n");
