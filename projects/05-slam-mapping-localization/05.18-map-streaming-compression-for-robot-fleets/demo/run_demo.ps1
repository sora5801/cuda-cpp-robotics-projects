# ===========================================================================
# run_demo.ps1 — one-command demo for 05.18 (Map streaming/compression for robot fleets)
#
...
$Slug       = 'map-streaming-compression-for-robot-fleets'                     # substituted by scaffold.py
