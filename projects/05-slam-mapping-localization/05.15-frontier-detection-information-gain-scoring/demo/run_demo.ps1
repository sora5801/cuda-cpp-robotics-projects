# ===========================================================================
# run_demo.ps1 — one-command demo for 05.15 (Frontier detection + information-gain scoring for exploration)
#
...
$Slug       = 'frontier-detection-information-gain-scoring'                     # substituted by scaffold.py
