// ===========================================================================
// main.cu — entry point for project 05.15 (Frontier detection + information-gain scoring for exploration)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.15 (frontier-detection-information-gain-scoring)\n");
