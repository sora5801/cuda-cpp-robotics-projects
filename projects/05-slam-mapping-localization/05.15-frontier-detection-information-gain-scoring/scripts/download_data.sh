#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 05.15 (Frontier detection + information-gain scoring for exploration)
...
echo "[download_data] Project 05.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
