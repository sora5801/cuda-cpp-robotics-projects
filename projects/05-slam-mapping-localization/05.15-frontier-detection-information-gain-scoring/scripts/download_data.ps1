# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 05.15 (Frontier detection + information-gain scoring for exploration)
#
...
Write-Host "[download_data] Project 05.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
