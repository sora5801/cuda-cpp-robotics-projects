# 05.15 — Frontier detection + information-gain scoring for exploration

**Difficulty:** intermediate · **Domain:** 5. SLAM, Mapping & Localization

> Catalog bullet (source of truth, verbatim): `Frontier detection + information-gain scoring for exploration`
>
...
1. Open [`build/frontier-detection-information-gain-scoring.sln`](build/frontier-detection-information-gain-scoring.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/frontier-detection-information-gain-scoring.exe`.
