#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 05.01 (TSDF fusion (KinectFusion clone) + marching-cubes mesh extraction)
...
# 05.01: expected_output.txt carries the real implementation's stable lines
...
SLUG='tsdf-fusion-marching-cubes-mesh-extraction'
