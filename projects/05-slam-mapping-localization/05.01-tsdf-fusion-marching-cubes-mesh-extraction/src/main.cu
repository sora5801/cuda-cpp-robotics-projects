// ===========================================================================
// main.cu — entry point for project 05.01 (TSDF fusion (KinectFusion clone) + marching-cubes mesh extraction)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 05.01 (tsdf-fusion-marching-cubes-mesh-extraction)\n");
