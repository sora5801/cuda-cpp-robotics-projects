...
//                  (project 05.01; copied from docs/PROJECT_TEMPLATE
...
//    (one integration or marching-cubes kernel launch per timed region;
//    main.cu brackets each with a GpuTimer); multi-stream projects record
