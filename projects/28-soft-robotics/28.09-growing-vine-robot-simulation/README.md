# 28.09 — Growing/vine robot simulation

**Difficulty:** [R&D] research · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `Growing/vine robot simulation [R&D]`
>
...
1. Open [`build/growing-vine-robot-simulation.sln`](build/growing-vine-robot-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/growing-vine-robot-simulation.exe`.
