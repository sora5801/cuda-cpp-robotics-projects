# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.09 (Growing/vine robot simulation)
#
...
Write-Host "[download_data] Project 28.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
