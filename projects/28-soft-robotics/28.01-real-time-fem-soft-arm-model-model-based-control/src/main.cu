// ===========================================================================
// main.cu — entry point for project 28.01 (Real-time FEM soft-arm model + model-based control (GPU SOFA-style))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.01 (real-time-fem-soft-arm-model-model-based-control)\n");
