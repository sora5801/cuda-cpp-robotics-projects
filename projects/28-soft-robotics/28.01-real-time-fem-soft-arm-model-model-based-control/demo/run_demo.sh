#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 28.01 (Real-time FEM soft-arm model + model-based control (GPU SOFA-style))
...
# Keep expected_output.txt in sync with the stable lines main.cu prints
...
SLUG='real-time-fem-soft-arm-model-model-based-control'
