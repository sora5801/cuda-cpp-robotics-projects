# ===========================================================================
# run_demo.ps1 — one-command demo for 28.01 (Real-time FEM soft-arm model + model-based control (GPU SOFA-style))
#
...
#
# For 28.01 this runs the whole staged pipeline in one shot: scenario load +
# model cross-check, the GPU-vs-CPU verify window, three analytic gates
# (static deflection / first-mode frequency / energy drift), tip-Jacobian
# identification, the 4-setpoint closed-loop tracking run, the artifacts,
# and the measured real-time factor — ~7 s total on the reference RTX 2080
# SUPER. Keep expected_output.txt in sync with the stable lines main.cu
# prints (see the "output contract" comment in ../src/main.cu).
#
...
$Slug       = 'real-time-fem-soft-arm-model-model-based-control'                     # substituted by scaffold.py
