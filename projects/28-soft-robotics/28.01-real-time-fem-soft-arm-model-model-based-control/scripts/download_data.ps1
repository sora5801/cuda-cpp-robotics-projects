# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.01 (Real-time FEM soft-arm model + model-based control (GPU SOFA-style))
#
...
Write-Host "[download_data] Project 28.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
