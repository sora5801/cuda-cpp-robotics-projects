...
#
# DECIDED for 28.01: this script is the honest no-op. The project's "data"
# is a synthetic scenario definition (constants of a synthetic elastomer arm
# + controller tuning) generated by make_synthetic.py — no public dataset
# teaches more here, because the point is a model whose ground truth is
# ANALYTIC (Euler-Bernoulli statics, cantilever mode frequencies).
#
