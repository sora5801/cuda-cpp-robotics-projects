# 28.06 — Jamming gripper granular (DEM) simulation

**Difficulty:** intermediate · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `Jamming gripper granular (DEM) simulation`
>
...
1. Open [`build/jamming-gripper-granular-simulation.sln`](build/jamming-gripper-granular-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/jamming-gripper-granular-simulation.exe`.
