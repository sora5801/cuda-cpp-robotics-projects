#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 28.06 (Jamming gripper granular (DEM) simulation)
...
echo "[download_data] Project 28.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
