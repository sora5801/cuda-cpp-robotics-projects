# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.06 (Jamming gripper granular (DEM) simulation)
#
...
Write-Host "[download_data] Project 28.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
