// ===========================================================================
// main.cu — entry point for project 28.06 (Jamming gripper granular (DEM) simulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.06 (jamming-gripper-granular-simulation)\n");
