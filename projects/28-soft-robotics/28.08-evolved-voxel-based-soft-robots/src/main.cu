// ===========================================================================
// main.cu — entry point for project 28.08 (Evolved voxel-based soft robots (Voxelyze-style on GPU))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.08 (evolved-voxel-based-soft-robots)\n");
