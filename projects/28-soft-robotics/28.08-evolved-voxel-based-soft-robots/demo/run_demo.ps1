# ===========================================================================
# run_demo.ps1 — one-command demo for 28.08 (Evolved voxel-based soft robots (Voxelyze-style on GPU))
#
...
$Slug       = 'evolved-voxel-based-soft-robots'                     # substituted by scaffold.py
