# 28.08 — Evolved voxel-based soft robots (Voxelyze-style on GPU)

**Difficulty:** [R&D] research · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `Evolved voxel-based soft robots (Voxelyze-style on GPU) [R&D]`
>
...
Evolved voxel-based soft robots (Voxelyze-style on GPU)
...
1. Open [`build/evolved-voxel-based-soft-robots.sln`](build/evolved-voxel-based-soft-robots.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/evolved-voxel-based-soft-robots.exe`.
