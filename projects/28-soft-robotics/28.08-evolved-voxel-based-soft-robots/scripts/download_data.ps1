# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.08 (Evolved voxel-based soft robots (Voxelyze-style on GPU))
#
...
Write-Host "[download_data] Project 28.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
