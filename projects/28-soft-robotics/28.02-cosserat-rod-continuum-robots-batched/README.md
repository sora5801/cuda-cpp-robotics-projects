# 28.02 — Cosserat-rod continuum robots batched: tendon-driven, concentric-tube

**Difficulty:** intermediate · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `Cosserat-rod continuum robots batched: tendon-driven, concentric-tube`
>
...
1. Open [`build/cosserat-rod-continuum-robots-batched.sln`](build/cosserat-rod-continuum-robots-batched.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/cosserat-rod-continuum-robots-batched.exe`.
