# ===========================================================================
# run_demo.ps1 — one-command demo for 28.02 (Cosserat-rod continuum robots batched: tendon-driven, concentric-tube)
#
...
$Slug       = 'cosserat-rod-continuum-robots-batched'                     # substituted by scaffold.py
