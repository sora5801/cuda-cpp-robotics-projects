# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.02 (Cosserat-rod continuum robots batched: tendon-driven, concentric-tube)
#
...
Write-Host "[download_data] Project 28.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
