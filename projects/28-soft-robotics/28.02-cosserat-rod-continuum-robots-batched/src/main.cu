// ===========================================================================
// main.cu — entry point for project 28.02 (Cosserat-rod continuum robots batched: tendon-driven, concentric-tube)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.02 (cosserat-rod-continuum-robots-batched)\n");
