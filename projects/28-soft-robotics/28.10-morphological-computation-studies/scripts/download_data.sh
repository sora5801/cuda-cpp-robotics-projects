#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 28.10 (Morphological computation studies)
...
echo "[download_data] Project 28.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
