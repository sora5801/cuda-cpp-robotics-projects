# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.10 (Morphological computation studies)
#
...
Write-Host "[download_data] Project 28.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
