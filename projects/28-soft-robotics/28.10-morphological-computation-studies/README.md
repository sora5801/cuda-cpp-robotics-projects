# 28.10 — Morphological computation studies

**Difficulty:** [R&D] research · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `Morphological computation studies [R&D]`
>
...
1. Open [`build/morphological-computation-studies.sln`](build/morphological-computation-studies.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/morphological-computation-studies.exe`.
