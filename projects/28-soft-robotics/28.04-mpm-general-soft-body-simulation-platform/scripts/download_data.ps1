# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.04 (MPM general soft-body simulation platform)
#
...
Write-Host "[download_data] Project 28.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
