#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 28.04 (MPM general soft-body simulation platform)
...
echo "[download_data] Project 28.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
