// ===========================================================================
// main.cu — entry point for project 28.04 (MPM general soft-body simulation platform)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.04 (mpm-general-soft-body-simulation-platform)\n");
