# ===========================================================================
# run_demo.ps1 — one-command demo for 28.04 (MPM general soft-body simulation platform)
#
...
$Slug       = 'mpm-general-soft-body-simulation-platform'                     # substituted by scaffold.py
