# 28.04 — MPM general soft-body simulation platform

**Difficulty:** intermediate · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `MPM general soft-body simulation platform`
>
...
1. Open [`build/mpm-general-soft-body-simulation-platform.sln`](build/mpm-general-soft-body-simulation-platform.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mpm-general-soft-body-simulation-platform.exe`.
