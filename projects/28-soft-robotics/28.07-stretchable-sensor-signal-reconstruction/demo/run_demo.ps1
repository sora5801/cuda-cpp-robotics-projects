# ===========================================================================
# run_demo.ps1 — one-command demo for 28.07 (Stretchable-sensor signal reconstruction (inverse problems on GPU))
#
...
$Slug       = 'stretchable-sensor-signal-reconstruction'                     # substituted by scaffold.py
