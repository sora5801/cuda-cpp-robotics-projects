// ===========================================================================
// main.cu — entry point for project 28.07 (Stretchable-sensor signal reconstruction (inverse problems on GPU))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.07 (stretchable-sensor-signal-reconstruction)\n");
