#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 28.07 (Stretchable-sensor signal reconstruction (inverse problems on GPU))
...
echo "[download_data] Project 28.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
