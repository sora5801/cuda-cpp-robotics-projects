# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.05 (Soft gripper contact simulation + design optimization)
#
...
Write-Host "[download_data] Project 28.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
