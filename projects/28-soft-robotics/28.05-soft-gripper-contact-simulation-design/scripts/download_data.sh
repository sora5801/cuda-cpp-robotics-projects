#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 28.05 (Soft gripper contact simulation + design optimization)
...
echo "[download_data] Project 28.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
