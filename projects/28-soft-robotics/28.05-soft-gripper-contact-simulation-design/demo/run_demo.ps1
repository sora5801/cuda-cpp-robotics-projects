# ===========================================================================
# run_demo.ps1 — one-command demo for 28.05 (Soft gripper contact simulation + design optimization)
#
...
$Slug       = 'soft-gripper-contact-simulation-design'                     # substituted by scaffold.py
