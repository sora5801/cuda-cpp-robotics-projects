# 28.05 — Soft gripper contact simulation + design optimization

**Difficulty:** intermediate · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `Soft gripper contact simulation + design optimization`
>
...
1. Open [`build/soft-gripper-contact-simulation-design.sln`](build/soft-gripper-contact-simulation-design.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/soft-gripper-contact-simulation-design.exe`.
