// ===========================================================================
// main.cu — entry point for project 28.05 (Soft gripper contact simulation + design optimization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.05 (soft-gripper-contact-simulation-design)\n");
