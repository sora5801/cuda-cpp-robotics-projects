// ===========================================================================
// main.cu — entry point for project 28.03 (PneuNet actuator FEM design sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 28.03 (pneunet-actuator-fem-design-sweeps)\n");
