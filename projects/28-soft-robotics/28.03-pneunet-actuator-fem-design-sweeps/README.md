# 28.03 — PneuNet actuator FEM design sweeps

**Difficulty:** intermediate · **Domain:** 28. Soft Robotics

> Catalog bullet (source of truth, verbatim): `PneuNet actuator FEM design sweeps`
>
...
1. Open [`build/pneunet-actuator-fem-design-sweeps.sln`](build/pneunet-actuator-fem-design-sweeps.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/pneunet-actuator-fem-design-sweeps.exe`.
