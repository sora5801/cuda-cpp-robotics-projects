#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 28.03 (PneuNet actuator FEM design sweeps)
...
echo "[download_data] Project 28.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
