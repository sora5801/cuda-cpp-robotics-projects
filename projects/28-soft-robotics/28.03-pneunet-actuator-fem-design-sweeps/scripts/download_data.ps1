# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 28.03 (PneuNet actuator FEM design sweeps)
#
...
Write-Host "[download_data] Project 28.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
