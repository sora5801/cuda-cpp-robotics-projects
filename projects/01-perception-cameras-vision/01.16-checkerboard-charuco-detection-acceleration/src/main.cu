// ===========================================================================
// main.cu — entry point for project 01.16 (Checkerboard/ChArUco detection acceleration for auto-calibration rigs)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.16 (checkerboard-charuco-detection-acceleration)\n");
