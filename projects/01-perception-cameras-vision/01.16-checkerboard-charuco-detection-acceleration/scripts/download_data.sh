#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.16 (Checkerboard/ChArUco detection acceleration for auto-calibration rigs)
...
echo "[download_data] Project 01.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
