# ===========================================================================
# run_demo.ps1 — one-command demo for 01.16 (Checkerboard/ChArUco detection acceleration for auto-calibration rigs)
#
...
#
# This script is GENERIC (unchanged from the template): it just builds, runs,
# and diffs. Keep expected_output.txt in sync with the stable lines main.cu
# prints (see the "output contract" comment in ../src/main.cu) whenever that
# output changes.
#
...
$Slug       = 'checkerboard-charuco-detection-acceleration'                     # substituted by scaffold.py
...
# (a scaffold placeholder marker line, if any remained, would be such a comment).
