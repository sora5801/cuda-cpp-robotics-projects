#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.16 (Checkerboard/ChArUco detection acceleration for auto-calibration rigs)
...
# Keep expected_output.txt in sync with the stable output lines documented in
...
SLUG='checkerboard-charuco-detection-acceleration'
