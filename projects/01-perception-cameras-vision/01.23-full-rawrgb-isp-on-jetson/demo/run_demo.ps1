# ===========================================================================
# run_demo.ps1 — one-command demo for 01.23 (Full RAW→RGB ISP on Jetson (Argus + custom CUDA stages))
#
...
#
# This script needed NO changes from the scaffolded template to drive the
# real ISP pipeline below — only expected_output.txt (this project's stable
# lines, see the "output contract" comment in ../src/main.cu) changed.
#
...
$Slug       = 'full-rawrgb-isp-on-jetson'                     # substituted by scaffold.py
