#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.23 (Full RAW→RGB ISP on Jetson (Argus + custom CUDA stages))
...
# expected_output.txt mirrors this project's stable output lines (see the
# "output contract" comment in ../src/main.cu).
# ===========================================================================
set -euo pipefail
...
SLUG='full-rawrgb-isp-on-jetson'
