...
//
// main.cu includes this the moment it loads its committed RAW mosaics/
// ground-truth files or writes a PPM/CSV artifact (CLAUDE.md section 6.3).
//
...
//   * The OPTIONAL CMake build (CLAUDE.md section 5: bonus, never a substitute)
...
// a single hardcoded absolute path (CLAUDE.md section 5).
//
...
//          names the file (never a silent default — CLAUDE.md section 13 honesty).
                                         ...
                                         const char* filename)
{
    ...
    // VS layout: exe three dirs below root (the REQUIRED build, CLAUDE.md section 5).
