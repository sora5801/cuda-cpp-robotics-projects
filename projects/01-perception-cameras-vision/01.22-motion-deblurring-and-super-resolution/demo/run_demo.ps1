# ===========================================================================
# run_demo.ps1 — one-command demo for 01.22 (Motion deblurring and super-resolution for inspection zoom)
#
...
#
# This script needed NO changes for the real deblurring/super-resolution
...
$Slug       = 'motion-deblurring-and-super-resolution'                     # substituted by scaffold.py
