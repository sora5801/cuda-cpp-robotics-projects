#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 01.22 (Motion deblurring and super-resolution for inspection zoom).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 01.22 (Motion deblurring and super-resolution for inspection zoom).")
