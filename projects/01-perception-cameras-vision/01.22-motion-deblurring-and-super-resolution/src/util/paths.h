...
//           01.22 (Motion deblurring and super-resolution for inspection
//           zoom; copied from docs/PROJECT_TEMPLATE/src/util/paths.h)
//
// Role in the project
// -------------------
...
// truth.pgm/blurred.pgm/psf_*.csv/lr_frame_*.pgm/shifts_truth.csv sample
// and writes every restoration/comparison PGM plus two convergence CSVs
// and gates_metrics.csv into demo/out/ (CLAUDE.md §6.3).
//
