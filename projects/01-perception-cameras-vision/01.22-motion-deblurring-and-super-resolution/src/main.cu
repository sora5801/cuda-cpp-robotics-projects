// ===========================================================================
// main.cu — entry point for project 01.22 (Motion deblurring and super-resolution for inspection zoom)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.22 (motion-deblurring-and-super-resolution)\n");
