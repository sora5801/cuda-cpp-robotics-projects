#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 01.19 (Structured-light decoding (Gray code, phase shift) for 3D scanners).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 01.19 (Structured-light decoding (Gray code, phase shift) for 3D scanners).")
