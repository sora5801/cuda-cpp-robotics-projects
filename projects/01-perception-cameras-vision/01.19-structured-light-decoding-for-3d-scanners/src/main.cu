// ===========================================================================
// main.cu — entry point for project 01.19 (Structured-light decoding (Gray code, phase shift) for 3D scanners)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.19 (structured-light-decoding-for-3d-scanners)\n");
