...
//           01.19 (Structured-light decoding (Gray code, phase shift) for
//           3D scanners; copied from docs/PROJECT_TEMPLATE — see
//           util/README.md for the deliberate-duplication rule)
//
// Role in the project
// -------------------
...
//
// This project loads TWENTY committed pattern PGMs plus three truth
// binaries plus params.csv from data/sample/, and writes six labeled
// artifacts into demo/out/ — exactly the two situations this header exists
// for; main.cu calls find_data_file() once per input file and
// resolve_out_dir() once at startup.
//
...
//   filename — the file's name inside data/sample/, e.g. "gray_b0_direct.pgm".
