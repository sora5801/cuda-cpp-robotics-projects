#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.19 (Structured-light decoding (Gray code, phase shift) for 3D scanners)
...
# Keep expected_output.txt in sync with this project's stable output lines
# (see the "output contract" comment in ../src/main.cu) whenever they change.
# ===========================================================================
set -euo pipefail
...
SLUG='structured-light-decoding-for-3d-scanners'
