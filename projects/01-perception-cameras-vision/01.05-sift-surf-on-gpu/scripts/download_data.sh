#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.05 (SIFT/SURF on GPU (harder, warp-level reductions))
...
echo "[download_data] Project 01.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
