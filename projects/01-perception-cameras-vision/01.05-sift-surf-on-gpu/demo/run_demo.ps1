# ===========================================================================
# run_demo.ps1 — one-command demo for 01.05 (SIFT/SURF on GPU (harder, warp-level reductions))
#
...
# the real implementation — it builds sift-surf-on-gpu.exe, runs it, and
...
$Slug       = 'sift-surf-on-gpu'                     # substituted by scaffold.py
