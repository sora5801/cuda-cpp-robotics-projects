// ===========================================================================
// main.cu — entry point for project 01.05 (SIFT/SURF on GPU (harder, warp-level reductions))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.05 (sift-surf-on-gpu)\n");
