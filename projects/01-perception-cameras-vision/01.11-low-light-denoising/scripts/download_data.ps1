# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 01.11 (Low-light denoising (bilateral, non-local means, fast BM3D variant))
#
...
Write-Host "[download_data] Project 01.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
