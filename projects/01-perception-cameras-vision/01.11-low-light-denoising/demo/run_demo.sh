#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.11 (Low-light denoising (bilateral, non-local means, fast BM3D variant))
...
# expected_output.txt is kept in sync with the real project's stable output
