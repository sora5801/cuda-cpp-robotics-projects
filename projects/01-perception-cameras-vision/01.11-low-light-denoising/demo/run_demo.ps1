# ===========================================================================
# run_demo.ps1 — one-command demo for 01.11 (Low-light denoising (bilateral, non-local means, fast BM3D variant))
#
...
#
# This script needed NO changes from the scaffold once the real
# implementation landed — it just builds, runs, and diffs stable lines
# generically. expected_output.txt is kept in sync with the stable lines
...
$Slug       = 'low-light-denoising'                     # substituted by scaffold.py
...
# (expected_output.txt's provenance header is such a comment).
