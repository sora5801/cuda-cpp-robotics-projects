// ===========================================================================
// main.cu — entry point for project 01.11 (Low-light denoising (bilateral, non-local means, fast BM3D variant))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.11 (low-light-denoising)\n");
