# ===========================================================================
# run_demo.ps1 — one-command demo for 01.20 (Time-of-flight raw processing: phase unwrapping, flying-pixel removal)
#
...
$Slug       = 'time-of-flight-raw-processing'                     # substituted by scaffold.py
