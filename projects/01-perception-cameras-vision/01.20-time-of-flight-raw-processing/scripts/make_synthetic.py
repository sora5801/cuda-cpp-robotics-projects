#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 01.20 (Time-of-flight raw processing: phase unwrapping, flying-pixel removal).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 01.20 (Time-of-flight raw processing: phase unwrapping, flying-pixel removal).")
