#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.20 (Time-of-flight raw processing: phase unwrapping, flying-pixel removal)
...
echo "[download_data] Project 01.20 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
