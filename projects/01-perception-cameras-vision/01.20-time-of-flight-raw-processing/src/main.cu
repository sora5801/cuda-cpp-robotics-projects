// ===========================================================================
// main.cu — entry point for project 01.20 (Time-of-flight raw processing: phase unwrapping, flying-pixel removal)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.20 (time-of-flight-raw-processing)\n");
