...
//           01.20 (Time-of-flight raw processing: phase unwrapping,
...
//
// main.cu includes this the moment it loads the committed tap stack /
// ground truth and writes its PGM/CSV/PPM artifacts (CLAUDE.md §6.3).
//
...
//   filename — the file's name inside data/sample/, e.g. "tof_f1_tap0.pgm".
