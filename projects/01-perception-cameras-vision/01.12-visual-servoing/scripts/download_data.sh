#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.12 (Visual servoing: image-Jacobian control loop entirely on GPU)
...
echo "[download_data] Project 01.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
