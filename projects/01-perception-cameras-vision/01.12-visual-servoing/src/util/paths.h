...
//
//   1) "Where is data/sample/ibvs_scenario.csv?"   -> find_data_file()
//   2) "Where do I write demo/out/…?"               -> resolve_out_dir()
//
// (project 01.12; copied from docs/PROJECT_TEMPLATE — see util/README.md
// for the deliberate-duplication rule.)
//
