// ===========================================================================
// main.cu — entry point for project 01.12 (Visual servoing: image-Jacobian control loop entirely on GPU)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.12 (visual-servoing)\n");
