// ===========================================================================
// main.cu — entry point for project 01.07 (Fisheye/omnidirectional unwarping and multi-camera surround-view stitching)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.07 (fisheye-omnidirectional-unwarping-and-multi)\n");
