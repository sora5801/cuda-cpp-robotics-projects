# ===========================================================================
# run_demo.ps1 — one-command demo for 01.07 (Fisheye/omnidirectional unwarping and multi-camera surround-view stitching)
#
...
#
# This script is generic (builds via MSBuild, runs the exe, diffs stable
# lines) and needed no changes once the real fisheye/BEV implementation
# landed — keep expected_output.txt in sync with the stable lines main.cu
...
$Slug       = 'fisheye-omnidirectional-unwarping-and-multi'                     # substituted by scaffold.py
...
# (this project's expected_output.txt header block is such a comment).
