#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.07 (Fisheye/omnidirectional unwarping and multi-camera surround-view stitching)
...
SLUG='fisheye-omnidirectional-unwarping-and-multi'
