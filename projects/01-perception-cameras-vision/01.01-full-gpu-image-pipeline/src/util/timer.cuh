...
//                  (project 01.01; copied from docs/PROJECT_TEMPLATE
...
//    project's simple single-stream structure (every kernel in main.cu
//    runs sequentially in stream 0 — the staged and fused pipelines are
//    timed one after the other, never concurrently).
