# ===========================================================================
# run_demo.ps1 — one-command demo for 01.01 (Full GPU image pipeline: debayer → undistort → rectify → resize → normalize, zero CPU copies)
#
...
#
# This script needed NO changes once the real implementation landed (as
# the template predicts) — it just builds+runs+diffs, generically, for any
# project. Keep expected_output.txt in sync with the stable lines main.cu
...
$Slug       = 'full-gpu-image-pipeline'                     # substituted by scaffold.py
