// ===========================================================================
// main.cu — entry point for project 01.08 (HDR exposure fusion + tone mapping for outdoor robots)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.08 (hdr-exposure-fusion-tone-mapping-for-outdoor)\n");
