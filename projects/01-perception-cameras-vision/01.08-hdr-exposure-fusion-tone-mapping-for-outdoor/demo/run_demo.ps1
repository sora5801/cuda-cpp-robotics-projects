# ===========================================================================
# run_demo.ps1 — one-command demo for 01.08 (HDR exposure fusion + tone mapping for outdoor robots)
#
...
#
# STATUS: unchanged from the scaffold — this generic build+run+diff logic
# needed no project-specific edits. The only thing that changes per project
# is expected_output.txt, kept in sync with main.cu's stable output lines
# (see the "output contract" comment in ../src/main.cu).
#
...
$Slug       = 'hdr-exposure-fusion-tone-mapping-for-outdoor'                     # substituted by scaffold.py
...
# (expected_output.txt's leading provenance note is such a comment).
