#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.08 (HDR exposure fusion + tone mapping for outdoor robots)
...
# expected_output.txt is kept in sync with main.cu's stable output lines
...
SLUG='hdr-exposure-fusion-tone-mapping-for-outdoor'
