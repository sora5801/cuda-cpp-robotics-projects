#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.08 (HDR exposure fusion + tone mapping for outdoor robots)
...
echo "[download_data] Project 01.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
