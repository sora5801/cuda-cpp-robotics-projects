...
//           01.17 (Camera-LiDAR / camera-camera extrinsic calibration —
...
//
// This project uses BOTH: main.cu loads three committed correspondence CSVs
// and one background PGM via find_data_file(), and writes four artifacts
// (convergence_curves.csv, basin_scatter.csv, gates_metrics.csv,
// overlay.ppm) into resolve_out_dir()'s directory.
//
...
//   filename — the file's name inside data/sample/, e.g. "cam_lidar_diverse.csv".
