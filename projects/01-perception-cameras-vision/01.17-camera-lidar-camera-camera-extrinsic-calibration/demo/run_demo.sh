#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.17 (Camera-LiDAR / camera-camera extrinsic calibration (batched reprojection-error optimization))
...
# expected_output.txt is kept in sync with main.cu's stable output lines (see
# the "output contract" comment in ../src/main.cu for exactly which lines
# those are).
# ===========================================================================
set -euo pipefail
...
SLUG='camera-lidar-camera-camera-extrinsic-calibration'
