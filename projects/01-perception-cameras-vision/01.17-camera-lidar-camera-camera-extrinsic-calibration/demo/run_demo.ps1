# ===========================================================================
# run_demo.ps1 — one-command demo for 01.17 (Camera-LiDAR / camera-camera extrinsic calibration (batched reprojection-error optimization))
#
...
$Slug       = 'camera-lidar-camera-camera-extrinsic-calibration'                     # substituted by scaffold.py
