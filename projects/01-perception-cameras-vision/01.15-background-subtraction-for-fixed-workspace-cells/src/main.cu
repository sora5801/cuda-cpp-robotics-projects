// ===========================================================================
// main.cu — entry point for project 01.15 (Background subtraction for fixed-workspace cells)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.15 (background-subtraction-for-fixed-workspace-cells)\n");
