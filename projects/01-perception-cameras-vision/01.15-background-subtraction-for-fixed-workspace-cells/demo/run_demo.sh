#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.15 (Background subtraction for fixed-workspace cells)
...
# expected_output.txt is kept in sync with main.cu's stable output lines by
# hand (see the "output contract" comment in ../src/main.cu).
# ===========================================================================
set -euo pipefail
...
SLUG='background-subtraction-for-fixed-workspace-cells'
