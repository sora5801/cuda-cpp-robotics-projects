# ===========================================================================
# run_demo.ps1 — one-command demo for 01.15 (Background subtraction for fixed-workspace cells)
#
...
#
# This script needed NO changes once the real implementation replaced the
# SAXPY placeholder — it is generic over any project's stable-line contract.
# expected_output.txt is kept in sync with the stable lines main.cu prints
# (see the "output contract" comment in ../src/main.cu) by hand, in the same
# change as any output-format edit.
#
...
$Slug       = 'background-subtraction-for-fixed-workspace-cells'                     # substituted by scaffold.py
