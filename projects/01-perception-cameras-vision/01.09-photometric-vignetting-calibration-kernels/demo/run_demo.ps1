# ===========================================================================
# run_demo.ps1 — one-command demo for 01.09 (Photometric/vignetting calibration kernels)
#
...
$Slug       = 'photometric-vignetting-calibration-kernels'                     # substituted by scaffold.py
...
# (the provenance note at the top of expected_output.txt is one such comment).
