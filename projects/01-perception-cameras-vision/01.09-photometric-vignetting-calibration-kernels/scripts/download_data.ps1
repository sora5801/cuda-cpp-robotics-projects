# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 01.09 (Photometric/vignetting calibration kernels)
#
...
# no-op (the same call 01.08's download_data.ps1 makes for its own
...
Write-Host "[download_data] Project 01.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
