// ===========================================================================
// main.cu — entry point for project 01.09 (Photometric/vignetting calibration kernels)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.09 (photometric-vignetting-calibration-kernels)\n");
