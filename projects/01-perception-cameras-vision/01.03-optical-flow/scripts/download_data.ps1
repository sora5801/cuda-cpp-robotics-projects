# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 01.03 (Optical flow: pyramidal Lucas-Kanade, Farneback, census-transform flow)
#
...
Write-Host "[download_data] Project 01.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
