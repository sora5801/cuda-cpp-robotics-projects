#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.03 (Optical flow: pyramidal Lucas-Kanade, Farneback, census-transform flow)
...
# Kept in sync with the "output contract" ../src/main.cu documents in its
# header comment.
# ===========================================================================
set -euo pipefail
