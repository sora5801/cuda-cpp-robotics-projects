...
//           01.03 (Optical flow: dense pyramidal Lucas-Kanade + census-
...
//
// main.cu uses find_data_file() to load the five committed PGM frames and
// resolve_out_dir() to write the artifact PPMs/PGMs/CSV (CLAUDE.md §6.3).
//
...
//   filename — the file's name inside data/sample/, e.g. "scene_a.pgm".
