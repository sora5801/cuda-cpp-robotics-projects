// ===========================================================================
// main.cu — entry point for project 01.03 (Optical flow: pyramidal Lucas-Kanade, Farneback, census-transform flow)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.03 (optical-flow)\n");
