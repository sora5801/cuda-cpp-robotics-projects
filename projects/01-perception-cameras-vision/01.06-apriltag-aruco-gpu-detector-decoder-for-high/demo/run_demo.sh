#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.06 (AprilTag / ArUco GPU detector-decoder for high-rate fiducial localization)
...
# the "output contract" comment in ../src/main.cu) whenever that changes.
# ===========================================================================
set -euo pipefail
...
SLUG='apriltag-aruco-gpu-detector-decoder-for-high'
