# ===========================================================================
# run_demo.ps1 — one-command demo for 01.06 (AprilTag / ArUco GPU detector-decoder for high-rate fiducial localization)
#
...
$Slug       = 'apriltag-aruco-gpu-detector-decoder-for-high'                     # substituted by scaffold.py
