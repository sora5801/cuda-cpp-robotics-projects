# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 01.06 (AprilTag / ArUco GPU detector-decoder for high-rate fiducial localization)
#
...
Write-Host "[download_data] Project 01.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
