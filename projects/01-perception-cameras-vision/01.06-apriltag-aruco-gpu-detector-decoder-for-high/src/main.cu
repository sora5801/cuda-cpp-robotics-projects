// ===========================================================================
// main.cu — entry point for project 01.06 (AprilTag / ArUco GPU detector-decoder for high-rate fiducial localization)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.06 (apriltag-aruco-gpu-detector-decoder-for-high)\n");
