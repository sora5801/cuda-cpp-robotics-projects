// ===========================================================================
// main.cu — entry point for project 01.13 (Canny + Hough line/circle detection for industrial alignment)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.13 (canny-hough-line-circle-detection-for-industrial)\n");
