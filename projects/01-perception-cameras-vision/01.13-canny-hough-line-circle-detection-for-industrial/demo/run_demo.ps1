# ===========================================================================
# run_demo.ps1 — one-command demo for 01.13 (Canny + Hough line/circle detection for industrial alignment)
#
...
#
# This project's real implementation needed NO changes to this script — only
# expected_output.txt (kept in sync with the stable lines main.cu prints; see
# the "output contract" comment in ../src/main.cu).
#
...
$Slug       = 'canny-hough-line-circle-detection-for-industrial'                     # substituted by scaffold.py
