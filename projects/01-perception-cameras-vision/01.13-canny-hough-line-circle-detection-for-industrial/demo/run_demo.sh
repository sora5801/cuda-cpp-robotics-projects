#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.13 (Canny + Hough line/circle detection for industrial alignment)
...
SLUG='canny-hough-line-circle-detection-for-industrial'
