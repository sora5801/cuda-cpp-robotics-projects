#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.13 (Canny + Hough line/circle detection for industrial alignment)
# (Linux/macOS twin of download_data.ps1 — keep the two in sync.)
#
# DECISION FOR THIS PROJECT: no public dataset applies — see download_data.ps1
# for why (synthetic ground truth beats a photograph here). Honest no-op.
#
...
echo "[download_data] Project 01.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
