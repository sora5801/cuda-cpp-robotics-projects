#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.14 (Template matching (NCC) at scale for pick verification)
...
# expected_output.txt is kept in sync with ../src/main.cu's stable output
# lines (see the "output contract" comment there) in the same change.
# ===========================================================================
set -euo pipefail
...
SLUG='template-matching-at-scale-for-pick-verification'
