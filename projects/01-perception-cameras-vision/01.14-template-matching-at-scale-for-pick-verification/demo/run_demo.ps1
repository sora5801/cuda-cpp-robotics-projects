# ===========================================================================
# run_demo.ps1 — one-command demo for 01.14 (Template matching (NCC) at scale for pick verification)
#
...
$Slug       = 'template-matching-at-scale-for-pick-verification'                     # substituted by scaffold.py
