...
//           copied from docs/PROJECT_TEMPLATE — see util/README.md for the
...
//
// main.cu includes this the moment it loads its committed tray/templates/
// truth sample and writes its PGM/PPM/CSV artifacts (CLAUDE.md §6.3).
//
...
//   filename — the file's name inside data/sample/, e.g. "tray.pgm".
