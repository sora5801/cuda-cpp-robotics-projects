// ===========================================================================
// main.cu — entry point for project 01.14 (Template matching (NCC) at scale for pick verification)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.14 (template-matching-at-scale-for-pick-verification)\n");
