#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.21 (Scene flow from RGB-D pairs)
...
echo "[download_data] Project 01.21 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
