# ===========================================================================
# run_demo.ps1 — one-command demo for 01.04 (Feature pipeline: FAST/Harris detection, ORB descriptors, brute-force Hamming matcher)
#
...
#
# RESOLVED (not a placeholder): this generic script needed NO changes for
# the real implementation — it builds feature-pipeline.exe, runs it, and
# diffs the stable lines against expected_output.txt, which is kept in sync
# with the "output contract" ../src/main.cu documents in its header comment.
#
...
$Slug       = 'feature-pipeline'                     # substituted by scaffold.py
