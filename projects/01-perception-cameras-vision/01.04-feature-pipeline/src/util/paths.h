...
//           01.04 (Feature pipeline: FAST/Harris detection, ORB
...
//
// main.cu includes this header because this project does both: it loads
// scene_a.pgm/scene_b.pgm/neg_scene_c.pgm from data/sample/ via
// find_data_file(), and it writes the keypoint/match PPM+CSV artifacts to
// demo/out/ via resolve_out_dir() (CLAUDE.md §6.3).
//
