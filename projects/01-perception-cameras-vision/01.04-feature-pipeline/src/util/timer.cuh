...
//                  (project 01.04; copied from docs/PROJECT_TEMPLATE
...
//    single-stream structure of the demos. This project launches every
//    kernel (detect/describe/match, for all three images) into the default
//    stream too — RESOLVED: no multi-stream adaptation was needed here.
