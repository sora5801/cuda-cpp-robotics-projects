// ===========================================================================
// main.cu — entry point for project 01.04 (Feature pipeline: FAST/Harris detection, ORB descriptors, brute-force Hamming matcher)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.04 (feature-pipeline)\n");
