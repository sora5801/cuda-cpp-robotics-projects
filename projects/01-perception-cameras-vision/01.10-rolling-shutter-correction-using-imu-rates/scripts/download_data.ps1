# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 01.10 (Rolling-shutter correction using IMU rates)
#
...
Write-Host "[download_data] Project 01.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
