# ===========================================================================
# run_demo.ps1 — one-command demo for 01.10 (Rolling-shutter correction using IMU rates)
#
...
#
# This script needed NO changes once the real rolling-shutter-correction
# implementation replaced the scaffolded SAXPY placeholder — only
# expected_output.txt was updated to match main.cu's real stable output
# lines (see the "output contract" comment in ../src/main.cu).
#
...
$Slug       = 'rolling-shutter-correction-using-imu-rates'                     # substituted by scaffold.py
