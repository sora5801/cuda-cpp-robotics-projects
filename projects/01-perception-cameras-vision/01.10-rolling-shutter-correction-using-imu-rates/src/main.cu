// ===========================================================================
// main.cu — entry point for project 01.10 (Rolling-shutter correction using IMU rates)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.10 (rolling-shutter-correction-using-imu-rates)\n");
