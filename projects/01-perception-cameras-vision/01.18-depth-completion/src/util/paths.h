...
//
// This project loads THREE committed sample files (rgb.ppm, truth_depth.bin,
// lidar_points.csv) and writes SEVEN demo/out/ artifacts, so both helpers
// below are load-bearing from main.cu's very first data-loading step.
//
...
//   filename — the file's name inside data/sample/, e.g. "rgb.ppm".
