// ===========================================================================
// main.cu — entry point for project 01.18 (Depth completion: sparse LiDAR + RGB → dense depth)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.18 (depth-completion)\n");
