#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 01.18 (Depth completion: sparse LiDAR + RGB → dense depth)
...
echo "[download_data] Project 01.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
