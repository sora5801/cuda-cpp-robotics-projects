# ===========================================================================
# run_demo.ps1 — one-command demo for 01.02 (Stereo depth: block matching, then Semi-Global Matching (SGM) kernels)
#
...
#
# 01.02: the real implementation is in; this script is unchanged from the
...
# The demo writes demo/out/disparity_bm.pgm, disparity_sgm.pgm, and
# error_map.pgm (git-ignored) — open them to SEE block matching's streaks
# and SGM cleaning them up (see demo/README.md).
#
...
$Slug       = 'stereo-depth'                     # substituted by scaffold.py
...
# (a stray scaffold-marker comment line, if any survived, would be one).
