#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 01.02 (Stereo depth: block matching, then Semi-Global Matching (SGM) kernels)
...
# 01.02: expected_output.txt carries the real implementation's stable lines
