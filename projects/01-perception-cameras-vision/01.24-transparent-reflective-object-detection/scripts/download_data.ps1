# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 01.24 (Transparent/reflective object detection via polarization imaging)
#
...
Write-Host "[download_data] Project 01.24 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
