// ===========================================================================
// main.cu — entry point for project 01.24 (Transparent/reflective object detection via polarization imaging)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 01.24 (transparent-reflective-object-detection)\n");
