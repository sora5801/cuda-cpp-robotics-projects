...
//           01.24 (Transparent/reflective object detection via polarization
//           imaging; copied from docs/PROJECT_TEMPLATE/src/util/paths.h)
//
// Role in the project
// -------------------
...
//
// This project uses both from the start: main.cu loads the committed
// mosaic.pgm/mosaic_negctrl.pgm/truth_maps.csv/params.csv sample and writes
// intensity_s0.pgm, dolp.pgm, aolp_vis.ppm, detection_overlay.ppm,
// brewster_curve.csv, and gates_metrics.csv into demo/out/ (CLAUDE.md §6.3).
//
