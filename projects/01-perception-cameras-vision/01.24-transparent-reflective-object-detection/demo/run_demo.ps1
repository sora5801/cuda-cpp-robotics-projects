# ===========================================================================
# run_demo.ps1 — one-command demo for 01.24 (Transparent/reflective object detection via polarization imaging)
#
...
#
# This script needed NO changes for the real polarization-imaging
# implementation — only expected_output.txt changed, to match the stable
# lines main.cu now prints (see the "output contract" comment in ../src/main.cu).
#
...
$Slug       = 'transparent-reflective-object-detection'                     # substituted by scaffold.py
