# ===========================================================================
# run_demo.ps1 — one-command demo for 36.04 (Connector/latch contact mechanics simulation)
#
...
$Slug       = 'connector-latch-contact-mechanics-simulation'                     # substituted by scaffold.py
