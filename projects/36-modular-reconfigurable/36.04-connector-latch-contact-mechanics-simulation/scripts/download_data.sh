#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 36.04 (Connector/latch contact mechanics simulation)
...
echo "[download_data] Project 36.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
