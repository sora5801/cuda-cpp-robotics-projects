# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 36.04 (Connector/latch contact mechanics simulation)
#
...
Write-Host "[download_data] Project 36.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
