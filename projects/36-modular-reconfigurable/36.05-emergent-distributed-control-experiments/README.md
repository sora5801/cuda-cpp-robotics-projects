# 36.05 — Emergent distributed control experiments at scale

**Difficulty:** [R&D] research · **Domain:** 36. Modular & Self-Reconfigurable Robots

> Catalog bullet (source of truth, verbatim): `Emergent distributed control experiments at scale [R&D]`
>
...
Emergent distributed control experiments at scale
...
1. Open [`build/emergent-distributed-control-experiments.sln`](build/emergent-distributed-control-experiments.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/emergent-distributed-control-experiments.exe`.
