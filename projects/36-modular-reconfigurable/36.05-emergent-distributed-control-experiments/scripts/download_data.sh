#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 36.05 (Emergent distributed control experiments at scale)
...
echo "[download_data] Project 36.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
