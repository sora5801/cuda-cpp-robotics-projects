# ===========================================================================
# run_demo.ps1 — one-command demo for 36.05 (Emergent distributed control experiments at scale)
#
...
$Slug       = 'emergent-distributed-control-experiments'                     # substituted by scaffold.py
