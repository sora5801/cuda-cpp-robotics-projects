// ===========================================================================
// main.cu — entry point for project 36.05 (Emergent distributed control experiments at scale)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 36.05 (emergent-distributed-control-experiments)\n");
