# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 36.01 (Reconfiguration planning over enormous state spaces (GPU search))
#
...
Write-Host "[download_data] Project 36.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
