#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 36.01 (Reconfiguration planning over enormous state spaces (GPU search))
...
echo "[download_data] Project 36.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
