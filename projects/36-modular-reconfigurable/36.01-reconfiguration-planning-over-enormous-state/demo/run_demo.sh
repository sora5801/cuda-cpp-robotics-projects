#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 36.01 (Reconfiguration planning over enormous state spaces (GPU search))
...
SLUG='reconfiguration-planning-over-enormous-state'
