# ===========================================================================
# run_demo.ps1 — one-command demo for 36.01 (Reconfiguration planning over enormous state spaces (GPU search))
#
...
$Slug       = 'reconfiguration-planning-over-enormous-state'                     # substituted by scaffold.py
