// ===========================================================================
// main.cu — entry point for project 36.01 (Reconfiguration planning over enormous state spaces (GPU search))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 36.01 (reconfiguration-planning-over-enormous-state)\n");
