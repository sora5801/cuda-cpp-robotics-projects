# 36.01 — Reconfiguration planning over enormous state spaces (GPU search)

**Difficulty:** [R&D] research · **Domain:** 36. Modular & Self-Reconfigurable Robots

> Catalog bullet (source of truth, verbatim): `Reconfiguration planning over enormous state spaces (GPU search) [R&D]`
>
...
Reconfiguration planning over enormous state spaces (GPU search)
...
1. Open [`build/reconfiguration-planning-over-enormous-state.sln`](build/reconfiguration-planning-over-enormous-state.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/reconfiguration-planning-over-enormous-state.exe`.
