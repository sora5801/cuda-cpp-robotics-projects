...
//                  (project 36.03; copied from docs/PROJECT_TEMPLATE
...
//    (main.cu launches its four stage kernels back-to-back, bracketing the
//    whole sequence with one GpuTimer); multi-stream projects would record
//    into their own streams instead.
