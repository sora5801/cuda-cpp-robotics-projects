// ===========================================================================
// main.cu — entry point for project 36.03 (Lattice-robot kinematics batches)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 36.03 (lattice-robot-kinematics-batches)\n");
