#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 36.03 (Lattice-robot kinematics batches)
...
# 36.03: the real implementation is in; expected_output.txt carries the real
# stable lines, kept in sync with the "output contract" comment atop
# ../src/main.cu (change the two together).
# ===========================================================================
set -euo pipefail
...
SLUG='lattice-robot-kinematics-batches'
