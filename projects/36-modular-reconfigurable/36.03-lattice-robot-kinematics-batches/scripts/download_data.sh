#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 36.03 (Lattice-robot kinematics batches)
...
echo "[download_data] Project 36.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
