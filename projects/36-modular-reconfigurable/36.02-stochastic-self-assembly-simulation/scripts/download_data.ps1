# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 36.02 (Stochastic self-assembly simulation)
#
...
Write-Host "[download_data] Project 36.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
