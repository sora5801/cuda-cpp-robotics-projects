#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 36.02 (Stochastic self-assembly simulation)
...
echo "[download_data] Project 36.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
