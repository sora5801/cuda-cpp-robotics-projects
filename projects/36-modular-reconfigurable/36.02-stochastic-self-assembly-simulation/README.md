# 36.02 — Stochastic self-assembly simulation

**Difficulty:** [R&D] research · **Domain:** 36. Modular & Self-Reconfigurable Robots

> Catalog bullet (source of truth, verbatim): `Stochastic self-assembly simulation [R&D]`
>
...
Stochastic self-assembly simulation
...
1. Open [`build/stochastic-self-assembly-simulation.sln`](build/stochastic-self-assembly-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/stochastic-self-assembly-simulation.exe`.
