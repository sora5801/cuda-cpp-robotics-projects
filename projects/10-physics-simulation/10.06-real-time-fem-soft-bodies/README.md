# 10.06 — Real-time FEM soft bodies (corotational, Neo-Hookean)

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Real-time FEM soft bodies (corotational, Neo-Hookean)`
>
...
1. Open [`build/real-time-fem-soft-bodies.sln`](build/real-time-fem-soft-bodies.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/real-time-fem-soft-bodies.exe`.
