#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.06 (Real-time FEM soft bodies (corotational, Neo-Hookean))
...
echo "[download_data] Project 10.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
