# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.06 (Real-time FEM soft bodies (corotational, Neo-Hookean))
#
...
Write-Host "[download_data] Project 10.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
