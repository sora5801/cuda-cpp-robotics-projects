// ===========================================================================
// main.cu — entry point for project 10.06 (Real-time FEM soft bodies (corotational, Neo-Hookean))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.06 (real-time-fem-soft-bodies)\n");
