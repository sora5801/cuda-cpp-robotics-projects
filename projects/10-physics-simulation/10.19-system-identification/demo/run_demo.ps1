# ===========================================================================
# run_demo.ps1 — one-command demo for 10.19 (System identification: CMA-ES fitting simulation to real logs, fitness in parallel)
#
...
$Slug       = 'system-identification'                     # substituted by scaffold.py
