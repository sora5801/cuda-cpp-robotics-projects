// ===========================================================================
// main.cu — entry point for project 10.19 (System identification: CMA-ES fitting simulation to real logs, fitness in parallel)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.19 (system-identification)\n");
