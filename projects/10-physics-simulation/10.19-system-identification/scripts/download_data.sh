#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.19 (System identification: CMA-ES fitting simulation to real logs, fitness in parallel)
...
echo "[download_data] Project 10.19 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
