// ===========================================================================
// main.cu — entry point for project 10.07 (Material Point Method (MPM) for soft robots + granular interaction)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.07 (material-point-method-for-soft-robots-granular)\n");
