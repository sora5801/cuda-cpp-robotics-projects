# ===========================================================================
# run_demo.ps1 — one-command demo for 10.07 (Material Point Method (MPM) for soft robots + granular interaction)
#
...
$Slug       = 'material-point-method-for-soft-robots-granular'                     # substituted by scaffold.py
