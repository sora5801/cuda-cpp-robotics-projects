#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 10.07 (Material Point Method (MPM) for soft robots + granular interaction)
...
SLUG='material-point-method-for-soft-robots-granular'
