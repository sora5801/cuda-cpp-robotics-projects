# 10.07 — Material Point Method (MPM) for soft robots + granular interaction

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Material Point Method (MPM) for soft robots + granular interaction`
>
...
1. Open [`build/material-point-method-for-soft-robots-granular.sln`](build/material-point-method-for-soft-robots-granular.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/material-point-method-for-soft-robots-granular.exe`.
