# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.07 (Material Point Method (MPM) for soft robots + granular interaction)
#
...
Write-Host "[download_data] Project 10.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
