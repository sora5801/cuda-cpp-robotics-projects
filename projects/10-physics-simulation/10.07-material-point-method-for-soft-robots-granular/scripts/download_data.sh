#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.07 (Material Point Method (MPM) for soft robots + granular interaction)
...
echo "[download_data] Project 10.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
