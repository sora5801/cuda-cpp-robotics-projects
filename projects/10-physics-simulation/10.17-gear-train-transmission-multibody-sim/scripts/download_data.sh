#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.17 (Gear-train / transmission multibody sim)
...
echo "[download_data] Project 10.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
