# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.17 (Gear-train / transmission multibody sim)
#
...
Write-Host "[download_data] Project 10.17 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
