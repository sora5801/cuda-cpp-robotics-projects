// ===========================================================================
// main.cu — entry point for project 10.17 (Gear-train / transmission multibody sim)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.17 (gear-train-transmission-multibody-sim)\n");
