# 10.17 — Gear-train / transmission multibody sim

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Gear-train / transmission multibody sim`
>
...
1. Open [`build/gear-train-transmission-multibody-sim.sln`](build/gear-train-transmission-multibody-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/gear-train-transmission-multibody-sim.exe`.
