#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.11 (Terramechanics: Bekker/Wong wheel-soil batch models for rovers)
...
echo "[download_data] Project 10.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
