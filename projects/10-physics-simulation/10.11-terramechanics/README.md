# 10.11 — Terramechanics: Bekker/Wong wheel-soil batch models for rovers

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Terramechanics: Bekker/Wong wheel-soil batch models for rovers`
>
...
1. Open [`build/terramechanics.sln`](build/terramechanics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/terramechanics.exe`.
