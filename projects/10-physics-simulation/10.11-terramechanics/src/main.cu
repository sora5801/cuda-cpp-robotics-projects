// ===========================================================================
// main.cu — entry point for project 10.11 (Terramechanics: Bekker/Wong wheel-soil batch models for rovers)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.11 (terramechanics)\n");
