# 10.15 — Blade-element-momentum rotor models batched for UAVs

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Blade-element-momentum rotor models batched for UAVs`
>
...
1. Open [`build/blade-element-momentum-rotor-models-batched.sln`](build/blade-element-momentum-rotor-models-batched.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/blade-element-momentum-rotor-models-batched.exe`.
