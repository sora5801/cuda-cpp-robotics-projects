# ===========================================================================
# run_demo.ps1 — one-command demo for 10.15 (Blade-element-momentum rotor models batched for UAVs)
#
...
$Slug       = 'blade-element-momentum-rotor-models-batched'                     # substituted by scaffold.py
