#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.15 (Blade-element-momentum rotor models batched for UAVs)
...
echo "[download_data] Project 10.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
