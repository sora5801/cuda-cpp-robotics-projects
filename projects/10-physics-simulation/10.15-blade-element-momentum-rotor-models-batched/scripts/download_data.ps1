# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.15 (Blade-element-momentum rotor models batched for UAVs)
#
...
Write-Host "[download_data] Project 10.15 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
