// ===========================================================================
// main.cu — entry point for project 10.03 (Massively parallel robot sim (Isaac-Gym-style: one robot, 10,000 environments))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.03 (massively-parallel-robot-sim)\n");
