#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 10.03 (Massively parallel robot sim (Isaac-Gym-style: one robot, 10,000 environments))
...
# 10.03: expected_output.txt carries the real implementation's stable lines
...
SLUG='massively-parallel-robot-sim'
