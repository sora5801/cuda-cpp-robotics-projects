# ===========================================================================
# run_demo.ps1 — one-command demo for 10.03 (Massively parallel robot sim (Isaac-Gym-style: one robot, 10,000 environments))
#
...
#
# 10.03: the real implementation is in; this script is unchanged from the
# template (no project-specific changes were needed). expected_output.txt
# carries the real stable lines — the output contract lives at the top of
# ../src/main.cu; change the two together. The demo writes
# demo/out/env_metrics.csv and demo/out/energy_drift.csv (both git-ignored,
# regenerated each run) — see demo/README.md for what each column means.
#
...
$Slug       = 'massively-parallel-robot-sim'                     # substituted by scaffold.py
...
# (the file-header explanation lines at the top of expected_output.txt are
# exactly this kind of comment).
