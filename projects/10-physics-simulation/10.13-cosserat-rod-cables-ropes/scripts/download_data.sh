#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.13 (Cosserat rod cables/ropes: tethers, sutures, wire-harness assembly)
...
echo "[download_data] Project 10.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
