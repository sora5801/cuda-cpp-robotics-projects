# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.13 (Cosserat rod cables/ropes: tethers, sutures, wire-harness assembly)
#
...
Write-Host "[download_data] Project 10.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
