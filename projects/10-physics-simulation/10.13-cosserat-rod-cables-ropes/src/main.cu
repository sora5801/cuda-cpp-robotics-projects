// ===========================================================================
// main.cu — entry point for project 10.13 (Cosserat rod cables/ropes: tethers, sutures, wire-harness assembly)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.13 (cosserat-rod-cables-ropes)\n");
