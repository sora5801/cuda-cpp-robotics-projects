# ===========================================================================
# run_demo.ps1 — one-command demo for 10.13 (Cosserat rod cables/ropes: tethers, sutures, wire-harness assembly)
#
...
$Slug       = 'cosserat-rod-cables-ropes'                     # substituted by scaffold.py
