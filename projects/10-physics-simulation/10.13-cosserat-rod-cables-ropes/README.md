# 10.13 — Cosserat rod cables/ropes: tethers, sutures, wire-harness assembly

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Cosserat rod cables/ropes: tethers, sutures, wire-harness assembly`
>
...
1. Open [`build/cosserat-rod-cables-ropes.sln`](build/cosserat-rod-cables-ropes.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/cosserat-rod-cables-ropes.exe`.
