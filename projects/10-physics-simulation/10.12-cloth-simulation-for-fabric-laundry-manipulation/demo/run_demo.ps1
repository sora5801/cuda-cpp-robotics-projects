# ===========================================================================
# run_demo.ps1 — one-command demo for 10.12 (Cloth simulation for fabric/laundry manipulation)
#
...
$Slug       = 'cloth-simulation-for-fabric-laundry-manipulation'                     # substituted by scaffold.py
