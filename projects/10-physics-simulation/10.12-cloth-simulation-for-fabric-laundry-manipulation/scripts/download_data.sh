#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.12 (Cloth simulation for fabric/laundry manipulation)
...
echo "[download_data] Project 10.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
