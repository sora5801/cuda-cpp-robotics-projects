# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.12 (Cloth simulation for fabric/laundry manipulation)
#
...
Write-Host "[download_data] Project 10.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
