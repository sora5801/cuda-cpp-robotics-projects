// ===========================================================================
// main.cu — entry point for project 10.12 (Cloth simulation for fabric/laundry manipulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.12 (cloth-simulation-for-fabric-laundry-manipulation)\n");
