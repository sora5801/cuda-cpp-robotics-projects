# 10.12 — Cloth simulation for fabric/laundry manipulation

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Cloth simulation for fabric/laundry manipulation`
>
...
1. Open [`build/cloth-simulation-for-fabric-laundry-manipulation.sln`](build/cloth-simulation-for-fabric-laundry-manipulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/cloth-simulation-for-fabric-laundry-manipulation.exe`.
