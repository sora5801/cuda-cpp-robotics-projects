// ===========================================================================
// main.cu — entry point for project 10.05 (Contact-model research: compliant vs. rigid, friction-cone approximations)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.05 (contact-model-research)\n");
