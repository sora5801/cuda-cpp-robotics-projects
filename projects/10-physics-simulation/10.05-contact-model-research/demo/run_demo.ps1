# ===========================================================================
# run_demo.ps1 — one-command demo for 10.05 (Contact-model research: compliant vs. rigid, friction-cone approximations)
#
...
$Slug       = 'contact-model-research'                     # substituted by scaffold.py
