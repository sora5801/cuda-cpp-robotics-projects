# 10.05 — Contact-model research: compliant vs. rigid, friction-cone approximations

**Difficulty:** [R&D] research · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Contact-model research: compliant vs. rigid, friction-cone approximations [R&D]`
>
...
Contact-model research: compliant vs. rigid, friction-cone approximations
...
1. Open [`build/contact-model-research.sln`](build/contact-model-research.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/contact-model-research.exe`.
