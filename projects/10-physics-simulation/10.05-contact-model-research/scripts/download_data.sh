#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.05 (Contact-model research: compliant vs. rigid, friction-cone approximations)
...
echo "[download_data] Project 10.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
