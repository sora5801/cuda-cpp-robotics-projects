# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.16 (Buoyancy + added-mass AUV models)
#
...
Write-Host "[download_data] Project 10.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
