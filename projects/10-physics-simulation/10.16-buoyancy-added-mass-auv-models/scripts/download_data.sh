#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.16 (Buoyancy + added-mass AUV models)
...
echo "[download_data] Project 10.16 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
