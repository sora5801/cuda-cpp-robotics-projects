# 10.16 — Buoyancy + added-mass AUV models

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Buoyancy + added-mass AUV models`
>
...
1. Open [`build/buoyancy-added-mass-auv-models.sln`](build/buoyancy-added-mass-auv-models.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/buoyancy-added-mass-auv-models.exe`.
