// ===========================================================================
// main.cu — entry point for project 10.04 (Differentiable rigid-body simulation (adjoints through the contact solver))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.04 (differentiable-rigid-body-simulation)\n");
