#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.04 (Differentiable rigid-body simulation (adjoints through the contact solver))
...
echo "[download_data] Project 10.04 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
