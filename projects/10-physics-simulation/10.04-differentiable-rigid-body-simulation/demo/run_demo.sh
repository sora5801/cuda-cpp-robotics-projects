#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 10.04 (Differentiable rigid-body simulation (adjoints through the contact solver))
...
SLUG='differentiable-rigid-body-simulation'
