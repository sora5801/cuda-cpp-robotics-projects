# ===========================================================================
# run_demo.ps1 — one-command demo for 10.04 (Differentiable rigid-body simulation (adjoints through the contact solver))
#
...
$Slug       = 'differentiable-rigid-body-simulation'                     # substituted by scaffold.py
