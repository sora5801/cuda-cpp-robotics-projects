// ===========================================================================
// main.cu — entry point for project 10.14 (Vehicle dynamics with Pacejka tire models, batched)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.14 (vehicle-dynamics-with-pacejka-tire-models)\n");
