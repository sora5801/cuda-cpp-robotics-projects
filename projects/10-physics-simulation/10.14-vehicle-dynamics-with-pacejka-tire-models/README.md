# 10.14 — Vehicle dynamics with Pacejka tire models, batched

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Vehicle dynamics with Pacejka tire models, batched`
>
...
1. Open [`build/vehicle-dynamics-with-pacejka-tire-models.sln`](build/vehicle-dynamics-with-pacejka-tire-models.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/vehicle-dynamics-with-pacejka-tire-models.exe`.
