#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.14 (Vehicle dynamics with Pacejka tire models, batched)
...
echo "[download_data] Project 10.14 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
