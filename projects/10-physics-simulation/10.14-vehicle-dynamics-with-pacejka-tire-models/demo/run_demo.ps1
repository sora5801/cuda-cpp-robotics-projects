# ===========================================================================
# run_demo.ps1 — one-command demo for 10.14 (Vehicle dynamics with Pacejka tire models, batched)
#
...
$Slug       = 'vehicle-dynamics-with-pacejka-tire-models'                     # substituted by scaffold.py
