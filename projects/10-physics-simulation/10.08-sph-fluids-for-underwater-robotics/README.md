# 10.08 — SPH fluids for underwater robotics

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `SPH fluids for underwater robotics`
>
...
1. Open [`build/sph-fluids-for-underwater-robotics.sln`](build/sph-fluids-for-underwater-robotics.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/sph-fluids-for-underwater-robotics.exe`.
