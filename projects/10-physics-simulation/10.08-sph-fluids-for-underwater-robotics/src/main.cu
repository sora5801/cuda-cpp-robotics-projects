// ===========================================================================
// main.cu — entry point for project 10.08 (SPH fluids for underwater robotics)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.08 (sph-fluids-for-underwater-robotics)\n");
