# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.08 (SPH fluids for underwater robotics)
#
...
Write-Host "[download_data] Project 10.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
