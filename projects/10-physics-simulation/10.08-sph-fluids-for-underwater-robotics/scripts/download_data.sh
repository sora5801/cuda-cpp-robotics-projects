#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.08 (SPH fluids for underwater robotics)
...
echo "[download_data] Project 10.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
