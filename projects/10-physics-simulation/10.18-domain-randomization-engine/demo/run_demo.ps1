# ===========================================================================
# run_demo.ps1 — one-command demo for 10.18 (Domain-randomization engine: per-environment physics parameters)
#
...
$Slug       = 'domain-randomization-engine'                     # substituted by scaffold.py
