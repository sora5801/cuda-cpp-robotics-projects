# 10.18 — Domain-randomization engine: per-environment physics parameters

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Domain-randomization engine: per-environment physics parameters`
>
...
1. Open [`build/domain-randomization-engine.sln`](build/domain-randomization-engine.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/domain-randomization-engine.exe`.
