// ===========================================================================
// main.cu — entry point for project 10.18 (Domain-randomization engine: per-environment physics parameters)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.18 (domain-randomization-engine)\n");
