# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.18 (Domain-randomization engine: per-environment physics parameters)
#
...
Write-Host "[download_data] Project 10.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
