#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.18 (Domain-randomization engine: per-environment physics parameters)
...
echo "[download_data] Project 10.18 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
