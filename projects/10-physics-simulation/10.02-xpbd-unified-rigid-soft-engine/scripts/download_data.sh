#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.02 (XPBD unified rigid+soft engine)
...
echo "[download_data] Project 10.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
