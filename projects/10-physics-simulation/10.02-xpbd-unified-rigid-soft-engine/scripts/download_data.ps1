# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.02 (XPBD unified rigid+soft engine)
#
...
Write-Host "[download_data] Project 10.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
