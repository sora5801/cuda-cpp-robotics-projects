# 10.02 — XPBD unified rigid+soft engine

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `XPBD unified rigid+soft engine`
>
...
1. Open [`build/xpbd-unified-rigid-soft-engine.sln`](build/xpbd-unified-rigid-soft-engine.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/xpbd-unified-rigid-soft-engine.exe`.
