# 10.10 — DEM granular media: legged robots on sand/gravel

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `DEM granular media: legged robots on sand/gravel`
>
...
1. Open [`build/dem-granular-media.sln`](build/dem-granular-media.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/dem-granular-media.exe`.
