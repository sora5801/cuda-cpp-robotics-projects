# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.10 (DEM granular media: legged robots on sand/gravel)
#
...
Write-Host "[download_data] Project 10.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
