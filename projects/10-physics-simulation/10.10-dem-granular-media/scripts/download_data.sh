#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.10 (DEM granular media: legged robots on sand/gravel)
...
echo "[download_data] Project 10.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
