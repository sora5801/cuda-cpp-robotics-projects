// ===========================================================================
// main.cu — entry point for project 10.10 (DEM granular media: legged robots on sand/gravel)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.10 (dem-granular-media)\n");
