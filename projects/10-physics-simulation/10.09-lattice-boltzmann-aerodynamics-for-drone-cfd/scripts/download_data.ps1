# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.09 (Lattice-Boltzmann aerodynamics for drone CFD)
#
...
Write-Host "[download_data] Project 10.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
