#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.09 (Lattice-Boltzmann aerodynamics for drone CFD)
...
echo "[download_data] Project 10.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
