// ===========================================================================
// main.cu — entry point for project 10.09 (Lattice-Boltzmann aerodynamics for drone CFD)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.09 (lattice-boltzmann-aerodynamics-for-drone-cfd)\n");
