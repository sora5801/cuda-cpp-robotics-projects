# 10.09 — Lattice-Boltzmann aerodynamics for drone CFD

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Lattice-Boltzmann aerodynamics for drone CFD`
>
...
1. Open [`build/lattice-boltzmann-aerodynamics-for-drone-cfd.sln`](build/lattice-boltzmann-aerodynamics-for-drone-cfd.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/lattice-boltzmann-aerodynamics-for-drone-cfd.exe`.
