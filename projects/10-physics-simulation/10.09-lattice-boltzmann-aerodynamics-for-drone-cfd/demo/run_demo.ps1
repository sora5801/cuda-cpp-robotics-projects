# ===========================================================================
# run_demo.ps1 — one-command demo for 10.09 (Lattice-Boltzmann aerodynamics for drone CFD)
#
...
$Slug       = 'lattice-boltzmann-aerodynamics-for-drone-cfd'                     # substituted by scaffold.py
