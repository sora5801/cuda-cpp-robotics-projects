# 10.01 — Mini GPU rigid-body engine: sweep-and-prune broadphase, narrowphase, PGS solver — the grand educational project

**Difficulty:** ★ beginner · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `★ Mini GPU rigid-body engine: sweep-and-prune broadphase, narrowphase, PGS solver — the grand educational project`
>
...
1. Open [`build/mini-gpu-rigid-body-engine.sln`](build/mini-gpu-rigid-body-engine.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/mini-gpu-rigid-body-engine.exe`.
