#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 10.01 (Mini GPU rigid-body engine: sweep-and-prune broadphase, narrowphase, PGS solver — the grand educational project)
...
SLUG='mini-gpu-rigid-body-engine'
