# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 10.01 (Mini GPU rigid-body engine: sweep-and-prune broadphase, narrowphase, PGS solver — the grand educational project)
#
...
Write-Host "[download_data] Project 10.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
