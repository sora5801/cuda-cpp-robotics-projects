#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.01 (Mini GPU rigid-body engine: sweep-and-prune broadphase, narrowphase, PGS solver — the grand educational project)
...
echo "[download_data] Project 10.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
