// ===========================================================================
// main.cu — entry point for project 10.20 (Real-to-sim: scene reconstruction → simulation asset pipeline)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 10.20 (real-to-sim)\n");
