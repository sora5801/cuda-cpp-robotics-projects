# 10.20 — Real-to-sim: scene reconstruction → simulation asset pipeline

**Difficulty:** intermediate · **Domain:** 10. Physics Simulation

> Catalog bullet (source of truth, verbatim): `Real-to-sim: scene reconstruction → simulation asset pipeline`
>
...
1. Open [`build/real-to-sim.sln`](build/real-to-sim.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/real-to-sim.exe`.
