#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 10.20 (Real-to-sim: scene reconstruction → simulation asset pipeline)
...
echo "[download_data] Project 10.20 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
