# 27.09 — Joint wear prediction (Archard) Monte Carlo

**Difficulty:** intermediate · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Joint wear prediction (Archard) Monte Carlo`
>
...
1. Open [`build/joint-wear-prediction-monte-carlo.sln`](build/joint-wear-prediction-monte-carlo.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/joint-wear-prediction-monte-carlo.exe`.
