#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.09 (Joint wear prediction (Archard) Monte Carlo)
...
echo "[download_data] Project 27.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
