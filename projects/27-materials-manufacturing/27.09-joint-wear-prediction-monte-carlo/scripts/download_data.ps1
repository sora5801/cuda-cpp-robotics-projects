# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.09 (Joint wear prediction (Archard) Monte Carlo)
#
...
Write-Host "[download_data] Project 27.09 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
