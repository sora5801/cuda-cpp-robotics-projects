// ===========================================================================
// main.cu — entry point for project 27.09 (Joint wear prediction (Archard) Monte Carlo)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.09 (joint-wear-prediction-monte-carlo)\n");
