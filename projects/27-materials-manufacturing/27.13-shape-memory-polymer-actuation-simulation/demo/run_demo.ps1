# ===========================================================================
# run_demo.ps1 — one-command demo for 27.13 (Shape-memory polymer actuation simulation)
#
...
$Slug       = 'shape-memory-polymer-actuation-simulation'                     # substituted by scaffold.py
