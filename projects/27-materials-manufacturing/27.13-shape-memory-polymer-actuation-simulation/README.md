# 27.13 — Shape-memory polymer actuation simulation

**Difficulty:** [R&D] research · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Shape-memory polymer actuation simulation [R&D]`
>
...
Shape-memory polymer actuation simulation
...
1. Open [`build/shape-memory-polymer-actuation-simulation.sln`](build/shape-memory-polymer-actuation-simulation.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/shape-memory-polymer-actuation-simulation.exe`.
