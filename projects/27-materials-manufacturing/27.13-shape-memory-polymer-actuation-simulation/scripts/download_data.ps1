# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.13 (Shape-memory polymer actuation simulation)
#
...
Write-Host "[download_data] Project 27.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
