#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.13 (Shape-memory polymer actuation simulation)
...
echo "[download_data] Project 27.13 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
