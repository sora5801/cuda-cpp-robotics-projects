# ===========================================================================
# run_demo.ps1 — one-command demo for 27.05 (3D printing: GPU slicing, support generation, FDM warp/thermal sim, SLM melt-pool sim)
#
...
$Slug       = '3d-printing'                     # substituted by scaffold.py
