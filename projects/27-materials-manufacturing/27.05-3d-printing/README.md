# 27.05 — 3D printing: GPU slicing, support generation, FDM warp/thermal sim, SLM melt-pool sim

**Difficulty:** [R&D] research · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `3D printing: GPU slicing, support generation, FDM warp/thermal sim, SLM melt-pool sim [R&D]`
>
...
3D printing: GPU slicing, support generation, FDM warp/thermal sim, SLM melt-pool sim
...
1. Open [`build/3d-printing.sln`](build/3d-printing.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/3d-printing.exe`.
