// ===========================================================================
// main.cu — entry point for project 27.05 (3D printing: GPU slicing, support generation, FDM warp/thermal sim, SLM melt-pool sim)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.05 (3d-printing)\n");
