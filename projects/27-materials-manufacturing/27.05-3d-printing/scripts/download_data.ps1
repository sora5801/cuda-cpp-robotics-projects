# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.05 (3D printing: GPU slicing, support generation, FDM warp/thermal sim, SLM melt-pool sim)
#
...
Write-Host "[download_data] Project 27.05 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
