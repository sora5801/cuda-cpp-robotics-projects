#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.12 (Magnetorheological fluid device simulation)
...
echo "[download_data] Project 27.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
