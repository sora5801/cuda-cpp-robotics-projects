# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.12 (Magnetorheological fluid device simulation)
#
...
Write-Host "[download_data] Project 27.12 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
