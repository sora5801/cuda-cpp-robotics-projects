// ===========================================================================
// main.cu — entry point for project 27.12 (Magnetorheological fluid device simulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.12 (magnetorheological-fluid-device-simulation)\n");
