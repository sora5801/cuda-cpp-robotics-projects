# ===========================================================================
# run_demo.ps1 — one-command demo for 27.12 (Magnetorheological fluid device simulation)
#
...
$Slug       = 'magnetorheological-fluid-device-simulation'                     # substituted by scaffold.py
