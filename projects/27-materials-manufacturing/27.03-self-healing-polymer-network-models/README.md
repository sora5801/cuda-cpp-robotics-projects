# 27.03 — Self-healing polymer network models

**Difficulty:** [R&D] research · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Self-healing polymer network models [R&D]`
>
...
Self-healing polymer network models
...
1. Open [`build/self-healing-polymer-network-models.sln`](build/self-healing-polymer-network-models.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/self-healing-polymer-network-models.exe`.
