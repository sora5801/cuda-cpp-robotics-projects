# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.03 (Self-healing polymer network models)
#
...
Write-Host "[download_data] Project 27.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
