#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.03 (Self-healing polymer network models)
...
echo "[download_data] Project 27.03 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
