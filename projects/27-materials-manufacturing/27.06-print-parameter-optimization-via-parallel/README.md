# 27.06 — Print-parameter optimization via parallel process simulation

**Difficulty:** intermediate · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Print-parameter optimization via parallel process simulation`
>
...
1. Open [`build/print-parameter-optimization-via-parallel.sln`](build/print-parameter-optimization-via-parallel.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/print-parameter-optimization-via-parallel.exe`.
