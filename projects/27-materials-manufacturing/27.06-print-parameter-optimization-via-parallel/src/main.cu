// ===========================================================================
// main.cu — entry point for project 27.06 (Print-parameter optimization via parallel process simulation)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.06 (print-parameter-optimization-via-parallel)\n");
