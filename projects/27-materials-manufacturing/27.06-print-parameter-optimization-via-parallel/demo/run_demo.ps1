# ===========================================================================
# run_demo.ps1 — one-command demo for 27.06 (Print-parameter optimization via parallel process simulation)
#
...
$Slug       = 'print-parameter-optimization-via-parallel'                     # substituted by scaffold.py
