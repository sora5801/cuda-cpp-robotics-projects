# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.06 (Print-parameter optimization via parallel process simulation)
#
...
Write-Host "[download_data] Project 27.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
