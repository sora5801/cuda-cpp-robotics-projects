#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.06 (Print-parameter optimization via parallel process simulation)
...
echo "[download_data] Project 27.06 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
