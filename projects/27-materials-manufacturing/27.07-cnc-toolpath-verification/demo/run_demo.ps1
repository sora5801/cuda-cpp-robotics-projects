# ===========================================================================
# run_demo.ps1 — one-command demo for 27.07 (CNC toolpath verification (GPU material-removal simulation))
#
...
$Slug       = 'cnc-toolpath-verification'                     # substituted by scaffold.py
