#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.07 (CNC toolpath verification (GPU material-removal simulation))
...
echo "[download_data] Project 27.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
