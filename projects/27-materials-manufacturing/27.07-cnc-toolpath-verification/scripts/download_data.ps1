# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.07 (CNC toolpath verification (GPU material-removal simulation))
#
...
Write-Host "[download_data] Project 27.07 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
