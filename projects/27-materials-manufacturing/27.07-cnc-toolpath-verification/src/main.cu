// ===========================================================================
// main.cu — entry point for project 27.07 (CNC toolpath verification (GPU material-removal simulation))
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.07 (cnc-toolpath-verification)\n");
