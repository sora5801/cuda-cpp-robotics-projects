// ===========================================================================
// main.cu — entry point for project 27.02 (Crystal plasticity / microstructure homogenization for structural alloys)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.02 (crystal-plasticity-microstructure-homogenization)\n");
