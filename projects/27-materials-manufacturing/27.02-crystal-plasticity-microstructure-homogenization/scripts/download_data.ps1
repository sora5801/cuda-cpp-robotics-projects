# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.02 (Crystal plasticity / microstructure homogenization for structural alloys)
#
...
Write-Host "[download_data] Project 27.02 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
