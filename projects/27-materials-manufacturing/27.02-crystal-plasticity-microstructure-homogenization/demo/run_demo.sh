#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 27.02 (Crystal plasticity / microstructure homogenization for structural alloys)
...
SLUG='crystal-plasticity-microstructure-homogenization'
