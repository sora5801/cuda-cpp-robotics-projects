# ===========================================================================
# run_demo.ps1 — one-command demo for 27.02 (Crystal plasticity / microstructure homogenization for structural alloys)
#
...
$Slug       = 'crystal-plasticity-microstructure-homogenization'                     # substituted by scaffold.py
