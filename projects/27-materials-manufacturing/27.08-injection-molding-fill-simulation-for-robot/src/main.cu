// ===========================================================================
// main.cu — entry point for project 27.08 (Injection-molding fill simulation for robot housings)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.08 (injection-molding-fill-simulation-for-robot)\n");
