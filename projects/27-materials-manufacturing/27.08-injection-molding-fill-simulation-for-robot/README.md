# 27.08 — Injection-molding fill simulation for robot housings

**Difficulty:** intermediate · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Injection-molding fill simulation for robot housings`
>
...
1. Open [`build/injection-molding-fill-simulation-for-robot.sln`](build/injection-molding-fill-simulation-for-robot.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/injection-molding-fill-simulation-for-robot.exe`.
