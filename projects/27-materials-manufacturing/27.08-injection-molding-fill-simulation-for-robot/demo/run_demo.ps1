# ===========================================================================
# run_demo.ps1 — one-command demo for 27.08 (Injection-molding fill simulation for robot housings)
#
...
$Slug       = 'injection-molding-fill-simulation-for-robot'                     # substituted by scaffold.py
