#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.08 (Injection-molding fill simulation for robot housings)
...
echo "[download_data] Project 27.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
