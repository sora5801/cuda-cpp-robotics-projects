# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.08 (Injection-molding fill simulation for robot housings)
#
...
Write-Host "[download_data] Project 27.08 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
