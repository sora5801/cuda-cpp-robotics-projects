// ===========================================================================
// main.cu — entry point for project 27.11 (Conductive e-textile percolation models)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.11 (conductive-e-textile-percolation-models)\n");
