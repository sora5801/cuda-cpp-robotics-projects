# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.11 (Conductive e-textile percolation models)
#
...
Write-Host "[download_data] Project 27.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
