#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.11 (Conductive e-textile percolation models)
...
echo "[download_data] Project 27.11 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
