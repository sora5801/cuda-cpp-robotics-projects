# ===========================================================================
# run_demo.ps1 — one-command demo for 27.11 (Conductive e-textile percolation models)
#
...
$Slug       = 'conductive-e-textile-percolation-models'                     # substituted by scaffold.py
