# 27.11 — Conductive e-textile percolation models

**Difficulty:** [R&D] research · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Conductive e-textile percolation models [R&D]`
>
...
Conductive e-textile percolation models
...
1. Open [`build/conductive-e-textile-percolation-models.sln`](build/conductive-e-textile-percolation-models.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/conductive-e-textile-percolation-models.exe`.
