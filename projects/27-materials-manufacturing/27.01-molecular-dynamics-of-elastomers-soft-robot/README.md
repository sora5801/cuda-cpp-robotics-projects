# 27.01 — Molecular dynamics (mini-LAMMPS) of elastomers → soft-robot material models

**Difficulty:** [R&D] research · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Molecular dynamics (mini-LAMMPS) of elastomers → soft-robot material models [R&D]`
>
...
Molecular dynamics (mini-LAMMPS) of elastomers → soft-robot material models
...
1. Open [`build/molecular-dynamics-of-elastomers-soft-robot.sln`](build/molecular-dynamics-of-elastomers-soft-robot.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/molecular-dynamics-of-elastomers-soft-robot.exe`.
