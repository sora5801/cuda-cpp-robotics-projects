#!/usr/bin/env bash
# ===========================================================================
# run_demo.sh — one-command demo for 27.01 (Molecular dynamics (mini-LAMMPS) of elastomers → soft-robot material models)
...
SLUG='molecular-dynamics-of-elastomers-soft-robot'
