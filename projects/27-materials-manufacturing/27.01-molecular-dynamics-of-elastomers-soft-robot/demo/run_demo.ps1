# ===========================================================================
# run_demo.ps1 — one-command demo for 27.01 (Molecular dynamics (mini-LAMMPS) of elastomers → soft-robot material models)
#
...
$Slug       = 'molecular-dynamics-of-elastomers-soft-robot'                     # substituted by scaffold.py
