# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.01 (Molecular dynamics (mini-LAMMPS) of elastomers → soft-robot material models)
#
...
Write-Host "[download_data] Project 27.01 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
