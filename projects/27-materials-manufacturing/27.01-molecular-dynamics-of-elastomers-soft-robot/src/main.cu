// ===========================================================================
// main.cu — entry point for project 27.01 (Molecular dynamics (mini-LAMMPS) of elastomers → soft-robot material models)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.01 (molecular-dynamics-of-elastomers-soft-robot)\n");
