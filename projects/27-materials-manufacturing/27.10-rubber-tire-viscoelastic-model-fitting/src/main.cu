// ===========================================================================
// main.cu — entry point for project 27.10 (Rubber/tire viscoelastic model fitting)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.10 (rubber-tire-viscoelastic-model-fitting)\n");
