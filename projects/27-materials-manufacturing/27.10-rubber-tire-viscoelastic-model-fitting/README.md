# 27.10 — Rubber/tire viscoelastic model fitting

**Difficulty:** intermediate · **Domain:** 27. Materials Science & Manufacturing

> Catalog bullet (source of truth, verbatim): `Rubber/tire viscoelastic model fitting`
>
...
1. Open [`build/rubber-tire-viscoelastic-model-fitting.sln`](build/rubber-tire-viscoelastic-model-fitting.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/rubber-tire-viscoelastic-model-fitting.exe`.
