#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for 27.10 (Rubber/tire viscoelastic model fitting)
...
echo "[download_data] Project 27.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
