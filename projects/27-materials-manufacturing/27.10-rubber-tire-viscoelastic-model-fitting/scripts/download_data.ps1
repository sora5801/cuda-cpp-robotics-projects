# ===========================================================================
# download_data.ps1 — public-dataset fetcher for 27.10 (Rubber/tire viscoelastic model fitting)
#
...
Write-Host "[download_data] Project 27.10 uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
