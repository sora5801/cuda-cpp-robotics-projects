#!/usr/bin/env python3
"""make_synthetic.py — synthetic sample-data generator for 27.04 (Composite layup optimization + Tsai-Wu failure envelope sweeps).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate the tiny synthetic sample for project 27.04 (Composite layup optimization + Tsai-Wu failure envelope sweeps).")
