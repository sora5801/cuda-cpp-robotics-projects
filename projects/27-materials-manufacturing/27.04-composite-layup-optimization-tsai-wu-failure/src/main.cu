// ===========================================================================
// main.cu — entry point for project 27.04 (Composite layup optimization + Tsai-Wu failure envelope sweeps)
//
...
int main(int argc, char** argv)
{
    ...
    std::printf("[demo] template placeholder demo for project 27.04 (composite-layup-optimization-tsai-wu-failure)\n");
