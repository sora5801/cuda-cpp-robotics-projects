...
> Generated by `tools/status.py` on 2026-07-08 from `catalog.json`.
...
## 4. Sensor Fusion & State Estimation (`04-sensor-fusion-state-estimation`) — 0/13 done

| ID | Project | Difficulty | Flagship | Status | Owner | Notes |
|----|---------|------------|----------|--------|-------|-------|
| 04.01 | Massive particle filter localization (10⁵–10⁶ particles, GPU likelihoods + resampling) | ★ beginner | ⭐ | todo |  |  |
...
| ID | Project | Difficulty | Flagship | Status | Owner | Notes |
|----|---------|------------|----------|--------|-------|-------|
| 05.01 | TSDF fusion (KinectFusion clone) + marching-cubes mesh extraction | ★ beginner | ⭐ | todo |  |  |
...
## 10. Physics Simulation (`10-physics-simulation`) — 0/20 done
...
| 10.03 | Massively parallel robot sim (Isaac-Gym-style: one robot, 10,000 environments) | ★ beginner | ⭐ | todo |  |  |
...
| ID | Project | Difficulty | Flagship | Status | Owner | Notes |
|----|---------|------------|----------|--------|-------|-------|
| 22.01 | 100k-agent swarm simulator: flocking, pheromone grids, stigmergy | ★ beginner | ⭐ | todo |  |  |
...
| ID | Project | Difficulty | Flagship | Status | Owner | Notes |
|----|---------|------------|----------|--------|-------|-------|
| 31.01 | Hamilton-Jacobi reachability: level-set grid solvers (stencil ops — GPU-perfect) | ★ beginner | ⭐ | todo |  |  |
