...
> Generated by `tools/status.py` on 2026-07-12 from `catalog.json`.
...
| 02 Perception — LiDAR & Point Clouds | 11/20 |
...
## 2. Perception — LiDAR & Point Clouds (`02-perception-lidar-point-clouds`) — 11/20 done
