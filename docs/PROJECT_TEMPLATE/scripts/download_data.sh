#!/usr/bin/env bash
# ===========================================================================
# download_data.sh — public-dataset fetcher for {{PROJECT_ID}} ({{PROJECT_NAME}})
...
echo "[download_data] Project {{PROJECT_ID}} uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
