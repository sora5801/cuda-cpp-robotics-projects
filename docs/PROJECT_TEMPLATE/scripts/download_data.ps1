# ===========================================================================
# download_data.ps1 — public-dataset fetcher for {{PROJECT_ID}} ({{PROJECT_NAME}})
#
...
Write-Host "[download_data] Project {{PROJECT_ID}} uses synthetic sample data (repo default; CLAUDE.md paragraph 8)."
