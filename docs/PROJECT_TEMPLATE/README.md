...
**Difficulty:** {{DIFFICULTY_BADGE}} · **Domain:** {{DOMAIN_NUMBER}}. {{DOMAIN_TITLE}}

> Catalog bullet (source of truth, verbatim): `{{RAW_BULLET}}`
>
...
1. Open [`build/{{PROJECT_SLUG}}.sln`](build/{{PROJECT_SLUG}}.sln) in Visual Studio 2026.
2. Select the `Release|x64` configuration.
3. Build (Ctrl+Shift+B). The executable lands at `build/x64/Release/{{PROJECT_SLUG}}.exe`.
